...
public class CredentialDataRequest {
    ...
    public static final class Builder {
         ...
         * key for a credential presentation is significantly smaller than the inconvenience of not
         * being able to present the credential at all.
         *
         * <p>By default this is set to true.
         *
         ...
         * consider an application doing a credential presentation for the sole purpose of display
         * the credential data to the user in a way that is not for presentation to a verifier.
         *
         * <p>By default this is set to true.
         *
