...
public class CredentialDataRequest {
    ...
    public static final class Builder {
         ...
         * key for a credential presentation significantly outweighs the inconvenience of not being
         * able to present the credential at all.
         *
         * <p>By default this is set to true.
         *
         ...
         *
         * <p>Not incremeting the use-count for an authentication key is useful in situations where
         * the authentication key is known with certainty to not be leaked. For example, consider
         * an application doing a credential presentation for the sole purpose of display the
         * credential data to the user in a way that is not for presentation to a verifier.
         *
         * <p>By default this is set to true.
         *
