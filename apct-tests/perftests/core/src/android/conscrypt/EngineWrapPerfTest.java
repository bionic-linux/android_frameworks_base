    ...
    public Collection getParams() {
        ...
        for (EngineFactory engineFactory : EngineFactory.values()) {
            for (BufferType bufferType : BufferType.values()) {
                params.add(new Object[] {new Config(bufferType, engineFactory, 64, "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256")});
                params.add(new Object[] {new Config(bufferType, engineFactory, 512, "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256")});
                params.add(new Object[] {new Config(bufferType, engineFactory, 4096, "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256")});
            }
        }
        return params;
    }
