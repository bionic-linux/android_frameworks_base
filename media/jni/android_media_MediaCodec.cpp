...
static jobject getJavaResources(
        JNIEnv *env,
        const std::vector<sp<MediaCodec::InstanceResourceInfo>>& resources) {
    jobject resourcesObj = env->NewObject(gArrayListInfo.clazz, gArrayListInfo.ctorId);
    for (const sp<MediaCodec::InstanceResourceInfo>& res : resources) {
...
status_t JMediaCodec::getRequiredResources(JNIEnv *env, jobject *resourcesObj) {
    std::vector<sp<MediaCodec::InstanceResourceInfo>> resources;
...
static jobject getJavaResources(
        JNIEnv *env,
        const std::vector<sp<MediaCodec::GlobalResourceInfo>>& resources) {
    jobject resourcesObj = env->NewObject(gArrayListInfo.clazz, gArrayListInfo.ctorId);
    for (const sp<MediaCodec::GlobalResourceInfo>& res : resources) {
...
static jobject android_media_MediaCodec_getGloballyAvailableResources(
        JNIEnv *env, jobject thiz) {
    (void)thiz;
    std::vector<sp<MediaCodec::GlobalResourceInfo>> resources;
