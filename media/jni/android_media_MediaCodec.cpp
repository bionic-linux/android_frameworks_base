...
static jobject getJavaResources(
    ...
    for (const MediaCodec::InstanceResourceInfo& res : resources) {
        ...
        env->SetLongField(object, gInstanceResourceInfo.resourceId, (jlong)res.mId);
...
static jobject getJavaResources(
    ...
    for (const MediaCodec::GlobalResourceInfo& res : resources) {
        ...
        env->SetLongField(object, gGlobalResourceInfo.resourceId, (jlong)res.mId);
...
static void android_media_MediaCodec_native_init(JNIEnv *env, jclass) {
    ...
    gGlobalResourceInfo.resourceId = env->GetFieldID(clazz.get(), "mId", "J");
    ...
    gInstanceResourceInfo.resourceId = env->GetFieldID(clazz.get(), "mId", "J");
