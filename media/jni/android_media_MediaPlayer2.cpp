...
void JNIMediaPlayer2Listener::notify(int64_t srcId, int msg, int ext1, int ext2,
    ...
    if (obj && obj->dataSize() > 0) {
        ...
        if (jParcel != NULL) {
            ...
            env->CallStaticVoidMethod(mClass, fields.post_event, mObject, srcId, msg, ext1, ext2,
                                      jParcel);
            env->DeleteLocalRef(jParcel);
        }
    } else {
        env->CallStaticVoidMethod(mClass, fields.post_event, mObject, srcId, msg, ext1, ext2, NULL);
    }
...
static void android_media_MediaPlayer2_handleDataSourceUrl(JNIEnv* env, jobject thiz,
                                                           jboolean isCurrent, jlong srcId,
                                                           jobject httpServiceObj, jstring path,
    ...
    if (!ConvertKeyValueArraysToKeyedVector(env, keys, values, &dsd->mHeaders)) {
        return;
    }
    ...
    process_media_player_call(env, thiz, err, "java/io/IOException", "handleDataSourceUrl failed.");
}

static void android_media_MediaPlayer2_handleDataSourceFD(JNIEnv* env, jobject thiz,
                                                          jboolean isCurrent, jlong srcId,
    ...
    ALOGV("handleDataSourceFD: srcId=%lld, fd=%d (%s), offset=%lld, length=%lld", (long long)srcId,
    ...
    process_media_player_call(env, thiz, err, "java/io/IOException", "handleDataSourceFD failed.");
}

static void android_media_MediaPlayer2_handleDataSourceCallback(JNIEnv* env, jobject thiz,
                                                                jboolean isCurrent, jlong srcId,
                                                                jobject dataSource) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
    ...
    process_media_player_call(env, thiz, err, "java/lang/RuntimeException",
                              "handleDataSourceCallback failed.");
}

static sp<ANativeWindowWrapper> getVideoSurfaceTexture(JNIEnv* env, jobject thiz) {
...
static void setVideoSurface(JNIEnv* env, jobject thiz, jobject jsurface,
                            jboolean mediaPlayerMustBeAlive) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
...
static void android_media_MediaPlayer2_setVideoSurface(JNIEnv* env, jobject thiz,
                                                       jobject jsurface) {
    setVideoSurface(env, thiz, jsurface, true /* mediaPlayerMustBeAlive */);
}

static jobject android_media_MediaPlayer2_getBufferingParams(JNIEnv* env, jobject thiz) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return NULL;
    ...
    process_media_player_call(env, thiz, mp->getBufferingSettings(&settings),
...
static void android_media_MediaPlayer2_setBufferingParams(JNIEnv* env, jobject thiz,
                                                          jobject params) {
    if (params == NULL) {
        return;
    }
    ...
    process_media_player_call(env, thiz, mp->setBufferingSettings(bp.settings),
                              "java/lang/IllegalStateException", "unexpected error");
}

static void android_media_MediaPlayer2_playNextDataSource(JNIEnv* env, jobject thiz, jlong srcId) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return;
...
static void android_media_MediaPlayer2_prepare(JNIEnv* env, jobject thiz) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return;
...
static void android_media_MediaPlayer2_start(JNIEnv* env, jobject thiz) {
    ALOGV("start");
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static void android_media_MediaPlayer2_stop(JNIEnv* env, jobject thiz) {
    ALOGV("stop");
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static void android_media_MediaPlayer2_pause(JNIEnv* env, jobject thiz) {
    ALOGV("pause");
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static jboolean android_media_MediaPlayer2_isPlaying(JNIEnv* env, jobject thiz) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return JNI_FALSE;
...
static void android_media_MediaPlayer2_setPlaybackParams(JNIEnv* env, jobject thiz,
                                                         jobject params) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
    ...
    ALOGV("setPlaybackParams: %d:%f %d:%f %d:%u %d:%u", pbp.speedSet, pbp.audioRate.mSpeed,
          pbp.pitchSet, pbp.audioRate.mPitch, pbp.audioFallbackModeSet, pbp.audioRate.mFallbackMode,
    ...
    process_media_player_call(env, thiz, err, "java/lang/IllegalStateException",
                              "unexpected error");
}

static jobject android_media_MediaPlayer2_getPlaybackParams(JNIEnv* env, jobject thiz) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return NULL;
    ...
    process_media_player_call(env, thiz, mp->getPlaybackSettings(&audioRate),
                              "java/lang/IllegalStateException", "unexpected error");
    if (env->ExceptionCheck()) {
        return nullptr;
    }
    ALOGV("getPlaybackSettings: %f %f %d %d", audioRate.mSpeed, audioRate.mPitch,
          audioRate.mFallbackMode, audioRate.mStretchMode);
...
static void android_media_MediaPlayer2_setSyncParams(JNIEnv* env, jobject thiz, jobject params) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return;
    ...
    ALOGV("setSyncParams: %d:%d %d:%d %d:%f %d:%f", scp.syncSourceSet, scp.sync.mSource,
          scp.audioAdjustModeSet, scp.sync.mAudioAdjustMode, scp.toleranceSet, scp.sync.mTolerance,
...
static jobject android_media_MediaPlayer2_getSyncParams(JNIEnv* env, jobject thiz) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return NULL;
    ...
    SyncParams scp;
    scp.frameRate = -1.f;
    process_media_player_call(env, thiz, mp->getSyncSettings(&scp.sync, &scp.frameRate),
                              "java/lang/IllegalStateException", "unexpected error");
    if (env->ExceptionCheck()) {
        return nullptr;
    }

    ALOGV("getSyncSettings: %d %d %f %f", scp.sync.mSource, scp.sync.mAudioAdjustMode,
          scp.sync.mTolerance, scp.frameRate);

    // sanity check params
    if (scp.sync.mSource >= AVSYNC_SOURCE_MAX ||
        scp.sync.mAudioAdjustMode >= AVSYNC_AUDIO_ADJUST_MODE_MAX || scp.sync.mTolerance < 0.f ||
...
static void android_media_MediaPlayer2_seekTo(JNIEnv* env, jobject thiz, jlong msec, jint mode) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return;
...
static void android_media_MediaPlayer2_notifyAt(JNIEnv* env, jobject thiz, jlong mediaTimeUs) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return;
...
static jint android_media_MediaPlayer2_getMediaPlayer2State(JNIEnv* env, jobject thiz) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
...
static jint android_media_MediaPlayer2_getVideoWidth(JNIEnv* env, jobject thiz) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return 0;
...
static jint android_media_MediaPlayer2_getVideoHeight(JNIEnv* env, jobject thiz) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return 0;
...
static jobject android_media_MediaPlayer2_native_getMetrics(JNIEnv* env, jobject thiz) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return 0;
...
static jlong android_media_MediaPlayer2_getCurrentPosition(JNIEnv* env, jobject thiz) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return 0;
...
static jlong android_media_MediaPlayer2_getDuration(JNIEnv* env, jobject thiz) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return 0;
...
static void android_media_MediaPlayer2_reset(JNIEnv* env, jobject thiz) {
    ALOGV("reset");
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static jint android_media_MediaPlayer2_getAudioStreamType(JNIEnv* env, jobject thiz) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return 0;
...
static jboolean android_media_MediaPlayer2_setParameter(JNIEnv* env, jobject thiz, jint key,
...
static jobject android_media_MediaPlayer2_getParameter(JNIEnv* env, jobject thiz, jint key) {
...
static void android_media_MediaPlayer2_setLooping(JNIEnv* env, jobject thiz, jboolean looping) {
...
static jboolean android_media_MediaPlayer2_isLooping(JNIEnv* env, jobject thiz) {
    ALOGV("isLooping");
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static void android_media_MediaPlayer2_setVolume(JNIEnv* env, jobject thiz, jfloat leftVolume,
                                                 jfloat rightVolume) {
    ...
    process_media_player_call(env, thiz, mp->setVolume((float)leftVolume, (float)rightVolume), NULL,
                              NULL);
}

// Sends the request and reply parcels to the media player via the
// binder interface.
static jint android_media_MediaPlayer2_invoke(JNIEnv* env, jobject thiz, jobject java_request,
                                              jobject java_reply) {
...
static jint android_media_MediaPlayer2_setMetadataFilter(JNIEnv* env, jobject thiz,
                                                         jobject request) {
    sp<MediaPlayer2> media_player = getMediaPlayer(env, thiz);
    if (media_player == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static jboolean android_media_MediaPlayer2_getMetadata(JNIEnv* env, jobject thiz,
                                                       jboolean update_only, jboolean apply_filter,
                                                       jobject reply) {
    sp<MediaPlayer2> media_player = getMediaPlayer(env, thiz);
    if (media_player == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static void android_media_MediaPlayer2_native_init(JNIEnv* env) {
    jclass clazz;
...
static void android_media_MediaPlayer2_native_setup(JNIEnv* env, jobject thiz, jobject weak_this) {
    ALOGV("native_setup");
...
static void android_media_MediaPlayer2_release(JNIEnv* env, jobject thiz) {
    ALOGV("release");
    decVideoSurfaceRef(env, thiz);
...
static void android_media_MediaPlayer2_native_finalize(JNIEnv* env, jobject thiz) {
...
static void android_media_MediaPlayer2_setAuxEffectSendLevel(JNIEnv* env, jobject thiz,
                                                             jfloat level) {
...
static void throwDrmStateException(JNIEnv* env, const char* msg, status_t err) {
    ...
    jobject exception = env->NewObject(gStateExceptionFields.classId, gStateExceptionFields.init,
...
static void android_media_MediaPlayer2_prepareDrm(JNIEnv* env, jobject thiz, jbyteArray uuidObj,
                                                  jbyteArray drmSessionIdObj) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return;
    ...
    if (drmSessionId.size() == 0) {
        jniThrowException(env, "java/lang/IllegalArgumentException", "empty drmSessionId");
        return;
    }
...
/////////////////////////////////////////////////////////////////////////////////////
// AudioRouting begin
static jboolean android_media_MediaPlayer2_setOutputDevice(JNIEnv* env, jobject thiz,
                                                           jint device_id) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        return false;
...
static void android_media_MediaPlayer2_enableDeviceCallback(JNIEnv* env, jobject thiz,
                                                            jboolean enabled) {
    sp<MediaPlayer2> mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        return;
...
static void android_media_MediaPlayer2_native_on_tear_down(JNIEnv* env __unused,
                                                           jobject thiz __unused, jlong callbackPtr,
                                                           jlong userDataPtr) {
...
static const JNINativeMethod gMethods[] = {
        ...
        {"nativeHandleDataSourceFD", "(ZJLjava/io/FileDescriptor;JJ)V",
         (void*)android_media_MediaPlayer2_handleDataSourceFD},
        {"nativeHandleDataSourceCallback", "(ZJLandroid/media/Media2DataSource;)V",
        ...
        {"_setVideoSurface", "(Landroid/view/Surface;)V",
         (void*)android_media_MediaPlayer2_setVideoSurface},
        {"getBufferingParams", "()Landroid/media/BufferingParams;",
         (void*)android_media_MediaPlayer2_getBufferingParams},
        {"_setBufferingParams", "(Landroid/media/BufferingParams;)V",
         (void*)android_media_MediaPlayer2_setBufferingParams},
        {"_prepare", "()V", (void*)android_media_MediaPlayer2_prepare},
        {"_start", "()V", (void*)android_media_MediaPlayer2_start},
        {"_stop", "()V", (void*)android_media_MediaPlayer2_stop},
        {"native_getMediaPlayer2State", "()I",
         (void*)android_media_MediaPlayer2_getMediaPlayer2State},
        ...
        {"native_getMetrics", "()Landroid/os/PersistableBundle;",
         (void*)android_media_MediaPlayer2_native_getMetrics},
        {"_setPlaybackParams", "(Landroid/media/PlaybackParams;)V",
         (void*)android_media_MediaPlayer2_setPlaybackParams},
        {"getPlaybackParams", "()Landroid/media/PlaybackParams;",
         (void*)android_media_MediaPlayer2_getPlaybackParams},
        {"_setSyncParams", "(Landroid/media/SyncParams;)V",
         (void*)android_media_MediaPlayer2_setSyncParams},
        {"getSyncParams", "()Landroid/media/SyncParams;",
         (void*)android_media_MediaPlayer2_getSyncParams},
        ...
        {"native_invoke", "(Landroid/os/Parcel;Landroid/os/Parcel;)I",
         (void*)android_media_MediaPlayer2_invoke},
        {"native_setMetadataFilter", "(Landroid/os/Parcel;)I",
         (void*)android_media_MediaPlayer2_setMetadataFilter},
        {"native_getMetadata", "(ZZLandroid/os/Parcel;)Z",
         (void*)android_media_MediaPlayer2_getMetadata},
        ...
        {"native_enableDeviceCallback", "(Z)V",
         (void*)android_media_MediaPlayer2_enableDeviceCallback},

        // StreamEventCallback for JAudioTrack
        {"native_stream_event_onTearDown", "(JJ)V",
         (void*)android_media_MediaPlayer2_native_on_tear_down},
        {"native_stream_event_onStreamPresentationEnd", "(JJ)V",
         (void*)android_media_MediaPlayer2_native_on_stream_presentation_end},
        {"native_stream_event_onStreamDataRequest", "(JJJ)V",
         (void*)android_media_MediaPlayer2_native_on_stream_data_request},
};

// This function only registers the native methods
static int register_android_media_MediaPlayer2Impl(JNIEnv* env) {
    return AndroidRuntime::registerNativeMethods(env, "android/media/MediaPlayer2Impl", gMethods,
                                                 NELEM(gMethods));
}
