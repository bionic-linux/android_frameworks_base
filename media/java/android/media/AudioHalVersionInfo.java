...
public final class AudioHalVersionInfo implements Parcelable, Comparable<AudioHalVersionInfo> {
    ...
    public static final @NonNull List<List<Integer>> VERSIONS =
            List.of(
                    List.of(AUDIO_HAL_TYPE_AIDL, 1 /* major */, 0 /* minor */), /* AIDL1.0 */
                    List.of(AUDIO_HAL_TYPE_HIDL, 7 /* major */, 1 /* minor */), /* HIDL7.1 */
                    List.of(AUDIO_HAL_TYPE_HIDL, 7 /* major */, 0 /* minor */), /* HIDL7.0 */
                    List.of(AUDIO_HAL_TYPE_HIDL, 6 /* major */, 0 /* minor */), /* HIDL6.0 */
                    List.of(AUDIO_HAL_TYPE_HIDL, 5 /* major */, 0 /* minor */), /* HIDL5.0 */
                    List.of(AUDIO_HAL_TYPE_HIDL, 4 /* major */, 0 /* minor */), /* HIDL4.0 */
                    List.of(AUDIO_HAL_TYPE_HIDL, 2 /* major */, 0 /* minor */), /* HIDL2.0 */
                    List.of(AUDIO_HAL_TYPE_HIDL, 1 /* major */, 0 /* minor */) /* HIDL1.0 */);
    ...
    private static final int VERSION_LIST_SIZE = 3;
    private static final int VERSION_LIST_INDEX_TYPE = 0;
    private static final int VERSION_LIST_INDEX_MAJOR = 1;
    private static final int VERSION_LIST_INDEX_MINOR = 2;
    ...
    public static @AudioHalType int getHalType(@NonNull List<Integer> tuple) {
        if (tuple.size() != VERSION_LIST_SIZE) {
            return INVALID;
        }
        return tuple.get(VERSION_LIST_INDEX_TYPE);
    }
    ...
    public static int getMajorVersion(@NonNull List<Integer> tuple) {
        ...
        return tuple.get(VERSION_LIST_INDEX_MAJOR);
    }
    ...
    public static int getMinorVersion(@NonNull List<Integer> tuple) {
        ...
        return tuple.get(VERSION_LIST_INDEX_MINOR);
    }
