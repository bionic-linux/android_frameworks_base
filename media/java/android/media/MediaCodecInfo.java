        ...
        public final boolean isFormatSupported(MediaFormat format) {
            ...
            if (profile != null) {
                ...
                final Set<String> criticalKeys =
                        isVideo() ? VideoCapabilities.VideoCapsLegacyImpl.VIDEO_LEVEL_CRITICAL_FORMAT_KEYS :
                        isAudio() ? AudioCapabilities.AudioCapsLegacyImpl.AUDIO_LEVEL_CRITICAL_FORMAT_KEYS :
                        null;
