...
public final class MediaCodecInfo {
    ...
    public static final class CodecCapabilities {
         ...
         * session.
         * <p>
         * In a shot, if a group of LCUs pan out quickly they can be marked as non-critical there
         * by enabling the encoder to reserve fewer bits during their encoding. Contrarily, LCUs
         * that remain in shot for a prolonged duration can be encoded at better quality in one
         * frame thereby setting-up an excellent long-term reference for all future frames.
         * <p>
