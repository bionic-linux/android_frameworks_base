    ...
    public static final class VideoCapabilities {
        ...
        public static final class PerformancePoint {
            ...
            /* package private */ boolean isEqualDimension(@NonNull PerformancePoint other) {
                int otherWidth = other.mWidth * other.mBlockSize.getWidth();
                int otherHeight = other.mHeight * other.mBlockSize.getHeight();
                return mWidth * mBlockSize.getWidth() == otherWidth
                        && mHeight * mBlockSize.getHeight() == otherHeight;
            }
