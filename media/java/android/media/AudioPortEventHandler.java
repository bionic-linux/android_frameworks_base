...
class AudioPortEventHandler {
                    ...
                    public void handleMessage(Message msg) {
                        ...
                        synchronized (mLock) {
                            if (msg.what == AUDIOPORT_EVENT_NEW_LISTENER) {
                                listeners = new ArrayList<WeakReference<AudioManager.OnAudioPortUpdateListener>>();
                                if (mListeners.contains(msg.obj)) {
                                    listeners.add(
                                            (WeakReference<AudioManager.OnAudioPortUpdateListener>) msg.obj);
                                }
                            } else {
    ...
    void registerListener(AudioManager.OnAudioPortUpdateListener l) {
        Preconditions.checkNotNull(l, "OnAudioPortUpdateListener shall not be null");
