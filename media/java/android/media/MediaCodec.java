...
final public class MediaCodec {
    ...
    public static class MediaImage extends Image {
        ...
        public MediaImage(
            ...
            // read media-info.  the size of media info can be 80, 156 or 160 depending on
            ...
            if (info.remaining() == 80 || info.remaining() == 156 || info.remaining() == 160) {
                boolean sizeIsLong = info.remaining() == 156 || info.remaining() == 160;
                int type = info.getInt();
                if (info.remaining() == 156) { // If the original size was 160
                    info.getInt(); // Skip 4 padding bytes
                }
                if (type != TYPE_YUV) {
