...
public final class TvInputManager {
    ...
    public static final class Session {
         ...
         * Returns empty TvAudioPresentation list if no presentations are available.
         */
         ...
         * Returns {@value TvAudioPresentation.PROGRAM_ID_UNKNOWN} if no audio presentation has
         ...
         * Returns {@value TvAudioPresentation.PRESENTATION_ID_UNKNOWN} if no audio presentation
         * has been selected.
         * @see #selectAudioPresentation
         */
