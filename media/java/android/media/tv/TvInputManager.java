...
public final class TvInputManager {
    ...
    public static final class Session {
        ...
        // @GuardedBy("mMetadataLock")
        private int mSelectedAudioProgramId = TvAudioPresentation.PROGRAM_ID_UNKNOWN;
        // @GuardedBy("mMetadataLock")
        private int mSelectedAudioPresentationId = TvAudioPresentation.PRESENTATION_ID_UNKNOWN;
        // @GuardedBy("mMetadataLock")
        ...
        public void tune(@NonNull Uri channelUri, Bundle params) {
            ...
            synchronized (mMetadataLock) {
                ...
                mSelectedAudioProgramId = TvAudioPresentation.PROGRAM_ID_UNKNOWN;
                mSelectedAudioPresentationId = TvAudioPresentation.PRESENTATION_ID_UNKNOWN;
        ...
        public void selectAudioPresentation(int presentationId, int programId) {
            synchronized (mMetadataLock) {
                if (presentationId != TvAudioPresentation.PRESENTATION_ID_UNKNOWN
        ...
        private boolean containsAudioPresentation(List<TvAudioPresentation> audioPresentations,
                    int presentationId) {
            synchronized (mMetadataLock) {
                for (TvAudioPresentation audioPresentation : audioPresentations) {
         ...
         * Returns empty TvAudioPresentation list if no presentation is available.
         */
        public List<TvAudioPresentation> getAudioPresentations() {
            synchronized (mMetadataLock) {
                ...
                return new ArrayList<TvAudioPresentation>(mAudioPresentations);
            }
        }
         ...
         * Returns {@value TvAudioPresentation.PROGRAM_ID_UNKNOWN} no audio presentation has been
         * selected from a program.
         ...
         * Returns {@value TvAudioPresentation.PRESENTATION_ID_UNKNOWN} no audio presentation has
         * been selected.
         * @see #selectAudioPresentation
         */
        ...
        boolean updateAudioPresentations(List<TvAudioPresentation> audioPresentations) {
            synchronized (mMetadataLock) {
                mAudioPresentations.clear();
                for (TvAudioPresentation presentation : audioPresentations) {
