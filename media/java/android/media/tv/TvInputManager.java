...
public final class TvInputManager {
    ...
    public final static class Hardware {
        ...
        public void overrideAudioSinkWithDeviceType(int deviceType, @Nullable String audioAddress, int samplingRate,
                int channelMask, int format) {
            try {
                mInterface.overrideAudioSinkWithDeviceType(deviceType, audioAddress, samplingRate, channelMask,
                        format);
            } catch (RemoteException e) {
                throw new RuntimeException(e);
            }
