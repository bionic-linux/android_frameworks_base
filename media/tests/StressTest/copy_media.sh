...
adbOptions=" "
resLabel=StressTestRes-1.0
srcDir="/tmp/$resLabel"
tgtDir="/data/local/tmp"
...
if [ ! -f "/tmp/$resLabel.zip" ]; then
  wget "https://storage.googleapis.com/android_media/frameworks/base/media/tests/StressTest/$resLabel.zip" -O /tmp/$resLabel.zip
fi
