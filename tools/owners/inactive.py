...
# Usage:
# ganpati2 --ganpati2=ganpati2  membership list --parent %android-team-auto.prod > /path/to/active/ldaps
# ganpati2 --ganpati2=ganpati2  membership list --parent %android-access.prod >> /path/to/active/ldaps
# inactive.py /path/to/active/ldaps
