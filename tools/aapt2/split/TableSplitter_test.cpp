...
TEST(TableSplitterTest, NoSplitPreferredDensity) {
  ...
  EXPECT_EQ(nullptr, test::GetValueForConfig<FileReference>(table.get(), "android:drawable/icon",
                                                            test::ParseConfigOrDie("mdpi")));
  EXPECT_EQ(nullptr, test::GetValueForConfig<FileReference>(table.get(), "android:drawable/icon",
                                                            test::ParseConfigOrDie("hdpi")));
  EXPECT_NE(nullptr, test::GetValueForConfig<FileReference>(table.get(), "android:drawable/icon",
                                                            test::ParseConfigOrDie("xhdpi")));
  EXPECT_EQ(nullptr, test::GetValueForConfig<FileReference>(table.get(), "android:drawable/icon",
                                                            test::ParseConfigOrDie("xxhdpi")));
...
TEST(TableSplitterTest, SplitTableByDensity) {
  ...
  EXPECT_NE(nullptr, test::GetValueForConfig<FileReference>(split_one, "android:drawable/foo",
                                                            test::ParseConfigOrDie("mdpi")));
  EXPECT_EQ(nullptr, test::GetValueForConfig<FileReference>(split_one, "android:drawable/foo",
                                                            test::ParseConfigOrDie("hdpi")));
  EXPECT_EQ(nullptr, test::GetValueForConfig<FileReference>(split_one, "android:drawable/foo",
                                                            test::ParseConfigOrDie("xhdpi")));
  EXPECT_EQ(nullptr, test::GetValueForConfig<FileReference>(split_one, "android:drawable/foo",
  ...
  EXPECT_EQ(nullptr, test::GetValueForConfig<FileReference>(split_two, "android:drawable/foo",
                                                            test::ParseConfigOrDie("mdpi")));
  EXPECT_NE(nullptr, test::GetValueForConfig<FileReference>(split_two, "android:drawable/foo",
                                                            test::ParseConfigOrDie("hdpi")));
  EXPECT_EQ(nullptr, test::GetValueForConfig<FileReference>(split_two, "android:drawable/foo",
                                                            test::ParseConfigOrDie("xhdpi")));
  EXPECT_EQ(nullptr, test::GetValueForConfig<FileReference>(split_two, "android:drawable/foo",
  ...
  EXPECT_EQ(nullptr, test::GetValueForConfig<FileReference>(split_three, "android:drawable/foo",
                                                            test::ParseConfigOrDie("mdpi")));
  EXPECT_EQ(nullptr, test::GetValueForConfig<FileReference>(split_three, "android:drawable/foo",
                                                            test::ParseConfigOrDie("hdpi")));
  EXPECT_NE(nullptr, test::GetValueForConfig<FileReference>(split_three, "android:drawable/foo",
                                                            test::ParseConfigOrDie("xhdpi")));
  EXPECT_EQ(nullptr, test::GetValueForConfig<FileReference>(split_three, "android:drawable/foo",
                                                            test::ParseConfigOrDie("xxhdpi")));
}
...
TEST(TableSplitterTest, SplitTableByConfigAndDensity) {
  ...
  ASSERT_TRUE(table.AddResource(foo, test::ParseConfigOrDie("land-hdpi"), {},
                                util::make_unique<Id>(), test::GetDiagnostics()));
  ...
  EXPECT_NE(nullptr, test::GetValueForConfig<Id>(split_one, "android:string/foo",
                                                 test::ParseConfigOrDie("land-hdpi")));
  EXPECT_EQ(nullptr, test::GetValueForConfig<Id>(split_one, "android:string/foo",
                                                 test::ParseConfigOrDie("land-xhdpi")));
  EXPECT_EQ(nullptr, test::GetValueForConfig<Id>(split_one, "android:string/foo",
                                                 test::ParseConfigOrDie("land-xxhdpi")));

  EXPECT_EQ(nullptr, test::GetValueForConfig<Id>(split_two, "android:string/foo",
                                                 test::ParseConfigOrDie("land-hdpi")));
  EXPECT_NE(nullptr, test::GetValueForConfig<Id>(split_two, "android:string/foo",
                                                 test::ParseConfigOrDie("land-xhdpi")));
  EXPECT_EQ(nullptr, test::GetValueForConfig<Id>(split_two, "android:string/foo",
                                                 test::ParseConfigOrDie("land-xxhdpi")));
}
