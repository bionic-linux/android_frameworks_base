...
public class Main {
     ...
     */
    public final static int HPROF_TIMEOUT = 120000;
    ...
    public Main() {
        ...
        clientUtils = new ClientUtils(DEFAULT_TIMEOUT);  // Client utils with 10s timeout.
    ...
    private void initDevice() {
        DeviceUtils.init(DEFAULT_TIMEOUT);

        IDevice devices[] = DeviceUtils.findDevices(DEFAULT_TIMEOUT);
