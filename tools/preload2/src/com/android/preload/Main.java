...
public class Main {
    ...
    public Main() {
        ...
        actions.add(new ReloadListAction(null, clientListModel));
        actions.add(new ClearTableAction(dataTableModel));
        actions.add(new RunMonkeyAction(null, dataTableModel));
        actions.add(new ScanPackageAction(null, dataTableModel));
        actions.add(new ScanAllPackagesAction(null, dataTableModel));
    ...
    private void startUp() {
        ...
        // Load clients.
        new ReloadListAction(getDevice(), clientListModel).run();
