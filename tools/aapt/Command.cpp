...
int doPackage(Bundle* bundle)
{
    ...
    if (filter.containsPseudo()) {
        bundle->setPseudolocalize(bundle->getPseudolocalize() | kPseudolocalizationAccented);
    }
    if (filter.containsPseudoBidi()) {
        bundle->setPseudolocalize(bundle->getPseudolocalize() | kPseudolocalizationBidi);
    }
