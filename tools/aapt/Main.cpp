...
void usage(void) {
    ...
    fprintf(stderr,
            ...
            "   --app-as-shared-lib\n"
            "       Make an app resource package that also can be loaded as shared library at "
            "runtime.\n"
            ...
            "       Forces aapt to return an error if it fails to find an entry for a "
            "configuration.\n"
            "   --output-text-symbols\n"
            ...
            case 'p':
                ...
                case '-':
                    if (strcmp(cp, "-debug-mode") == 0) {
                        ...
                        if (!argc) {
                            fprintf(stderr,
                                    "ERROR: No argument supplied for '--target-sdk-version' "
                                    "option\n");
                            wantUsage = true;
                            goto bail;
                        }
                        ...
                        if (!argc) {
                            fprintf(stderr,
                                    "ERROR: No argument supplied for '--preferred-density' "
                                    "option\n");
                            wantUsage = true;
                            goto bail;
                        }
                        ...
                        if (!argc) {
                            fprintf(stderr,
                                    "ERROR: No argument supplied for '--rename-manifest-package' "
                                    "option\n");
                            wantUsage = true;
                            goto bail;
                        }
                        ...
                        if (!argc) {
                            fprintf(stderr,
                                    "ERROR: No argument supplied for "
                                    "'--rename-instrumentation-target-package' option\n");
                            wantUsage = true;
                            goto bail;
                        }
                        ...
                        if (!argc) {
                            fprintf(stderr,
                                    "ERROR: No argument supplied for '-output-text-symbols' "
                                    "option\n");
                            wantUsage = true;
                            goto bail;
                        }
