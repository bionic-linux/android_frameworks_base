...
public final class rsMath {
    ...
    /**
     * Return the inverse cosine of Float.
     *
     * @param data
     * @return
     */
    public static Float acos(Float data) {
        double dx;
        dx = data.x;
        dx = Math.acos(dx);

        return new Float((float)dx);
    }
    ...
    /**
     * Return the inverse hyperbolic cosine of float.
     *
     * @param data
     * @return
     */
    public static Float acosh(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Return the value of inverse cosine divided by PI of Float.
     *
     * @param data
     * @return
     */
    public static Float acospi(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Return the inverse sine of Float.
     *
     * @param data
     * @return
     */
    public static Float asin(Float data) {
        double dx;
        dx = data.x;
        dx = Math.asin(dx);
    ...
    /**
     * Return the inverse hyperbolic sine of Float.
     *
     * @param data
     * @return
     */
    public static Float asinh(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Return the value of inverse sine divided by PI of Float.
     *
     * @param data
     * @return
     */
    public static Float asinpi(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Return the inverse tangent of Float.
     *
     * @param data
     * @return
     */
    public static Float atan(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Return the atan2 value of Float.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Return the inverse hyperbolic tangent of float.
     *
     * @param data
     * @return
     */
    public static Float atanh(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Return the value of inverse tangent divided by PI of Float.
     *
     * @param data
     * @return
     */
    public static Float atanpi(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Return the inverse tangent with 2 parameters divided by PI of Float.
     *
     * @param a
     * @param b
     * @return
     */
    public static Float atan2pi(Float a, Float b) {
        double dx;
    ...
    /**
     * Return the cube root of Float.
     *
     * @param data
     * @return
     */
    public static Float cbrt(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Return the double value greater or equal to the Float.
     *
     * @param data
     * @return
     */
    public static Float ceil(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Copy the sign bit from b to a of Float.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Return the cosine value of Float.
     *
     * @param data
     * @return
     */
    public static Float cos(Float data) {
        double dx;
    ...
    /**
     * Return the hyperbolic cosine of Float.
     *
     * @param data
     * @return
     */
    public static Float cosh(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Return the cosine of the value multiplied by PI of Float.
     *
     * @param data
     * @return
     */
    public static Float cospi(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Return the vector distance of Float.
     *
     * @param a
     * @param b
     * @return
    ...
    public static Float dot(Float2 a, Float2 b) {
        return new Float(a.x * b.x + a.y * b.y);
    }
    ...
    /**
     * Convert from radians to degrees of Float.
     *
     * @param data
     * @return
     */
    public static Float degrees(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Return the error function of Float.
     *
     * @param data
     * @return
     */
    ...
    public static Float2 erf(Float2 data) {
        ...
        dx = erf(new Float(data.x)).x;
        dy = erf(new Float(data.y)).x;
    ...
    /**
     * Returns Euler's number e raised to the power of Float.
     *
     * @param data
     * @return
     */
    public static Float exp(Float data) {
        double dx;
    ...
    /**
     * Returns 2 raised to the power of Float.
     *
     * @param data
     * @return
     */
    public static Float exp2(Float data) {
        double dx;
    ...
    /**
     * Calculates Float raised to the power of "exponent".
     *
     * @param data
     * @param exponent
     * @return
     */
    public static Float pow(Float data, Float exponent) {
        double dx;

        dx = Math.pow(data.x, exponent.x);
    ...
    public static Float4 pow(Float4 data, Float exponent) {
        ...
        dy = Math.pow(data.y, exponent.x);
        dz = Math.pow(data.z, exponent.x);
        dw = Math.pow(data.w, exponent.x);

        return new Float4((float)dx, (float)dy, (float)dz, (float)dw);
    }

    /**
     * Return ten raised to the power of Float.
     *
     * @param data
     * @return
     */
    public static Float exp10(Float data) {
        double dx;
        dx = data.x;
        dx = Math.pow(10, dx);
    ...
    /**
     * Return e raised to the power of Float and then minus one.
     *
     * @param data
     * @return
     */
    public static Float expm1(Float data) {
        double dx;
        dx = data.x;
        dx = Math.expm1(dx);
    ...
    /**
     * Return the fast distance value of Float2.
     *
     * @param a
     * @param b
     * @return
    ...
    public static Float2 clamp(Float2 data, Float low, Float high) {
        ...
        dx = data.x < low.x ? low.x : (data.x > high.x ? high.x : data.x);
        dy = data.y < low.x ? low.x : (data.y > high.x ? high.x : data.y);
    ...
    public static Float3 clamp(Float3 data, Float low, Float high) {
        ...
        dx = data.x < low.x ? low.x : (data.x > high.x ? high.x : data.x);
        dy = data.y < low.x ? low.x : (data.y > high.x ? high.x : data.y);
        dz = data.z < low.x ? low.x : (data.z > high.x ? high.x : data.z);
    ...
    public static Float4 clamp(Float4 data, Float low, Float high) {
        ...
        dy = data.y < low.x ? low.x : (data.y > high.x ? high.x : data.y);
        dz = data.z < low.x ? low.x : (data.z > high.x ? high.x : data.z);
        dw = data.w < low.x ? low.x : (data.w > high.x ? high.x : data.w);
    ...
    public static Float fmax(Float v1, Float v2) {
        return new Float(Math.max(v1.x, v2.x));
    }
     ...
     * @return
     */
    public static Float fmin(Float v1, Float v2) {
        return new Float(Math.min(v1.x, v2.x));
    }
     ...
     * @return
     */
    public static Float half_sqrt(Float data) {
        double dx;
        dx = data.x;
    ...
    public static Float ldexp(Float v1, Int v2) {
        return new Float((float)(v1.x * Math.pow(2, v2.x)));
    }
    ...
    /**
     * Return the natural logarithm of Float.
     *
     * @param data
     * @return
     */
    ...
    /**
     * Return the base 10 logarithm of Float.
     *
     * @param data
     * @return
     */
     ...
     * @return
     */
    public static Float nextafter(Float a, Float b) {
        float dx;
    ...
    /**
     * Return vector data ^ n of Float.
     *
     * @param data
     * @param n
     * @return
     */
    public static Float pown(Float data, Int n) {
        double dx;

        dx = Math.pow(data.x, n.x);
    ...
    /**
     * Return the sine of Float.
     *
     * @param data
     * @return
     */
    public static Float sin(Float data) {
        double dx;
        dx = data.x;
        dx = Math.sin(dx);
    ...
    public static Float mix(Float start, Float stop, Float amount) {
        Float sub = Float.sub(stop, start);
        Float mul = Float.mul(sub, amount);

        return Float.add(mul, start);
    }
    ...
    public static Float mad(Float a, Float b, Float c) {
        return Float.add(Float.mul(a, b), c);
    }
    ...
    public static Float2 modf(Float a) {
        ...
        double value = Math.abs(a.x);
        double intPart = Math.floor(value);
        double dotPart = value - intPart;
        Float fIpart = new Float((float) intPart);
        Float fdpart = new Float((float) dotPart);
        if (a.x < 0) {
            fIpart.negate();
            fdpart.negate();
        }
     ...
     * @return
     */
    public static Float rint(Float data) {
        double dx;
        dx = Math.rint(data.x);
    ...
    public static Float rootn(Float data, Int n) {
        double[] dv = new double[] {data.x};
        double[] dr = new double[1];
        for (int i = 0; i < 1; i++) {
            if (dv[i] > 0) {
                if (n.x != 0) {
                    dr[i] = Math.pow(dv[i], 1.f / n.x);
                } else {
            ...
            if (dv[i] < 0) {
                if ((n.x % 2) == 0.f) {
                    ...
                    dr[i] = -1 * Math.pow(-1 * dv[i], 1.f / n.x);
                }
            }
        }

        return new Float((float)dr[0]);
    }
    ...
    /**
     * Return the bigger one between Float.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Return the bigger one between UChar.
     *
     * @param a
     * @param b
     * @return
    ...
    public static UChar max(UChar a, UChar b) {
        ...
        UChar dx = new UChar(a.getValue() > b.getValue() ? a.getValue() : b.getValue());

        return new UChar(dx);
    }

    /**
     * Return the bigger one between UChar2.
     *
     * @param a
     * @param b
     * @return
     */
    public static UChar2 max(UChar2 a, UChar2 b) {

        UChar dx = new UChar(max(a.x, b.x));
        UChar dy = new UChar(max(a.y, b.y));

        return new UChar2(dx, dy);
    }

    /**
     * Return the bigger one between UChar3.
     *
     * @param a
     * @param b
     * @return
     */
    public static UChar3 max(UChar3 a, UChar3 b) {

        UChar dx = new UChar(max(a.x, b.x));
        UChar dy = new UChar(max(a.y, b.y));
        UChar dz = new UChar(max(a.z, b.z));

        return new UChar3(dx, dy, dz);
    }

    /**
     * Return the bigger one between UChar4.
     *
     * @param a
     * @param b
     * @return
     */
    public static UChar4 max(UChar4 a, UChar4 b) {

        UChar dx = new UChar(max(a.x, b.x));
        UChar dy = new UChar(max(a.y, b.y));
        UChar dz = new UChar(max(a.z, b.z));
        UChar dw = new UChar(max(a.w, b.w));

        return new UChar4(dx, dy, dz, dw);
    }

    /**
     * Return the bigger one between Char.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Return the bigger one between Char2.
     *
     * @param a
     * @param b
     * @return
     */
    public static Char2 max(Char2 a, Char2 b) {
        byte dx, dy;

        dx = a.x > b.x ? a.x : b.x;
        dy = a.y > b.y ? a.y : b.y;

        return new Char2(dx, dy);
    }

    /**
     * Return the bigger one between Char3.
     *
     * @param a
     * @param b
     * @return
     */
    public static Char3 max(Char3 a, Char3 b) {
        byte dx, dy, dz;
        ...
        return new Char3(dx, dy, dz);
    }

    /**
     * Return the bigger one between Char4.
     *
     * @param a
     * @param b
     * @return
     */
    public static Char4 max(Char4 a, Char4 b) {
        byte dx, dy, dz, dw;
    ...
    /**
     * Return the bigger one between Short.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Return the bigger one between Int.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Return the smaller one between Float.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Return the smaller one between UChar.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Return the smaller one between UChar2.
     *
     * @param a
     * @param b
     * @return
     */
    public static UChar2 min(UChar2 a, UChar2 b) {

        UChar dx = new UChar(min(a.x, b.x));
        UChar dy = new UChar(min(a.y, b.y));

        return new UChar2(dx, dy);
    }

    /**
     * Return the smaller one between UChar3.
     *
     * @param a
     * @param b
     * @return
     */
    public static UChar3 min(UChar3 a, UChar3 b) {

        UChar dx = new UChar(min(a.x, b.x));
        UChar dy = new UChar(min(a.y, b.y));
        UChar dz = new UChar(min(a.z, b.z));

        return new UChar3(dx, dy, dz);
    }

    /**
     * Return the smaller one between UChar4.
     *
     * @param a
     * @param b
     * @return
     */
    public static UChar4 min(UChar4 a, UChar4 b) {

        UChar dx = new UChar(min(a.x, b.x));
        UChar dy = new UChar(min(a.y, b.y));
        UChar dz = new UChar(min(a.z, b.z));
        UChar dw = new UChar(min(a.w, b.w));
    ...
    /**
     * Return the smaller one between Char2.
     *
     * @param a
     * @param b
     * @return
     */
    public static Char2 min(Char2 a, Char2 b) {
        byte dx, dy;
    ...
    /**
     * Return the smaller one between Char3.
     *
     * @param a
     * @param b
     * @return
     */
    public static Char3 min(Char3 a, Char3 b) {
        byte dx, dy, dz;
    ...
    /**
     * Return the smaller one between Char4.
     *
     * @param a
     * @param b
     * @return
     */
    public static Char4 min(Char4 a, Char4 b) {
        byte dx, dy, dz, dw;
    ...
    /**
     * Return the smaller one between Short.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Return the smaller one between Int.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Return the tangent value of Float.
     *
     * @param data
     * @return
     */
    public static Float tan(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Return the hyperbolic tangent  of Float.
     *
     * @param data
     * @return
     */
    public static Float tanh(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Return the tangent of the value multiplied by PI of Float.
     *
     * @param data
     * @return
     */
    public static Float tanpi(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Returns the absolute value of Short.
     *
     * @param data
     * @return
     */
    public static Short abs(Short data) {
        short dx = data.x;
    ...
    /**
     * Returns the absolute value of Char.
     *
     * @param data
     * @return
     */
    public static Char abs(Char data) {
        byte dx = data.x;
    ...
    /**
     * Returns the absolute value of Char2.
     *
     * @param data
     * @return
     */
    public static Char2 abs(Char2 data) {
        byte dx = data.x;
        byte dy = data.y;
    ...
    /**
     * Returns the absolute value of Char3.
     *
     * @param data
     * @return
     */
    public static Char3 abs(Char3 data) {
        byte dx = data.x;
        byte dy = data.y;
        byte dz = data.z;
    ...
    /**
     * Returns the absolute value of Char4.
     *
     * @param data
     * @return
     */
    public static Char4 abs(Char4 data) {
        byte dx = data.x;
        byte dy = data.y;
        byte dz = data.z;
        byte dw = data.w;
    ...
    /**
     * Compute the gamma function of Float.
     *
     * @param data
     * @return
     */
    public static Float tgamma(Float data) {
        double dx;
        dx = data.x;
    ...
    /**
     * Return the smaller one between Long.
     *
     * @param a
     * @param b
     * @return
    ...
    /**
     * Returns the number of leading 0-bits in Int.
     *
     * @param data
     * @return
     */
    public static Int clz(Int data) {
        int dx;
        dx = clz(data.x);
     ...
     * @return
     */
    private static short clz(short x) {
        short sum = 0;
        for (int i = 1; i <= 16; i++) {
            if ((x & 0x1) == 0) {
                sum++;
    ...
    /**
     * Returns the number of leading 0-bits in Short.
     *
     * @param data
     * @return
     */
    public static Short clz(Short data) {
        short dx;
        dx = clz(data.x);
     ...
     * @return
     */
    private static byte clz(byte x) {
        byte sum = 0;
        for (int i = 1; i <= 8; i++) {
            if ((x & 0x1) == 0) {
                sum++;
    ...
    /**
     * Returns the number of leading 0-bits in Char.
     *
     * @param data
     * @return
     */
    public static Char clz(Char data) {
        byte dx;
        dx = clz(data.x);
    ...
    /**
     * Returns the number of leading 0-bits in Char2.
     *
     * @param data
     * @return
     */
    public static Char2 clz(Char2 data) {
        byte dx, dy;
        dx = clz(data.x);
        dy = clz(data.y);
    ...
    /**
     * Returns the number of leading 0-bits in Char3.
     *
     * @param data
     * @return
     */
    public static Char3 clz(Char3 data) {
        byte dx, dy, dz;
        dx = clz(data.x);
        dy = clz(data.y);
        dz = clz(data.z);
    ...
    /**
     * Returns the number of leading 0-bits in Char4.
     *
     * @param data
     * @return
     */
    public static Char4 clz(Char4 data) {
        byte dx, dy, dz, dw;
        dx = clz(data.x);
        dy = clz(data.y);
        dz = clz(data.z);
    ...
    /**
     * Returns the number of leading 0-bits in UChar.
     *
     * @param data
     * @return
     */
    public static UChar clz(UChar data) {
        char dx = 0;
    ...
    /**
     * Returns the number of leading 0-bits in UChar2.
     *
     * @param data
     * @return
     */
    public static UChar2 clz(UChar2 data) {
        UChar dx, dy;
        dx = clz(data.x);
        dy = clz(data.y);
    ...
    /**
     * Returns the number of leading 0-bits in UChar3.
     *
     * @param data
     * @return
     */
    public static UChar3 clz(UChar3 data) {
        UChar dx, dy, dz;
        dx = clz(data.x);
        dy = clz(data.y);
        dz = clz(data.z);
    ...
    /**
     * Returns the number of leading 0-bits in UChar4.
     *
     * @param data
     * @return
     */
    public static UChar4 clz(UChar4 data) {
        UChar dx, dy, dz, dw;
        dx = clz(data.x);
        dy = clz(data.y);
        dz = clz(data.z);
