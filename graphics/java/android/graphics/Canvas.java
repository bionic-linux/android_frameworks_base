...
public class Canvas {
    ...
    */
    ...
    private static native void copyNativeCanvasState(long srcCanvas, long dstCanvas);
    private static native int native_saveLayer(long nativeCanvas, RectF bounds,
    ...
    private static native void native_concat(long nCanvas, long nMatrix);
    private static native void native_setMatrix(long nCanvas, long nMatrix);
    private static native boolean native_clipRect(long nCanvas,
    ...
    private static native boolean native_getClipBounds(long nativeCanvas,
                                                       Rect bounds);
    private static native void native_getCTM(long canvas, long matrix);
    ...
    private static native void native_drawColor(long nativeCanvas, int color,
                                                int mode);
    private static native void native_drawPaint(long nativeCanvas, long paint);
    private static native void native_drawLine(long nativeCanvas, float startX,
                                               float startY, float stopX,
                                               float stopY, long paint);
    ...
    private static native void native_drawRoundRect(long nativeCanvas,
                                                    RectF rect, float rx,
                                                    float ry, long paint);
    private static native void native_drawPath(long nativeCanvas, long path,
                                               long paint);
    private native void native_drawBitmap(long nativeCanvas, long bitmap,
                                                 float left, float top,
    ...
    private native void native_drawBitmap(long nativeCanvas, long bitmap,
                                                 ...
                                                 int screenDensity,
                                                 int bitmapDensity);
    private static native void native_drawBitmap(long nativeCanvas, long bitmap,
                                                 Rect src, Rect dst,
                                                 long nativePaintOrZero,
                                                 int screenDensity,
                                                 int bitmapDensity);
    private static native void native_drawBitmap(long nativeCanvas, int[] colors,
                                                int offset, int stride, float x,
                                                 ...
                                                 boolean hasAlpha,
                                                 long nativePaintOrZero);
    private static native void nativeDrawBitmapMatrix(long nCanvas, long nBitmap,
                                                      long nMatrix, long nPaint);
    private static native void nativeDrawBitmapMesh(long nCanvas, long nBitmap,
                                                    int meshWidth, int meshHeight,
                                                    float[] verts, int vertOffset,
                                                    int[] colors, int colorOffset, long nPaint);
    private static native void nativeDrawVertices(long nCanvas, int mode, int n,
                   float[] verts, int vertOffset, float[] texs, int texOffset,
                   int[] colors, int colorOffset, short[] indices,
                   int indexOffset, int indexCount, long nPaint);

    private static native void native_drawText(long nativeCanvas, char[] text,
                                               int index, int count, float x,
                                               float y, int flags, long paint);
