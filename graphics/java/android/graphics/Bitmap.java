...
public final class Bitmap implements Parcelable {
    ...
    */
    ...
    private static native Bitmap nativeCopy(long srcBitmap, int nativeConfig,
                                            boolean isMutable);
    ...
    private static native void nativeCopyPixelsToBuffer(long nativeBitmap,
                                                        Buffer dst);
    private static native void nativeCopyPixelsFromBuffer(long nb, Buffer src);
    ...
    private static native void nativeSetHasAlpha(long nBitmap, boolean hasAlpha);
    private static native boolean nativeHasMipMap(long nativeBitmap);
    private static native void nativeSetHasMipMap(long nBitmap, boolean hasMipMap);
    private static native boolean nativeSameAs(long nb0, long nb1);
