...
public class BitmapFactory {
    ...
    public static class Options {
         ...
         * output format, i.e. there is no {@link MediaCodecInfo.CodecCapabilities#COLOR_FormatYUVP010}
         * in its {@link MediaCodecInfo.CodecCapabilities#colorFormats}, then it
         * is unable to decode 10-bit heif images to {@link Bitmap.Config#RGBA_1010102},
         * please use {@link Bitmap.Config#RGB_565} as inPreferredConfig instead.</p>
         *
