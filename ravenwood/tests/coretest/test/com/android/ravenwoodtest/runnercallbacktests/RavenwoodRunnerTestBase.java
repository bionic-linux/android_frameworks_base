...
import android.platform.test.ravenwood.RavenwoodConfig$Private;
...
public abstract class RavenwoodRunnerTestBase {
    ...
    private void doTest(Class<?> testClazz, String expectedResult) {
        ...
        // a critical error.
        RavenwoodConfig$Private.setCriticalErrorHandler(listener.sCriticalErrorListener);
        ...
        try {
            ...
            RavenwoodConfig$Private.setCriticalErrorHandler(null);
        }
