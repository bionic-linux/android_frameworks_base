...
public class RavenwoodRuntimeEnvironmentController {
    ...
    private static void loadRavenwoodProperties() {
        ...
        sTestPackageName = withDefault(props.get("instPackageName"), DEFAULT_PACKAGE_NAME);
        sTargetPackageName = withDefault(props.get("packageName"), sTestPackageName);

        // TODO Read them from the manifest too?
    }
