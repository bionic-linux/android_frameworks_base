...
#define COMPILE_ASSERT(expr, err) __unused static const char(err)[(expr) ? 1 : -1] = "";
...
class DrawGLFunctor : public Functor {
  public:
    ...
    virtual status_t operator()(int what, void* data) {
        ...
        auto render_pipeline_type = android::uirenderer::Properties::getRenderPipelineType();
        aw_info.version = (render_pipeline_type == android::uirenderer::RenderPipelineType::OpenGL)
                                  ? 2
...
const JNINativeMethod kJniMethods[] = {
        {"nativeCreateGLFunctor", "(J)J", reinterpret_cast<void*>(CreateGLFunctor)},
        {"nativeDestroyGLFunctor", "(J)V", reinterpret_cast<void*>(DestroyGLFunctor)},
