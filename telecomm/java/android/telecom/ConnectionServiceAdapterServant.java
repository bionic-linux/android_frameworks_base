...
final class ConnectionServiceAdapterServant {
        ...
        private void internalHandleMessage(Message msg) throws RemoteException {
            switch (msg.what) {
                ...
                case MSG_ON_RTT_INITIATION_FAILURE:
                    mDelegate.onRttInitiationFailure((String) msg.obj, null /*Session.Info*/);
                    break;
    ...
    private final IConnectionServiceAdapter mStub = new IConnectionServiceAdapter.Stub() {
        ...
        @Override
        public void onRttInitiationFailure(String connectionId, Session.Info sessionInfo)
                throws RemoteException {
            mHandler.obtainMessage(MSG_ON_RTT_INITIATION_FAILURE, connectionId).sendToTarget();
        }
