...
public abstract class Connection extends Conferenceable {
     ...
     * start time of the conference.
     *
     * Based on {@link SystemClock#elapsedRealtime()}, which ensures that wall-clock changes do
     ...
     *
     * @param connectTimeMillis The connection time, in milliseconds.  Stored in the format
