...
public abstract class Connection extends Conferenceable {
    ...
    /**
     * Informs listeners that a previously requested RTT connection via
     * {@link ConnectionRequest#isRequestingRtt()} or
     * {@link #onStartRtt(ParcelFileDescriptor, ParcelFileDescriptor)}
     * has succeeded.
     * @hide
     */
    public final void sendRttConnectionSuccess() {
        mListeners.forEach((l) -> l.onRttConnectionSuccess(Connection.this));
    }
     ...
     * @hide
     */
    public final void sendRttConnectionFailure() {
        mListeners.forEach((l) -> l.onRttConnectionFailure(Connection.this));
    }
     ...
     * @hide
     */
    public final void sendRttConnectionRemotelyTerminated() {
        mListeners.forEach((l) -> l.onRttConnectionRemotelyTerminated(Connection.this));
    }
     ...
     * @hide
     */
    public final void sendRemoteRttUpgradeRequest() {
        mListeners.forEach((l) -> l.onRemoteRttUpgradeRequest(Connection.this));
    }
     ...
     * The connection service should call {@link #sendRttConnectionSuccess} or
     * {@link #sendRttConnectionFailure} to inform Telecom of the success or failure of the
     ...
     * request sent via {@link #sendRemoteRttUpgradeRequest}. Acceptance of the request is
