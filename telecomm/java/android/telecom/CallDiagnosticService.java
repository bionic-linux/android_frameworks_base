...
public abstract class CallDiagnosticService extends Service {
    ...
    /**
     * Telecom calls this method on the CallDiagnosticsService with details about a new call which
     * was added to Telecom.
     * <p>
     * The CallDiagnosticsService returns an implementation of {@link DiagnosticCall} to be used for
     * the lifespan of this call.
     *
