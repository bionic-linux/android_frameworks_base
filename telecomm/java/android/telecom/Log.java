...
public class Log {
    ...
    public static void addEvent(EventManager.IEventRecord recordEntry, String event) {
        getEventManager().event(recordEntry, event, null);
    }

    public static void addEvent(EventManager.IEventRecord recordEntry, String event, Object data) {
        getEventManager().event(recordEntry, event, data);
    }

    public static void addEvent(EventManager.IEventRecord recordEntry, String event, String format,
            Object... args) {
