...
public class EventManager {
    ...
    private final Map<IEventRecord, EventRecord> mCallEventRecordMap = new HashMap<>();
    ...
    public class EventRecord {
        ...
        private final IEventRecord mRecordEntry;

        public EventRecord(IEventRecord recordEntry) {
            mRecordEntry = recordEntry;
        }

        public IEventRecord getRecordEntry() {
            return mRecordEntry;
        }
        ...
        public void dump(IndentingPrintWriter pw) {
            ...
            for (Event event : mEvents) {
                ...
                if (event.data != null) {
                    ...
                    if (data instanceof IEventRecord) {
                        // If the data is another IEventRecord, then change the data to the
    ...
    public void event(IEventRecord recordEntry, String event, Object data) {
    ...
    public void event(IEventRecord recordEntry, String event, String format, Object... args) {
        String msg;
        try {
    ...
    public void changeEventCacheSize(int newSize) {
        ...
        oldEventLog.forEach((newRecord -> {
            IEventRecord recordEntry = newRecord.getRecordEntry();
