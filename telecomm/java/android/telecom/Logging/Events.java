...
public class Events {
    ...
    public interface EventRecordEntry {
        /**
    ...
    private final Map<EventRecordEntry, EventRecord> mCallEventRecordMap = new HashMap<>();
    ...
    private Sessions.ISessionIdQueryHandler mSessionIdHandler;
    /**
    ...
    public class EventRecord {
        ...
        private final EventRecordEntry mRecordEntry;

        public EventRecord(EventRecordEntry recordEntry) {
            mRecordEntry = recordEntry;
        }

        public EventRecordEntry getRecordEntry() {
            return mRecordEntry;
        }
        ...
        public List<EventTiming> extractEventTimings() {
            ...
            for (Event event : mEvents) {
                if (requestResponsePairs.containsKey(event.eventId)) {
                    ...
                    // of pending events.
                    for (Events.TimedEventPair p : requestResponsePairs.get(event.eventId)) {
        ...
        public void dump(IndentingPrintWriter pw) {
            ...
            for (Event event : mEvents) {
                ...
                if (event.data != null) {
                    ...
                    if (data instanceof EventRecordEntry) {
                        // If the data is another EventRecordEntry, then change the data to the
    ...
    public Events(@NonNull Sessions.ISessionIdQueryHandler l) {
        mSessionIdHandler = l;
    }

    public void event(EventRecordEntry recordEntry, String event, Object data) {
    ...
    public void event(EventRecordEntry recordEntry, String event, String format, Object... args) {
        String msg;
        try {
    ...
    public void changeEventCacheSize(int newSize) {
        ...
        oldEventLog.forEach(this::addCallEventRecord);
    }
    ...
    private void addCallEventRecord(EventRecord newRecord) {
        EventRecordEntry recordEntry = newRecord.getRecordEntry();
