...
public abstract class DiagnosticCall {
     ...
     * displayDiagnostic with the specified messageId is no longer applicable (e.g. service has
    ...
    /**
     * Handles a request from a {@link CallDiagnosticService} to update the call details for this
     * {@link DiagnosticCall}.
