...
public class TelecomManager {
     ...
     * change the call screening app. <p> A {@link SecurityException} will be thrown if calling
     * package name doesn't match the package of the passed {@link ComponentName}
     *
     * @param componentName to verify that the calling package name matches the package of the passed
     * ComponentName.
     */
    ...
    /**
     * Used to verify that the passed ComponentName is default call screening app. <p> A {@link
     * SecurityException} will be thrown if the package for the specified {@link ComponentName} does
    ...
    /**
     * Used to set the default call screening package. <p> Requires permission: {@link
     * android.Manifest.permission#MODIFY_PHONE_STATE} Requires permission: {@link
     * android.Manifest.permission#WRITE_SECURE_SETTINGS} <p> A {@link IllegalArgumentException} will
     * be thrown if the specified package and component name of {@link ComponentName} does't exist, or
     * the specified component of {@link ComponentName} does't have {@link
     * android.Manifest.permission#BIND_SCREENING_SERVICE}.
     *
