...
public class TelecomManager {
     ...
     *
     * The string extra {@link #EXTRA_DEFAULT_CALL_SCREENING_APP_COMPONENT_NAME} will contain the name
     * of the Component of the previous or the new call screening app.
     *
     * The boolean extra {@link #EXTRA_IS_DEFAULT_CALL_SCREENING_APP} will indicate the component name
     * in the String extra {@link #EXTRA_DEFAULT_CALL_SCREENING_APP_COMPONENT_NAME} is default call
     * screening app or not.
     */
     ...
     *
     * A {@link SecurityException} will be thrown if calling package name doesn't match the package of
     * the passed {@link ComponentName}
     *
     ...
     *
     * A {@link SecurityException} will be thrown if the package for the specified {@link
     * ComponentName} does not belong to the calling app.
     *
