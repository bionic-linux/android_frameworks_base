...
public class FmBand implements Parcelable {
    ...
    /**
     * Default band for US 87.8MHz - 108MHz, 200kHz channel offset.
     */
    ...
    public FmBand(int minFrequency, int maxFrequency, int channelOffset, int defaultFrequency) {
        ...
        if (maxFrequency % channelOffset != 0 || minFrequency % channelOffset != 0
                || defaultFrequency % channelOffset != 0) {
            throw new IllegalArgumentException(
                    "Frequencies must be multipliers of the channeloffset");
        }
     ...
     *            , {@link #BAND_CHINA}
     * @throws IllegalArgumentException
     *             it the band is not one of {@link #BAND_US}, {@link #BAND_EU},
     *             {@link #BAND_JAPAN}, {@link #BAND_CHINA}
     */
    public FmBand(int band) {
        switch (band) {
        case BAND_US:
            this.mMinFrequency = 87800;
            this.mMaxFrequency = 108000;
            this.mDefaultFrequency = 87800;
