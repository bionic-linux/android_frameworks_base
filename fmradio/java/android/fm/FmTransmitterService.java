...
public class FmTransmitterService extends IFmTransmitter.Stub {
    ...
    private PhoneStateListener mPhoneStateListener = new PhoneStateListener() {
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            if (state == TelephonyManager.CALL_STATE_RINGING) {
                ...
                int result = _fm_transmitter_forcedPause();
                if (result == FmTransmitter.STATE_STARTING) {
                    notifyOnForcedReset(FmTransmitter.RESET_NON_CRITICAL);
                } else if (result == FmTransmitter.STATE_STARTED
                        || result == FmTransmitter.STATE_SCANNING) {
                    notifyOnForcedPause();
                }
    ...
    private native int _fm_transmitter_forcedPause();
