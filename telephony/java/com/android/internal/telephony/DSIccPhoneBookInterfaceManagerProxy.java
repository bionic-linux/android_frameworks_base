...
public class DSIccPhoneBookInterfaceManagerProxy extends IIccPhoneBook.Stub {
    private static final String TAG = "DSIccPbkIntMngProxy";
    private Phone[] mPhone;

    /* only one DSIccPhonBookInterfaceManagerProxy exists */
    public DSIccPhoneBookInterfaceManagerProxy(Phone[] phone) {
