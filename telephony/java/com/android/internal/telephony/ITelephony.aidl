...
interface ITelephony {
     ...
     *
     * @param subId The subscription ID.
     * @param ics The cancel signal for the request to disable the 5g core network.
     * @param disableGlobally Disable 5g core network for all subscription IDs or not.
     * @return true on success and false on failure.
     *
     * @hide
     */
    public void requestDisable5gCoreNetwork(int subId, ICancellationSignal ics, boolean disableGlobally);
