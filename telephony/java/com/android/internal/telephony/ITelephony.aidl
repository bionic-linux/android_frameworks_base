...
interface ITelephony {
   ...
   /**
    ...
    /**
     * Add a SignalStrengthUpdateRequest to receive notification when Signal Strength breach the
     * specified thresholds.
     */
    void addSignalStrengthUpdateRequest(int subId, in SignalStrengthUpdateRequest request);

    /**
     * Remove a SignalStrengthUpdateRequest from system.
     */
    void removeSignalStrengthUpdateRequest(int subId, in SignalStrengthUpdateRequest request);
}
