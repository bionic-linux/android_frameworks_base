...
interface ISub {
     ...
     * @return SubInfoRecord, maybe null
     */
    List<SubInfoRecord> getSubInfoUsingSimId(int simId);
     ...
     */
    int addSubInfoRecord(String iccId, int simId);
     ...
     * @return the number of records updated
     */
    int setDispalyNumberFormat(int format, long subId);
    ...
    int getSimId(long subId);
    
    long[] getSubId(int simId);
