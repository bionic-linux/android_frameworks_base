...
public class SmsMessage extends SmsMessageBase {
    ...
    /**
     *  TP-Status - status of a previously submitted SMS.
     *  This field is true if the message is a SMS-STATUS-REPORT message.
     */
    ...
    /**
     * Gets Encoded Relative Validty Period Value from Validity period in mins.
     *
    ...
    public static SubmitPdu getSubmitPdu(String scAddress,
        ...
        if (validityPeriod >= VALIDITY_PERIOD_MIN && validityPeriod <= VALIDITY_PERIOD_MAX) {
            relativeValidityPeriod = getRelativeValidityPeriod(validityPeriod);
        }
    ...
    private void parseSmsSubmit(PduParser p, int firstByte) {
        ...
        } else { // VALIDITY_PERIOD_FORMAT_ENHANCED or ALIDITY_PERIOD_FORMAT_ABSOLUTE
