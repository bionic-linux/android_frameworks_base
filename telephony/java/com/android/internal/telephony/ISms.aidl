...
interface ISms {
     ...
     * @return list of SmsRawData of all sms on ICC
     */
    List<SmsRawData> getAllMessagesFromIccEfUsingSub(in int subscription, String callingPkg);
     ...
     *
     */
     boolean updateMessageOnIccEfUsingSub(in int subscription, String callingPkg, int messageIndex, int newStatus,
             in byte[] pdu);
     ...
     *
     */
    boolean copyMessageToIccEfUsingSub(in int subscription, String callingPkg, int status, in byte[] pdu,
           in byte[] smsc);
     ...
     * @param subscription the subscription id.
     */
    void sendDataUsingSub(int subscription, String callingPkg, in String destAddr, in String scAddr, in int destPort,
            in byte[] data, in PendingIntent sentIntent, in PendingIntent deliveryIntent);
     ...
     */
    void sendTextUsingSub(in int subscription, String callingPkg, in String destAddr, in String scAddr, in String text,
            in PendingIntent sentIntent, in PendingIntent deliveryIntent);
     ...
     * @param subscription the subscription on which the SMS has to be sent.
     */
    void sendTextWithPriorityUsingSub(in int subscription, in String destAddr, in String scAddr, in String text,
            in PendingIntent sentIntent, in PendingIntent deliveryIntent,
            in int priority);
     ...
     * @param subscription the subscription on which the SMS has to be sent.
     */
    void sendMultipartTextUsingSub(in int subscription, String callingPkg, in String destinationAddress, in String scAddress,
            in List<String> parts, in List<PendingIntent> sentIntents,
            in List<PendingIntent> deliveryIntents);
     ...
     * @see #disableCellBroadcast(int)
     */
    boolean enableCellBroadcastUsingSub(in int subscription, int messageIdentifier);
     ...
     * @see #enableCellBroadcast(int)
     */
    boolean disableCellBroadcastUsingSub(in int subscription, int messageIdentifier);
     ...
     * @see #disableCellBroadcastRange(int, int)
     */
    boolean enableCellBroadcastRangeUsingSub(int subscription, int startMessageId, int endMessageId);
     ...
     */
    boolean disableCellBroadcastRangeUsingSub(int subscription, int startMessageId, int endMessageId);
     ...
     * Requires system permission.
     */
    int getPremiumSmsPermissionUsingSub(int subscription, String packageName);
     ...
     * Requires system permission.
     */
    void setPremiumSmsPermissionUsingSub(int subscription, String packageName, int permission);
     ...
     * @see #getImsSmsFormat()
     */
    boolean isImsSmsSupportedUsingSub(int subscription);
     ...
     * @see #isImsSmsSupported()
     */
    String getImsSmsFormatUsingSub(int subscription);
