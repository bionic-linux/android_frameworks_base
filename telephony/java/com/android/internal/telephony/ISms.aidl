...
interface ISms {
    ...
    /**
     * Send an SMS with cdma options using Subscription Id.
     *
     * @param subId the subId on which the SMS has to be sent.
     * @param destAddr the address to send the message to
     * @param scAddr the SMSC to send the message through, or NULL for the
     ...
     *  ----------------------------------
     *  Any Other values included Negative considered as Invalid Priority Indicator of the message.
     * @param callbackNumber call back number used for CDMA message, NULL in case of GSM message
     */
    void sendTextForSubscriberWithCdmaOptions(in int subId, String callingPkg, in String destAddr,
            in String scAddr, in String text, in PendingIntent sentIntent,
            in PendingIntent deliveryIntent, in boolean persistMessageForNonDefaultSmsApp,
            in int priority, in String callbackNumber);
    ...
    /**
     * Send a multi-part text based SMS with cdma options using Subscription Id.
     *
     * @param subId the subId on which the SMS has to be sent.
     * @param destinationAddress the address to send the message to
     * @param scAddress is the service center address or null to use
     ...
     * @param callbackNumber call back number used for CDMA message, NULL in case of GSM message
     */
    void sendMultipartTextForSubscriberWithCdmaOptions(in int subId, String callingPkg,
            in String destinationAddress, in String scAddress, in List<String> parts,
            in List<PendingIntent> sentIntents, in List<PendingIntent> deliveryIntents,
            in boolean persistMessageForNonDefaultSmsApp, in int priority, in String callbackNumber);
