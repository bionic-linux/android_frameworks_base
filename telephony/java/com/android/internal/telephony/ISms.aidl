...
interface ISms {
     ...
     * @return list of SmsRawData of all sms on ICC
     */
    List<SmsRawData> getAllMessagesFromIccEfOnSubscription(String callingPkg, in int subscription);
     ...
     *
     */
     boolean updateMessageOnIccEfOnSubscription(String callingPkg, int messageIndex, int newStatus,
     ...
     *
     */
    boolean copyMessageToIccEfOnSubscription(String callingPkg, int status, in byte[] pdu,
     ...
     * @param subscription the subscription id.
     */
    void sendDataOnSubscription(String callingPkg, in String destAddr, in String scAddr, in int destPort,
            in byte[] data, in PendingIntent sentIntent, in PendingIntent deliveryIntent,
            int subscription);
     ...
     */
    void sendTextOnSubscription(String callingPkg, in String destAddr, in String scAddr, in String text,
            in PendingIntent sentIntent, in PendingIntent deliveryIntent,
            in int subscription);
     ...
     * @param subscription the subscription on which the SMS has to be sent.
     */
    void sendTextWithPriorityOnSubscription(in String destAddr, in String scAddr, in String text,
            in PendingIntent sentIntent, in PendingIntent deliveryIntent,
     ...
     * @param subscription the subscription on which the SMS has to be sent.
     */
    void sendMultipartTextOnSubscription(String callingPkg, in String destinationAddress, in String scAddress,
            in List<String> parts, in List<PendingIntent> sentIntents,
     ...
     * @see #disableCellBroadcast(int)
     */
    boolean enableCellBroadcastOnSubscription(int messageIdentifier, in int subscription);
     ...
     * @see #enableCellBroadcast(int)
     */
    boolean disableCellBroadcastOnSubscription(int messageIdentifier, in int subscription);
     ...
     * @see #disableCellBroadcastRange(int, int)
     */
    boolean enableCellBroadcastRangeOnSubscription(int startMessageId, int endMessageId, int subscription);
     ...
     */
    boolean disableCellBroadcastRangeOnSubscription(int startMessageId, int endMessageId, int subscription);
     ...
     * Requires system permission.
     */
    int getPremiumSmsPermissionOnSubscription(String packageName, int subscription);
     ...
     * Requires system permission.
     */
    void setPremiumSmsPermissionOnSubscription(String packageName, int permission, int subscription);
     ...
     * @see #getImsSmsFormat()
     */
    boolean isImsSmsSupportedOnSubscription(int subscription);
     ...
     * @see #isImsSmsSupported()
     */
    String getImsSmsFormatOnSubscription(int subscription);
