...
interface ISms {
     ...
     *
     */
     boolean updateMessageOnIccEfUsingSub(in int subscription, String callingPkg,
     ...
     *
     */
    boolean copyMessageToIccEfUsingSub(in int subscription, String callingPkg, int status,
     ...
     * @param subscription the subscription id.
     */
    void sendDataUsingSub(int subscription, String callingPkg, in String destAddr,
     ...
     */
    void sendTextUsingSub(in int subscription, String callingPkg, in String destAddr,
     ...
     * @param subscription the subscription on which the SMS has to be sent.
     */
    void sendMultipartTextUsingSub(in int subscription, String callingPkg,
     ...
     */
    boolean disableCellBroadcastRangeUsingSub(int subscription, int startMessageId,
            int endMessageId);
