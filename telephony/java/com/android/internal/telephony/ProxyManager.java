...
import com.android.internal.telephony.DSIccPhoneBookInterfaceManagerProxy;
import com.android.internal.telephony.DSIccSmsInterfaceManagerProxy;
import com.android.internal.telephony.DSPhoneSubInfoProxy;
...
public class ProxyManager extends Handler {
    ...
    //DSIccSmsInterfaceManagerProxy to use proper IccSmsInterfaceManager object
    private DSIccSmsInterfaceManagerProxy mDSIccSmsInterfaceManagerProxy;
    //DSIccPhoneBookInterfaceManager    Proxy to use proper IccPhoneBookInterfaceManagerProxy object
    private DSIccPhoneBookInterfaceManagerProxy mDSIccPhoneBookInterfaceManagerProxy;
    //DSPhoneSubInfoProxy to use proper PhoneSubInfoProxy object
    private DSPhoneSubInfoProxy mDSPhoneSubInfoProxy;
    ...
    private ProxyManager(Context context, Phone[] phoneProxy, UiccManager uiccManager,
        ...
        mDSIccPhoneBookInterfaceManagerProxy = new DSIccPhoneBookInterfaceManagerProxy(mProxyPhones);
        mDSPhoneSubInfoProxy = new DSPhoneSubInfoProxy(mProxyPhones);
        mDSIccSmsInterfaceManagerProxy = new DSIccSmsInterfaceManagerProxy(mProxyPhones);
    ...
    private void getDefaultProperties(Context context) {
        ...
        if (resetToDefault) {
            Settings.System.putInt(context.getContentResolver(),
                    Settings.System.DUAL_SIM_VOICE_CALL, TelephonyManager.DEFAULT_SUB);
            Settings.System.putInt(context.getContentResolver(),
                    Settings.System.DUAL_SIM_DATA_CALL, TelephonyManager.DEFAULT_SUB);
            Settings.System.putInt(context.getContentResolver(),
                    Settings.System.DUAL_SIM_SMS, TelephonyManager.DEFAULT_SUB);
            Settings.System.putInt(context.getContentResolver(),
