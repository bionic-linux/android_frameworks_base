...
public interface TelephonyProperties
{
    ...
    static final String[] SIM_RECORDS_PROPERTY_ICC_OPERATOR_NUMERIC = {
    ...
    static final String[] SIM_RECORDS_PROPERTY_ICC_OPERATOR_ALPHA = {
    ...
    static final String[] SIM_RECORDS_PROPERTY_ICC_OPERATOR_ISO_COUNTRY = {
