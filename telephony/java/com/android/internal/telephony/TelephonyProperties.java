...
public interface TelephonyProperties
{
    ...
    static final String[] SIM_PROPERTY_ICC_OPERATOR_NUMERIC = {
    ...
    static final String[] SIM_PROPERTY_ICC_OPERATOR_ALPHA = {
    ...
    static final String[] SIM_PROPERTY_ICC_OPERATOR_ISO_COUNTRY = {
    ...
    static final String[] SIM_PROPERTY_SIM_STATE = {
