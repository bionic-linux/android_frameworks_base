...
public class ImsCallProfile implements Parcelable {
    ...
    public static int getVideoStateFromCallType(int callType) {
        boolean isTx = (callType & CALL_TYPE_VT_TX_BIT) == CALL_TYPE_VT_TX_BIT;
        boolean isRx = (callType & CALL_TYPE_VT_RX_BIT) == CALL_TYPE_VT_RX_BIT;
        boolean isVt = (callType & CALL_TYPE_VT_BIT) == CALL_TYPE_VT_BIT;
