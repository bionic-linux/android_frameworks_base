...
public class MbmsStreamingServiceBase extends IMbmsStreamingService.Stub {
    ...
    /**
     * Dispose of the stream identified by {@code serviceId}. No notification back to the app is
     * required for this operation, and the callback provided via
     * {@link #startStreaming(String, int, String, IStreamingServiceCallback)} should no be
     * longer used after this method has called by the app.
     * @param appName The app name as negotiated with the wireless carrier.
     * @param subscriptionId The subscription id to use.
     ...
     * {@code subscriptionId} arguments. No notification back to the app is required for this
     * operation, and the corresponding callback provided via
