...
public final class ImsReasonInfo implements Parcelable {
    ...
    /**
    *Upragde Downgrade request rejected by :-
    ...
    */
    ...
    /**
    *Upragde Downgrade request cacncelled by the user who initiated it
    */
    public static final int CODE_USER_CANCELLED_SESSION_MODIFICATION = 512;

    /**
     * UPGRADE DOWNGRADE operation failed
     * This can happen due to failure from SIP/RTP/SDP generation or a
     * call end is triggered/received
     * while Reinvite is in progress.
     */
    public static final int CODE_SESSION_MODIFICATION_FAILED = 513;
