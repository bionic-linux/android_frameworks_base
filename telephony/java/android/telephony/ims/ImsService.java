...
public class ImsService extends Service {
    ...
    @LongDef(flag = true,
            ...
            value = {
                    ...
                    // whether or not ImsFeature.FEATURE_EMERGENCY_MMTEL feature is set.
     ...
     * this method should return {@code null}. If this feature is supported, then this method should
     * never be {@code null} and the optional ImsService capability flag
     * {@link #CAPABILITY_SIP_DELEGATE_CREATION} should be set in
