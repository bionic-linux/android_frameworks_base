...
/**
 * Base implementation of ImsVideoCallProvider, which implements stub versions of the methods
 * in the IImsVideoCallProvider AIDL. Override the methods that your implementation of
 * ImsVideoCallProvider supports.
 *
 * DO NOT remove or change the existing APIs, only add new ones to this Base implementation or you
 * will break other implementations of ImsVideoCallProvider maintained by other ImsServices.
 * @hide
 */
public class ImsVideoCallProvider {
