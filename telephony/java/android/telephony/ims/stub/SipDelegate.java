...
public interface SipDelegate {
     ...
     * {@link #closeSession(String)} instead.
     */
    @Deprecated
     ...
     * {@link SipDelegateConnection#closeSession(String)} to signal to the framework that
     ...
     *         framework is requesting be closed.
     */
    default void closeSession(@NonNull String callId) {
        closeDialog(callId);
    }
