...
public class RcsPresenceExchangeImplBase extends RcsCapabilityExchange {
    ...
    public static final int CAPABILITY_UPDATE_TRIGGER__ETAG_EXPIRED = 0;
    /** A capability update has been requested due to moving to LTE with VoPS disabled. */
    public static final int CAPABILITY_UPDATE_TRIGGER__MOVE_TO_LTE_VOPS_DISABLED = 1;
    /** A capability update has been requested due to moving to LTE with VoPS enabled. */
    public static final int CAPABILITY_UPDATE_TRIGGER__MOVE_TO_LTE_VOPS_ENABLED = 2;
    /** A capability update has been requested due to moving to eHRPD. */
    public static final int CAPABILITY_UPDATE_TRIGGER__MOVE_TO_EHRPD = 3;
    /** A capability update has been requested due to moving to HSPA+. */
    public static final int CAPABILITY_UPDATE_TRIGGER__MOVE_TO_HSPAPLUS = 4;
    /** A capability update has been requested due to moving to 3G. */
    public static final int CAPABILITY_UPDATE_TRIGGER__MOVE_TO_3G = 5;
    /** A capability update has been requested due to moving to 2G. */
    public static final int CAPABILITY_UPDATE_TRIGGER__MOVE_TO_2G = 6;
    /** A capability update has been requested due to moving to WLAN */
    public static final int CAPABILITY_UPDATE_TRIGGER__MOVE_TO_WLAN = 7;
    /** A capability update has been requested due to moving to IWLAN */
    public static final int CAPABILITY_UPDATE_TRIGGER__MOVE_TO_IWLAN = 8;
    /** A capability update has been requested but the reason is unknown. */
    public static final int CAPABILITY_UPDATE_TRIGGER__UNKNOWN = 9;
    ...
    /** @hide*/
    @IntDef(value = {
            CAPABILITY_UPDATE_TRIGGER__ETAG_EXPIRED,
            CAPABILITY_UPDATE_TRIGGER__MOVE_TO_LTE_VOPS_DISABLED,
            CAPABILITY_UPDATE_TRIGGER__MOVE_TO_LTE_VOPS_ENABLED,
            CAPABILITY_UPDATE_TRIGGER__MOVE_TO_EHRPD,
            CAPABILITY_UPDATE_TRIGGER__MOVE_TO_HSPAPLUS,
            CAPABILITY_UPDATE_TRIGGER__MOVE_TO_3G,
            CAPABILITY_UPDATE_TRIGGER__MOVE_TO_2G,
            CAPABILITY_UPDATE_TRIGGER__MOVE_TO_WLAN,
            CAPABILITY_UPDATE_TRIGGER__MOVE_TO_IWLAN,
            CAPABILITY_UPDATE_TRIGGER__UNKNOWN,
