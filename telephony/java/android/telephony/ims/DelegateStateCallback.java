 ...
 * - the {@link SipDelegate} associated with this callback has been created or destroyed in response
 * to a creation or destruction request from the framework,
 * - the SIP IMS configuration associated with this {@link SipDelegate} has changed, and
 * - the IMS registration of the feature tags associated with this {@link SipDelegate} have changed.
 * @hide
 */
public interface DelegateStateCallback {

    /**
     * Must be called after {@link SipTransportImplBase#createSipDelegate} is called to notify the
     * framework and remote application that the {@link SipDelegate} has been successfully created.
     *
