...
public class ImsCallSessionListener {
    ...
    /**
     * A request has been sent out to initiate a new IMS call session and a 183 response has been
     * received from the network.  This is called between the time a call session is first started,
     * which is indicated by receiving a 200 response from the network, and when
     * {@link #callSessionProgressing(ImsStreamMediaProfile)} is first called.
     *
