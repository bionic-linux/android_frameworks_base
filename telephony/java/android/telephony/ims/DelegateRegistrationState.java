...
public final class DelegateRegistrationState implements Parcelable {
     ...
     * {@link SipDelegateConnection#closeSession(String)}.
     */
     ...
     * using {@link SipDelegateConnection#closeSession(String)} before the IMS registration
     ...
     * using {@link SipDelegateConnection#closeSession(String)} before this operation can proceed.
     */
