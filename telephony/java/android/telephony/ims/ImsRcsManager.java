...
public class ImsRcsManager {
     ...
     * this Intent if the carrier supports bulk RCS contact exchange, which can be queried using the
     * key {@link android.telephony.CarrierConfigManager.Ims#KEY_RCS_BULK_CAPABILITY_EXCHANGE_BOOL}
     * or {@link android.telephony.CarrierConfigManager.KEY_USE_RCS_PRESENCE_BOOL}. Otherwise, the
     * RCS contact discovery opt-in dialog will not be shown.
     * <p>
