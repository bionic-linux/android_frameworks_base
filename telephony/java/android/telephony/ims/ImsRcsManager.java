...
public class ImsRcsManager {
     ...
     * {@link CarrierConfigManager#KEY_RCS_PRESENCE_SUPPORTED_BOOL}. Otherwise, the RCS contact
     * discovery opt-in dialog will not be shown.
     * <p>
     ...
     * @see #isAvailable(int)
     * @see android.telephony.CarrierConfigManager#KEY_RCS_PRESENCE_SUPPORTED_BOOL
     * @throws ImsException if the IMS service is not available when calling this method.
     * See {@link ImsException#getCode()} for more information on the error codes.
     * @hide
     */
