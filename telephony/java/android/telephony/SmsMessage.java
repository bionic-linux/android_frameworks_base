...
public class SmsMessage {
     ...
     * @param languageTable GSM national language table to use.
     * @param languageShiftTable GSM national language shift table to use
     * @param refNumber  to create SmsHeader
     * @param seqNumber  to create SmsHeader
     * @param msgCount  to create SmsHeader
     * @return a byte[] containing the encoded message
     */
    public static byte[] getSubmitPduEncodedMessage(boolean isTypeGsm, String destinationAddress,
                                                     String message, int encoding,
