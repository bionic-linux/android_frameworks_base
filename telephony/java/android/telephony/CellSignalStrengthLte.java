...
public final class CellSignalStrengthLte extends CellSignalStrength implements Parcelable {
     ...
     */
    private static final int SIGNAL_STRENGTH_LTE_RSSI_UNKNOWN_ASU = 99;
    /**
     * Indicates the maximum valid RSSI value in ASU.
     *
     * Reference: TS 27.007 8.5 - Signal quality +CSQ
     */
    private static final int SIGNAL_STRENGTH_LTE_RSSI_VALID_VALUE_MAX_VALUE = 31;
    /**
     * Indicates the minimum valid RSSI value in ASU.
     *
     * Reference: TS 27.007 8.5 - Signal quality +CSQ
     */
    private static final int SIGNAL_STRENGTH_LTE_RSSI_VALID_VALUE_MIN_VALUE = 0;
     ...
     *
     * The value range is [-113, -51] inclusively or {@link SignalStrength#INVALID} if not known
     * or not detectable.
     *
     * Reference: TS 27.007 8.5 Signal quality +CSQ
     *
     * @return the RSSI if available or {@link SignalStrength#INVALID} if unavailable.
     */
    public int getRssi() {
        return mRssi;
    }
    ...
    private static int convertRssiAsuToDBm(int rssiAsu) {
        if (rssiAsu != SIGNAL_STRENGTH_LTE_RSSI_UNKNOWN_ASU &&
                (rssi >= SIGNAL_STRENGTH_LTE_RSSI_VALID_VALUE_MIN_VALUE
                        && rssi <= SIGNAL_STRENGTH_LTE_RSSI_VALID_VALUE_MAX_VALUE)) {
            RLog.e(TAG, "convertRssiAsuToDBm: invalid rssiAsu", rssiAsu);
