...
public final class CellSignalStrengthLte extends CellSignalStrength implements Parcelable {
    ...
    public void calculateLevel(PersistableBundle cc, ServiceState ss) {
        ...
        if (cc == null) {
            ...
            if (DBG) log("calculateLevel() carrierconfig - rsrpOnly="
        ...
        if (rsrpOnly) {
            if (DBG) log("calculateLevel() - rsrp = " + rsrpIconLevel);
            if (rsrpIconLevel != -1) {
        ...
        if (DBG) log("calculateLevel() - rsrp:" + mRsrp + " snr:" + mRssnr + " rsrpIconLevel:"
