...
public final class CellSignalStrengthLte extends CellSignalStrength implements Parcelable {
    ...
    /**
     * Indicates RSRP is considered for {@link #getLevel()} and reporting from modem.
     *
     * @hide
     */
    public static final int USE_RSRP = 1 << 0;
    /**
     * Indicates RSRQ is considered for {@link #getLevel()} and reporting from modem.
     *
     * @hide
     */
    public static final int USE_RSRQ = 1 << 1;
    /**
     * Indicates RSSNR is considered for {@link #getLevel()} and reporting from modem.
     *
     * @hide
     */
     ...
     * (RSSNR) for the number of LTE signal bars. If multiple measures are set bit, the parameter
    ...
    public void updateLevel(PersistableBundle cc, ServiceState ss) {
        ...
        if (cc == null) {
            ...
            mParametersUseForLevel = cc.getInt(
                    CarrierConfigManager.KEY_PARAMETERS_USE_FOR_4G_LTE_SIGNAL_BAR_INT);
