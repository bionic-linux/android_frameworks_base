...
public class SubscriptionManager {
     ...
     *
     * <p>A valid subscription ID is unnecessarily an active subscription ID
     * (check with {@link #isActiveSubscriptionId(int)}) or an usable subscription ID
     * (check with {@link #isUsableSubscriptionId(int)}). Unless specifically noted, subscription
     ...
     *
     * <p>A usable subscription ID is a valid subscription ID, but unnecessarily an active
     * subscription ID (check with {@link #isActiveSubscriptionId(int)}). Some subscription APIs
     * need work with a usable subscription ID, and this is noted in their documentation;
     * otherwise, a subscription ID does not need to be usable for subscription functions, only
     * valid.
     *
     * @param subscriptionId the subscription ID
    ...
    /**
     * Checks if the supplied subscription ID corresponds to a subscription which is active in use
     * on the device. It is a valid and usable subscription ID.
     *
     * @param subscriptionId the subscription ID.
