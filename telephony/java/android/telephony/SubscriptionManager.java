...
public class SubscriptionManager {
    ...
    /**
     * TelephonyProvider column name for UICC card identifier. For pSIM it is the ICCID of the
     * current enabled profile on the card, while for eSIM it is the EID of the card.
     * <P>Type: TEXT (String)</P>
     * @hide
     */
