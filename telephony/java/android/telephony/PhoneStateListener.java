...
public class PhoneStateListener {
    ...
    public PhoneStateListener(int subId, Looper looper) {
        ...
        callback = new PhoneStateListenerImpl(mHandler);
    }
    ...
    private static class PhoneStateListenerImpl extends IPhoneStateListener.Stub {
        private WeakReference<Handler> mRefHandler;

        PhoneStateListenerImpl(Handler handler) {
     ...
     */
    PhoneStateListenerImpl callback;
