...
public final class SignalThresholdInfo implements Parcelable {
    ...
    public static final class Builder {
        ...
        /**
         * Set the hysteresis time in milliseconds to prevent flapping.
         * A value of 0 disables hysteresis
         *
        ...
        /**
         * Set the interval in dB defining the required magnitude change between reports.
         *
         ...
         *
         * The range and unit must reference specific SignalMeasurementType. Thresholds will sort
         ...
         *
         * @throws IllegalArgumentException if the signal measurement type is invalid, the
         * thresholds array is null, any value in the thresholds is out of range, or the RAN is
         * not allowed to set with the signal measurement type.
         */
    ...
    private void validateThresholdRange(@SignalMeasurementType int signalMeasurement,
            int[] thresholds) {
        if (thresholds == null) {
            throw new IllegalArgumentException("thresholds array is null");
        }
