...
     * available and valid at the time of call and bootstrapping is not requested,
     ...
     *
     * System will clearn up the {@link SignalStrengthUpdateRequest} if the caller process died
     * without calling {@link #clearSignalStrengthUpdateRequest(SignalStrengthUpdateRequest)}.
     *
     * If this TelephonyManager object has been created with {@link #createForSubscriptionId},
     * applies to the given subId. Otherwise, applies to
     * {@link SubscriptionManager#getDefaultSubscriptionId()}. For the same caller, a later request
     * with same subId will replace the previous request. To request for multiple subIds,
