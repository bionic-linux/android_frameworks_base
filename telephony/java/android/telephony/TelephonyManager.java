...
public class TelephonyManager {
    ...
    */
     ...
     */
    @SystemApi
    public static final String CAPABILITY_THERMAL_MITIGATION_SUPPORTED =
            "CAPABILITY_THERMAL_MITIGATION_SUPPORTED";
     ...
     * ({@link #CAPABILITY_THERMAL_MITIGATION_SUPPORTED}) returns false, then {@link
    ...
    @RequiresFeature(
            enforcement = "android.telephony.TelephonyManager#isRadioInterfaceCapabilitySupported",
            value = TelephonyManager.CAPABILITY_THERMAL_MITIGATION_SUPPORTED)
