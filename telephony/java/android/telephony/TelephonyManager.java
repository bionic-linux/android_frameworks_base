...
public class TelephonyManager {
    ...
    */
     ...
     * {@link IImsServiceFeatureListener} callback is registered as a listener for feature updates.
     * @param slotIndex The SIM slot that we are requesting the {@link IImsMMTelFeature} for.
     * @param callback Listener that will send updates to ImsManager when there are updates to
     * ImsServiceController.
     * @return {@link IImsMMTelFeature} interface for the feature specified or {@link null} if
     * it is unavailable.
     * @hide
     */
    public IImsMMTelFeature getImsMMTelFeatureAndListen(int slotIndex,
     ...
     * MMTelFeature is available, the {@link IImsServiceFeatureListener} callback is registered as a
     ...
     * @hide
     */
    public IImsMMTelFeature getImsEmergencyMMTelFeatureAndListen(int slotIndex,
            IImsServiceFeatureListener callback) {
        try {
            ITelephony telephony = getITelephony();
            if (telephony != null) {
     ...
     * feature for emergency calling or {@link null} if the service is not available. If an
     * RcsFeature is available, the {@link IImsServiceFeatureListener} callback is registered as a
     * listener for feature updates.
     * @param slotIndex The SIM slot that we are requesting the {@link IImsRcsFeature} for.
     * @param callback Listener that will send updates to ImsManager when there are updates to
     * ImsServiceController.
     * @return {@link IImsRcsFeature} interface for the feature specified or {@link null} if
     * it is unavailable.
     * @hide
     */
    public IImsRcsFeature getImsRcsFeatureAndListen(int slotIndex,
            IImsServiceFeatureListener callback) {
        try {
            ITelephony telephony = getITelephony();
            if (telephony != null) {
