...
public class TelephonyManager {
    ...
    */
    ...
    /**
     * Returns an array of Opertor-controlled PLMNs from the USIM App.
     * Returns null if the query fails.
     *
     * <p>Requires Permission: {@link android.Manifest.permission#READ_PHONE_STATE READ_PHONE_STATE}
     * or that the calling app has carrier privileges (see {@link #hasCarrierPrivileges}).
    ...
    /**
     * Returns an array of Home PLMNs from the USIM App.
     * Returns null if the query fails.
     *
     * <p>Requires Permission: {@link android.Manifest.permission#READ_PHONE_STATE READ_PHONE_STATE}
     * or that the calling app has carrier privileges (see {@link #hasCarrierPrivileges}).
    ...
    public @Nullable String[] getEhplmns() {
        return getEhplmns(getSubId(), APPTYPE_USIM);
    }
   ...
   /**
     ...
     * given subId. Otherwise, applies to {@link SubscriptionManager#getDefaultSubscriptionId()}
     *
     * <p>Requires Permission: READ_PHONE_STATE, for the profile owner or calling apps that have the
     * READ_PHONE_STATE permission or carrier privileges (see {@link #hasCarrierPrivileges}).
     * The profile owner is an app that owns a managed profile on the device; for more details
     * see <a href="https://developer.android.com/work/managed-profiles">Work profiles</a>. Profile
