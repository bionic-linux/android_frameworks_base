...
public final class CellSignalStrengthCdma extends CellSignalStrength implements Parcelable {
    ...
    /**
     * SignalStrength constructor that works with the HAL.
     *
    ...
    public CellSignalStrengthCdma(int cdmaDbm, int cdmaEcio, int evdoDbm, int evdoEcio,
        ...
        mCdmaDbm = ((mCdmaDbm > 0) && (mCdmaDbm < 120))  ? -mCdmaDbm : Integer.MAX_VALUE;
        mCdmaEcio = ((mCdmaEcio > 0) && (mCdmaEcio < 160)) ? -mCdmaEcio : Integer.MAX_VALUE;

        mEvdoDbm = ((mEvdoDbm > 0) && (mEvdoDbm < 120)) ? -mEvdoDbm : Integer.MAX_VALUE;
        mEvdoEcio = ((mEvdoEcio > 0) && (mEvdoEcio < 160)) ? -mEvdoEcio : Integer.MAX_VALUE;
        mEvdoSnr = ((mEvdoSnr > 0) && (mEvdoSnr <= 8)) ? mEvdoSnr : Integer.MAX_VALUE;
    }
