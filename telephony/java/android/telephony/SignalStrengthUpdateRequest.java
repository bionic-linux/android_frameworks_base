...
public final class SignalStrengthUpdateRequest implements Parcelable {
    ...
    public static final class Builder {
         ...
         * radio access network type in the collection is not unique, the length of thresholds in
         * each SignalThresholdInfo is smaller than {@link #MINIMUM_NUMBER_OF_THRESHOLDS} or larger
         * than {@link #MAXIMUM_NUMBER_OF_THRESHOLDS}
         */
