...
public class MSimTelephonyManager extends TelephonyManager {
    ...
    public static MSimTelephonyManager from(Context context) {
        return (MSimTelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
    }
    ...
    public String getDeviceSoftwareVersion(int subscription) {
        try {
            return getSubscriberInfo().getDeviceSvn(subscription);
    ...
    public String getDeviceId(int subscription) {
        ...
        try {
            return getSubscriberInfo().getDeviceId(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            return null;
    ...
    public boolean hasIccCard(int subscription) {
        ...
        try {
            return getITelephony().hasIccCard(subscription);
        } catch (RemoteException ex) {
    ...
    public String getSimSerialNumber(int subscription) {
        try {
            return getSubscriberInfo().getIccSerialNumber(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
    ...
    public int getLteOnCdmaMode(int subscription) {
        try {
            return getITelephony().getLteOnCdmaMode(subscription);
        } catch (RemoteException ex) {
            // Assume no ICC card if remote exception which shouldn't happen
    ...
    public String getSubscriberId(int subscription) {
        try {
            return getSubscriberInfo().getSubscriberId(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
    ...
    public String getLine1Number(int subscription) {
        try {
            return getSubscriberInfo().getLine1Number(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
    ...
    public String getLine1AlphaTag(int subscription) {
        try {
            return getSubscriberInfo().getLine1AlphaTag(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
    ...
    public String getMsisdn(int subscription) {
        try {
            return getSubscriberInfo().getMsisdn(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
    ...
    public String getVoiceMailNumber(int subscription) {
        try {
            return getSubscriberInfo().getVoiceMailNumber(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
    ...
    public String getCompleteVoiceMailNumber(int subscription) {
        try {
            return getSubscriberInfo().getCompleteVoiceMailNumber(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
    ...
    public int getVoiceMessageCount(int subscription) {
        try {
            return getITelephony().getVoiceMessageCount(subscription);
        } catch (RemoteException ex) {
            return 0;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
    ...
    public String getVoiceMailAlphaTag(int subscription) {
        try {
            return getSubscriberInfo().getVoiceMailAlphaTag(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
    ...
    public int getCallState(int subscription) {
        try {
            return getITelephony().getCallState(subscription);
        } catch (RemoteException ex) {
    ...
    public int getCdmaEriIconIndex(int subscription) {
        try {
            return getITelephony().getCdmaEriIconIndex(subscription);
        } catch (RemoteException ex) {
            // the phone process is restarting.
            return -1;
        } catch (NullPointerException ex) {
    ...
    public int getCdmaEriIconMode(int subscription) {
        try {
            return getITelephony().getCdmaEriIconMode(subscription);
        } catch (RemoteException ex) {
            // the phone process is restarting.
            return -1;
        } catch (NullPointerException ex) {
    ...
    public String getCdmaEriText(int subscription) {
        try {
            return getITelephony().getCdmaEriText(subscription);
        } catch (RemoteException ex) {
            // the phone process is restarting.
            return null;
        } catch (NullPointerException ex) {
