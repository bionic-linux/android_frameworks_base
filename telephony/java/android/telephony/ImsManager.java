...
public class ImsManager {
     ...
     * <p>
     * Usage: This intent is sent as an ordered broadcast. If the settings application is is going
     ...
     * failure. If the user taps this notification, the framework will then send an intent to the
     * {@code com.android.settings.Settings$WifiCallingSettingsActivity} activity with
     * {@link #EXTRA_WFC_REGISTRATION_FAILURE_TITLE} and
     * {@link #EXTRA_WFC_REGISTRATION_FAILURE_MESSAGE} for the Activity to use to display the
     * registration error information to the user.
     */
    @SdkConstant(SdkConstant.SdkConstantType.BROADCAST_INTENT_ACTION)
