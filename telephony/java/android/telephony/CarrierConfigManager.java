...
public class CarrierConfigManager {
    ...
    */
    ...
    /**
     * String array for bundled apps that need to be enabled 
     * {@link android.content.pm.PackageManager#COMPONENT_ENABLED_STATE_DEFAULT} for current
     * carrier to work as intended. Bundled apps not listed in this string array may be
     * set to {@link android.content.pm.PackageManager#COMPONENT_ENABLED_STATE_DISABLED} based on
     ...
     *
     * <p> It is recommended that this key should be configured by the OEM only.
     * @hide
     */
