  ...
  public static final String KEY_OPPORTUNISTIC_TIME_TO_SCAN_AFTER_CAPABILITY_SWITCH_TO_PRIMARY_LONG
    ...
    */
    ...
    public static final class Iwlan {
         ...
         * #EPDG_ADDRESS_PLMN_REGISTERED}, {@link #EPDG_ADDRESS_PLMN_IMSI},
         * {@link #EPDG_ADDRESS_PLMN_EHPLMN_ALL}, {@link
         * #EPDG_ADDRESS_PLMN_EHPLMN_FIRST}
         * @hide
         */
        public static final String KEY_EPDG_ADDRESS_PLMN_PRIORITY_INT_ARRAY =
                KEY_PREFIX + "epdg_address_plmn_priority_int_array";
        ...
        /** @hide */
        @IntDef({
                EPDG_ADDRESS_PLMN_REGISTERED,
                EPDG_ADDRESS_PLMN_IMSI,
                EPDG_ADDRESS_PLMN_EHPLMN_ALL,
                EPDG_ADDRESS_PLMN_EHPLMN_FIRST
        })
         ...
         * @hide
         */
        public static final int EPDG_ADDRESS_PLMN_REGISTERED = 0;
        /**
         * Use IMSI based PLMN
         * @hide
         */
        public static final int EPDG_ADDRESS_PLMN_IMSI = 1;
        /**
         * Use all EHPLMN from SIM EF files
         * @hide
         */
        public static final int EPDG_ADDRESS_PLMN_EHPLMN_ALL = 2;
        /**
         * Use first EHPLMN from SIM EF files
         * @hide
         */
        public static final int EPDG_ADDRESS_PLMN_EHPLMN_FIRST = 3;
        ...
        private static PersistableBundle getDefaults() {
            ...
            defaults.putIntArray(
                    KEY_EPDG_ADDRESS_PLMN_PRIORITY_INT_ARRAY,
                    new int[]{
                            EPDG_ADDRESS_PLMN_REGISTERED,
                            EPDG_ADDRESS_PLMN_IMSI,
                            EPDG_ADDRESS_PLMN_EHPLMN_ALL});
