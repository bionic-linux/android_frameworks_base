...
public class CarrierConfigManager {
    ...
    */
    ...
    /**
     * Where there is no preloaded voicemail number on a SIM card, specifies the carrier's default
     * voicemail number for unregistered state in IMS.
     * When empty string, no default voicemail number is specified for unregistered state in IMS.
     */
    public static final String KEY_DEFAULT_VM_NUMBER_IMS_UNREGISTERED_STRING =
            "default_vm_number_ims_unregistered_string";
    ...
    static {
        ...
        sDefaults.putString(KEY_DEFAULT_VM_NUMBER_IMS_UNREGISTERED_STRING, "");
