...
public class CarrierConfigManager {
    ...
    */
    ...
    /**
     * Flag indicating whether the carrier supports the capability exchange when the contact is
     * changed or expired.
     */
    ...
    /**
     * Flag indicating whether the carrier supports the capability exchange with a list of contact.
     * when {@code true}, the device could compose one capability query with multiple contacts. When
     * {@code false}, the device could only query the capability of one contact at a time.
     */
    public static final String KEY_RCS_CAPABILITY_EXCHANGE_LIST_SUBSCRIBE_BOOL =
            "rcs_capability_exchange_list_subscribe_bool";
    ...
    */
    ...
    static {
        ...
        sDefaults.putBoolean(KEY_RCS_CAPABILITY_EXCHANGE_LIST_SUBSCRIBE_BOOL, false);
