...
public class ApnSetting implements Parcelable {
    ...
    /** @hide */
    public ApnSetting(int id, String operatorNumeric, String entryName, String apnName,
            String proxy, String port, String mmsc, String mmsProxy, String mmsPort,
        ...
        this.mProxy = URLFromString(proxy);
        this.mPort = portFromString(port);
        this.mMmsc = URLFromString(mmsc);
        this.mMmsProxy = inetAddressFromString(mmsProxy);
        this.mMmsPort = portFromString(mmsPort);
        this.mUser = user;
    ...
    public ApnSetting(ApnSetting apn) {
        this(apn.mId, apn.mOperatorNumeric, apn.mEntryName, apn.mApnName, URLToString(apn.mProxy),
                portToString(apn.mPort), URLToString(apn.mMmsc), inetAddressToString(apn.mMmsProxy),
                portToString(apn.mMmsPort), apn.mUser, apn.mPassword, apn.mAuthType,
                apn.mTypes, apn.mProtocol, apn.mRoamingProtocol, apn.mCarrierEnabled, apn.mBearer,
    ...
    public String toString() {
        ...
        sb.append("[ApnSettingV3] ")
                ...
                .append(", ").append(URLToString(mProxy))
    ...
    public boolean equals(Object o) {
        ...
        && mOperatorNumeric.equals(other.mOperatorNumeric)
        && mApnName.equals(other.mApnName)
    ...
    public boolean similar(ApnSetting other) {
        return (!this.canHandleType(TYPE_DUN)
                ...
                && xorEqualsURL(this.mProxy, other.mProxy)
    ...
    public ContentValues toContentValues() {
        ...
        if (mProxy != null) {
            apnValue.put(Telephony.Carriers.PROXY, URLToString(mProxy));
        }
    ...
    public static URL URLFromString(String url) {
        try {
            return isNullOrEmpty(url) ? null : new URL(url);
    ...
    public static InetAddress inetAddressFromString(String inetAddress) {
        inetAddress =  NetworkUtils.trimV4AddrZeros(inetAddress);
        if (inetAddress == null) {
            return null;
        }
        String[] octets = inetAddress.split("\\.");
        if (octets.length != 4) return null;
        byte[] addr = new byte[4];
        for (int i = 0; i < 4; i++) {
            try {
                if (octets[i].length() > 3) {
                    Log.e(LOG_TAG, "Can't parse InetAddress from string.");
                    return null;
                }
    ...
    /** @hide */
    public static int portFromString(String strPort) {
        int port = -1;
        if (!isNullOrEmpty(strPort)) {
            try {
    ...
    public static ApnSetting makeApnSetting(Cursor cursor) {
        ...
        return new Builder()
                ...
                .setMmsPort(portFromString(
                        cursor.getString(cursor.getColumnIndexOrThrow(
                                Telephony.Carriers.MMSPORT))))
                .setUser(cursor.getString(cursor.getColumnIndexOrThrow(Telephony.Carriers.USER)))
                .setPassword(
                ...
                .setBearer(cursor.getInt(cursor.getColumnIndexOrThrow(Telephony.Carriers.BEARER)))
                .setBearerBitmask(
                        cursor.getInt(cursor.getColumnIndexOrThrow(
                ...
                .setMtu(cursor.getInt(cursor.getColumnIndexOrThrow(Telephony.Carriers.MTU)))
                .setMvnoType(
                        cursor.getString(cursor.getColumnIndexOrThrow(
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeString(mProxy == null ? null : mProxy.toString());
        dest.writeString(mPort == -1 ? null : Integer.toString(mPort));
        dest.writeString(mMmsc == null ? null : mMmsc.toString());
        dest.writeString(mMmsProxy == null ? null : mMmsProxy.toString());
        dest.writeString(mMmsPort == -1 ? null : Integer.toString(mMmsPort));
    ...
    private ApnSetting(Parcel in) {
        this(in.readInt(), in.readString(), in.readString(), in.readString(),
                ...
                in.readString(), in.readInt() > 0, 0, 0, 0,
                false, 0, 0, 0, 0, in.readString(), null);
    }
    ...
    public static class Builder{
        ...
        /**
         * Sets the types bitmap of the APN.
         *
         * @param typesBitmap the types bitmap to set for the APN
         * @hide
         */
        public Builder setTypesBitmap(int typesBitmap) {
            this.mTypesBitmap = typesBitmap;
            return this;
        }
         ...
         */
        public Builder setProxy(URL proxy) {
            this.mProxy = proxy;
            return this;
        }
        ...
        public Builder setTypes(@ApnType List<String> types) {
            this.mTypes = types.toArray(new String[0]);
            return this;
        }
