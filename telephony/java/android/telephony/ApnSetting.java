...
public class ApnSetting implements Parcelable {
    ...
    private ApnSetting(Builder builder) {
        this.mEntryName = (builder.mEntryName == null ? "" : builder.mEntryName);
        this.mApnName = (builder.mApnName == null ? "" : builder.mApnName);
        this.mProxy = builder.mProxy;
        this.mPort = builder.mPort;
        this.mMmsc = builder.mMmsc;
        this.mMmsProxy = builder.mMmsProxy;
        this.mMmsPort = builder.mMmsPort;
        this.mUser = (builder.mUser == null ? "" : builder.mUser);
        ...
        this.mOperatorNumeric = (builder.mOperatorNumeric == null ? "" : builder.mOperatorNumeric);
        this.mProtocol = (builder.mProtocol == null ? "" : builder.mProtocol);
        this.mRoamingProtocol = (builder.mRoamingProtocol == null ? "" : builder.mRoamingProtocol);
        this.mMtu = builder.mMtu;
        this.mCarrierEnabled = builder.mCarrierEnabled;
        this.mBearer = builder.mBearer;
        this.mBearerBitmask = (builder.mBearerBitmask
                | ServiceState.getBitmaskForTech(builder.mBearer));
        ...
        this.mMvnoType = (builder.mMvnoType == null ? "" : builder.mMvnoType);
        this.mMvnoMatchData = (builder.mMvnoMatchData == null ? "" : builder.mMvnoMatchData);
    }

    /** @hide */
    public static ApnSetting makeApnSetting(int id, String operatorNumeric, String entryName,
            String apnName, URL proxy, int port, URL mmsc, InetAddress mmsProxy,
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeString(URLToString(mProxy));
        dest.writeString(portToString(mPort));
        dest.writeString(URLToString(mMmsc));
        dest.writeString(inetAddressToString(mMmsProxy));
        dest.writeString(portToString(mMmsPort));
    ...
    private static ApnSetting readFromParcel(Parcel in) {
        return makeApnSetting(in.readInt(), in.readString(), in.readString(), in.readString(),
                URLFromString(in.readString()), portFromString(in.readString()),
                URLFromString(in.readString()), inetAddressFromString(in.readString()),
                portFromString(in.readString()), in.readString(), in.readString(), in.readInt(),
