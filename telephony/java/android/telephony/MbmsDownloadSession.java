...
public class MbmsDownloadSession implements AutoCloseable {
     ...
     * May throw an {@link IllegalStateException} or {@link IllegalArgumentException}.
     *
     * TODO: does the application need to request new file services via requestUpdateFileServices?
     * TODO: What errors can be returned?
     ...
     */
    public void addServiceAnnouncementFile(byte[] fileContents) {
        IMbmsDownloadService downloadService = mService.get();
        if (downloadService == null) {
            throw new IllegalStateException("Middleware not yet bound");
        }
