...
public final class NfcActivityManager extends IAppCallback.Stub
    ...
    public void setReaderMode(Binder token, int flags, Bundle extras) {
        ...
        NfcAdpater.callService(() -> NfcAdapter.sService.setReaderMode(token, flags, extras));
    }
    ...
    void requestNfcServiceCallback() {
        NfcAdpater.callService(() -> NfcAdapter.sService.setAppCallback(this));
    }

    void verifyNfcPermission() {
        NfcAdpater.callService(() -> NfcAdapter.sService.verifyNfcPermission());
    }
