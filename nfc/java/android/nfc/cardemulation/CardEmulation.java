...
public final class CardEmulation {
    ...
    public boolean registerPollingLoopPatternFilterForService(@NonNull ComponentName service,
        ...
        final String pollingLoopPatternFilterV = validatePollingLoopPatternFilter(pollingLoopPatternFilter);
        return callServiceReturn(() ->
            sService.registerPollingLoopPatternFilterForService(
                mContext.getUser().getIdentifier(), service, pollingLoopPatternFilterV, autoTransact),
            false);
    }
