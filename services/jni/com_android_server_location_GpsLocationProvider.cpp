...
LOGD("android_location_GpsLocationProvider_class_init_native");
...
LOGD("android_location_GpsLocationProvider_init");
    ...
    if (sGpsXtraInterface && !sGpsXtraInterface->init(&sGpsXtraCallbacks))
