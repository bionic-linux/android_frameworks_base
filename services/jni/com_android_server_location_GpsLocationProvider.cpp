...
static void agps_status_callback(AGpsStatus* agps_status)
{
    ...
    if (agps_status->size >= sizeof(AGpsStatus_v3)) {
        // HAL impl with AGpsStatus_v3
    ...
    } else if (agps_status->size >= sizeof(AGpsStatus_v2)) {
        // HAL impl with AGpsStatus_v2
        byteArray = convert_v4_ip(agps_status->ipaddr, false);
    } else if (agps_status->size >= sizeof(AGpsStatus_v1)) {
        // HAL impl with AGpsStatus_v1
    } else {
        // invalid HAL impl
        isSupported = false;
    }
