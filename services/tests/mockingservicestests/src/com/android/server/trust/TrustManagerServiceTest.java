...
public class TrustManagerServiceTest {
    ...
    private void setupFingerprint(int strength, boolean enrolled) {
        ...
        when(mFingerprintManager.hasEnrolledFingerprints(sensorId, TEST_USER_ID))
                .thenReturn(enrolled);
    }
    ...
    private void setupFace(int strength, boolean enrolled) {
        ...
        when(mFaceManager.hasEnrolledTemplates(sensorId, TEST_USER_ID)).thenReturn(enrolled);
    }
