...
public class RulesManagerServiceTest {
    ...
    public void checkComplete_noCallerPermission() throws Exception {
        configureCallerDoesNotHavePermission();
        mRulesManagerService.checkComplete(null, true);
    }
    ...
    public void checkComplete_operationInProgressOk() throws Exception {
        ...
        // Make the call.
        mRulesManagerService.checkComplete(tokenBytes, true /* success */);
    ...
    public void checkComplete_badToken() throws Exception {
        ...
        try {
            mRulesManagerService.checkComplete(badTokenBytes, true /* success */);
            fail();
        } catch (IllegalArgumentException expected) {
        }
    ...
    public void checkComplete() throws Exception {
        ...
        // Make the call.
        mRulesManagerService.checkComplete(tokenBytes, false /* success */);
    ...
    public void checkComplete_nullTokenBytes() throws Exception {
        ...
        // Make the call.
        mRulesManagerService.checkComplete(null /* tokenBytes */, true /* success */);
