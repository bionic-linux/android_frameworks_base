...
public class TimeZoneDetectorStrategyTest {
    ...
    private FakeTimeZoneDetectorStrategyHelper mFakeTimeZoneDetectorStrategyHelper;

    @Before
    public void setUp() {
        mFakeTimeZoneDetectorStrategyHelper = new FakeTimeZoneDetectorStrategyHelper();
        mTimeZoneDetectorStrategy =
                new TimeZoneDetectorStrategy(mFakeTimeZoneDetectorStrategyHelper);
    }
    ...
    /**
     * The {@link TimeZoneDetectorStrategy.Helper} is left to detect whether changing the the time
    ...
    class FakeTimeZoneDetectorStrategyHelper implements TimeZoneDetectorStrategy.Helper {
    ...
    private class Script {
        ...
        Script initializeTimeZoneDetectionEnabled(boolean enabled) {
            mFakeTimeZoneDetectorStrategyHelper.initializeTimeZoneDetectionEnabled(enabled);
            return this;
        }

        Script initializeTimeZoneSetting(boolean initialized) {
            mFakeTimeZoneDetectorStrategyHelper.initializeTimeZone(initialized);
            return this;
        }

        Script timeZoneDetectionEnabled(boolean timeZoneDetectionEnabled) {
            mFakeTimeZoneDetectorStrategyHelper.simulateTimeZoneDetectionEnabled(
        ...
        Script verifyTimeZoneNotSet() {
            mFakeTimeZoneDetectorStrategyHelper.assertTimeZoneNotSet();
            return this;
        }

        Script verifyTimeZoneSetAndReset(PhoneTimeZoneSuggestion timeZoneSuggestion) {
            mFakeTimeZoneDetectorStrategyHelper.assertTimeZoneSuggested(timeZoneSuggestion);
            mFakeTimeZoneDetectorStrategyHelper.commitAllChanges();
            return this;
        }
