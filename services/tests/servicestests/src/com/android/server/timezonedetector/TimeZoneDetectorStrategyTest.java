...
public class TimeZoneDetectorStrategyTest {
    ...
    private void makePhone1SuggestionAndCheckState(Script script, SuggestionTestCase testCase) {
        ...
        String currentZoneId = mFakeTimeZoneDetectorStrategyCallback.getTimeZoneSetting();
    ...
    /**
     * The {@link TimeZoneDetectorStrategy.Callback} is left to detect whether changing the the time
