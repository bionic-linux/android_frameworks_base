...
public class RecoverySystemServiceTestable extends RecoverySystemService {
    ...
    public static class FakeSystemProperties {
        private String mUncrypt = null;
        private String mSetupBcb = null;
        private String mClearBcb = null;
        private String mCtlStart = null;

        public String get(String key) {
            if (RecoverySystemService.INIT_SERVICE_UNCRYPT.equals(key)) {
                return mUncrypt;
            } else if (RecoverySystemService.INIT_SERVICE_SETUP_BCB.equals(key)) {
                return mSetupBcb;
            } else if (RecoverySystemService.INIT_SERVICE_CLEAR_BCB.equals(key)) {
                return mClearBcb;
            } else {
        ...
        public void setUncrypt(String uncrypt) {
            this.mUncrypt = uncrypt;
        }

        public void setSetupBcb(String setupBcb) {
            this.mSetupBcb = setupBcb;
        }

        public void setClearBcb(String clearBcb) {
            this.mClearBcb = clearBcb;
        }

        public void setCtlStart(String ctlStart) {
            this.mCtlStart = ctlStart;
        }
