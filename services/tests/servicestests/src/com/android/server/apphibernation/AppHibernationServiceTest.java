 ...
 */
@SmallTest
public class AppHibernationServiceTest {
    ...
    public void setUp() throws RemoteException {
        ...
        verify(mContext, times(2)).registerReceiver(receiverCaptor.capture(), any());
    ...
    @Test
    public void testGetHibernationState() {
        // WHEN we hibernate a package for a user
        mAppHibernationService.setHibernationState(PACKAGE_NAME_1, true, USER_ID_1);
    ...
    @Test
    public void testGetHibernationState_newPackage() {
        ...
        mAppHibernationService.setHibernationState(PACKAGE_NAME_2, true, USER_ID_1);
    ...
    @Test
    public void testGetHibernationState_replacingPackage() {
    ...
    @Test
    public void testGetHibernationState_newUser() throws RemoteException {
        ...
        mAppHibernationService.setHibernationState(PACKAGE_NAME_1, true, USER_ID_2);
