...
public class BluetoothAirplaneModeListenerTest {
    ...
    public void testIgnoreOnAirplanModeChange() {
        Assert.assertFalse(mBluetoothAirplaneModeListener.shouldSkipAirplanModeChange());
        ...
        Assert.assertTrue(mBluetoothAirplaneModeListener.shouldSkipAirplanModeChange());
    }
