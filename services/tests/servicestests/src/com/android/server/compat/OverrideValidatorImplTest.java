...
public class OverrideValidatorImplTest {
    ...
    @Test
    public void getOverrideAllowedState_forcedFinalBuildTargetSdkChangeDebugAppOptin_allowOverride()
            throws Exception {
        CompatConfig config = CompatConfigBuilder.create(debuggableBuild(), mContext)
                        .addEnableAfterSdkChangeWithId(TARGET_SDK_AFTER, 1)
                        .addEnableAfterSdkChangeWithId(TARGET_SDK, 2).build();
        config.forceUserFinalForTest(true);
        IOverrideValidator overrideValidator = config.getOverrideValidator();
        when(mPackageManager.getApplicationInfo(eq(PACKAGE_NAME), anyInt()))
                .thenReturn(ApplicationInfoBuilder.create()
                        .debuggable()
    ...
    @Test
    public void getOverrideAllowedState_forcedFinalBuildEnabledChangeDebugApp_rejectOverride()
            throws Exception {
        CompatConfig config = CompatConfigBuilder.create(debuggableBuild(), mContext)
                        .addEnabledChangeWithId(1).build();
        config.forceUserFinalForTest(true);
    ...
    @Test
    public void getOverrideAllowedState_forcedFinalBuildDisabledChangeDebugApp_allowOverride()
            throws Exception {
        CompatConfig config = CompatConfigBuilder.create(debuggableBuild(), mContext)
                .addDisabledChangeWithId(1).build();
        config.forceUserFinalForTest(true);
    ...
    @Test
    public void getOverrideAllowedState_forcedFinalBuildAnyChangeReleaseApp_rejectOverride()
            throws Exception {
        CompatConfig config = CompatConfigBuilder.create(debuggableBuild(), mContext)
                        .addEnableAfterSdkChangeWithId(TARGET_SDK_BEFORE, 1)
                        .addEnableAfterSdkChangeWithId(TARGET_SDK, 2)
    ...
    @Test
    public void getOverrideAllowedState_forcedFinalBuildAnyChangeNotInstalledApp_deferOverride()
            throws Exception {
        CompatConfig config = CompatConfigBuilder.create(debuggableBuild(), mContext)
                        .addEnableAfterSdkChangeWithId(TARGET_SDK_BEFORE, 1)
                        .addEnableAfterSdkChangeWithId(TARGET_SDK, 2)
