...
public abstract class IpMemoryStoreClient {
    ...
    public void storeBlob(@NonNull final String l2Key, @NonNull final String clientId,
        ...
        try {
            try {
                getService().storeBlob(l2Key, clientId, name, data, listener.toParcelable());
            } catch (InterruptedException | ExecutionException m) {
                listener.onComplete(new Status(Status.ERROR_UNKNOWN));
            }
        } catch (RemoteException e) {
    ...
    public void findL2Key(@NonNull final NetworkAttributes attributes,
        ...
        try {
            try {
                getService().findL2Key(attributes.toParcelable(), listener.toParcelable());
            } catch (InterruptedException | ExecutionException m) {
    ...
    public void isSameNetwork(@NonNull final String l2Key1, @NonNull final String l2Key2,
        ...
        try {
            try {
                getService().isSameNetwork(l2Key1, l2Key2, listener.toParcelable());
            } catch (InterruptedException | ExecutionException m) {
                listener.onSameNetworkResponse(new Status(Status.ERROR_UNKNOWN), null);
            }
        } catch (RemoteException e) {
    ...
    public void retrieveNetworkAttributes(@NonNull final String l2Key,
        ...
        try {
            try {
                getService().retrieveNetworkAttributes(l2Key, listener.toParcelable());
            } catch (InterruptedException | ExecutionException m) {
    ...
    public void retrieveBlob(@NonNull final String l2Key, @NonNull final String clientId,
        ...
        try {
            try {
                getService().retrieveBlob(l2Key, clientId, name, listener.toParcelable());
            } catch (InterruptedException | ExecutionException m) {
