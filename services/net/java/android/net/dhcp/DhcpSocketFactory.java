...
public class DhcpSocketFactory {
    /**
     * Build a packet socket for DHCP.
     */
    ...
    /**
     * Build a UDP socket for DHCP.
     * @param threadStatsTag active tag to use when accounting Socket traffic
     */
    public FileDescriptor makeUdpSocket(InterfaceParams iface, int port, int threadStatsTag)
            throws ErrnoException, SocketException {
        final int oldTag = TrafficStats.getAndSetThreadStatsTag(threadStatsTag);
