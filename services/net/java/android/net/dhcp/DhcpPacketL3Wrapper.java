...
import static android.net.dhcp.DhcpPacket.IP_TYPE_UDP;
...
public class DhcpPacketL3Wrapper {
    ...
    /**
     * Creates a new L3 packet (including IP header) containing the DHCP udp packet.
     *
     * <p>This method relies upon {@link DhcpPacket#buildPacket(ByteBuffer)} to insert payload.
     */
