...
public final class IpConfigurationParcelableUtil {
    public static StaticIpConfigurationParcelable toStableParcelable(@Nullable StaticIpConfiguration config) {
        if (config == null) {
            return null;
        }
    ...
    public static StaticIpConfiguration fromStableParcelable(@Nullable StaticIpConfigurationParcelable p) {
        if (p == null) {
            return null;
        }
