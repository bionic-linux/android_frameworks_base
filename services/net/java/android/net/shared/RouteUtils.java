...
public class RouteUtils {
    ...
    public static void addRoutesToLocalNetwork(final INetd netd, final String iface,
        ...
        for (RouteInfo route : routes) {
            if (!route.isDefaultRoute()) {
                modifyRoute(netd, true/* add */, INetd.LOCAL_NET_ID, route);
            }
        }

        // IPv6 link local should be activated always.
        modifyRoute(netd, true/* add */, INetd.LOCAL_NET_ID,
    ...
    public static int removeRoutesFromLocalNetwork(final INetd netd, final List<RouteInfo> routes) {
        ...
        for (RouteInfo route : routes) {
            try {
                modifyRoute(netd, false/* remove */, INetd.LOCAL_NET_ID, route);
    ...
    /** Add or remove |route|. */
    public static void modifyRoute(final INetd netd, final boolean add, final int netId,
