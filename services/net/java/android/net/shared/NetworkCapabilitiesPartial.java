...
public class NetworkCapabilitiesPartial {
    ...
    /**
     * Returns the array of transport types on the network.
     */
    public int[] getTransportTypes() {
        return unpackBits(mTransportTypes);
    }

    /**
     * Identical to {@link BitUtils#unpackBits(long)}. Must be inlined as BitUtils is an internal
     * utils class.
     */
    private static int[] unpackBits(long val) {
