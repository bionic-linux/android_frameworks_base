...
public class IpReachabilityMonitor {
     ...
     * TODO: wrap MultinetworkPolicyTracker too
     */
    interface Config {
        void acquireWakeLock(long durationMs);

        static Config makeDefault(Context context, String iface) {
    ...
    public IpReachabilityMonitor(Context context, String ifName, SharedLog log, Callback callback,
        ...
        this(ifName, getInterfaceIndex(ifName), log, callback, tracker,
                Config.makeDefault(context, ifName));
    }

    @VisibleForTesting
    IpReachabilityMonitor(String ifName, int ifIndex, SharedLog log, Callback callback,
            MultinetworkPolicyTracker tracker, Config config) {
        ...
        // TODO: pass in as parameter and avoid creating a specific thread for NetlinkSocketObserver
