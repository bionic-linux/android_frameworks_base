...
public class IpClientUtil {
    ...
    public static void makeIpClient(Context context, String ifName, IpClientCallback callback) {
    ...
    private static class IpClientCallbacksProxy extends IIpClientCallbacks.Stub {
        protected final IpClientCallback mCb;
        IpClientCallbacksProxy(IpClientCallback cb) {
            mCb = cb;
        }
