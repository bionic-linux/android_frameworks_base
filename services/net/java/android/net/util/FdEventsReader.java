...
public abstract class FdEventsReader<T> {
    ...
    protected FdEventsReader(Handler h, T buffer) {
        mHandler = h;
    ...
    protected abstract int recvBufSize(T buffer);
     ...
     */
    protected abstract int readPacket(FileDescriptor fd, T buffer) throws Exception;
     ...
     */
    protected void handlePacket(T recvbuf, int length) {}
