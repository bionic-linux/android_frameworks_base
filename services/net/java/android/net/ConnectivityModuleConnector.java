...
public class ConnectivityModuleConnector {
    ...
    private final ModuleServiceIntentProvider mIntentProvider;
    ...
    @VisibleForTesting
    ConnectivityModuleConnector(@Nullable ModuleServiceIntentProvider intentProvider) {
        mIntentProvider = intentProvider == null
                ? new ModuleServiceIntentProviderImpl() : intentProvider;
    }
     ...
     */
    @VisibleForTesting
    public interface ModuleServiceIntentProvider {
        /**
    ...
    private class ModuleServiceIntentProviderImpl implements ModuleServiceIntentProvider {
        @Nullable
        @Override
    ...
    public void startModuleService(
        ...
        Intent intent = mIntentProvider.getModuleServiceIntent(pm, serviceIntentBaseAction,
                servicePermissionName, true /* inSystemProcess */);

        // Otherwise use the updatable module version
        if (intent == null) {
            intent = mIntentProvider.getModuleServiceIntent(pm, serviceIntentBaseAction,
