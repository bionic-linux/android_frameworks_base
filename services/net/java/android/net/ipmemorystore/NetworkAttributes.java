...
public class NetworkAttributes {
    ...
    public static class Builder {
        ...
        /**
         * Set the lease expiry timestamp of assigned v4 address.The lease expiry timestamp
         * in milliseconds since epoch and Long.MAX_VALUE (0xffffffff) is used to represent
         * "infinite lease".
