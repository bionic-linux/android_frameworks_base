...
public class NetworkAttributes {
    ...
    @Nullable
    public final Integer assignedV4AddressExpiry;
    private static final float WEIGHT_ASSIGNEDV4ADDREXPIRY = 300.0f;
    ...
    public NetworkAttributes(
            ...
            @Nullable final Integer assignedV4AddressExpiry,
    ...
    public static class Builder {
        ...
        @Nullable
        private Integer mAssignedAddressExpiry;
        @Nullable
        ...
        /**
         * Set the lease expiration of assigned address.
         * @param assignedV4AddressExpiry The lease expiration of assigned address.
         * @return This builder.
         */
        public Builder setAssignedV4AddressExpiry(
                @Nullable final Integer assignedV4AddressExpiry) {
            if (null != assignedV4AddressExpiry && assignedV4AddressExpiry < 0) {
                throw new IllegalArgumentException("IPv4 address lease expiry can't be negative");
            }
