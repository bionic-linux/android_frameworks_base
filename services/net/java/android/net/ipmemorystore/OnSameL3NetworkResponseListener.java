 ...
 * @hide
 */
public abstract class OnSameL3NetworkResponseListener {
    /**
     * The memory store has come up with the answer to a query that was sent.
     */
    public abstract void onSameL3NetworkResponse(Status status, SameL3NetworkResponse response);

    /** Converts this OnSameL3NetworkResponseListener to a parcelable object */
    @NonNull
    public IOnSameL3NetworkResponseListener.Stub toParcelable() {
        return new IOnSameL3NetworkResponseListener.Stub() {
            ...
            public void onSameL3NetworkResponse(final StatusParcelable statusParcelable,
                ...
                OnSameL3NetworkResponseListener.this.onSameL3NetworkResponse(
