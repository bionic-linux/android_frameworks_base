...
class OwnersData {
    ...
    private static final String TAG_USER_RESTRICTIONS_POLICY_ENGINE_MIGRATION =
            "user-restrictions-policy-engine-migration";
    ...
    private static final String ATTR_USER_RESTRICTIONS_MIGRATED_TO_POLICY_ENGINE =
    ...
    private class DeviceOwnerReadWriter extends FileReadWriter {
        ...
        void writeInner(TypedXmlSerializer out) throws IOException {
            ...
            out.startTag(null, TAG_USER_RESTRICTIONS_POLICY_ENGINE_MIGRATION);
            out.attributeBoolean(null, ATTR_USER_RESTRICTIONS_MIGRATED_TO_POLICY_ENGINE,
                    mUserRestrictionsMigratedToPolicyEngine);
            out.endTag(null, TAG_USER_RESTRICTIONS_POLICY_ENGINE_MIGRATION);
        ...
        boolean readInner(TypedXmlPullParser parser, int depth, String tag) {
            ...
            switch (tag) {
                ...
                case TAG_POLICY_ENGINE_MIGRATION:
                    ...
                    break;
                case TAG_USER_RESTRICTIONS_POLICY_ENGINE_MIGRATION:
                    mUserRestrictionsMigratedToPolicyEngine = parser.getAttributeBoolean(
                            null, ATTR_USER_RESTRICTIONS_MIGRATED_TO_POLICY_ENGINE, false);
                    break;
                default:
