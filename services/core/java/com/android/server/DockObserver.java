...
final class DockObserver extends SystemService {
    ...
    private void updateVideoStateLocked() {
        Intent intent = new Intent();
        if (mVideoState != STATE_VIDEO_AVAILABLE) {
            intent.setAction(tomtom.platform.Intent.ACTION_VIDEO_UNAVAILABLE);
        } else {
            intent.setAction(tomtom.platform.Intent.ACTION_VIDEO_AVAILABLE);
        }
