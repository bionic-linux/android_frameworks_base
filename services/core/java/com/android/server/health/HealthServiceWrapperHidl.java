...
final class HealthServiceWrapperHidl implements HealthServiceWrapper {
    ...
    public HealthInfo getHealthInfo() throws RemoteException {
        ...
        service.getHealthInfo((result, value) -> {
     ...
     * {@link #INSTANCE_VENDOR} and in device / framework manifest are used. This function
     * should
     * only be called once.
     *
     ...
     *                                available on this device), or none of these instances are
    ...
    interface Callback {
         ...
         *                 Can be a dead service before service notification of a new service is
         *                 delivered.
         *                 Implementation must handle cases for {@link RemoteException}s when
         *                 calling
         *                 into service.
