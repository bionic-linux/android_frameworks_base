 ...
 * TimeDetectorService. The TimeDetectorService guarantees that all calls to the strategy besides
 * {@link #initialize(Callback)} are made using a single, dedicated thread.
 *
 * @hide
 */
