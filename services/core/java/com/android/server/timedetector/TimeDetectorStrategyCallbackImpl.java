...
public final class TimeDetectorStrategyCallbackImpl implements TimeDetectorStrategy.Callback {
     ...
     */
    private static final int SYSTEM_CLOCK_UPDATE_THRESHOLD_DEFAULT = 2 * 1000;
    private final int mSystemClockUpdateThreshold;
    ...
    public TimeDetectorStrategyCallbackImpl(@NonNull Context context) {
        ...
        mSystemClockUpdateThreshold =
                SystemProperties.getInt("ro.time_detector_update_diff",
                        SYSTEM_CLOCK_UPDATE_THRESHOLD_DEFAULT);
    }

    @Override
    public int systemClockUpdateThresholdMillis() {
        return mSystemClockUpdateThreshold;
    }
