...
public class WirelessDebuggingManager {
    ...
    private static native boolean native_pairing_start(String password, String guid, String name);
    private static native void native_pairing_cancel();
    ...
    class PairingThread extends Thread {
        ...
        @Override
        public void run() {
                        Slog.e(TAG, "Unable to enable pairing discovery.");
                        // TODO: send FAILED response back to UI
            boolean paired = native_pairing_start(mPairingCode, mGuid, mName);
