...
public class RuntimeInfoService extends Binder {
    ...
    /**
     * Add information to {@link CoreLibrary.DebugInfo} about the time zone data supplied by the
     * "Time zone updates via APK" feature.
     */
    private static void addTimeZoneApkDebugInfo(CoreLibrary.DebugInfo coreLibraryDebugInfo) {
     ...
     * {@link #reportTimeZoneInfoProto(CoreLibrary.DebugInfo, ProtoOutputStream)} as well.
     */
    private static void reportTimeZoneInfo(CoreLibrary.DebugInfo coreLibraryDebugInfo,
            PrintWriter pw) {
     ...
     *
     * <p>If you change this method, make sure to modify
     * {@link #reportTimeZoneInfo(CoreLibrary.DebugInfo, PrintWriter)}.
     */
    private static void reportTimeZoneInfoProto(
            CoreLibrary.DebugInfo coreLibraryDebugInfo, ProtoOutputStream protoStream) {
        for (CoreLibrary.DebugEntry debugEntry : coreLibraryDebugInfo.getDebugEntries()) {
            long entryToken = protoStream.start(RuntimeInfoServiceDumpProto.DEBUG_ENTRY);
