 ...
 *
 * TODO This class is synchronized. It may make sense to move the synchronization to the Service.
 * See also the TODO in the settings listener code.
 */
public class TimeZoneDetectorStrategy {

    /**
     * Used by {@link TimeZoneDetectorStrategy} to interact with device settings. It can be
     * faked for tests.
     */
    @VisibleForTesting
    ...
    public static synchronized TimeZoneDetectorStrategy getInstance(Context context) {
        if (sInstance == null) {
            Helper timeZoneDetectionServiceHelper = new TimeZoneDetectorStrategyHelperImpl(context);
    ...
    @VisibleForTesting
    public TimeZoneDetectorStrategy(Helper timeZoneDetectionServiceHelper) {
    ...
    public void dumpState(PrintWriter pw) {
        pw.println(" TimeZoneDetectorStrategy.mCurrentSuggestion=" + mCurrentSuggestion);
        pw.println(" TimeZoneDetectorStrategy.mSuggestionsByPhoneId=" + mSuggestionByPhoneId);
