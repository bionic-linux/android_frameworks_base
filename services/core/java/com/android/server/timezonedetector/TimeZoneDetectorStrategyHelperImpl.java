...
/**
 * The real implementation of {@link TimeZoneDetectorStrategy.Helper}.
 */
public final class TimeZoneDetectorStrategyHelperImpl implements TimeZoneDetectorStrategy.Helper {

    private static final String LOG_TAG = TimeZoneDetectorStrategy.LOG_TAG;
    private static final boolean DBG = TimeZoneDetectorStrategy.DBG;
    ...
    TimeZoneDetectorStrategyHelperImpl(Context context) {
        mContext = context;
    ...
    public void setListener(Listener listener) {
        ...
        mCr.registerContentObserver(
                ...
                // TODO Think harder about threading
    ...
    public void dumpState(PrintWriter pw) {
        pw.println(" TimeZoneDetectorStrategyHelperImpl.getTimeZoneSetting()="
                + getTimeZoneSetting());
    }

    @Override
    public void dumpLogs(IndentingPrintWriter ipw) {
        ipw.println("TimeZoneDetectorStrategyHelperImpl:");
