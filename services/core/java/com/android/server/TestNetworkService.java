...
class TestNetworkService extends ITestNetworkManager.Stub {
    ...
    protected TestNetworkService(@NonNull Context context,
            @NonNull INetworkManagementService netManager) {
     ...
     */
    @Override
    public synchronized ParcelFileDescriptor buildTun(@NonNull String iface,
            @NonNull LinkAddress[] linkAddrs, @NonNull String callingPackage) {
    ...
    @NonNull private static final SparseArray<TestNetworkAgent> mTestNetworkTracker = new SparseArray<>();
    ...
    public static class TestNetworkAgent extends NetworkAgent implements IBinder.DeathRecipient {
        ...
        private synchronized void teardown() {
            ...
            // Has to be in here to ensure all teardown codepaths properly clean up resources
            mTestNetworkTracker.remove(netId);
        }
    }

    private static TestNetworkAgent registerTestNetworkAgent(
            @NonNull Looper looper, @NonNull Context context, @NonNull String iface, int callingUid,
            @NonNull IBinder binder)
    ...
    public synchronized void buildTestNetwork(
            @NonNull String iface, @NonNull IBinder binder, @NonNull String callingPackage) {
        enforceTestNetworkPermissions(mContext, callingPackage);
    ...
    @Override
    public synchronized void teardownTestNetwork(int netId, @NonNull String callingPackage) {
        enforceTestNetworkPermissions(mContext, callingPackage);
    ...
    public static void enforceTestNetworkPermissions(
            @NonNull Context context, @NonNull String callingPackage) {
