...
class TestNetworkService extends ITestNetworkManager.Stub {
    ...
    private static SparseArray<TestNetworkAgent> mTestNetworkTracker = new SparseArray<>();
    ...
    public static class TestNetworkAgent extends NetworkAgent implements IBinder.DeathRecipient {
        ...
        private synchronized void teardown() {
            ...
            // Has to be in here to ensure all cleanup codepaths properly
    ...
    private static TestNetworkAgent registerTestNetworkAgent(
        ...
        checkNotNull(netIntf, "No such network interface found");
