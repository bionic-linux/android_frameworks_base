...
class TestNetworkService extends ITestNetworkManager.Stub {
     ...
     */
    @Override
    public ParcelFileDescriptor buildTun(
     ...
     */
    @Override
    public ParcelFileDescriptor buildTap(@NonNull String iface, @NonNull String callingPackage) {
        return buildTunTap(iface, null, false, callingPackage);
    }

    private ParcelFileDescriptor buildTunTap(
            @NonNull String iface,
            @Nullable LinkAddress[] linkAddrs,
            boolean useTun,
            @NonNull String callingPackage) {
        synchronized (TestNetworkService.this) {
            ...
            try {
                ParcelFileDescriptor tunIntf =
                        ParcelFileDescriptor.adoptFd(jniCreateTunTap(iface, useTun));
    ...
    @Override
    public void teardownTestNetwork(int netId, @NonNull String callingPackage) {
        synchronized (TestNetworkService.this) {
            enforceTestNetworkPermissions(mContext, callingPackage);
