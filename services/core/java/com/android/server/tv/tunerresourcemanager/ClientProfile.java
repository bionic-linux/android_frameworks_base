...
public final class ClientProfile {
    ...
    */
    public static class Builder {
         ...
         *     challenger scenario. The default behavior favors the resource challenger and
         * grants them ownership of the resource if resourceHolderRetain is not explicitly
         * set to true.
         */
