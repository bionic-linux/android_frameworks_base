...
public final class ShutdownThread extends Thread {
    ...
    // maximun time we wait for the StorageManagerService before going on.
    // Shorter time may cause unmount fail if 3rd app occupy files but no impact.
    private static final int MAX_SHUTDOWN_WAIT_TIME = SystemProperties.getInt("sys.shutdown.maxwaittime", 20*1000);
