...
public class TetherInterfaceStateMachine extends StateMachine {
    ...
    private void setInterfaceState(int newInterfaceState) {
        mInterfaceState = newInterfaceState;
        mTetherController.notifyInterfaceStateChange(
                mIfaceName, TetherInterfaceStateMachine.this, mInterfaceState, mLastError);
    }

    class InitialState extends State {
        @Override
        public void enter() {
            setInterfaceState(IControlsTethering.STATE_AVAILABLE);
        }
    ...
    class LocalHotspotState extends State {
        ...
        public void enter() {
            ...
            setInterfaceState(IControlsTethering.STATE_LOCAL_HOTSPOT);
        }
    ...
    class TetheredState extends State {
        ...
        public void enter() {
            ...
            setInterfaceState(IControlsTethering.STATE_TETHERED);
        }
    ...
    class UnavailableState extends State {
        ...
        public void enter() {
            mLastError = ConnectivityManager.TETHER_ERROR_NO_ERROR;
            setInterfaceState(IControlsTethering.STATE_UNAVAILABLE);
        }
    }
}
