 ...
 * Calling #startObserveAllNetwork() to observe all networks. Listening all
 * network is necessary while the expression of preferred upstreams remains
 * a list of legacy connectivity types.  In future, this can be revisited.
 * Calling #registerMobileNetworkRequest() to bring up mobile network, ex:
 * DUN.
 *
...
public class UpstreamNetworkMonitor {
    ...
    public void startObserveAllNetwork() {
        stop();
    ...
    public Network getDefaultInternetUpstream() {
        return mDefaultInternetNetwork;
    }
