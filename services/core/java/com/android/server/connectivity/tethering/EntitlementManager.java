...
public class EntitlementManager {
    ...
    private ResultReceiver buildProxyReceiver(int type, final ResultReceiver receiver) {
        ...
        //ResultReceiver rr = new ResultReceiver(null) {
            ...
            protected void onReceiveResult(int resultCode, Bundle resultData) {
                Log.d(TAG, "in the proxy");
                updateEntitlementCacheValue(type, resultCode);
                receiver.send(resultCode, null);
            }
        };

        return writeToPracel(rr);
    }

    private ResultReceiver writeToPracel(final ResultReceiver receiver) {
    ...
    public void updateEntitlementCacheValue(int type, int resultCode) {
        if (DBG) {
    ...
    public void getLatestTetheringEntitlementValue(int downstream, ResultReceiver receiver,
        ...
        if (!isTetherProvisioningRequired()) {
            receiver.send(TETHER_ERROR_ENTITLEMENT_UNKONWN, null);
            return;
        }
