...
public class EntitlementManager {
    ...
    private static final String EXTRA_ADD_SUBID = "extraAddSubId";
    ...
    public static class OnEntitlementCallback {
        ...
        /**
         * Provisioning will be started if needed.
         */
    ...
    private void handleStartProvisioningIfNeeded(int type, boolean showProvisioningUi) {
        ...
        mCallback.onMaybeStartProvisioning();
    ...
    protected void runSilentTetherProvisioning(int type) {
        ...
        intent.putExtra(EXTRA_ADD_SUBID, mConfig.subId);
