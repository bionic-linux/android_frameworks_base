...
public class NetworkAgentInfo implements Comparable<NetworkAgentInfo> {
    ...
    @Nullable private InternalScore mLastScore;
    // This represents the quality of the network.
    private InternalScore mScore;
    ...
    public InternalScore getLastScore() {
        return mLastScore;
    }

    public InternalScore getScore() {
        return mScore;
    }
    ...
    public void setScore(final NetworkScore score) {
        mScore = InternalScore.fromNetworkScore(score, networkCapabilities, networkAgentConfig);
    }
