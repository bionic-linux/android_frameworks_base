...
public class QosCallbackTracker {
    ...
    @NonNull
    private final ConnectivityService.NetworkRequestCounter mNetworkRequestCounter;
     ...
     */
    private int mAgentCallbackIdCounter = 0;
    ...
    public QosCallbackTracker(@NonNull final Handler connectivityServiceHandler,
            final ConnectivityService.NetworkRequestCounter networkRequestCounter) {
    ...
    public void registerCallback(@NonNull final IQosCallback callback,
        ...
        mNetworkRequestCounter.enforceRequestCountLimit(uid);
    ...
    private void handleRegisterCallback(@NonNull final IQosCallback callback,
        ...
        if (CollectionUtils.any(mConnections, c -> c.getBinder().equals(binder))) {
            ...
            mNetworkRequestCounter.decrementNetworkRequestPerUidCount(uid);
            return;
        }

        // Increment the counter before using it avoid any reordering.
        mAgentCallbackIdCounter = mAgentCallbackIdCounter + 1;
    ...
    private void handleUnregisterCallback(@NonNull final IBinder binder,
        ...
        mNetworkRequestCounter.decrementNetworkRequestPerUidCount(agentConnection.getUid());
