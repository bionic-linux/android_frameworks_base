...
public class Nat464Xlat extends BaseNetworkObserver {
    ...
    private enum State {
        ...
        DISCOVERING,  // like as IDLE, except prefix discovery in progress.
    ...
    public static boolean requiresClat(NetworkAgentInfo nai) {
        ...
        // We only run clat on networks that have a global IPv6 address and and don't have a native
        // IPv4 address.
     ...
     * @return true if the network requires clat, false otherwise.
     */
    public static boolean shouldStartClat(NetworkAgentInfo nai) {
        LinkProperties lp = nai.linkProperties;
    ...
    protected void stop() {
        if (!isStarted()) {
            Slog.e(TAG, "startClat: already stopped");
            return;
        }
        ...
        // fixupLinkProperties, and if we're still in RUNNING state at that time, we'll tell
        // ConnectivityService that we still have a stacked interface.
        leaveStartedState();
