...
public class PermissionMonitor implements PackageManagerInternal.PackageListObserver {
    ...
    public synchronized void startMonitoring() {
        ...
        for (PackageInfo app : apps) {
            ...
            boolean hasRestrictedPermission = hasRestrictedNetworkPermission(app, uid);
    ...
    @VisibleForTesting
    boolean hasRestrictedNetworkPermission(@NonNull final PackageInfo app, final int uid) {
    ...
    protected Boolean highestPermissionForUid(Boolean currentPermission, String name, int uid) {
        ...
        try {
            ...
            final boolean hasRestrictedPermission = hasRestrictedNetworkPermission(app, uid);
            if (isNetwork || hasRestrictedPermission) {
     ...
     */
    @Override
    public synchronized void onPackageChanged(@NonNull String packageName, int uid) {
        sendPackagePermissionsForUid(uid, getPermissionForUid(uid));
    }
