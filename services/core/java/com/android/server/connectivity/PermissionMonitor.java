...
public class PermissionMonitor {
    ...
    /** Returns whether if given uid has using background network permission. */
    public synchronized boolean hasUseBackgroundNetworksPermission(int uid) {
        // mApps already checked both network and using restricted network permissions. If uid is in
