    ...
    public static TcpKeepalivePacketData tcpKeepalivePacket(
        ...
        try {
            ...
            if (checkIfSocketIdel(fd)) {
                throw new InvalidPacketException(ERROR_INVALID_IP_ADDRESS); //TODO change to ERROR_SOCKET_NOT_IDLE
            }
            ...
            if (checkIfSocketIdel(fd)) {
                throw new InvalidPacketException(ERROR_INVALID_IP_ADDRESS); //TODO change to ERROR_MAY_CAUSE_DATA_CORRUPTION
            }
        } catch (ErrnoException e) {
