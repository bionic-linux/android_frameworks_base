...
public class InternalScore {
    ...
    /**
     * Make an InternalScore from a NetworkScore
     */
    public static InternalScore withPolicy(@NonNull final NetworkScore originalScore,
            final boolean isValidated) {
        return new InternalScore(originalScore.getLegacyInt(),
