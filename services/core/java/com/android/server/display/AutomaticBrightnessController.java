...
class AutomaticBrightnessController {
    ...
    private static int mAmbientLightHorizon;

    // The intercept used for the weighting calculation. This is used in order to keep all possible
    // weighting values positive.
    private static int mWeightingIntercept;
    ...
    private static final class AmbientLightRingBuffer{
        ...
        public AmbientLightRingBuffer(long lightSensorRate) {
            mCapacity = (int) Math.ceil(mAmbientLightHorizon * BUFFER_SLACK / lightSensorRate);
