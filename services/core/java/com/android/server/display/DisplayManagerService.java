        ...
        public void onUidImportance(int uid, int importance) {
            synchronized (mPendingCallbackSelfLocked) {
                ...
                for (int i = size - 1; i >= 0; i--) {
                    ...
                    PendingCallback pendingCallbackByPid = pendingCallbacksByUid.get(pid);
                    pendingCallbackByPid.sendPendingDisplayEvent();
            ...
            if (isUidCached(uid)) {
                ...
                synchronized (mPendingCallbackSelfLocked) {
                    ...
                    if (pendingCallbacksByUid == null) {
                        ...
                        PendingCallback pendingCallback = pendingCallbacksByUid.get(pid);
