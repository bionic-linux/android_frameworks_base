...
public class IpSecService extends IIpSecService.Stub {
    ...
    private final class TransformRecord extends ManagedResource {
        ...
        protected void nullifyRecord() {
            mConfig = null;
            mResourceId = IpSecTransform.INVALID_RESOURCE_ID;
        }
    }
    ...
    private final class SpiRecord extends ManagedResource {
        ...
        protected void nullifyRecord() {
            ...
            mResourceId = IpSecManager.SecurityParameterIndex.INVALID_RESOURCE_ID;
        }
    }
    ...
    public Bundle reserveSecurityParameterIndex(
        ...
        try {
            ...
            retBundle.putInt(
                    IpSecManager.SecurityParameterIndex.KEY_STATUS, IpSecManager.Status.OK);
            ...
            retBundle.putInt(
                    IpSecManager.SecurityParameterIndex.KEY_STATUS,
                    IpSecManager.Status.SPI_UNAVAILABLE);
            retBundle.putInt(IpSecManager.SecurityParameterIndex.KEY_RESOURCE_ID, resourceId);
            retBundle.putInt(IpSecManager.SecurityParameterIndex.KEY_SPI, spi);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        ...
        for (int direction : DIRECTIONS) {
            ...
            try {
                ...
                if (result != c.getSpi(direction)) {
                    ...
                    retBundle.putInt(
                            IpSecTransform.KEY_RESOURCE_ID, IpSecTransform.INVALID_RESOURCE_ID);
                    return retBundle;
                }
            } catch (ServiceSpecificException e) {
                // FIXME: get the error code and throw is at an IOException from Errno Exception
