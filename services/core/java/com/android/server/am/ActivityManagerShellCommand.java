...
final class ActivityManagerShellCommand extends ShellCommand {
    ...
    private int mLaunchTaskDisplayAreaFeature;
    ...
    private Intent makeIntent(int defUser) throws URISyntaxException {
        ...
        mLaunchTaskDisplayAreaFeature = FEATURE_UNDEFINED;
        ...
        return Intent.parseCommandArgs(this, new Intent.CommandOptionHandler() {
            ...
            public boolean handleOption(String opt, ShellCommand cmd) {
                ...
                } else if (opt.equals("--launch-task-display-area-feature")) {
                    mLaunchTaskDisplayAreaFeature = Integer.parseInt(getNextArgRequired());
    ...
    int runStartActivity(PrintWriter pw) throws RemoteException {
        ...
        do {
            ...
            if (mLaunchTaskDisplayAreaFeature != FEATURE_UNDEFINED) {
                ...
                options.setLaunchTaskDisplayAreaFeature(mLaunchTaskDisplayAreaFeature);
            }
