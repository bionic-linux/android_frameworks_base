...
final class ActivityManagerShellCommand extends ShellCommand {
    ...
    private Intent makeIntent(int defUser) throws URISyntaxException {
        ...
        mLaunchTaskDisplayAreaFeatureId = FEATURE_UNDEFINED;
        ...
        return Intent.parseCommandArgs(this, new Intent.CommandOptionHandler() {
            ...
            public boolean handleOption(String opt, ShellCommand cmd) {
                ...
                } else if (opt.equals("--launch-task-display-area-feature-id")) {
                    mLaunchTaskDisplayAreaFeatureId = Integer.parseInt(getNextArgRequired());
    ...
    int runStartActivity(PrintWriter pw) throws RemoteException {
        ...
        do {
            ...
            if (mLaunchTaskDisplayAreaFeatureId != FEATURE_UNDEFINED) {
                ...
                options.setLaunchTaskDisplayAreaFeatureId(mLaunchTaskDisplayAreaFeatureId);
            }
