...
class LockSettingsShellCommand extends ShellCommand {
    ...
    private final int mOrigPid;
    private final int mOrigUid;

    private String mOld = "";
    private String mNew = "";

    LockSettingsShellCommand(LockPatternUtils lockPatternUtils, Context context, int origPid,
            int origUid) {
