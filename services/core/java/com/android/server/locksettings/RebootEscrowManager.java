...
class RebootEscrowManager {
    ...
    private void setLoadEscrowDataErrorCodeIfUnset(@RebootEscrowErrorCode int errorCode) {
        if (mLoadEscrowDataErrorCode == ERROR_NONE) {
            mLoadEscrowDataErrorCode = errorCode;
        }
    }
    ...
    void scheduleLoadRebootEscrowDataOrFail(Handler retryHandler, int attemptNumber,
        ...
        setLoadEscrowDataErrorCodeIfUnset(ERROR_RETRY_COUNT_EXHAUSTED);
    ...
    void loadRebootEscrowDataWithRetry(Handler retryHandler, int attemptNumber,
        ...
        if (escrowKey == null) {
            setLoadEscrowDataErrorCodeIfUnset(ERROR_LOAD_ESCROW_KEY);
        ...
        if (!allUsersUnlocked) {
            setLoadEscrowDataErrorCodeIfUnset(ERROR_UNLOCK_ALL_USERS);
        }
    ...
    private void reportMetricOnRestoreComplete(boolean success, int attemptCount) {
        ...
        if (!success) {
            setLoadEscrowDataErrorCodeIfUnset(ERROR_UNKNOWN);
        }
    ...
    private RebootEscrowKey getAndClearRebootEscrowKey(SecretKey kk) throws IOException {
        ...
        if (rebootEscrowProvider == null) {
            ...
            setLoadEscrowDataErrorCodeIfUnset(ERROR_NO_PROVIDER);
            return null;
        }
