...
class RebootEscrowManager {
    ...
    @IntDef({ERROR_NONE, ERROR_UNKNOWN, ERROR_NO_PROVIDER, ERROR_LOAD_ESCROW_KEY,
            ERROR_RETRY_COUNT_EXHAUSTED, ERROR_UNLOCK_ALL_USERS})
    ...
    static class Injector {
        ...
        public String getVbmetaDigest(boolean other) {
            if (other) {
                return SystemProperties.get(OTHER_VBMETA_DIGEST_PROP_NAME);
            }
            return SystemProperties.get(VBMETA_DIGEST_PROP_NAME);
        }
    }
