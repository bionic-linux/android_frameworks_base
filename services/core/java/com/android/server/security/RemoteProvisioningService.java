...
import android.security.rkpd.service.Registration;
...
public class RemoteProvisioningService extends IRemoteProvisioning.Stub {
    static final String TAG = "RemoteProvisioningSvc";
    ...
    @Override
    public IRegistration getRegistration(String irpcName) throws RemoteException {
        Log.i(TAG, "getRegistration");
