...
/**
 * A {@link SystemService} that implements the remote provisioning system service. This service is
 * backed by a mainline module, allowing the underlying implementation to be updated. The code here
 * is mostly just a thin proxy for the code in com.android.rkpd.
 *
 * @hide
 */
public class RemoteProvisioningService extends IRemoteProvisioning.Stub {
    ...
    public void getRegistration(String irpcName, IGetRegistrationCallback callback)
        ...
        Registration.getRegistrationAsync(
                mContext,
                irpcName,
                ...
                new OutcomeReceiver<>() {
                    ...
                    @Override
                    public void onError(RemoteException error) {
                        try {
