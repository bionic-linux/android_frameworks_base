...
class NetworkPriorityClassifier {
    ...
    public static boolean checkMatchesPriorityRule(
        ...
        final int selectedUnderlyingNetworkMatch = networkPriority.getSelectedUnderlyingNetwork();
        final boolean isSelectedUnderlyingNetwork =
                currentlySelected != null
                        && Objects.equals(currentlySelected.network, networkRecord.network);
        if (selectedUnderlyingNetworkMatch == MATCH_REQUIRED && !isSelectedUnderlyingNetwork
                || selectedUnderlyingNetworkMatch == MATCH_FORBIDDEN
        ...
        if (caps.getLinkUpstreamBandwidthKbps() < networkPriority.getMinUpstreamBandwidthKbps()) {
            return false;
        }
