...
import android.net.vcn.VcnLinkCriterion;
...
class NetworkPriorityClassifier {
    ...
    public static boolean checkMatchesPriorityRule(
        ...
        for (VcnLinkCriterion criteria : networkPriority.getLinkCriteria()) {
            if (!checkMatchesLinkCriterion(criteria, networkRecord)) {
                return false;
            }
        }
    ...
    @VisibleForTesting(visibility = Visibility.PRIVATE)
    public static boolean checkMatchesLinkCriterion(
            VcnLinkCriterion linkCriterion, UnderlyingNetworkRecord networkRecord) {
        if (LinkCriterion instanceof VcnLinkCriterion.EstimatedBandwidthCriterion) {
            return checkMatchesEstimatedBandwidthCriterion(
                    (VcnLinkCriterion.EstimatedBandwidthCriterion) linkCriterion, networkRecord);
        } else {
            logWtf(
                    "Got unknown VcnLinkCriterion class: "
                            + linkCriterion.getClass().getSimpleName());
            return false;
        }
    }

    private static boolean checkMatchesEstimatedBandwidthCriterion(
            VcnLinkCriterion.EstimatedBandwidthCriterion estimatedBandwidthCriterion,
            UnderlyingNetworkRecord networkRecord) {
        return networkRecord.networkCapabilities.getLinkUpstreamBandwidthKbps()
                        >= estimatedBandwidthCriterion.minUpstreamBandwidthKbps
                && networkRecord.networkCapabilities.getLinkDownstreamBandwidthKbps()
                        >= estimatedBandwidthCriterion.minDownstreamBandwidthKbps;
    }
