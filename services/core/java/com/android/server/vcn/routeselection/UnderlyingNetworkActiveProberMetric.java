 ...
 * @hide
 */
public abstract class UnderlyingNetworkActiveProberMetric extends UnderlyingNetworkMetric {
    private static final String TAG = UnderlyingNetworkActiveProberMetric.class.getSimpleName();

    protected UnderlyingNetworkActiveProberMetric(
