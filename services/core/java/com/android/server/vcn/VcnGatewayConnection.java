...
public class VcnGatewayConnection extends StateMachine {
    ...
    VcnGatewayConnection(
        ...
        if (mConnectionConfig.hasOption(VCN_GATEWAY_OPTION_RECOVER_FROM_DATA_STALL_WITH_MOBIKE)) {
            android.util.Log.i("TEST", "hasOption(RECOVER_FROM_DATA_STALL_WITH_MOBIKE)");
            ...
            android.util.Log.i("TEST", "hasOption(RECOVER_FROM_DATA_STALL_WITH_MOBIKE) False");
        }
