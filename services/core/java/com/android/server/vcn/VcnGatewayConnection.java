...
public class VcnGatewayConnection extends StateMachine {
     ...
     *
     * <p>Defaults to 1, unless overridden by carreir config
     */
            ...
            switch (msg.what) {
                ...
                case EVENT_SETUP_COMPLETED:
                    ...
                    final int parallelTunnelCount =
                            Math.max(
                                    1,
                                    mDeps.getParallelTunnelCount(
                                            mLastSnapshot, mSubscriptionGroup));
    ...
    public static class Dependencies {
        ...
        public int getParallelTunnelCount(
            ...
            return TUNNEL_AGGREGATION_SA_COUNT_MAX_DEFAULT;
        }
    }
