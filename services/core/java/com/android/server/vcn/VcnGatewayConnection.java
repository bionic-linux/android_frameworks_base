...
import static android.net.vcn.VcnManager.VCN_ERROR_CLASS_INFORMATIONAL;
import static android.net.vcn.VcnManager.VCN_ERROR_CODE_INTERNAL_FAILURE;
    ...
    private void sessionLost(int token, @Nullable Exception exception) {
        ...
        if (exception != null) {
            mGatewayStatusCallback.onGatewayConnectionError(
                    ...
                    "Received " + exception.getClass().getSimpleName() + " with message: " + exception.getMessage());
        }

        sessionLostWithoutCallback(token, exception);
    }

    private void notifyStatusCallbackForSessionClosed(@Nullable Exception exception) {
        // final int errorClass;
        // final int errorCode;
        // final String exceptionClass;
        // final String exceptionMessage;
        // if (exception == null) {
        //     errorClass = VCN_ERROR_CLASS_INFORMATIONAL;
        //     errorCode
        // }
