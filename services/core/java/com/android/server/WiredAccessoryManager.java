    ...
    private void onSystemReady() {
        if (mUseDevInputEventForAudioJack) {
            ...
            if (mInputManager.getSwitchState(-1, InputDevice.SOURCE_ANY,
                    mInputManager.mSwUnsupportedInsert) == 1) {
                switchValues |= mInputManager.mSwUnsupportedInsertBit;
            }
    ...
    public void notifyWiredAccessoryChanged(long whenNanos, int switchValues, int switchMask) {
        ...
        synchronized (mLock) {
            ...
            switch (mSwitchValues & (SW_HEADPHONE_INSERT_BIT | SW_MICROPHONE_INSERT_BIT
                    | SW_LINEOUT_INSERT_BIT | mInputManager.mSwUnsupportedInsertBit)) {
                case 0:
                    headset = 0;
                    break;
                ...
                default:
                    headset = 0;
                    if ((mSwitchValues & mInputManager.mSwUnsupportedInsertBit) != 0) {
