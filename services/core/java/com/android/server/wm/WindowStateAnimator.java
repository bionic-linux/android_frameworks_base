...
class WindowStateAnimator {
    ...
    SurfaceControl createSurfaceLocked() {
        ...
        if (mSurfaceControl == null) {
            ...
            int defaultWidth = mAnimDw;
            int defaultHeight = mAnimDh;
            if (consumingNavBar) {
                // When we need to expand the window with FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS,
                // assign the default width and height of the window to the size of the display
                // we can use.
                if (displayContent != null) {
                    final DisplayInfo displayInfo = displayContent.getDisplayInfo();
                    defaultWidth = displayInfo.logicalWidth;
                    defaultHeight = displayInfo.logicalHeight;
                }
            }
