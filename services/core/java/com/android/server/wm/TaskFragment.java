...
class TaskFragment extends WindowContainer<WindowContainer> {
    ...
    private boolean shouldReportOrientationUnspecified() {
        ...
        final DisplayRotation displayRotation = getDisplayContent().getDisplayRotation();
        ...
        if (getDisplayContent().getDisplayRotation().getUserRotationMode()
            ...
            if (displayRotation.isLandscapeOrSeascape(displayRotation.mLastSensorRotation)) {
            ...
            if (displayRotation.isAnyPortrait(displayRotation.mLastSensorRotation)) {
                return top != null && isLandscapeOrientation(top.getRequestedOrientation())
                        || adjacentTop != null && isLandscapeOrientation(
                        adjacentTop.getRequestedOrientation());
            }
        }
        return true;
