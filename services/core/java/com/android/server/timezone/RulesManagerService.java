...
public final class RulesManagerService extends IRulesManager.Stub {
    ...
    private static RulesManagerService create(Context context) {
        ...
        File baseTzVersionFile = new File(TimeZoneDataFiles.getRuntimeModuleTzVersionFile());
        ...
        return new RulesManagerService(
                ...
                new TimeZoneDistroInstaller(TAG, baseTzVersionFile, tzDataDir));
    }
    ...
    private RulesState getRulesStateInternal() {
        synchronized(this) {
            String baseRulesVersion;
            try {
                baseRulesVersion = mInstaller.readBaseRulesVersion();
            } catch (IOException e) {
            ...
            return new RulesState(baseRulesVersion, DISTRO_FORMAT_VERSION_SUPPORTED,
            ...
            if ("-format_state".equals(args[0]) && args[1] != null) {
                for (char c : args[1].toCharArray()) {
                    switch (c) {
                        ...
                        case 'b': {
                            // Report base image rules version
                            String value = "Unknown";
                            if (rulesState != null) {
