...
/* private package */ class AudioVolumeChangeHandler {
    ...
    public void init() {
        ...
        AudioSystem.registerAudioVolumeGroupCallback(mAudioVolumeGroupCallback);
    }
    ...
    protected void finalize() {
        if (mAudioVolumeGroupCallback != null) {
            AudioSystem.unregisterAudioVolumeGroupCallback(mAudioVolumeGroupCallback);
        }
    }
    ...
    */
    ...
    private final class AudioVolumeGroupCallback extends INativeAudioVolumeGroupCallback.Stub {
        public void onAudioVolumeGroupChanged(int groupId, int flags) {
            Slog.v(TAG, "onAudioVolumeGroupChanged groupId=" +  groupId + ", flags=" + flags);
            sendAudioVolumeGroupChangedToClients(groupId, flags);
        }
    }
}
