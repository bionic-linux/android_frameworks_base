...
public class VpnManagerService extends IVpnManager.Stub {
    ...
    private boolean isLockdownVpnEnabled() {
        return LegacyVpnProfileStore.get(Credentials.LOCKDOWN_VPN) != null;
    }
    ...
    public boolean updateLockdownVpn() {
        ...
        synchronized (mVpns) {
            ...
            byte[] profileTag = LegacyVpnProfileStore.get(Credentials.LOCKDOWN_VPN);
            if (profileTag == null) {
            ...
            final VpnProfile profile = VpnProfile.decode(
                    profileName, LegacyVpnProfileStore.get(Credentials.VPN + profileName));
            if (profile == null) {
