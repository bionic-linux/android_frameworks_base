...
public abstract class NetworkPolicyManagerInternal {
    ...
    /**
     *  Notifies that any of the {@link android.net.NetworkStatsProviderBase} has reached its quota
     *  which was set through {@link android.net.NetworkStatsProviderBase#setLimit(String, long)}.
     *
