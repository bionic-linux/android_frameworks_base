        ...
        if (augmentStart != SubscriptionPlan.TIME_UNKNOWN) {
            ...
            for (int i = 0; i < combined.size(); i++) {
                ...
                if (entry.bucketStart >= augmentStart
                    ...
                    entry.rxBytes = multiplySafeByRational(targetRxBytes, entry.rxBytes, rawRxBytes);
                    entry.txBytes = multiplySafeByRational(targetTxBytes, entry.txBytes, rawTxBytes);
