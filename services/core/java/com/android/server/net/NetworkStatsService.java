...
public class NetworkStatsService extends INetworkStatsService.Stub {
     ...
     * @param provider the binder interface of {@link android.net.AbstractNetworkStatsProvider} that
