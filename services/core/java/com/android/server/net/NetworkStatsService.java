...
public class NetworkStatsService extends INetworkStatsService.Stub {
    ...
    private static class NetworkStatsProviderCallbackImpl extends INetworkStatsProviderCallback.Stub
        ...
        @Override
        public void onStatsUpdated(int token, @Nullable NetworkStats ifaceStatsParcel,
                @Nullable NetworkStats uidStatsParcel) {
            ...
            synchronized (mProviderStatsLock) {
                ...
                mIfaceStats.combineAllValues(ifaceStatsParcel);
                mUidStats.combineAllValues(uidStatsParcel);
            }
        }
