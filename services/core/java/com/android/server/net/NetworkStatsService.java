...
public class NetworkStatsService extends INetworkStatsService.Stub {
    ...
    private void recordSnapshotLocked(long currentTime) throws RemoteException {
        ...
        Trace.traceEnd(TRACE_TAG_NETWORK);
        xtSnapshot.addAllValues(providersnapshot);
        devSnapshot.addAllValues(providersnapshot);
    ...
    private void performPollLocked(int flags) {
        ...
        if (!mHandler.hasMessages(MSG_POLL_STATS_PROVIDER)) {
            mHandler.sendEmptyMessageDelayed(MSG_POLL_STATS_PROVIDER, mSettings.getPollDelay());
        }
    ...
    private NetworkStats getNetworkStatsUidDetail(String[] ifaces)
        ...
        uidSnapshot.addAllValues(providerStats);
    ...
    private @NonNull NetworkStats getNetworkStatsFromProviders(int how) {
        ...
        invokeForAllStatsProviderCallbacks((cb) -> ret.addAllValues(cb.getCachedStats(how)));
        return ret;
    }

    @FunctionalInterface
    private interface ThrowableConsumer<S, T extends Throwable> {
        void accept(S s) throws T;
    }

    private void invokeForAllStatsProviderCallbacks(
            @NonNull ThrowableConsumer<NetworkStatsProviderCallbackImpl, RemoteException> task) {
    ...
    private static class NetworkStatsProviderCallbackImpl extends INetworkStatsProviderCallback.Stub
        ...
        public void onStatsUpdated(int token, @Nullable NetworkStats ifaceStats,
            ...
            synchronized (mProviderStatsLock) {
                if (ifaceStats != null) mIfaceStats.addAllValues(ifaceStats);
                if (uidStats != null) mUidStats.addAllValues(uidStats);
            }
        }
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_POLL_STATS_PROVIDER: {
                    ...
                    mService.invokeForAllStatsProviderCallbacks(
                            (cb) -> cb.mProvider.requestStatsUpdate(0 /* unused */));
                }
                default: {
                    return false;
                }
