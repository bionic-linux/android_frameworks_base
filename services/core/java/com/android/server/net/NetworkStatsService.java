...
public class NetworkStatsService extends INetworkStatsService.Stub {
    ...
    private void bootstrapStatsLocked() {
        try {
            // Get the snapshot for each type of snapshot to avoid double counting.
            // In case of framework restart that will cause losing the last snapshots
            // and double counting with very large snapshot while re-initializing.
            // Thus, here needs to get the last snapshot to re-initialize last snapthot
