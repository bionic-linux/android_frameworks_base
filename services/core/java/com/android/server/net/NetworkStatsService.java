...
public class NetworkStatsService extends INetworkStatsService.Stub {
    ...
    private void performPollLocked(int flags) {
        ...
        try {
            ...
            // and the log, and that it doesn't matter too much as this is just a debug log.
            Log.d(TAG, "requestStatsUpdate timeout "
                    + (registeredCallbackCount - mStatsProviderSem.availablePermits())
