...
class NetworkStatsObservers {
    ...
    private static class NetworkUsageRequestInfo extends RequestInfo {
        ...
        protected void recordSample(StatsContext statsContext) {
            ...
            mRecorder.recordDiffLocked(delta, statsContext.mActiveIfaces,
    ...
    private static class UserUsageRequestInfo extends RequestInfo {
        ...
        protected void recordSample(StatsContext statsContext) {
            ...
            final NetworkStats delta = statsContext.mUidSnapshot.subtract(mLastSnapshot);
            mRecorder.recordDiffLocked(delta, statsContext.mActiveUidIfaces,
                    statsContext.mCurrentTime);
            mLastSnapshot = statsContext.mUidSnapshot;
        }
