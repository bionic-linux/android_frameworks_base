...
final class RequestShortAudioDescriptorAction extends HdmiCecFeatureAction {
    ...
    */
    interface RequestSADCallback {
         ...
         *
         * @param keyValuePairs a set of SAD needs to pass to audio HAL.
         * @param supportMultiChannels indicates if support multi-channels
         */
        void updateSAD(String keyValuePairs, int supportMultiChannels);
    }
    ...
    private void resetShortAudioDescriptor() {
        ...
        mCallback.updateSAD(keyValuePairs, Constants.DISABLED);
    }
    ...
    private int ifSupportMultiChannels() {
    ...
    private void setAudioFormat() {
        ...
        mCallback.updateSAD(keyValuePairs, ifSupportMultiChannels());
        finish();
    }
