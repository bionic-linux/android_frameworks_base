...
final class NewDeviceAction extends HdmiCecFeatureAction {
    ...
    public boolean start() {
        HdmiDeviceInfo info = localDevice().mService.getHdmiCecNetwork().getCecDeviceInfo(mDeviceLogicalAddress);
        ...
        if (mOldDeviceInfo != null
            ...
            if (mOldDeviceInfo != null) {
                ...
                localDevice().mService.getHdmiCecNetwork().removeCecDevice(localDevice(), mDeviceLogicalAddress);
            }
