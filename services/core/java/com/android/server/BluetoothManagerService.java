...
class BluetoothManagerService extends IBluetoothManager.Stub {
    ...
    // Reason code for enable and disable
    private static final int REASON_PACKAGE = 0;
    private static final int REASON_AIRPLANE_MODE = 1;
    private static final int REASON_DISALLOWED = 2;
    private static final int REASON_RESTARTED = 3;
    private static final int REASON_START_CRASH = 4;
    private static final int REASON_SYSTEM_BOOT = 5;
    private static final int REASON_UNEXPECTED = 6;
    private static final int REASON_USER_SWITCH = 7;
    private static final int REASON_RESTORE_USER_SETTING = 8;
    ...
    private class ActiveLog {
        ...
        public String toString() {
            return timeToLog(mTimestamp) + (mEnable ? "  Enabled " : " Disabled ")
                    + " due to " + getReasonString(mReason) + " by " + mPackageName;
        }
                ...
                public void onUserRestrictionsChanged(int userId, Bundle newRestrictions,
                    ...
                    if (userId == UserHandle.USER_SYSTEM
                        ...
                        if (userId == UserHandle.USER_SYSTEM && newRestrictions.getBoolean(
                            ...
                            sendDisableMsg(REASON_DISALLOWED, ActivityThread.currentPackageName());
                        } else {
            ...
            synchronized (this) {
                ...
                if (isAirplaneModeOn()) {
                    ...
                    if (st == BluetoothAdapter.STATE_BLE_ON) {
                        ...
                        sendDisableMsg(REASON_AIRPLANE_MODE, ActivityThread.currentPackageName());
                    }
            ...
            switch (msg.what) {
                ...
                case MESSAGE_RESTORE_USER_SETTING:
                    if ((msg.arg1 == RESTORE_SETTING_TO_OFF) && mEnable) {
                        ...
                        persistBluetoothSetting(BLUETOOTH_OFF);
                        mEnableExternal = false;
                        sendDisableMsg(REASON_RESTORE_USER_SETTING,
                                ActivityThread.currentPackageName());
                        ...
                        mEnableExternal = true;
                        // waive WRITE_SECURE_SETTINGS permission check
                        sendEnableMsg(false, REASON_RESTORE_USER_SETTING,
                                ActivityThread.currentPackageName());
                    }
                    break;
                ...
                case MESSAGE_USER_SWITCHED: {
                    ...
                    if (mBluetooth != null && isEnabled()) {
                        ...
                        // disable
                        addActiveLog(REASON_USER_SWITCH, ActivityThread.currentPackageName(),
                                false);
                        handleDisable();
    ...
    public void dump(FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        int a = BluetoothProtoEnums.ADAPTER_TOGGLE_REASON_AIRPLANE_MODE;
    ...
    private static String getReasonString(int reason) {
        switch (reason) {
            case REASON_PACKAGE: return "REASON_PACKAGE";
            case REASON_AIRPLANE_MODE: return "REASON_AIRPLANE_MODE";
            case REASON_DISALLOWED: return "REASON_DISALLOWED";
            case REASON_RESTARTED: return "REASON_RESTARTED";
            case REASON_START_CRASH: return "REASON_START_CRASH";
            case REASON_SYSTEM_BOOT: return "REASON_SYSTEM_BOOT";
            case REASON_UNEXPECTED: return "REASON_UNEXPECTED";
            case REASON_USER_SWITCH: return "REASON_USER_SWITCH";
            case REASON_RESTORE_USER_SETTING: return "REASON_RESTORE_USER_SETTING";
