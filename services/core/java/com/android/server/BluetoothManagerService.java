...
class BluetoothManagerService extends IBluetoothManager.Stub {
    ...
    BluetoothManagerService(Context context) {
        ...
        mIsCsisClientSupported = context.getResources()
                .getBoolean(com.android.internal.R.bool.config_csis_client_supported);

        // TODO: We need a more generic way to initialize the persist keys of FeatureFlagUtils
        value = SystemProperties.get(FeatureFlagUtils.PERSIST_PREFIX + FeatureFlagUtils.CSIS_CLIENT_SETTINGS);
        if (!TextUtils.isEmpty(value)) {
            ...
            FeatureFlagUtils.setEnabled(context, FeatureFlagUtils.CSIS_CLIENT_SETTINGS, isCsisClientEnabled);
