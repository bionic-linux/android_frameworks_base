...
class BluetoothManagerService extends IBluetoothManager.Stub {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_BLUETOOTH_SERVICE_DISCONNECTED: {
                    ...
                    addCrashLog();
                    addActiveLog(BluetoothProtoEnums.ENABLE_DISABLE_REASON_UNEXPECTED,
                ...
                case MESSAGE_RESTART_BLUETOOTH_SERVICE: {
                    ...
                    addActiveLog(BluetoothProtoEnums.ENABLE_DISABLE_REASON_RESTARTED,
                            ActivityThread.currentPackageName(), true);
                    handleEnable(mQuietEnable);
                    break;
                }
    ...
    private void recoverBluetoothServiceFromError(boolean clearBle) {
        ...
        // disable
        addActiveLog(BluetoothProtoEnums.ENABLE_DISABLE_REASON_START_CRASH,
                ActivityThread.currentPackageName(), false);
        handleDisable();
    ...
    private static String getReasonString(int reason) {
        switch (reason) {
            ...
            case BluetoothProtoEnums.ENABLE_DISABLE_REASON_RESTARTED:
                return "RESTARTED";
            case BluetoothProtoEnums.ENABLE_DISABLE_REASON_START_CRASH:
                return "START_CRASH";
            case BluetoothProtoEnums.ENABLE_DISABLE_REASON_SYSTEM_BOOT:
                return "SYSTEM_BOOT";
            case BluetoothProtoEnums.ENABLE_DISABLE_REASON_UNEXPECTED:
                return "UNEXPECTED";
