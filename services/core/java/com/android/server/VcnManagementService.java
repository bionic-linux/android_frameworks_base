...
import android.net.vcn.VcnManager.VcnErrorClass;
...
public class VcnManagementService extends IVcnManagementService.Stub {
    ...
    public void registerVcnStatusCallback(
        ...
        Binder.withCleanCallingIdentity(
                () -> handleRegisterVcnStatusCallback(subGroup, callback, opPkgName));
    }

    private void handleRegisterVcnStatusCallback(
            @NonNull ParcelUuid subGroup,
            @NonNull IVcnStatusCallback callback,
            @NonNull String opPkgName) {
    ...
    public void unregisterVcnStatusCallback(@NonNull IVcnStatusCallback callback) {
        ...
        Binder.withCleanCallingIdentity(() -> handleUnregisterVcnStatusCallback(callback));
    }

    private void handleUnregisterVcnStatusCallback(@NonNull IVcnStatusCallback callback) {
        final IBinder cbBinder = callback.asBinder();
        synchronized (mLock) {
