...
class VibratorShim : public V1_4::IVibrator {
  public:
    ...
    Return<void> perform(V1_0::Effect effect, V1_0::EffectStrength strength, perform_cb _hidl_cb) override {
        return perform_1_4(static_cast<V1_3::Effect>(effect), strength, nullptr, _hidl_cb);
    }
    Return<void> perform_1_1(V1_1::Effect_1_1 effect, V1_0::EffectStrength strength, perform_1_1_cb _hidl_cb) override {
        return perform_1_4(static_cast<V1_3::Effect>(effect), strength, nullptr, _hidl_cb);
    }
    Return<void> perform_1_2(V1_2::Effect effect, V1_0::EffectStrength strength, perform_1_2_cb _hidl_cb) override {
        return perform_1_4(static_cast<V1_3::Effect>(effect), strength, nullptr, _hidl_cb);
    }
    ...
    Return<void> perform_1_3(V1_3::Effect effect, V1_0::EffectStrength strength, perform_1_3_cb _hidl_cb) override {
        return perform_1_4(static_cast<V1_3::Effect>(effect), strength, nullptr, _hidl_cb);
    }
    Return<uint32_t> getCapabilities() override {
        ...
        return (cap & (aidl::IVibrator::CAP_ON_CALLBACK | aidl::IVibrator::CAP_PERFORM_CALLBACK)) > 0;
    }
    Return<V1_0::Status> on_1_4(uint32_t timeoutMs, const sp<V1_4::IVibratorCallback>& callback) override {
    ...
    Return<void> perform_1_4(V1_3::Effect effect, V1_0::EffectStrength strength,
                             const sp<V1_4::IVibratorCallback>& callback, perform_1_4_cb _hidl_cb) override {
...
class HalWrapper {
  public:
    static std::unique_ptr<HalWrapper> Create() {
        sp<aidl::IVibrator> aidlVib = waitForDeclaredService<aidl::IVibrator>(aidl::IVibrator::descriptor + String16("/default"));
        if (aidlVib) {
