...
static GnssLocation createGnssLocation(jint gnssLocationFlags, jdouble latitudeDegrees,
...
Return<void> GnssCallback::gnssLocationCb(const GnssLocation& location) {
    ...
    env->CallVoidMethod(mCallbacksObj, method_reportLocation, boolToJbool(hasLatLong), jLocation);
    checkAndClearExceptionFromCallback(env, __FUNCTION__);
...
Return<void> GnssCallback::gnssSvStatusCb(const IGnssCallback::GnssSvStatus& svStatus) {
    ...
    if (listSize > static_cast<uint32_t>(android::hardware::gnss::V1_0::GnssMax::SVS_COUNT)) {
    ...
    for (size_t i = 0; i < listSize; ++i) {
        enum ShiftWidth : uint8_t { SVID_SHIFT_WIDTH = 8, CONSTELLATION_TYPE_SHIFT_WIDTH = 4 };

        const IGnssCallback::GnssSvInfo& info = svStatus.gnssSvList.data()[i];
        svidWithFlags[i] =
                (info.svid << SVID_SHIFT_WIDTH) |
...
Return<void> GnssGeofenceCallback::gnssGeofenceTransitionCb(
        int32_t geofenceId, const GnssLocation& location, GeofenceTransition transition,
...
Return<void> GnssGeofenceCallback::gnssGeofenceStatusCb(GeofenceAvailability status,
    ...
    env->CallVoidMethod(mCallbacksObj, method_reportGeofenceStatus, status, jLocation);
    checkAndClearExceptionFromCallback(env, __FUNCTION__);
    env->DeleteLocalRef(jLocation);
    return Void();
}
...
struct GnssMeasurementCallback : public IGnssMeasurementCallback_V1_1 {
  ...
  private:
    ...
    jobjectArray translateGnssMeasurements(
            JNIEnv* env, const IGnssMeasurementCallback_V1_1::GnssMeasurement* measurements_v1_1,
            const IGnssMeasurementCallback_V1_0::GnssMeasurement* measurements_v1_0, size_t count);
    jobject translateGnssClock(JNIEnv* env, const IGnssMeasurementCallback_V1_0::GnssClock* clock);
...
Return<void> GnssMeasurementCallback::gnssMeasurementCb(
    ...
    measurementArray = translateGnssMeasurements(env, data.measurements.data(), NULL,
...
Return<void> GnssMeasurementCallback::GnssMeasurementCb(
    ...
    clock = translateGnssClock(env, &data.clock);
    measurementArray =
            translateGnssMeasurements(env, NULL, data.measurements.data(), data.measurementCount);
    setMeasurementData(env, clock, measurementArray);
...
jobjectArray GnssMeasurementCallback::translateGnssMeasurements(
        JNIEnv* env, const IGnssMeasurementCallback_V1_1::GnssMeasurement* measurements_v1_1,
        const IGnssMeasurementCallback_V1_0::GnssMeasurement* measurements_v1_0, size_t count) {
    if (count == 0) {
        return NULL;
    ...
    jobjectArray gnssMeasurementArray =
            env->NewObjectArray(count, gnssMeasurementClass, NULL /* initialElement */);
...
void GnssMeasurementCallback::setMeasurementData(JNIEnv* env, jobject clock,
    ...
    jmethodID gnssMeasurementsEventCtor =
            env->GetMethodID(gnssMeasurementsEventClass, "<init>",
                             "(Landroid/location/GnssClock;[Landroid/location/GnssMeasurement;)V");

    jobject gnssMeasurementsEvent = env->NewObject(
            gnssMeasurementsEventClass, gnssMeasurementsEventCtor, clock, measurementArray);
...
Return<void> GnssNiCallback::niNotifyCb(const IGnssNiCallback::GnssNiNotification& notification) {
    ...
    if (requestorId && text) {
        env->CallVoidMethod(mCallbacksObj, method_reportNiNotification, notification.notificationId,
                            notification.niType, notification.notifyFlags, notification.timeoutSec,
                            notification.defaultResponse, requestorId, text,
                            notification.requestorIdEncoding, notification.notificationIdEncoding);
    } else {
        ALOGE("%s: OOM Error\n", __func__);
    }
...
struct AGnssCallback : public IAGnssCallback {
    ...
    Return<void> agnssStatusIpV6Cb(const IAGnssCallback::AGnssStatusIpV6& agps_status) override;

    Return<void> agnssStatusIpV4Cb(const IAGnssCallback::AGnssStatusIpV4& agps_status) override;

  private:
    jbyteArray convertToIpV4(uint32_t ip);
};

Return<void> AGnssCallback::agnssStatusIpV6Cb(const IAGnssCallback::AGnssStatusIpV6& agps_status) {
    JNIEnv* env = getJniEnv();
...
Return<void> AGnssCallback::agnssStatusIpV4Cb(const IAGnssCallback::AGnssStatusIpV4& agps_status) {
    JNIEnv* env = getJniEnv();
    jbyteArray byteArray = NULL;
...
Return<void> GnssBatchingCallback::gnssLocationBatchCb(const hidl_vec<GnssLocation>& locations) {
    ...
    jobjectArray jLocations = env->NewObjectArray(
            locations.size(), env->FindClass("android/location/Location"), nullptr);
...
static void android_location_GnssLocationProvider_init_once(JNIEnv* env, jclass clazz) {
    ...
    method_reportNiNotification = env->GetMethodID(
            clazz, "reportNiNotification", "(IIIIILjava/lang/String;Ljava/lang/String;II)V");
    ...
    method_reportNavigationMessages = env->GetMethodID(
            clazz, "reportNavigationMessage", "(Landroid/location/GnssNavigationMessage;)V");
...
static jboolean android_location_GnssLocationProvider_is_supported(JNIEnv* /* env */,
                                                                   jclass /* clazz */) {
    return (gnssHal != nullptr) ? JNI_TRUE : JNI_FALSE;
}

static jboolean android_location_GnssLocationProvider_is_agps_ril_supported(JNIEnv* /* env */,
                                                                            jclass /* clazz */) {
...
static jboolean android_location_GnssLocationProvider_init(JNIEnv* env, jobject obj) {
     ...
     */
    if (!mCallbacksObj) mCallbacksObj = env->NewGlobalRef(obj);
...
static jboolean android_location_GnssLocationProvider_set_position_mode(
        JNIEnv* /* env */, jobject /* obj */, jint mode, jint recurrence, jint min_interval,
        jint preferred_accuracy, jint preferred_time, jboolean low_power_mode) {
    Return<bool> result = false;
    if (gnssHal_V1_1 != nullptr) {
        result = gnssHal_V1_1->setPositionMode_1_1(
                static_cast<IGnss_V1_0::GnssPositionMode>(mode),
                static_cast<IGnss_V1_0::GnssPositionRecurrence>(recurrence), min_interval,
                preferred_accuracy, preferred_time, low_power_mode);
    } else if (gnssHal != nullptr) {
        result = gnssHal->setPositionMode(
                static_cast<IGnss_V1_0::GnssPositionMode>(mode),
                static_cast<IGnss_V1_0::GnssPositionRecurrence>(recurrence), min_interval,
...
static void android_location_GnssLocationProvider_inject_time(JNIEnv* /* env */, jobject /* obj */,
                                                              jlong time, jlong timeReference,
                                                              jint uncertainty) {
    if (gnssHal != nullptr) {
...
static void android_location_GnssLocationProvider_inject_best_location(
        JNIEnv*, jobject, jint gnssLocationFlags, jdouble latitudeDegrees, jdouble longitudeDegrees,
    ...
    if (gnssHal_V1_1 != nullptr) {
        GnssLocation location = createGnssLocation(
                ...
                speedMetersPerSec, bearingDegrees, horizontalAccuracyMeters, verticalAccuracyMeters,
...
static jboolean android_location_GnssLocationProvider_supports_xtra(JNIEnv* /* env */,
                                                                    jobject /* obj */) {
...
static void android_location_GnssLocationProvider_agps_data_conn_open(JNIEnv* env,
                                                                      jobject /* obj */,
...
static void android_location_GnssLocationProvider_set_agps_server(JNIEnv* env, jobject /* obj */,
    ...
    auto result =
            agnssIface->setServer(static_cast<IAGnssCallback::AGnssType>(type), c_hostname, port);
    if (!result.isOk() || !result) {
    ...
    if (gnssDebugIface == nullptr) {
        ...
        for (size_t i = 0; i < data.satelliteDataArray.size(); i++) {
            internalState << "constell: "
                          ...
                          << data.satelliteDataArray[i].serverPredictionAgeSeconds << ", ephType: "
...
static void android_location_GnssLocationProvider_update_network_state(
        JNIEnv* env, jobject /* obj */, jboolean connected, jint type, jboolean roaming,
        jboolean available, jstring extraInfo, jstring apn) {
    if (agnssRilIface != nullptr) {
        auto result = agnssRilIface->updateNetworkState(
                connected, static_cast<IAGnssRil::NetworkType>(type), roaming);
        if (!result.isOk() || !result) {
...
static jboolean android_location_GnssGeofenceProvider_is_geofence_supported(JNIEnv* /* env */,
                                                                            jobject /* obj */) {
    return (gnssGeofencingIface != nullptr) ? JNI_TRUE : JNI_FALSE;
}

static jboolean android_location_GnssGeofenceProvider_add_geofence(
        JNIEnv* /* env */, jobject /* obj */, jint geofenceId, jdouble latitude, jdouble longitude,
...
static jboolean android_location_GnssMeasurementsProvider_is_measurement_supported(JNIEnv* env,
                                                                                   jclass clazz) {
...
static jboolean android_location_GnssMeasurementsProvider_start_measurement_collection(
        JNIEnv* /* env */, jobject /* obj */, jboolean enableFullTracking) {
    if (gnssMeasurementIface == nullptr) {
...
static jboolean android_location_GnssMeasurementsProvider_stop_measurement_collection(JNIEnv* env,
                                                                                      jobject obj) {
    if (gnssMeasurementIface == nullptr) {
...
static jboolean android_location_GnssLocationProvider_set_emergency_supl_pdn(
        JNIEnv*, jobject, jint emergencySuplPdn) {
...
static jboolean android_location_GnssLocationProvider_set_supl_version(JNIEnv*, jobject,
                                                                       jint version) {
    if (gnssConfigurationIface == nullptr) {
        ALOGE("no GNSS configuration interface available");
        return JNI_FALSE;
...
static jboolean android_location_GnssLocationProvider_set_supl_es(JNIEnv*, jobject, jint suplEs) {
    if (gnssConfigurationIface == nullptr) {
        ALOGE("no GNSS configuration interface available");
        return JNI_FALSE;
    }
...
static jboolean android_location_GnssLocationProvider_set_supl_mode(JNIEnv*, jobject, jint mode) {
    if (gnssConfigurationIface == nullptr) {
        ALOGE("no GNSS configuration interface available");
        return JNI_FALSE;
    }
...
static jboolean android_location_GnssLocationProvider_set_gps_lock(JNIEnv*, jobject, jint gpsLock) {
    if (gnssConfigurationIface == nullptr) {
        ALOGE("no GNSS configuration interface available");
        return JNI_FALSE;
    }
...
static jboolean android_location_GnssLocationProvider_set_lpp_profile(JNIEnv*, jobject,
                                                                      jint lppProfile) {
    if (gnssConfigurationIface == nullptr) {
        ALOGE("no GNSS configuration interface available");
        return JNI_FALSE;
...
static jboolean android_location_GnssLocationProvider_set_gnss_pos_protocol_select(
        JNIEnv*, jobject, jint gnssPosProtocol) {
    if (gnssConfigurationIface == nullptr) {
        ALOGE("no GNSS configuration interface available");
        return JNI_FALSE;
    }
...
static const JNINativeMethod sMethods[] = {
        ...
        {"class_init_native", "()V",
         reinterpret_cast<void*>(android_location_GnssLocationProvider_class_init_native)},
        {"native_is_supported", "()Z",
         reinterpret_cast<void*>(android_location_GnssLocationProvider_is_supported)},
        ...
        {"native_init_once", "()V",
         reinterpret_cast<void*>(android_location_GnssLocationProvider_init_once)},
        ...
        {"native_inject_best_location", "(IDDDFFFFFFJ)V",
        ...
        {"native_supports_xtra", "()Z",
         reinterpret_cast<void*>(android_location_GnssLocationProvider_supports_xtra)},
        {"native_inject_xtra_data", "([BI)V",
         reinterpret_cast<void*>(android_location_GnssLocationProvider_inject_xtra_data)},
        {"native_agps_data_conn_open", "(Ljava/lang/String;I)V",
        ...
        {"native_update_network_state", "(ZIZZLjava/lang/String;Ljava/lang/String;)V",
...
static const JNINativeMethod sGeofenceMethods[] = {
        ...
        {"native_pause_geofence", "(I)Z",
         reinterpret_cast<void*>(android_location_GnssGeofenceProvider_pause_geofence)},
...
int register_android_server_location_GnssLocationProvider(JNIEnv* env) {
    jniRegisterNativeMethods(env, "com/android/server/location/GnssBatchingProvider",
                             sMethodsBatching, NELEM(sMethodsBatching));
    jniRegisterNativeMethods(env, "com/android/server/location/GnssGeofenceProvider",
                             sGeofenceMethods, NELEM(sGeofenceMethods));
    jniRegisterNativeMethods(env, "com/android/server/location/GnssMeasurementsProvider",
                             sMeasurementMethods, NELEM(sMeasurementMethods));
    jniRegisterNativeMethods(env, "com/android/server/location/GnssNavigationMessageProvider",
                             sNavigationMessageMethods, NELEM(sNavigationMessageMethods));
    return jniRegisterNativeMethods(env, "com/android/server/location/GnssLocationProvider",
