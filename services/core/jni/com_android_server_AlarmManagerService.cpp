...
static const int ANDROID_ALARM_TIME_CHANGE_MASK = 1 << 16;
...
static void log_timerfd_create_error(clockid_t id)
{
    if (errno == EINVAL) {
        ...
        case CLOCK_BOOTTIME_ALARM:
            ...
            // https://git.kernel.org/cgit/linux/kernel/git/torvalds/linux.git/commit/?id=6cffe00f7d4e24679eae6b7aae4caaf915288256
            // https://git.kernel.org/cgit/linux/kernel/git/torvalds/linux.git/commit/?id=11ffa9d6065f344a9bd769a2452f26f2f671e5f8

        case CLOCK_BOOTTIME:
            LOG_ALWAYS_FATAL("kernel does not support timerfd_create(CLOCK_BOOTTIME)");
            // https://git.kernel.org/cgit/linux/kernel/git/torvalds/linux.git/commit/?id=4a2378a943f09907fb1ae35c15de917f60289c14
