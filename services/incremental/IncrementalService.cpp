...
<<<<<<< TARGET BRANCH (cc0870 Merge "Merge "Merge "Fix CtsShortcutHostTestCases#testSecond)
...
>>>>>>> SOURCE BRANCH (f6e442 Merge "mkdir .incomplete in backing storage to fix CTS/GTS f)
        if (!status.isOk()) {
