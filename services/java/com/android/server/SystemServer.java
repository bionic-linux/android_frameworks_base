...
public final class SystemServer {
    ...
    private static final String IS_GSI_RUNNING_FILE = "/metadata/gsi/booted";
    ...
    private void startOtherServices() {
        ...
        if (mFactoryTestMode != FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            final boolean isRunningGsi = new File(IS_GSI_RUNNING_FILE).exists();
            if (hasPdb && !isRunningGsi) {
