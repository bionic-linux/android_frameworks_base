...
class ServerThread {
    ...
    public void initAndLoop() {
        ...
        TelephonyRegistry msimTelephonyRegistry = null;
        ...
        /*    if (android.telephony.MSimTelephonyManager.getDefault().isMultiSimEnabled()) {
                ...
                msimTelephonyRegistry = new TelephonyRegistry(context);
        ...
        final TelephonyRegistry msimTelephonyRegistryF = msimTelephonyRegistry;
