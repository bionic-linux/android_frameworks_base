...
class TelephonyRegistry extends ITelephonyRegistry.Stub {
    ...
    @Override
    public void listenUsingSub(int subscription, String pkgForDebug, IPhoneStateListener callback, int events,
            boolean notifyNow) {
    ...
    public void notifyDataConnectionUsingSub(int subscription, int state, boolean isDataConnectivityPossible,
            String reason, String apn, String apnType, LinkProperties linkProperties,
            LinkCapabilities linkCapabilities, int networkType, boolean roaming) {
    ...
    public void notifyDataConnectionFailedUsingSub(int subscription, String reason, String apnType) {
