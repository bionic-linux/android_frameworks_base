                    ...
                    if (MSimTelephonyManager.getDefault().isMultiSimEnabled()) {
                        ...
                        if (mphone != null) {
                            ...
                            for (int i = 0; i < MSimTelephonyManager.getDefault().
                                    getPhoneCount(); i++) {
                                radioOff = radioOff && !mphone.isRadioOnUsingSub(i);
                                if (mphone.isRadioOnUsingSub(i)) {
                                    Log.w(TAG, "Turning off radio on Subscription :" + i);
                                    mphone.setRadioUsingSub(i, false);
                                }
                            }
                        }
                    } else {
                    ...
                    if (!radioOff) {
                        try {
                            ...
                            if (MSimTelephonyManager.getDefault().isMultiSimEnabled()) {
                                ...
                                for (int i = 0; i < MSimTelephonyManager.getDefault().
                                        getPhoneCount(); i++) {
                                    subRadioOff = subRadioOff && !mphone.isRadioOnUsingSub(i);
                                }
