...
public final class SELinuxMMAC {
    ...
    public static boolean readInstallPolicy() {
        ...
        // We add all the rules once we know there's no problems.
        List<Policy> policies = new ArrayList<Policy>();

        // A separate structure to hold the default stanza. We need to add
        // this to the end of the policies list structure.
        ...
        try {
            ...
            while (parser.next() != XmlPullParser.END_TAG) {
                ...
                if ("signer".equals(tagName)) {
                    policies.add(readSigner(parser));
                } else if ("default".equals(tagName)) {
                    defaultPolicy = readDefault(parser);
                } else {
                    skip(parser);
                }
            }
            ...
            sb.append(MAC_PERMISSIONS).append(ex);
     ...
     */
    private static Policy readSigner(XmlPullParser parser) throws IOException,
        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            ...
            if ("seinfo".equals(tagName)) {
                ...
                pb.setGlobalSeinfo(seinfo);
                readSeinfo(parser);
            } else if ("package".equals(tagName)) {
                String pkgName = parser.getAttributeValue(null, "name");
                String seinfo = readPackage(parser);
                pb.addInnerPackageMap(pkgName, seinfo);
     ...
     *         the {@link Policy} instance.
     */
    private static Policy readDefault(XmlPullParser parser) throws IOException,
            XmlPullParserException {
     ...
     * @return a String which represents the seinfo value found. Null can be returned
     *         if no seinfo tag was present.
     * @throws IOException
     * @throws XmlPullParserException
     */
    private static String readPackage(XmlPullParser parser) throws IOException,
            XmlPullParserException {
        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            ...
            String tagName = parser.getName();
            if ("seinfo".equals(tagName)) {
                seinfo = parser.getAttributeValue(null, "value");
                readSeinfo(parser);
            } else {
                skip(parser);
            }
 ...
 *         .setGlobalSeinfo("paltform")
 *         .addInnerPackageMap("com.foo.", "bar")
 *         .addInnerPackageMap("com.foo.other", "bar")
 *         .build();
 * }
 * </pre>
 * <p>
...
final class Policy {
    ...
    public static final class PolicyBuilder {
        ...
        public PolicyBuilder() {
            ...
            mPkgMap = new HashMap<String, String>(3);
        }
         ...
         *         null, zero length or contains non-valid characters [^a-zA-Z_].
         */
        public PolicyBuilder setGlobalSeinfo(String seinfo) {
         ...
         */
        public PolicyBuilder addInnerPackageMap(String pkgName, String seinfo) {
        ...
        /**
         * General validation routine for android package names. This is a copy of the
         * method that lives in PackageParser.java with the same name.
         *
         * @param name the package name of the app given as a string.
         * @return boolean indicating if the package name is valid, false otherwise.
         */
        private boolean validatePackageName(String name) {
            if (name == null)
                return false;
        ...
        /**
         * General validation routine for the attribute string of an element. Checks
         * if the string is non-null, positive length and only contains [a-zA-Z_].
         *
