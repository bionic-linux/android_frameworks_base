...
public final class SELinuxMMAC {
        ...
        try {
            ...
            while (parser.next() != XmlPullParser.END_TAG) {
                ...
                if ("signer".equals(tagName)) {
                    Policy signerPolicy = readSigner(parser);
                    ...
                    Policy defPolicy = readDefault(parser);
                    // Return of a Policy instance ensures certain invariants have
                    // passed, however, we still want to do some cross policy checking.
     ...
     *         package tag.
     */
    private static void readPackage(XmlPullParser parser, Policy.PolicyBuilder pb) throws
        IOException, XmlPullParserException, IllegalArgumentException, IllegalStateException {
