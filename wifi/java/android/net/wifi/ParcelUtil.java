...
/**
 * Provides utilities for serializing/deserializing a non-Parcelable objects to/from
 * a Parcel object.
 *
 * @hide
 */
public class ParcelUtil {
     ...
     * |encodedKey| will be skip. Since a PrivateKey can only be constructed with
