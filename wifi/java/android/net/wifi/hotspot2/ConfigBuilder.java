...
public final class ConfigBuilder {
     ...
     * object.  The configuration data is a base64 encoded MIME multipart message.  Below is
     ...
     */
    public static PasspointConfiguration buildPasspointConfig(byte[] data) {
        try {
            // Decode the data.
    ...
    /**
     * Create a {@link PasspointConfiguration} object from the MIME (Multipurpose Internet Mail
     * Extension) parts.
     *
    ...
    private static PasspointConfiguration createPasspointConfig(Map<String, byte[]> mimeParts)
        ...
        // Credential is needed for storing the certificates and private key.
     ...
     * an optional boundary string separated by a ";".
     *
    ...
    private static Pair<String, String> parseContentType(String contentType) throws IOException {
        ...
        Log.e(TAG, "Attributes: " + attributes.length);
        Log.e(TAG, "Type: " + type);
        if (attributes.length == 2) {
            Log.e(TAG, "Boundary: " + attributes[1]);
    ...
    private static Map<String, String> readHeaders(LineNumberReader in)
        ...
        for (;;) {
            ...
            if (nameEnd < 0) {
                if (value != null) {
                    // Continuation line for the value.
