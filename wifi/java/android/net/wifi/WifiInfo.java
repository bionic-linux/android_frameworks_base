        ...
        if (stats != null) {
            ...
            if (mLastPacketCountUpdateTimeStamp != RESET_TIME_STAMP
                    ...
                    txBadRate = txBadRate * lastSampleWeight
                        + (txbad - txBad) * OUTPUT_SCALE_FACTOR / timeDelta * currentSampleWeight;
                    txSuccessRate = txSuccessRate * lastSampleWeight
                        + (txgood - txSuccess) * OUTPUT_SCALE_FACTOR / timeDelta * currentSampleWeight;
                    rxSuccessRate = rxSuccessRate * lastSampleWeight
                        + (rxgood - rxSuccess) * OUTPUT_SCALE_FACTOR / timeDelta * currentSampleWeight;
