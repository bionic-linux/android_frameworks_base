...
public class WifiInfo implements TransportInfo, Parcelable {
    ...
    public int hashCode() {
        ...
        return Objects.hash(mWifiSsid, mBSSID, mNetworkId, mRssi, mSupplicantState, mLinkSpeed,
                ...
                mMeteredHint, mEphemeral, mTrusted, mRequestingPackageName, mOsuAp, mFqdn,
                mProviderFriendlyName, txBad, txRetries, txSuccess, rxSuccess,
                mLostTxPacketsPerSecond, mTxRetriedTxPacketsPerSecond,
                mSuccessfulTxPacketsPerSecond, mSuccessfulRxPacketsPerSecond, score, mWifiStandard,
                mMaxSupportedTxLinkSpeed, mMaxSupportedRxLinkSpeed, mPasspointUniqueId);
    }
