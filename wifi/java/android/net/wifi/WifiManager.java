...
public class WifiManager {
     ...
     *
     * @deprecated Starting with Build.VERSION_CODES#S, WifiInfo retrieval is moved to
     ...
     * }</pre>
     * <p>
     * <b>Compatibility Note:</b> Apps can continue using this API, however newer features
     * like ability to mask out location sensitive data in WifiInfo, etc will not be supported
     * via this API.
     * </p>
     */
    @Deprecated
