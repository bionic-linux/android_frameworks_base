...
public:
    ...
    /*
     * If OVERLAY_THEME_DIR_PROPERTY is set, search for runtime resource
     * overlay APKs in VENDOR_OVERLAY_DIR/<value of OVERLAY_THEME_DIR_PROPERTY>
     * in addition to VENDOR_OVERLAY_DIR.
     */
