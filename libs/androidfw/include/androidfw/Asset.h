...
class Asset {
 ...
 private:
   ...
   * The asset takes ownership of the FileMap.
   */
  static Asset* createFromCompressedMap(FileMap* dataMap, size_t uncompressedLen, AccessMode mode);
...
class _CompressedAsset : public Asset {
 public:
   ...
   * On success, the object takes ownership of "fd".
   */
  status_t openChunk(int fd, off64_t offset, int compressionMethod, size_t uncompressedLen,
