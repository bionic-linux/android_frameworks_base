...
class ZipUtils {
 public:
  ...
  static bool inflateToBuffer(int fd, void* buf, long uncompressedLen, long compressedLen);
  static bool inflateToBuffer(const void* in, void* buf, long uncompressedLen, long compressedLen);
   ...
   */
  static bool examineGzip(FILE* fp, int* pCompressionMethod, long* pUncompressedLen,
