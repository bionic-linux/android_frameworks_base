...
public class WindowAnimationFrameStatsMonitorTest {
    ...
    @Before
    public void setup() {
        android.support.test.InstrumentationRegistry.registerInstance(getInstrumentation(),
                new Bundle());
    ...
    public void captureWindowAnimationFrameStats() {
        ...
        IAppHelper webViewBrowserHelper = new StandardAppHelper(mInstrumentation,
