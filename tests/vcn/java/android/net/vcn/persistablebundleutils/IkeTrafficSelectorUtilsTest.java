...
public class IkeTrafficSelectorUtilsTest {
    ...
    private static void verifyPersistableBundleEncodeDecodeIsLossless(IkeTrafficSelector ts) {
        PersistableBundle bundle = IkeTrafficSelectorUtils.toPersistableBundle(ts);
        IkeTrafficSelector resultTs = IkeTrafficSelectorUtils.fromPersistableBundle(bundle);
