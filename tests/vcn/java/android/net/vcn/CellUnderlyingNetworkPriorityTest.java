...
public class CellUnderlyingNetworkPriorityTest {
    private static final Set<String> ALLOWED_PLMN_IDS = new HashSet<>();
    private static final Set<Integer> ALLOWED_CARRIER_IDS = new HashSet<>();

    private static CellUnderlyingNetworkPriority getTestNetworkPriority() {
    ...
    public void testBuilderAndGetters() {
        final CellUnderlyingNetworkPriority networkPriority = getTestNetworkPriority();
    ...
    public void testBuilderAndGettersForDefaultValues() {
        final CellUnderlyingNetworkPriority networkPriority =
                new CellUnderlyingNetworkPriority.Builder().build();
