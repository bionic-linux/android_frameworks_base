...
public class VcnGatewayConnectionConfigTest {
    ...
    private static final Set<Integer> GATEWAY_OPTIONS =
            Collections.singleton(VCN_GATEWAY_OPTION_RECOVER_FROM_DATA_STALL_WITH_MOBIKE);
    ...
    private static VcnGatewayConnectionConfig buildTestConfigWithExposedCapsAndOptions(
        ...
        android.util.Log.i("TEST", "buildTestConfigWithExposedCapsAndOptions builder " + builder);
        android.util.Log.i(
                "TEST",
                "buildTestConfigWithExposedCapsAndOptions gatewayOptions " + gatewayOptions);
        android.util.Log.i(
                "TEST", "buildTestConfigWithExposedCapsAndOptions exposedCaps " + exposedCaps);
        android.util.Log.i(
                "TEST", "buildTestConfigWithExposedCapsAndOptions EXPOSED_CAPS " + EXPOSED_CAPS);
    ...
    private static VcnGatewayConnectionConfig buildTestConfigWithGatewayOptions(
        ...
        android.util.Log.i("TEST", "buildTestConfigWithGatewayOptions 1 builder " + builder);
        android.util.Log.i(
                "TEST", "buildTestConfigWithGatewayOptions 1 EXPOSED_CAPS " + EXPOSED_CAPS);
    ...
    public static VcnGatewayConnectionConfig buildTestConfigWithGatewayOptions(
            Set<Integer> gatewayOptions) {
        android.util.Log.i(
                "TEST", "buildTestConfigWithGatewayOptions 2 EXPOSED_CAPS " + EXPOSED_CAPS);
    ...
    public void testBuilderRequiresValidOption() {
        try {
            newBuilder()
                    .addGatewayOption(VCN_GATEWAY_OPTION_RECOVER_FROM_DATA_STALL_WITH_MOBIKE + 1);
    ...
    public void testBuilderAndGetters() {
        ...
        assertFalse(
                config.hasGatewayOption(VCN_GATEWAY_OPTION_RECOVER_FROM_DATA_STALL_WITH_MOBIKE));
    }
