...
public class WifiNetworkPriorityTest {
    ...
    public void testBuilderAndGetters() {
        final WifiNetworkPriority networkPriority = getTestNetworkPriority();
    ...
    public void testBuilderAndGettersForDefaultValues() {
        final WifiNetworkPriority networkPriority = new WifiNetworkPriority.Builder().build();
    ...
    public void testPersistableBundle() {
        ...
        assertEquals(
                networkPriority,
                NetworkPriority.fromPersistableBundle(networkPriority.toPersistableBundle()));
    }
}
