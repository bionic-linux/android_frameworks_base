...
public class CellNetworkPriorityTest {
    ...
    public void testBuilderAndGetters() {
        final CellNetworkPriority networkPriority = getTestNetworkPriority();
    ...
    public void testBuilderAndGettersForDefaultValues() {
        final CellNetworkPriority networkPriority = new CellNetworkPriority.Builder().build();
