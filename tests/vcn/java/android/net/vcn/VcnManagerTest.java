...
public class VcnManagerTest {
    ...
    public void testVcnStatusCallbackBinder() throws Exception {
        ...
        cbBinder.onGatewayConnectionError(
                ...
                VcnManager.VCN_ERROR_CLASS_INFORMATIONAL,
                VcnManager.VCN_ERROR_CODE_INTERNAL_FAILURE,
                "java.net.UnknownHostException",
                "exception_message");
        verify(mMockStatusCallback)
                .onGatewayConnectionError(
                        eq(UNDERLYING_NETWORK_CAPABILITIES),
                        eq(VcnManager.VCN_ERROR_CLASS_INFORMATIONAL),
                        eq(VcnManager.VCN_ERROR_CODE_INTERNAL_FAILURE),
