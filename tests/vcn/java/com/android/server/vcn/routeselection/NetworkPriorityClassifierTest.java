...
public class NetworkPriorityClassifierTest {
    ...
    public void testMatchWithoutNotMeteredBit() {
        final VcnWifiUnderlyingNetworkPriorityRule wifiNetworkPriority =
                new VcnWifiUnderlyingNetworkPriorityRule.Builder()
                        .setNetworkQuality(NETWORK_QUALITY_OK)
                        .setMatchesMetered(false /* allowMetered */)
                        .build();
    ...
    private void verifyMatchWifiWithSsid(boolean useMatchedSsid, boolean expectMatch) {
        ...
        final VcnWifiUnderlyingNetworkPriorityRule wifiNetworkPriority =
                new VcnWifiUnderlyingNetworkPriorityRule.Builder()
                        .setNetworkQuality(NETWORK_QUALITY_OK)
                        .setMatchesMetered(true /* allowMetered */)
                        .setMatchingSsids(Set.of(nwPrioritySsid))
                        .build();
    ...
    private static VcnCellUnderlyingNetworkPriorityRule.Builder getCellNetworkPriorityBuilder() {
    ...
    public void testMatchOpportunisticCell() {
        final VcnCellUnderlyingNetworkPriorityRule opportunisticCellNetworkPriority =
    ...
    private void verifyMatchMacroCellWithAllowedPlmnIds(
        ...
        final VcnCellUnderlyingNetworkPriorityRule networkPriority =
                getCellNetworkPriorityBuilder()
                        .setMatchingOperatorPlmnIds(Set.of(networkPriorityPlmnId))
                        .build();
    ...
    private void verifyMatchMacroCellWithAllowedSpecificCarrierIds(
        ...
        final VcnCellUnderlyingNetworkPriorityRule networkPriority =
                getCellNetworkPriorityBuilder()
                        .setMatchingSpecificCarrierIds(Set.of(networkPriorityCarrierId))
                        .build();
    ...
    public void testMatchWifiFailWithoutNotRoamingBit() {
        final VcnCellUnderlyingNetworkPriorityRule networkPriority =
                getCellNetworkPriorityBuilder().setMatchesRoaming(false /* allowRoaming */).build();
