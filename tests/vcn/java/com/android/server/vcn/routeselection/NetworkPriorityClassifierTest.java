...
import static com.android.server.vcn.routeselection.NetworkPriorityClassifier.checkMatchesLinkCriteria;
...
import android.net.vcn.VcnLinkCriteriaTest;
...
public class NetworkPriorityClassifierTest {
    ...
    @Test
    public void testMatchEstimatedBandwidthCriteria() {
        final EstimatedBandwidthCriteria criteria =
                VcnLinkCriteriaTest.getTestEstimatedBandwidthCriteria();
        ...
        final NetworkCapabilities equalToBandwidthCriteria =
                new NetworkCapabilities.Builder(CELL_NETWORK_CAPABILITIES)
                        .setLinkUpstreamBandwidthKbps(
                                VcnLinkCriteriaTest.TEST_MIN_UPSTREAM_BANDWIDTH_KBPS)
                        .setLinkDownstreamBandwidthKbps(
                                VcnLinkCriteriaTest.TEST_MIN_DOWNSTREAM_BANDWIDTH_KBPS)
                        .build();
        final NetworkCapabilities failingBandwidthCriteria =
                new NetworkCapabilities.Builder(CELL_NETWORK_CAPABILITIES)
                        .setLinkUpstreamBandwidthKbps(
                                VcnLinkCriteriaTest.TEST_MIN_UPSTREAM_BANDWIDTH_KBPS - 1)
                        .setLinkDownstreamBandwidthKbps(
                                VcnLinkCriteriaTest.TEST_MIN_DOWNSTREAM_BANDWIDTH_KBPS - 1)
                        .build();

        assertTrue(checkMatchesLinkCriteria(criteria, mCellNetworkRecord));
        assertTrue(
                checkMatchesLinkCriteria(
                        criteria,
                        new UnderlyingNetworkRecord(
                                mNetwork,
