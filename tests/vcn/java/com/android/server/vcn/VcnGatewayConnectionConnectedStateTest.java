...
public class VcnGatewayConnectionConnectedStateTest extends VcnGatewayConnectionTestBase {
    ...
    public void testDataStallTriggersMigration() throws Exception {
        verifyDataStallTriggersMigration(
                mVcnNetwork, TEST_UNDERLYING_NETWORK_RECORD_1, true /* expectMobike */);
    }

    @Test
    public void testDataStallOnOtherNetworkWontTriggerMigration() throws Exception {
        verifyDataStallTriggersMigration(
                mock(Network.class), TEST_UNDERLYING_NETWORK_RECORD_1, false /* expectMobike */);
    }

    @Test
    public void testDataStallWontTriggerMigrationWhenUnderlyingNetworkLost() throws Exception {
        verifyDataStallTriggersMigration(
                mock(Network.class), null /* underlyiNetworkRecord */, false /* expectMobike */);
    }
