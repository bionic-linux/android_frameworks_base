...
public class VcnGatewayConnectionDisconnectingStateTest extends VcnGatewayConnectionTestBase {
    ...
    public void testTimeoutExpired() throws Exception {
        Runnable delayedEvent = verifyTeardownTimeoutAlarm(false /* expectCanceled */);
        ...
        // since verifyTeardownTimeoutAlarm() verifies the WakeupMessage was scheduled with the
        // correct delay.
        delayedEvent.run();
        mTestLooper.dispatchAll();
