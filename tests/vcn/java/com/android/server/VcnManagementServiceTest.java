...
public class VcnManagementServiceTest {
    ...
    private void verifyVcnStatusCallbackOnEnteredSafemode(
        ...
        boolean expectCallback = hasPermissionsforSubGroup && hasLocationPermission;
        verify(mMockStatusCallback, expectCallback ? times(1) : never()).onEnteredSafemode();
    }

    @Test
    public void testVcnStatusCallbackOnEnteredSafemodeWithCarrierPrivileges() throws Exception {
        verifyVcnStatusCallbackOnEnteredSafemode(
                TEST_UUID_1,
                TEST_PACKAGE_NAME,
                TEST_UID,
    ...
    public void testRegisterVcnStatusCallback() throws Exception {
        ...
        assertEquals(TEST_UUID_1, cbInfo.getSubscriptionGroup());
        assertEquals(mMockStatusCallback, cbInfo.getStatusCallback());
        assertEquals(TEST_PACKAGE_NAME, cbInfo.getPackageName());
        assertEquals(TEST_UID, cbInfo.getUid());
