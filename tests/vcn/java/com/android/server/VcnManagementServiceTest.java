...
public class VcnManagementServiceTest {
    ...
    public void testRegisterVcnStatusCallback_VcnInactive() throws Exception {
        ...
        // Establish the correct permissions for TEST_CB_PACKAGE so it is permissioned to receive
        // STATUS_CODE_INACTIVE (instead of NOT_CONFIGURED).
        doReturn(true)
                .when(snapshot)
                .packageHasPermissionsForSubscriptionGroup(
