...
public class VcnManagementServiceTest {
    ...
    @Test
    public void testGetUnderlyingNetworkPolicyCellular_restricCell() throws Exception {
        checkGetUnderlyingNetworkPolicy(
                TRANSPORT_CELLULAR,
    ...
    @Test
    public void testGetUnderlyingNetworkPolicyCellular_restricCell_safeMode() throws Exception {
        checkGetUnderlyingNetworkPolicy(
                TRANSPORT_CELLULAR,
                true /* isCellRestrcited */,
                false /* isActive */,
