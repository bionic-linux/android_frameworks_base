...
public class IpRangeTest {
    ...
    public void testContainsRangeEqualRanges() {
        final IpRange r1 = new IpRange(IPV6_ADDR, 35);
        final IpRange r2 = new IpRange(IPV6_ADDR, 35);
    ...
    public void testContainsRangeSubset() {
        final IpRange r1 = new IpRange(IPV6_ADDR, 100);
        final IpRange r2 = new IpRange(address("2001:db8::0101"), 100);
    ...
    public void testContainsRangeSubsetSameStartAddr() {
        final IpRange r1 = new IpRange(IPV6_ADDR, 35);
        final IpRange r2 = new IpRange(IPV6_ADDR, 39);
    ...
    public void testContainsRangeOverlapping() {
        final IpRange r1 = new IpRange(address("2001:db9::"), 32);
    ...
    @Test
    public void testIsOverlappingRangeSubset() {
        final IpRange r1 = new IpRange(IPV6_ADDR, 35);
        final IpRange r2 = new IpRange(IPV6_ADDR, 39);
    ...
    public void testIsOverlappingRangeDisjoint() {
        final IpRange r1 = new IpRange(IPV6_ADDR, 32);
        final IpRange r2 = new IpRange(address("2001:db9::"), 32);
    ...
    public void testIsOverlappingRangePartialOverlapHigh() {
        final IpRange r1 = new IpRange(address("2001:db7::"), 32);
