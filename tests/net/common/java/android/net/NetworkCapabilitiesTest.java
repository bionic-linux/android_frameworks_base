...
public class NetworkCapabilitiesTest {
    ...
    public void testGetNetworkSpecifier() {
        final NetworkCapabilities nc = new NetworkCapabilities();
        nc.addTransportType(TRANSPORT_WIFI);
        final StringNetworkSpecifier specifier = new StringNetworkSpecifier("TEST_SPECIFIER");
    ...
    public void testAdministratorUids() {
        final NetworkCapabilities nc = new NetworkCapabilities();
        final List<Integer> administratorUids = new ArrayList<>();
        // The default value of administrator uids is an empty ArrayList.
        assertEquals(administratorUids, nc.getAdministratorUids());
        administratorUids.add(new Integer(1001));
        administratorUids.add(new Integer(10001));
