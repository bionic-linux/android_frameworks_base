...
public class ConnectivityManagerTest {
    ...
    /*class TestExecutor extends Executor {
        ...
        ArrayBlockingQueue<> mArrayBlockingQueue = new ArrayBlockingQueue<Runnable>();
    ...
    public void testQosCallbackConnectivityServiceCalled()
            throws Exception {
        ExceptionUtils.ThrowingConsumer<Executor> consumer = executor -> {
            ...
            mgr.registerQosCallback(filter, callback, executor);
            ...
            try {
                mgr.registerQosCallback(mock(QosFilter.class), callback, executor);
