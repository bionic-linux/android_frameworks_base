...
class NetworkStatsParcelableWrapperTest {
    ...
    fun testToNetworkStatsEntry() {
        ...
        for (i in TEST_STATS_SET2.indices) {
    ...
    fun testToNetworkStats() {
        ...
        for (i in TEST_STATS_SET1.indices) {
    ...
    fun testSubtract() {
        ...
        assertEquals(TEST_STATS1, TEST_STATS3.subtract(TEST_STATS2))
        // STATS3 - STATS1 = STATS2
        assertEquals(TEST_STATS2, TEST_STATS3.subtract(TEST_STATS1))
    }
}
