...
public class UidRangeTest {
   ...
   */
    ...
    public void testNegativeUidsDisallowed() {
        assertThrows("Negative start UID",
                IllegalArgumentException.class, () -> new UidRange(-2, 100));
        assertThrows("Negative stop UID",
                IllegalArgumentException.class, () -> new UidRange(-200, -100));
    }

    @Test
    public void testStopLessThanStartDisallowed() {
        final int x = 4195000;
        assertThrows("Negative length UID range",
                IllegalArgumentException.class, () -> new UidRange(x, x - 1));
    }
}
