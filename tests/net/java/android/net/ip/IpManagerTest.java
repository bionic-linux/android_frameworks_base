...
public class IpManagerTest {
    ...
    public void testValidInitialConfigurations() throws Exception {
        InitialConfiguration[] invalidConfigurations = {
            ...
            conf(links("192.0.2.12/24"), prefixes("192.0.2.0/24"), nets("192.0.2.2")),
            // valid IPv6 configuration
            conf(links("2001:db8:dead:beef:f00::a0/128"), prefixes("2001:db8:dead:beef::/64"), nets("2001:db8:dead:beef:f00::02")),

            // valid IPv6/v4 configuration
            conf(links("192.0.2.12/24"), prefixes("192.0.2.0/24"), nets("192.0.2.2")),
            // valid IPv6 configuration without any GUA.
            conf(links("192.0.2.12/24"), prefixes("192.0.2.0/24"), nets("192.0.2.2"))
        };
    ...
    public void testInvalidInitialConfigurations() throws Exception {
        InitialConfiguration[] invalidConfigurations = {
            ...
            conf(links("192.0.2.12/24"), prefixes("198.51.100.0/24"), nets("192.0.2.2")),
            // addr not in prefix
            conf(links("198.51.2.12/24"), prefixes("198.51.100.0/24"), nets("192.0.2.2")),
            // dns not in prefix
            conf(links("192.0.2.12/24"), prefixes("192.0.2.0/24"), nets("198.51.100.2")),

            // default ipv6 route and no GUA
            conf(links("2001:db8:dead:beef:f00::a0/128"), prefixes("::/0"), nets("198.51.100.2"))
        };
    ...
    static Set<InetAddress> nets(String... addresses) {
