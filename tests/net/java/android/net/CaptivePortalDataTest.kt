...
class CaptivePortalDataTest {
    ...
    fun testParcelUnparcel() {
        assertParcelSane(data, fieldCount = 6)
    ...
    fun testEquals() {
        ...
        assertNotEqualsAfterChange { it.setUserPortalUrl(Uri.parse("https://other.example.com/")) }
        assertNotEqualsAfterChange { it.setUserPortalUrl(null) }
        assertNotEqualsAfterChange { it.setVenueInfoUrl(Uri.parse("https://other.example.com/")) }
        assertNotEqualsAfterChange { it.setVenueInfoUrl(null) }
        assertNotEqualsAfterChange { it.setBytesRemaining(789L) }
        assertNotEqualsAfterChange { it.setSecondsRemaining(12L) }
