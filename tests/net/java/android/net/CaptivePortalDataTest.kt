...
class CaptivePortalDataTest {
    private val data = CaptivePortalData.Builder()
            ...
            .setSessionManagementUrl(Uri.parse("https://venue.example.com/session"))
            .setBytesRemaining(456L)
            .setExpiryTime(789L)
            .setCaptive(true)
            .build()

    private fun makeBuilder(): CaptivePortalData.Builder = CaptivePortalData.Builder(data)
    ...
    fun testParcelUnparcel() {
        ...
        assertParcelingIsLossless(makeBuilder().setSessionManagementUrl(null).build())
    }
    ...
    fun testEquals() {
        ...
        assertNotEqualsAfterChange { it.setSessionManagementUrl(Uri.parse("https://example.com/")) }
        assertNotEqualsAfterChange { it.setSessionManagementUrl(null) }
    ...
    private fun assertNotEqualsAfterChange(mutator: (CaptivePortalData.Builder) -> Unit) {
        ...
        assertNotEquals(data, newBuilder.build())
    }
}