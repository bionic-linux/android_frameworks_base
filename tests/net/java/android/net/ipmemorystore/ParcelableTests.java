...
public class ParcelableTests {
    ...
    public void testPrivateDataParceling() throws Exception {
        ...
        for (int i = 0; i < in.data.length; ++i) {
            assertEquals(in.data[i], out.data[i]);
        }
    }
    ...
    public void testSameL3NetworkResponseParceling() throws Exception {
        ...
        parceled.l2Key1 = "key 1";
        parceled.l2Key2 = "key 2";
        parceled.confidence = 0.43f;

        final SameL3NetworkResponse in = new SameL3NetworkResponse(parceled);
