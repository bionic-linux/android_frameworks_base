...
public class ParcelableTests {
    ...
    public void testNetworkAttributesParceling() throws Exception {
        ...
        builder.setAssignedAddress((Inet4Address) Inet4Address.getByName("1.2.3.4"));
        ...
        builder.setAssignedAddress((Inet4Address) Inet4Address.getByName("0A1C:2E40:480A::1CA6"));
