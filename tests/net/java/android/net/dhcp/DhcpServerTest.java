...
public class DhcpServerTest {
    ...
    // TODO: replace with mock(DhcpPacketListener.class, withSettings().useConstructor(handler))
    // once supported (may be available in mockito-target-inline or mockito-target-extended libs).
    private static class MockPacketListener extends DhcpPacketListener {
        MockPacketListener(Handler handler) {
            super(handler);
        }
        ...
        protected FileDescriptor createFd() {
            // Base implementation will not start the listener with a null fd
            return null;
        }
    }
    ...
    public void setUp() throws Exception {
        ...
        mPacketListener = spy(new MockPacketListener(new Handler(mLooper.getLooper())));
