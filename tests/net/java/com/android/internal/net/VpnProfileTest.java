...
public class VpnProfileTest {
    ...
    private VpnProfile getSampleIkev2Profile() {
        final VpnProfile p = new VpnProfile(DUMMY_PROFILE_KEY);
    ...
    public void testEquals() {
        assertEquals(getSampleIkev2Profile(), getSampleIkev2Profile());

        final VpnProfile modified = getSampleIkev2Profile();
        modified.maxMtu--;
        assertNotEquals(getSampleIkev2Profile(), modified);
    }

    @Test
    public void testParcelUnparcel() {
        assertParcelSane(getSampleIkev2Profile(), 23);
    }
    ...
    public void testEncodeDecode() {
        final VpnProfile profile = getSampleIkev2Profile();
