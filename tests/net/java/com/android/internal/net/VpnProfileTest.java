...
public class VpnProfileTest {
    ...
    private String getEncodedDecodedIkev2ProfileMissingValues(int... missingIndicies) {
        // Sort to ensure when we remove, we can do it from greatest first.
        Arrays.sort(missingIndicies);
        ...
        for (int i = missingIndicies.length - 1; i >= 0; i--) {
            parts.remove(missingIndicies[i]);
        }
    ...
    public void testEncodeDecodeInvalidNumberOfValues() {
        final String tooFewValues =
                getEncodedDecodedIkev2ProfileMissingValues(
                        ...
                        ENCODED_INDEX_RESTRICTED_TO_TEST_NETWORKS /* missingIndicies */);
