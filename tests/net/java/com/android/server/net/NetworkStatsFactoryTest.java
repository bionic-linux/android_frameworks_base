...
public class NetworkStatsFactoryTest extends NetworkStatsBaseTest {
    ...
    public void setUp() throws Exception {
        ...
        mFactory.updateVpnTransportInfos(new VpnTransportInfo[0]);
    }
    ...
    public void testVpnRewriteTrafficThroughItself() throws Exception {
        final VpnTransportInfo[] infos =
                new VpnTransportInfo[] {createVpnTransportInfo(new String[] {TEST_IFACE})};
        mFactory.updateVpnTransportInfos(infos);
    ...
    public void testVpnWithClat() throws Exception {
        VpnTransportInfo[] infos = new VpnTransportInfo[] {
                createVpnTransportInfo(new String[] {CLAT_PREFIX + TEST_IFACE})};
        mFactory.updateVpnTransportInfos(infos);
    ...
    public void testVpnWithTwoUnderlyingIfaces_packetDuplication() throws Exception {
        ...
        VpnTransportInfo[] infos = new VpnTransportInfo[] {
                createVpnTransportInfo(new String[] {TEST_IFACE, TEST_IFACE2})};
        mFactory.updateVpnTransportInfos(infos);
    ...
    public void testConcurrentVpns() throws Exception {
        ...
        final VpnTransportInfo[] infos = new VpnTransportInfo[] {
                createVpnTransportInfo(TUN_IFACE, new String[] {TEST_IFACE}),
                createVpnTransportInfo(TUN_IFACE2, new String[] {TEST_IFACE2})};
        mFactory.updateVpnTransportInfos(infos);
