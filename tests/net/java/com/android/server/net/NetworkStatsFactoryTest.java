...
public class NetworkStatsFactoryTest extends NetworkStatsBaseTest {
    ...
    public void vpnWithClat() throws Exception {
        ...
        // UID_RED: 3000 bytes, 100 packets
        // UID_BLUE: 1500 bytes, 50 packets
        // UID_VPN: 150 bytes, 0 packets
        //
        // For 3300 bytes received over v4-WiFi, 9300 bytes were actually sent over WiFi, which is
        // expected to be split as follows:
        // UID_RED: 6000 bytes, 200 packets
        // UID_BLUE: 3000 bytes, 100 packets
        // UID_VPN: 300 bytes, 0 packets
        final NetworkStats tunStats = parseDetailedStats(R.raw.xt_qtaguid_vpn_with_clat);

        assertValues(tunStats, CLAT_PREFIX + TEST_IFACE, UID_RED, 6000L, 200L, 3000, 100L);
        assertValues(tunStats, CLAT_PREFIX + TEST_IFACE, UID_BLUE, 3000L, 100L, 1500L, 50L);

        // TODO: Fix this! All 464xlat ovehead is directly applied to the VPN.
        assertValues(tunStats, CLAT_PREFIX + TEST_IFACE, UID_VPN, 300L, 0L, 150L, 0L);
    }
