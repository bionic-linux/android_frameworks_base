...
public class IpSecServiceTest {
    ...
    public void testValidateAlgorithmsAuth() {
        ...
        for (IpSecAlgorithm algo : new IpSecAlgorithm[] {CRYPT_ALGO, AEAD_ALGO}) {
            assertThrows("Invalid algorithm type", IllegalArgumentException.class, () -> {
    ...
    public void testValidateAlgorithmsNoAlgorithms() {
        final IpSecConfig conf = new IpSecConfig();
        assertThrows("No algorithms specified",
                IllegalArgumentException.class, () -> mIpSecService.validateAlgorithms(conf));
    }
    ...
    public void testValidateAlgorithmsAeadWithAuth() {
        ...
        assertThrows("Both AEAD and auth algorithm specified",
                IllegalArgumentException.class, () -> mIpSecService.validateAlgorithms(conf));
    }
    ...
    public void testValidateAlgorithmsAeadWithCrypt() {
        ...
        assertThrows("Both AEAD and crypt algorithm specified",
                IllegalArgumentException.class, () -> mIpSecService.validateAlgorithms(conf));
    }
    ...
    public void testValidateAlgorithmsAeadWithAuthAndCrypt() {
        ...
        conf.setAuthentication(AUTH_ALGO);
        conf.setEncryption(CRYPT_ALGO);
        assertThrows("AEAD, auth and crypt algorithm specified",
                IllegalArgumentException.class, () -> mIpSecService.validateAlgorithms(conf));
    }
    ...
    public void testValidateIpAddresses() throws Exception {
        ...
        for (String address : invalidAddresses) {
            assertThrows("Invalid address", IllegalArgumentException.class, () ->
    ...
    public void testReserveNetId() {
        ...
        assertThrows("Resources should be exhausted",
                IllegalStateException.class, () -> mIpSecService.reserveNetId());
