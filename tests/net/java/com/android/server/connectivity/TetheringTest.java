...
public class TetheringTest {
    ...
    public void localOnlyWifiHotspotStartStop() throws Exception {
        ...
        mLooper.dispatchAll();
        // TOOD: Why is listInterfaces() called more than once?
        verify(mNMService, atLeastOnce()).listInterfaces();
        ...
        mLooper.dispatchAll();
        // TOOD: Why is setWifiApEnabled() called more than once?
        verify(mWifiManager, atLeastOnce()).setWifiApEnabled(null, false);
        verifyNoMoreInteractions(mWifiManager);
        ...
        // TOOD: Why is {g,s}etInterfaceConfig() called more than once?
