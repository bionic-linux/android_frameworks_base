...
public class TetheringTest {
    ...
    private void runUsbTethering(NetworkState upstreamState) {
        when(mUpstreamNetworkMonitor.getDefaultInternetUpstream()).thenReturn(upstreamState.network);
        prepareUsbTethering(upstreamState);
        sendUsbBroadcast(true, true, true);
        mLooper.dispatchAll();

        // If default upstream is available, tethering should receive EVENT_UPSTREAM_CALLBACK callback
        // to choose tether upstream after starting UpstreamNetworkMonitor
