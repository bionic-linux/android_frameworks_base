...
public class PermissionMonitorTest {
    ...
    private boolean wouldCarryoverPackagePackage(String partition, int targetSdkVersion, int uid) {
    ...
    public void testIsGrandfatheredPackage() {
        ...
        assertTrue(wouldCarryoverPackagePackage(PARTITION_SYSTEM, VERSION_P, SYSTEM_UID));
        assertTrue(wouldCarryoverPackagePackage(PARTITION_VENDOR, VERSION_P, SYSTEM_UID));
        assertFalse(wouldCarryoverPackagePackage(PARTITION_SYSTEM, VERSION_P, MOCK_UID1));
        assertTrue(wouldCarryoverPackagePackage(PARTITION_VENDOR, VERSION_P, MOCK_UID1));
        assertTrue(wouldCarryoverPackagePackage(PARTITION_SYSTEM, VERSION_Q, SYSTEM_UID));
        assertTrue(wouldCarryoverPackagePackage(PARTITION_VENDOR, VERSION_Q, SYSTEM_UID));
        assertFalse(wouldCarryoverPackagePackage(PARTITION_SYSTEM, VERSION_Q, MOCK_UID1));
        assertFalse(wouldCarryoverPackagePackage(PARTITION_VENDOR, VERSION_Q, MOCK_UID1));

        doReturn(VERSION_Q).when(mDeps).getDeviceFirstSdkInt();
        assertFalse(wouldCarryoverPackagePackage(PARTITION_SYSTEM, VERSION_P, SYSTEM_UID));
        assertTrue(wouldCarryoverPackagePackage(PARTITION_VENDOR, VERSION_P, SYSTEM_UID));
        assertFalse(wouldCarryoverPackagePackage(PARTITION_SYSTEM, VERSION_P, MOCK_UID1));
        assertTrue(wouldCarryoverPackagePackage(PARTITION_VENDOR, VERSION_P, MOCK_UID1));
        assertFalse(wouldCarryoverPackagePackage(PARTITION_SYSTEM, VERSION_Q, SYSTEM_UID));
        assertFalse(wouldCarryoverPackagePackage(PARTITION_VENDOR, VERSION_Q, SYSTEM_UID));
        assertFalse(wouldCarryoverPackagePackage(PARTITION_SYSTEM, VERSION_Q, MOCK_UID1));
        assertFalse(wouldCarryoverPackagePackage(PARTITION_VENDOR, VERSION_Q, MOCK_UID1));

        assertFalse(wouldCarryoverPackagePackage(PARTITION_OEM, VERSION_Q, SYSTEM_UID));
        assertFalse(wouldCarryoverPackagePackage(PARTITION_PRODUCT, VERSION_Q, SYSTEM_UID));
        assertFalse(wouldCarryoverPackagePackage(PARTITION_OEM, VERSION_Q, MOCK_UID1));
        assertFalse(wouldCarryoverPackagePackage(PARTITION_PRODUCT, VERSION_Q, MOCK_UID1));
    }
