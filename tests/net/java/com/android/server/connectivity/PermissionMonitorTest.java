...
public class PermissionMonitorTest {
    ...
    public void testUserAndPackageAddRemove() throws Exception {
        ...
        when(mPackageManager.getPackagesForUid(UserHandle.getUid(MOCK_USER1, SYSTEM_UID)))
                .thenReturn(new String[]{SYSTEM_PACKAGE1});
        when(mPackageManager.getPackagesForUid(UserHandle.getUid(MOCK_USER2, SYSTEM_UID)))
                .thenReturn(new String[]{SYSTEM_PACKAGE1});
        ...
        addPackageForUsers(new int[]{MOCK_USER1, MOCK_USER2}, SYSTEM_PACKAGE2, SYSTEM_UID);
        mNetdMonitor.expectPermission(SYSTEM, new int[]{MOCK_USER1, MOCK_USER2},
                new int[]{SYSTEM_UID});
        ...
        when(mPackageManager.getPackagesForUid(UserHandle.getUid(MOCK_USER1, MOCK_UID1)))
                .thenReturn(new String[]{});
        when(mPackageManager.getPackagesForUid(UserHandle.getUid(MOCK_USER2, MOCK_UID1)))
                .thenReturn(new String[]{});
