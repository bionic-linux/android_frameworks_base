...
public class PermissionMonitorTest {
    ...
    public void testUserAndPackageAddRemove() throws Exception {
        ...
        when(mPackageManager.getPackagesForUid(anyInt())).thenReturn(new String[]{SYSTEM_PACKAGE1});
        ...
        mNetdMonitor.expectPermission(SYSTEM, new int[]{MOCK_USER1, MOCK_USER2}, new int[]{SYSTEM_UID});
