...
public class PermissionMonitorTest {
    ...
    private boolean hasRestrictedNetPerm(int targetSdkVersion, int uid, PackageInfo pInfo) {
    ...
    private static PackageInfo packageInfoWithPermissions(int flag, String[] permissions,
            String partition) {
    ...
    public void testHasRestrictedNetworkPermission() {
        assertFalse(hasRestrictedNetPerm(VERSION_P, MOCK_UID1, systemPackageInfoWithPermissions()));
        assertFalse(hasRestrictedNetPerm(VERSION_P, MOCK_UID1,
                systemPackageInfoWithPermissions(CHANGE_NETWORK_STATE)));
        assertTrue(hasRestrictedNetPerm(VERSION_P, MOCK_UID1,
        ...
        assertFalse(hasRestrictedNetPerm(VERSION_Q, MOCK_UID1, systemPackageInfoWithPermissions()));
        assertFalse(hasRestrictedNetPerm(VERSION_Q, MOCK_UID1,
                systemPackageInfoWithPermissions(CHANGE_WIFI_STATE)));
    }
    ...
    public void testHasRestrictedNetworkPermissionSystemUid() {
        ...
        assertTrue(hasRestrictedNetPerm(VERSION_P, SYSTEM_UID, systemPackageInfoWithPermissions()));
        assertTrue(hasRestrictedNetPerm(VERSION_P, SYSTEM_UID,
                systemPackageInfoWithPermissions(CHANGE_WIFI_STATE)));
        assertTrue(hasRestrictedNetPerm(VERSION_P, SYSTEM_UID,
                systemPackageInfoWithPermissions(CONNECTIVITY_USE_RESTRICTED_NETWORKS)));

        doReturn(VERSION_Q).when(mPermissionMonitor).getDeviceFirstSdkInt();
        assertFalse(hasRestrictedNetPerm(VERSION_Q, SYSTEM_UID,
                systemPackageInfoWithPermissions()));
        assertFalse(hasRestrictedNetPerm(VERSION_Q, SYSTEM_UID,
                systemPackageInfoWithPermissions(CHANGE_WIFI_STATE)));
        assertTrue(hasRestrictedNetPerm(VERSION_Q, SYSTEM_UID,
                systemPackageInfoWithPermissions(CONNECTIVITY_USE_RESTRICTED_NETWORKS)));
    }

    @Test
    public void testHasRestrictedNetworkPermissionVendorApp() {
        assertTrue(hasRestrictedNetPerm(VERSION_P, MOCK_UID1, vendorPackageInfoWithPermissions()));
        assertTrue(hasRestrictedNetPerm(VERSION_P, MOCK_UID1,
        ...
        assertFalse(hasRestrictedNetPerm(VERSION_Q, MOCK_UID1, vendorPackageInfoWithPermissions()));
        assertFalse(hasRestrictedNetPerm(VERSION_Q, MOCK_UID1,
                vendorPackageInfoWithPermissions(CHANGE_WIFI_STATE)));
        assertFalse(hasRestrictedNetPerm(VERSION_Q, MOCK_UID1,
                vendorPackageInfoWithPermissions(CHANGE_NETWORK_STATE)));
