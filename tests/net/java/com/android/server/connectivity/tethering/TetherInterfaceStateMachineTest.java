...
import static com.android.server.connectivity.Tethering.Mode;
...
public class TetherInterfaceStateMachineTest {
    ...
    private void initTetheredStateMachine(int interfaceType, String upstreamIface) throws Exception {
        ...
        dispatchCommand(TetherInterfaceStateMachine.CMD_TETHER_REQUESTED, Mode.TETHERING);
     ...
     */
    private void dispatchCommand(int command, Object obj) {
        mTestedSm.sendMessage(command, obj);
        mLooper.dispatchAll();
    }
