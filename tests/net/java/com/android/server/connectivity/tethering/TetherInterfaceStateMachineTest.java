...
public class TetherInterfaceStateMachineTest {
    ...
    private void initStateMachine(int interfaceType) throws Exception {
        initStateMachine(interfaceType, false /* disableDhcp */);
    }

    private void initStateMachine(int interfaceType, boolean disableDhcp) throws Exception {
        mTestedSm = new TetherInterfaceStateMachine(
                IFACE_NAME, mLooper.getLooper(), interfaceType, mSharedLog,
                mNMService, mStatsService, mTetherHelper, disableDhcp,
    ...
    private void initTetheredStateMachine(int interfaceType, String upstreamIface,
            boolean disableDhcp) throws Exception {
        initStateMachine(interfaceType, disableDhcp);
    ...
    public void startsOutAvailable() {
        mTestedSm = new TetherInterfaceStateMachine(IFACE_NAME, mLooper.getLooper(),
                ...
                false /* disableDhcp */, mTetheringDependencies);
        mTestedSm.start();
        mLooper.dispatchAll();
    ...
    public void doesNotStartDhcpServerIfDisabled() throws Exception {
        initTetheredStateMachine(TETHERING_WIFI, UPSTREAM_IFACE, true /* disableDhcp */);
        dispatchTetherConnectionChanged(UPSTREAM_IFACE);
    ...
    private void assertDhcpStarted(IpPrefix expectedPrefix) {
        ...
        assertEquals(3600, params.dhcpLeaseTimeSecs);
    }
