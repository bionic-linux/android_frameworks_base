    ...
    public void testRequiresClat() throws Exception {
        ...
        for (int type : supportedTypes) {
            ...
            for (NetworkInfo.DetailedState state : supportedDetailedStates) {
                ...
                String error_msg = msg + String.format(" skip464xlat=%b", mMisc.skip464xlat);
                assertFalse(error_msg, Nat464Xlat.requiresClat(mNai));

                mMisc.skip464xlat = false;
                error_msg = msg + String.format(" skip464xlat=%b", mMisc.skip464xlat);
                assertTrue(error_msg, Nat464Xlat.requiresClat(mNai));
            }
        }
    }
