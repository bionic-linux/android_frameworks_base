...
public class VpnTest {
    ...
    // Change detector test - This profile name must NOT change due for backwards compatibility
    @Test
    ...
    @Test
    public void testStartVpnProfile_notConsented() throws Exception {
        final Vpn vpn = createVpn(primaryUser.id);
        setMockedUsers(primaryUser);
    ...
    @Test
    public void testStartVpnProfile_missingProfile() throws Exception {
        final Vpn vpn = createVpn(primaryUser.id);
        setMockedUsers(primaryUser);
