...
public class VpnTest {
    ...
    private void checkProvisionVpnProfile(
            Vpn vpn, @Nullable Integer grantedOp, boolean expectedResult, int... checkedOps) {
        if (grantedOp != null) {
    ...
    public void testProvisionVpnProfilePreconsented() throws Exception {
        ...
        checkProvisionVpnProfile(vpn, AppOpsManager.OP_ACTIVATE_PLATFORM_VPN, true /* expectedResult */,
                AppOpsManager.OP_ACTIVATE_PLATFORM_VPN);
    }
    ...
    public void testProvisionVpnProfileNotPreconsented() throws Exception {
        ...
        checkProvisionVpnProfile(vpn, null /* grantedOp */, false /* expectedResult */,
