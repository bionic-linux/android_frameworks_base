...
public class VpnTest {
    ...
    private static Range<Integer> uidRangeForUser(int userId) {
        return Vpn.createUidRangeForUser(userId);
    }
    ...
    public void testLockdownAllowlist() throws Exception {
        ...
        verify(mConnectivityManager).setRequireVpnForUids(true, toRanges(new UidRangeParcel[] {
                new UidRangeParcel(
                        user.getLower() + PKG_UIDS[1] + 1, user.getLower() + PKG_UIDS[3] - 1),
                new UidRangeParcel(user.getLower() + PKG_UIDS[3] + 1, user.getUpper())
        }));
        ...
        verify(mConnectivityManager).setRequireVpnForUids(true, toRanges(new UidRangeParcel[] {
                ...
                new UidRangeParcel(
                        user.getLower() + PKG_UIDS[0] + 1, user.getLower() + PKG_UIDS[3] - 1)
        }));
        ...
        verify(mConnectivityManager).setRequireVpnForUids(true, toRanges(new UidRangeParcel[] {
                new UidRangeParcel(
                        user.getLower() + PKG_UIDS[0] + 1, user.getLower() + PKG_UIDS[1] - 1),
                new UidRangeParcel(user.getLower() + PKG_UIDS[1] + 1, user.getUpper())
        }));
        ...
        verify(mConnectivityManager).setRequireVpnForUids(true, toRanges(new UidRangeParcel[] {
                new UidRangeParcel(
                        user.getLower() + PKG_UIDS[0] + 1, user.getLower() + PKG_UIDS[2] - 1),
                new UidRangeParcel(user.getLower() + PKG_UIDS[2] + 1, user.getUpper())
        }));
    }
