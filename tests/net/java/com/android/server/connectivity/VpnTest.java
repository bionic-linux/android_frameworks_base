...
public class VpnTest {
    ...
    public void startRacoon(final String serverAddr, final String expectedAddr)
        ...
        // AtomicReferences to capture the arguments sent to registerNetworkAgent.
        // Used because the when(mConnectivityManager.registerNetworkAgent(...).thenAnswer(...) does
        ...
        try {
            ...
            assertTrue("Timed out waiting for legacy runner to register agent",
            ...
            assertTransportInfoMatches(ncReference.get(),
                    VpnManager.TYPE_VPN_LEGACY, "testProfileNameZ");
        } finally {
