...
void JNI_COLORSPACE_METHOD(nativeYuv420pToRgba8888)(JNIEnv* env, jclass clazz, jobject input,
...
void JNI_COLORSPACE_METHOD(nativeArgb8888ToRgba8888)(JNIEnv* env, jclass clazz, jobject input,
                                                     jobject output, jint width, jint height) {
...
void JNI_COLORSPACE_METHOD(nativeRgba8888ToHsva8888)(JNIEnv* env, jclass clazz, jobject input,
                                                     jobject output, jint width, jint height) {
    Rgba* pInput = static_cast<Rgba*>(env->GetDirectBufferAddress(input));
    Rgba* pOutput = static_cast<Rgba*>(env->GetDirectBufferAddress(output));
...
void JNI_COLORSPACE_METHOD(nativeRgba8888ToYcbcra8888)(JNIEnv* env, jclass clazz, jobject input,
                                                       jobject output, jint width, jint height) {
    Rgba* pInput = static_cast<Rgba*>(env->GetDirectBufferAddress(input));
    Rgba* pOutput = static_cast<Rgba*>(env->GetDirectBufferAddress(output));
