...
public final class ScriptIntrinsicBLAS extends ScriptIntrinsic {
    ...
    private static final int RsBlas_bgemm = 1000;
    ...
    /**
     *
     * 8-bit GEMM-like operation
     *
     * @hide
     **/
    public void BGEMM(Allocation A, int a_offset, Allocation B, int b_offset, Allocation C, int c_offset, int c_mult) {
        ...
        mRS.nScriptIntrinsicBLAS_BGEMM(getID(mRS), M, N, K, A.getID(mRS), a_offset, B.getID(mRS), b_offset, C.getID(mRS), c_offset, c_mult);
