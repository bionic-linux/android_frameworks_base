...
public class FieldPacker {
    ...
    static FieldPacker createFieldPack(Object[] args) {
        VariableLengthFieldPacker fp = new VariableLengthFieldPacker();
        for (Object arg : args) {
            fp.addSafely(arg);
        }
        return fp;
...
class VariableLengthFieldPacker extends FieldPacker {
    public VariableLengthFieldPacker() {
        super(RenderScript.sPointerSize * 8);
    }
    ...
    public void addSafely(Object obj) {
        boolean retry;
