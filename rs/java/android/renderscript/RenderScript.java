...
public class RenderScript {
    ...
    */
    ...
    native ByteBuffer rsnAllocationGetByteBuffer(long con, long alloc);
    synchronized ByteBuffer nAllocationGetByteBuffer(long alloc) {
        validate();
        return rsnAllocationGetByteBuffer(mContext, alloc);
    }
