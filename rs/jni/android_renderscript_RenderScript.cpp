...
static void
nScriptIntrinsicBLAS_BGEMM(JNIEnv *_env, jobject _this, jlong con, jlong id, jint M, jint N, jint K,
                                             jlong A, jbyte a_offset, jlong B, jbyte b_offset, jlong C, jbyte c_offset,
                                             jint c_mult_int) {
    RsBlasCall call;
    memset(&call, 0, sizeof(call));
    call.func = RsBlas_bgemm;
    call.M = M;
    call.N = N;
    call.K = K;
...
{"rsnScriptIntrinsicBLAS_BGEMM",     "(JJIIIJBJBJBI)V",                       (void*)nScriptIntrinsicBLAS_BGEMM },
