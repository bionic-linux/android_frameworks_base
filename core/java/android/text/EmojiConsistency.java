...
public final class EmojiConsistency {
     ...
     * {@link android.graphics.Typeface.DEFAULT} for matched codepoint sequences.
     *
     * Codepoint sequences returned MUST match exactly to be considered a match. For example,
     * variation selectors will be included for all required matches. It is not required that
     * clients normalize the sequences in any way.
     *
