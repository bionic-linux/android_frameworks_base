 ...
 *         </li>
 *         <li>
 *             For each match, check against NonStandardEmoji before adding ReplacementSpan
 *         </li>
 *         <li>
 *             If in NonStandardEmojiSet, do not add a replacement span (defer to platform render).
 *         </li>
 *         <li>
 *             Otherwise, do custom rendering like normal (add ReplacementSpan).
 *         </li>
 *     </ol>
 * </p>
 */
