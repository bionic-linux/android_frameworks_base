...
public final class TzDataSetVersion {
    ...
    /**
     * Returns true if the version information provided would be compatible with this device.
     */
    public static boolean isCompatibleWithThisRelease(TzDataSetVersion tzDataSetVersion) {
        return libcore.timezone.TzDataSetVersion.isCompatibleWithThisDevice(
                tzDataSetVersion.mDelegate);
    }

    /**
     * Read an Android time zone data set version file.
     */
    @NonNull
    public static TzDataSetVersion readFromFile(File file) throws IOException, TzDataSetException {
        try {
            return new TzDataSetVersion(libcore.timezone.TzDataSetVersion.readFromFile(file));
    ...
    /** Returns Android revision. See {@link TzDataSetVersion}. */
