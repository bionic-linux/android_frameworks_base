...
public final class BluetoothAdapter {
     ...
     * The same {@link BluetoothDevice} and {@link #MetadataListner} pair can only be registered
     ...
     * is null.
     * @throws IllegalArgumentException If double register same {@link #MetadataListner} and
     * {@link BluetoothDevice} pair.
     * @hide
     */
    @SystemApi
    @RequiresPermission(Manifest.permission.BLUETOOTH_PRIVILEGED)
     ...
     * Unregistration can be done on both Bluetooth ON and OFF.
     * {@link #registerMetadataListener(MetadataListener, BluetoothDevice, Handler)} must
     * be called before unregister.
     * Unregister a device that is not regestered would cause {@link IllegalArgumentException}.
     *
     ...
     * @return true on success, false on error
     * @throws NullPointerException If one of {@code device} is null.
     * @throws IllegalArgumentException If {@code device} is not registered.
     * @hide
     */
    @SystemApi
    @RequiresPermission(Manifest.permission.BLUETOOTH_PRIVILEGED)
