...
public final class BluetoothCodecStatus implements Parcelable {
     ...
     * @return true if both lists contain same capabilities.
     */
     ...
     * @return true if the codec config matches, false otherwise.
     */
     ...
     *
     * @return an list with the codecs local capabilities.
     */
     ...
     *
     * @return a list with the codecs selectable capabilities.
     */
