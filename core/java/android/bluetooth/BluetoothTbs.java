...
/**
 * This class provides the public APIs to control the Call Control profile.
 *
 * <p>
 ...
 *
 * <p>
 * BluetoothTbs is a proxy object for controlling the Bluetooth Telephone Bearer
 * Service via IPC. Use {@link BluetoothAdapter#getProfileProxy} to get the
 * BluetoothTbs proxy object.
 *
 * @hide
 */
public final class BluetoothTbs implements BluetoothProfile {
    ...
    public abstract static class Callback {
         ...
         *
         * <p>
         * An application must call {@link BluetoothTbs#requestResult} to complete the
         * request.
         *
    ...
    /**
     * Create a BluetoothTbs proxy object for interacting with the local Bluetooth
     * telephone bearer service.
     */
    /* package */ BluetoothTbs(Context context, ServiceListener listener) {
        mContext = context;
    ...
    private boolean doBind() {
        synchronized (mConnection) {
            if (mService == null) {
                ...
                try {
                    return mAdapter.getBluetoothManager().bindBluetoothProfileService(BluetoothProfile.TBS,
                            mConnection);
                } catch (RemoteException e) {
    ...
    private void doUnbind() {
        synchronized (mConnection) {
            if (mService != null) {
                ...
                try {
                    mAdapter.getBluetoothManager().unbindBluetoothProfileService(BluetoothProfile.TBS, mConnection);
                } catch (RemoteException e) {
    ...
    public boolean registerBearer(@Nullable String uci, @NonNull List<String> uriSchemes, int capabilities,
            @NonNull String provider, int technology, @NonNull Executor executor, @NonNull Callback callback) {
        if (DBG) {
        ...
        final IBluetoothTbs service = getService();
        if (service != null) {
            synchronized (mServerIfLock) {
                if (mCallback != null) {
                ...
                try {
                    ...
                    service.registerBearer(mToken, callbackWrapper, uci, uriSchemes, capabilities, provider, technology);
                } catch (RemoteException e) {
                    Log.e(TAG, "", e);
                    mCallback = null;
                    return false;
     ...
     */
    @RequiresPermission(android.Manifest.permission.BLUETOOTH_PRIVILEGED)
    public void onCallAdded(@NonNull BluetoothTbsCall call) {
        if (DBG) {
     ...
     */
    @RequiresPermission(android.Manifest.permission.BLUETOOTH_PRIVILEGED)
    public void onCallStateChanged(@NonNull UUID callId, @BluetoothTbsCall.State int state) {
        if (DBG) {
     ...
     * calls.
     *
     * @param calls curent calls list
     * @hide
     */
    @RequiresPermission(android.Manifest.permission.BLUETOOTH_PRIVILEGED)
     public void currentCallsList(@NonNull List<BluetoothTbsCall> calls) {
        final IBluetoothTbs service = getService();
        if (service != null) {
            try {
    ...
    private final IBluetoothProfileServiceConnection mConnection = new IBluetoothProfileServiceConnection.Stub() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            mService = IBluetoothTbs.Stub.asInterface(Binder.allowBlocking(service));
        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_TBS_SERVICE_CONNECTED: {
                if (mServiceListener != null) {
                    mServiceListener.onServiceConnected(BluetoothProfile.TBS, BluetoothTbs.this);
                }
                break;
            }
            case MESSAGE_TBS_SERVICE_DISCONNECTED: {
                if (mServiceListener != null) {
                    mServiceListener.onServiceDisconnected(BluetoothProfile.TBS);
                }
                break;
            }
            }
