...
public final class BluetoothLeBroadcastSourceInfo implements Parcelable {
     ...
     *
     * @param audioSource BluetoothDevice representing a Broadcast Source
     * @param advSid advertising SID of the Broadcast Source the Broadcast Sink is synchronized
     *     with.
     ...
     *
     * @param sourceId Source Id for this Broadcast Source info object
     * @param audioSource BluetoothDevice representing the Broadcast Source
     * @param advSid advertising SID of the Broadcast Source with which Broadcast Sink is
     *     synchronized with
     ...
     *
     * @param sourceId Source Id for this Broadcast Source info object
     * @param device BluetoothDevice representing the Broadcast Source
     * @param advSid advertising SID of the Broadcast Source with which Broadcast Sink is
     *     synchronized
     * @param numSubGroups number of subgroups within the BIG
    ...
    /**
     * Get the BIS indices (channels) the Broadcast Sink is synchronized with
     *
