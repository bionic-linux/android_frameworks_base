...
public final class BluetoothCsisClient implements BluetoothProfile, AutoCloseable {
     ...
     */
    public static final String EXTRA_CSIS_GROUP_ID =
            "android.bluetooth.extra.CSIS_GROUP_ID";
    ...
    /**
     * Intent used to broadcast group lock status
     *
     * <p>This intent will have 3 extra:
     * <ul>
     * <li> {@link BluetoothDevice#EXTRA_DEVICE} - The remote device. It can
     * be null if no device is active. </li>
     * <li> {@link #EXTRA_CSIS_GROUP_LOCK_STATE} - true when locked, false otherwise </li>
     * <li> {@link #EXTRA_CSIS_GROUP_LOCK_OP_STATUS} - lock status of the lock operation  </li>
     * </ul>
     *
     * <p>Requires {@link android.Manifest.permission#BLUETOOTH} permission to
     * receive.
     ...
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_CSIS_GROUP_LOCK_CHANGED =
            "android.bluetooth.action.CSIS_GROUP_LOCK_CHANGED";

    /**
     * Group lock state used as a bool extra field in {@link #ACTION_CSIS_GROUP_LOCK_CHANGED} intent.
     * @hide
     */
    public static final String EXTRA_CSIS_GROUP_LOCK_STATE =
            "android.bluetooth.extra.CSIS_GROUP_LOCK_STATE";
    ...
    /**
     * Group lock operation status used as an int extra field in
     *  {@link #ACTION_CSIS_GROUP_LOCK_CHANGED} intent, can be any of
     *
     *  <p>
     *  <ul>
     *  <li> {@link #GROUP_LOCK_SUCCESS} </li>
     *  <li> {@link #GROUP_LOCK_FAILED_INVALID_GROUP} </li>
     *  <li> {@link #GROUP_LOCK_FAILED_GROUP_EMPTY} </li>
     *  <li> {@link #GROUP_LOCK_FAILED_GROUP_NOT_CONNECTED} </li>
     *  <li> {@link #GROUP_LOCK_FAILED_LOCKED_BY_OTHER} </li>
     *  <li> {@link #GROUP_LOCK_FAILED_OTHER_REASON} </li>
     *  </ul>
     *  <p>
     * @hide
     */
    public static final String EXTRA_CSIS_GROUP_LOCK_OP_STATUS =
            "android.bluetooth.extra.CSIS_GROUP_LOCK_OP_STATUS";

    private BluetoothAdapter mAdapter;
    private final BluetoothProfileConnector<IBluetoothCsisClient> mProfileConnector =
            new BluetoothProfileConnector(this, BluetoothProfile.CSIS_CLIENT,
                    TAG, IBluetoothCsisClient.class.getName()) {
                @Override
    ...
    private IBluetoothCsisClient getService() {
    ...
    /**
     * Lock or unlock the set.
     * @param group_id group ID to destroy
     * @param lock whether to lock or unlock the set
    ...
    public boolean groupLockSet(int group_id, boolean lock) {
        ...
        try {
            if (service != null && isEnabled()) {
                service.groupLockSet(group_id, lock);
                return true;
            }
            if (service == null) Log.w(TAG, "Proxy not attached to service");
            return false;
