...
public final class BluetoothGatt implements BluetoothProfile {
     ...
     *
     * @throws IllegalArgumentException when no BLUETOOTH_PERM permission.
     * @hide
     */
    public boolean requestLeConnectionParameters(int minConnectionInterval,
                                                 int maxConnectionInterval,
                                                 int slaveLatency, int supervisionTimeout) {
        if (DBG) {
            Log.d(TAG, "requestLeConnectionParameters() - min=(" + minConnectionInterval
        ...
        try {
            mService.leConnectionRawParametersUpdate(mClientIf, mDevice.getAddress(),
