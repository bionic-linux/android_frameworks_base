...
/**
 * Represents the LE Properties of the LE Connection to remote device. 
 ...
 */
public class BluetoothLeProperties {
    ...
    /*package*/ BluetoothLeProperties(BluetoothDevice device) {
        //TODO: Implementation
    }
     ...
     * data throughput behavior. The BluetoothLePropertiesCallback#onConnectionParamUpdated will be 
    ...
    /**
     * To suggest to the Bluetooth Controller to optimize the LE connection based on the desired
     * link latency behavior. The BluetoothLePropertiesCallback#onConnectionParamUpdated will be 
     * triggered the result of this call.
     */
    ...
    /**
     * To suggest to the Bluetooth Controller to optimize the LE connection based on the desired
     * power usage behavior. The BluetoothLePropertiesCallback#onConnectionParamUpdated will be 
     * triggered the result of this call.
     */
     ...
     * increase efficiency. The callback {@link BluetoothLePropertiesCallback#onMtuChanged} will be 
    ...
    /**
     * The callback {@link BluetoothLePropertiesCallback#onPhyUpdate} will be triggered as a result
     * of this call. 
     * 
     */
     ...
     * in {@link BluetoothLePropertiesCallback#onPhyRead}
     */
    public void readPhy() {
        //TODO: Implementation
    }
