...
public class BluetoothGattService implements Parcelable {
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        BluetoothGattIncludedService[] includedServices =
            new BluetoothGattIncludedService[mIncludedServices.size()];
        int i = 0;
    ...
    private BluetoothGattService(Parcel in) {
        ...
        BluetoothGattCharacteristic[] chrcs =
            in.createTypedArray(BluetoothGattCharacteristic.CREATOR);
        if (chrcs != null) {
        ...
        BluetoothGattIncludedService[] inclSvcs =
            in.createTypedArray(BluetoothGattIncludedService.CREATOR);
        if (chrcs != null) {
