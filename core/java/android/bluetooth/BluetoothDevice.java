...
public final class BluetoothDevice implements Parcelable {
    ...
    /**
     * To set a string metadata with defined key into Bluetooth storage.
    ...
    */
    ...
    public boolean setMetadata(int key, String value) {
        final IBluetooth service = sService;
        if (service == null) {
            Log.e(TAG, "BT not enabled. Cannot set metadata");
            return false;
        }
    ...
    public String getMetaData(int key) {
        final IBluetooth service = sService;
        if (service == null) {
            Log.e(TAG, "BT not enabled. Cannot get metadata");
            return null;
        }
        try {
