...
public class WebViewZygote {
    ...
    private static void connectToZygoteIfNeeded() {
        ...
        try {
            ...
            // The zygote can't talk to PackageManager or construct a LoadedApk since it's
            // single-threaded pre-fork, so doesn't have an ActivityThread and can't use Binder.
