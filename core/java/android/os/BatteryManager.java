...
public class BatteryManager {
    ...
    public static final int CHARGING_POLICY_ADAPTIVE_AON = OsProtoEnums.CHARGING_POLICY_ADAPTIVE_AON; // = 2
    public static final int CHARGING_POLICY_ADAPTIVE_AC = OsProtoEnums.CHARGING_POLICY_ADAPTIVE_AC; // = 3
    public static final int CHARGING_POLICY_ADAPTIVE_LONGLIFE = OsProtoEnums.CHARGING_POLICY_ADAPTIVE_LONGLIFE; // = 4
