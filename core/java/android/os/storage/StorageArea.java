 ...
 * closed area, {@link #openStorageArea} needs to be invoked.
 *
 * Users can delete storage areas using {@link #deleteStorageArea}.
 */
@FlaggedApi(Flags.FLAG_UNLOCKED_STORAGE_API)
public class StorageArea implements AutoCloseable {
     ...
     * If this method throws an {@link IOException}, this represents the error state of trying to close
     * a storage area that still has open files.
     *
     * If other {@link StorageArea} instances exist for the same storage area, then this method only
