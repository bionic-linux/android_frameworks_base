...
public class UpdateEngine {
     ...
     */
    public void applyPayload(@NonNull AssetFileDescriptor afd,
            @NonNull String[] headerKeyValuePairs) {
        try {
            mUpdateEngine.applyPayloadFd(afd.getParcelFileDescriptor(), afd.getStartOffset(),
                    afd.getLength(), headerKeyValuePairs);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
