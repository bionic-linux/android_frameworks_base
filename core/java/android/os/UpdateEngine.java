...
public class UpdateEngine {
    ...
    /**
     * Applies the payload passed as AssetFileDescriptor {@code afd} instead of
     ...
     */
    public void applyPayload(@NonNull AssetFileDescriptor afd, long offset, long size,
            @NonNull String[] headerKeyValuePairs) {
        try {
            mUpdateEngine.applyPayloadFd(
                    afd.getParcelFileDescriptor(), offset, size, headerKeyValuePairs);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
