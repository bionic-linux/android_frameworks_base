...
public class AndroidOnTapManager {
     ...
     * Status codes
     */
    /** We are bound to AOT installation service, but failed to get its status */
    ...
    private class AndroidOnTapServiceConnection implements ServiceConnection {
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            try {
                ...
                Slog.e(TAG, "Unable to get status from AOT installation service");
    ...
    public void unbind() {
        ...
        if (mService != null) {
            try {
                ...
                Slog.e(TAG, "Unable to unregister from AOT installation service");
            }
        }
