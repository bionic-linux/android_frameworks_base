...
public final class BatteryStatsManager {
     ...
     *
     * @param networkType Connection type.
     ...
     * @param networkType The type of the network. As defined in ConnectivityManager.TYPE_*
     */
    @RequiresPermission(android.Manifest.permission.UPDATE_DEVICE_STATS)
    public void reportNetworkInterfaceType(@NonNull String iface,
            @LegacyNetworkType int networkType) {
        try {
