...
public class Binder implements IBinder {
    ...
    */
    ...
    public final @Nullable String getTransactionTraceName(int transactionCode) {
        final boolean isInterfaceAutoGenerated = getMaxTransactionId() == 0;
        if (mTransactionTraceNames == null) {
            final int highestId = isInterfaceAutoGenerated ? TRANSACTION_TRACE_NAME_ID_LIMIT
        ...
        final int index = isInterfaceAutoGenerated
