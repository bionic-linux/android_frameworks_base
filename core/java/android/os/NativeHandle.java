...
public final class NativeHandle {
    ...
    /**
     * Constructs a {@link NativeHandle} instance containing the given
    ...
    /**
     * Convenience method for instantiating a {@link NativeHandle} from native code.
     * The constructed object does not assume ownership of the file descriptors or
