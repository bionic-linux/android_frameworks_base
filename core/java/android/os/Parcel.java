...
public final class Parcel {
     ...
     */
    public final void writeFileDescriptorArray(FileDescriptor[] value) {
        if (value != null) {
            int N = value.length;
            writeInt(N);
            for (int i=0; i<N; i++) {
                writeFileDescriptor(value[i]);
            }
        } else {
            writeInt(-1);
        }
     ...
     **/
    public final FileDescriptor[] createFileDescriptorArray() {
        int N = readInt();
        if (N < 0) {
            return null;
        }
     ...
     * @return the FileDescriptor array, or null if the array is null.
     **/
    public final void readFileDescriptorArray(FileDescriptor[] val) {
        int N = readInt();
        if (N == val.length) {
            for (int i=0; i<N; i++) {
