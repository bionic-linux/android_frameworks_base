...
public class TelephonyRegistryManager {
    ...
    private final Map<SignalStrengthsUpdateRequest, IBinder> mSignalStrengthsRequestMap =
            new HashMap<>();
     ...
     * @param request
     */
    public void addSignalStrengthsUpdateRequest(SignalStrengthsUpdateRequest request) {
        ...
        try {
            ...
            sRegistry.addSignalStrengthsUpdateRequest(mContext.getOpPackageName(), request, token);
    ...
    public void removeSignalStrengthsUpdateRequest(SignalStrengthsUpdateRequest request) {
        ...
        try {
            sRegistry.removeSignalStrengthsUpdateRequest(request, token);
