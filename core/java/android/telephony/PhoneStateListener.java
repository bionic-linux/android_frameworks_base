...
public class PhoneStateListener {
     ...
     * even in some situations such as the screen of the device is off. The apps who listen to
     * the signal strengths via {@link LISTEN_SIGNAL_STRENGTHS} will get always-reported signal
     * strength changes via {@link #onSignalStrengthsChanged}.
     *
     * @hide
     */
