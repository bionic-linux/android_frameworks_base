...
public final class SEService {
    ...
    /**
      * Indicates that the state change was due to the secure element is initialized successfully
      */
    public static final String STATE_CHANGED_REASON_INITIALIZED = "Initialized";

    /**
      * Indicates that the state change was due to the secure element is initialized unsuccessfully.
      */
