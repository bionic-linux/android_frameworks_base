...
public class SEService {
    ...
    ISecureElementCallback getCallback() {
        return mCallback;
    }
     ...
     */
    private ISecureElementReader getReader(String name) throws IOException {
        try {
            ISecureElementReader reader = mSecureElementService.getReader(name);
            return reader;
        } catch (RemoteException e) {
