...
/**
 * This application's network security configuration.
 *
 * <p>{@link #getConfigForHostname(String)} provides a means to obtain network security configuration
 * to be used for communicating with a specific hostname.</p>
 *
 * TODO: Move this into the already existing NetworkSecurityPolicy once the interaction with
 * libcore is figured out.
 * @hide
 */
public final class ApplicationConfig {
    ...
    private void ensureInitialized() {
        synchronized(mLock) {
            ...
            mInitialized = true;
            mConfigSource = null;
            mTrustManager = new RootTrustManagerImpl(this);
        }
    }
}
