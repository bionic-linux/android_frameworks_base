 ...
 *
 * <p>This {@code X509TrustManager} just delegates to the specific trust manager for the hostname
 * being used for the connection (See {@link ApplicationConfig#getConfigForHostname(String)} and
 * {@link NetworkSecurityTrustManagerImpl}).</p>
 *
 ...
 * non-aware call.
 * @hide */
public class RootTrustManagerImpl implements X509TrustManager {
    private final ApplicationConfig mConfig;
    public RootTrustManagerImpl(ApplicationConfig config) {
        mConfig = config;
    }
