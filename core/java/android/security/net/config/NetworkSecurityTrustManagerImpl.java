 ...
 * @hide
 */
public class NetworkSecurityTrustManagerImpl implements X509TrustManager {
    ...
    public NetworkSecurityTrustManagerImpl(NetworkSecurityConfig config) {
    ...
    public void checkServerTrusted(X509Certificate[] certs, String authType)
            throws CertificateException {
        List<X509Certificate> trustedChain = mDelegate.checkServerTrusted(certs, authType,
                (String) null);
    ...
    private void checkPins(List<X509Certificate> chain) throws CertificateException {
        ...
        if (pinSet.pins.isEmpty()
                || pinSet.expirationTime < System.currentTimeMillis()
