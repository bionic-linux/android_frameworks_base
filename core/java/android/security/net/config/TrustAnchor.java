...
public final class TrustAnchor {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TrustAnchor)) {
            return false;
        }
        TrustAnchor otherAnchor = (TrustAnchor) other;
        return overridesPins == otherAnchor.overridesPins
                && certificate.equals(otherAnchor.certificate);
    }
}
