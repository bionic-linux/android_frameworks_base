...
public class KeyCharacteristics implements Parcelable {
    public List<KeymasterArgument> swEnforced;
    public List<KeymasterArgument> hwEnforced;
    ...
    public void writeToParcel(Parcel out, int flags) {
        out.writeTypedList(swEnforced);
        out.writeTypedList(hwEnforced);
    }

    public void readFromParcel(Parcel in) {
        swEnforced = in.createTypedArrayList(KeymasterArgument.CREATOR);
        hwEnforced = in.createTypedArrayList(KeymasterArgument.CREATOR);
    }
}
