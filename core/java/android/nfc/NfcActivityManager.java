...
public final class NfcActivityManager extends IAppCallback.Stub
    ...
    class NfcActivityState {
        ...
        NfcDtaPatternNumber mDtaPatternNo = new NfcDtaPatternNumber();
    ...
    public boolean setDtaPatternNo(Activity activity, NfcDtaPatternNumber dtaPatternNo,
            SetDtaPatternNoCompleteCallback setCompleteCallback) {
        boolean isResumed;
        Binder token;
        if (dtaPatternNo.getValue() == NfcDtaPatternNumber.PN_ERR) {
            return false;
        }
    ...
    public boolean updatePatternNo(Binder token, NfcDtaPatternNumber patternNo) {
        if (DBG) Log.d(TAG, "Setting pattern number");
        try {
            return NfcAdapter.sService.setDtaPatternNo(token, this, patternNo.getValue());
    ...
    public void onActivityResumed(Activity activity) {
        int readerModeFlags = 0;
        NfcDtaPatternNumber dtaPatternNo = new NfcDtaPatternNumber();
        Bundle readerModeExtras = null;
        Binder token;
        synchronized (NfcActivityManager.this) {
            NfcActivityState state = findActivityState(activity);
        ...
        if (dtaPatternNo.getValue() != NfcDtaPatternNumber.PN_NONE) {
    ...
    public void onActivityPaused(Activity activity) {
        ...
        synchronized (NfcActivityManager.this) {
            ...
            dtaPatternNoSet = state.mDtaPatternNo.getValue() != NfcDtaPatternNumber.PN_NONE;
        }
        ...
        if (dtaPatternNoSet) {
            // Unset pattern number settings to default value
            updatePatternNo(token, new NfcDtaPatternNumber());
        }
    }
