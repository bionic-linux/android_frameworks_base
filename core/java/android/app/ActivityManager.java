...
public class ActivityManager {
    ...
    public static class MemoryInfo implements Parcelable {
         ...
         * environment. This value might be different from {@code totalMem}.
         * This could be due to many reasons. For example, the ODM could reserve part of the memory
         * for the Trusted Execution Environment (TEE) which the kernel doesn't have access or
         * knowledge about it.
         */
