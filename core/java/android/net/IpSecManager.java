        ...
        private SecurityParameterIndex(
            ...
            try {
                ...
                switch (status) {
                    ...
                    default:
                        Log.wtf(TAG, "Unknown status returned by IpSecService: " + status);
                        break;
                }
                ...
                if (mSpi == INVALID_SECURITY_PARAMETER_INDEX) {
                    // TODO: This should never happen, throw unchecked exception?
                    Log.wtf(TAG, "SPI Request Returned INVALID SPI!");
                }

                if (mResourceId == INVALID_RESOURCE_ID) {
                    // TODO: This should never happen, throw unchecked exception?
                    Log.wtf(TAG, "SPI Request Returned INVALID Resource ID!");
                }
