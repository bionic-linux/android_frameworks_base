...
public class ConnectivityManager {
   ...
   /**
    ...
    public void requestNetwork(@NonNull NetworkRequest request,
        ...
        CallbackHandler cbHandler = new CallbackHandler(handler);
        requestNetwork(request, 0, legacyType, cbHandler, networkCallback);
    }
    ...
    public void requestNetwork(@NonNull NetworkRequest request,
        ...
        int legacyType = inferLegacyTypeForNetworkCapabilities(request.networkCapabilities);
        requestNetwork(request, timeoutMs, legacyType, getDefaultHandler(), networkCallback);
    }
    ...
    public void requestNetwork(@NonNull NetworkRequest request,
        ...
        int legacyType = inferLegacyTypeForNetworkCapabilities(request.networkCapabilities);
        CallbackHandler cbHandler = new CallbackHandler(handler);
        requestNetwork(request, timeoutMs, legacyType, cbHandler, networkCallback);
    }
