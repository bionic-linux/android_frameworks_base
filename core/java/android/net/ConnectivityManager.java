...
public class ConnectivityManager {
    ...
    /**
     * A Mobile data connection. Some devices support more than one.
     *
     * @deprecated Applications should instead use {@link NetworkCapabilities#hasTransport} or
     *         {@link #requestNetwork(NetworkRequest, NetworkCallback)} to request a network
     *         with this type. {@see NetworkCapabilities} for supported transports.
     */
    @Deprecated
    public static final int TYPE_MOBILE      = 0;

    /**
     * A WIFI data connection. Some devices support more than one.
     *
     * @deprecated Applications should instead use {@link NetworkCapabilities#hasTransport} or
     *         {@link #requestNetwork(NetworkRequest, NetworkCallback)} to request a network
     *         with this type. {@see NetworkCapabilities} for supported transports.
     ...
     * @deprecated Applications should instead use {@link NetworkCapabilities#TRANSPORT_VPN}
     *         instead.
     */
    @Deprecated
