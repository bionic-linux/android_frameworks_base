...
public final class TcpRepairWindow {
    ...
    // Note : as a departure from the contents of the C sturcture, this is already scaled by the
    // window scale found in tcpinfo.
     ...
     */
    public TcpRepairWindow(int snd_wl1, int snd_wnd, int max_window, int rcv_wnd, int rcv_wup) {
