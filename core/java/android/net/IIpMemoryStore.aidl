...
oneway interface IIpMemoryStore {
     ...
     */
    void storeNetworkAttributes(String l2Key, in NetworkAttributesParceled attributes,
     ...
     */
    void findL2Key(in NetworkAttributesParceled attributes, IOnL2KeyResponseListener listener);
