...
public class NetworkTemplate implements Parcelable {
     ...
     */
    public static final int SUBSCRIBER_ID_MATCH_RULE_FULL = 0;
    /**
    ...
    /**
     * Network ID is never supposed to be null (if it is, it is a bug that
     ...
     */
    public static final String NETWORKID_ALL = null;
    ...
    public static NetworkTemplate buildTemplateWifi(@NonNull String networkId) {
        ...
        return new NetworkTemplate(MATCH_WIFI, null, new String[] { null },
     ...
     * and IMSI.
     *
     * Call with {@link #NETWORKID_ALL} for {@code networkId} to get result regardless of SSID.
     */
    ...
    public String toString() {
        ...
        builder.append(", subscriberIdMatchRule=").append(mSubscriberIdMatchRule);
    ...
    /**
     * Check if network with matching IMSI. Returns true when {@code mSubscriberIdMatchRule}
     * is {@code SUBSCRIBER_ID_MATCH_RULE_ALL}.
     */
    ...
    /**
     * Check if network with matching SSID. Returns true when {@code mNetworkId}
     * is {@code NETWORKID_ALL}.
     */
    public boolean matchesNetworkId(@Nullable String networkId) {
        return Objects.equals(mNetworkId, NETWORKID_ALL)
