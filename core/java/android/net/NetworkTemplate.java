...
public class NetworkTemplate implements Parcelable {
    ...
    private boolean isValidSubscriberIdMatchRule() {
        switch (mMatchRule) {
            case MATCH_MOBILE:
            case MATCH_CARRIER:
                // Mobile and Carrier don't allow to match all subscriber ID.
    ...
    public NetworkTemplate(int matchRule, String subscriberId, String[] matchSubscriberIds,
        ...
        if (!isValidSubscriberIdMatchRule()) {
            throw new IllegalArgumentException("Invalid SubscriberIdMatchRule in match rule: "
