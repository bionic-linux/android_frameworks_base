...
public class NetworkTemplate implements Parcelable {
    ...
    public NetworkTemplate(int matchRule, String subscriberId, String[] matchSubscriberIds,
            String networkId) {
        // In matchesMobile and matchesMobileWildcard methods, originally hard code to match
        // metered network  Thus, when build a template with MATCH_MOBILE or MATCH_MOBILE_WILDCARD,
        // meteredness will be ignored. In current design, hard code to match metered network
        // is removed from the methods so constructor should keep the same behavior.
