...
public class NetworkTemplate implements Parcelable {
     ...
     * and IMSI.
     *
     * Call with null {@code networkId} to get result regardless of SSID.
     */
    ...
    public NetworkTemplate(int matchRule, String subscriberId, String[] matchSubscriberIds,
        ...
        this(matchRule, subscriberId, matchSubscriberIds, networkId, metered, roaming,
                defaultNetwork, subType, SUBSCRIBER_ID_MATCH_RULE_FULL);
    }
    ...
    public int hashCode() {
        return Objects.hash(mMatchRule, mSubscriberId, mNetworkId, mMetered, mRoaming,
                mDefaultNetwork, mSubType, mSubscriberIdMatchRule);
    }
    ...
    /**
     * Check if network with matching SSID.
     */
