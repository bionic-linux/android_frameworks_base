...
public final class Ikev2VpnProfile extends PlatformVpnProfile {
    ...
    private Ikev2VpnProfile(
        ...
        mAllowedAlgorithms = new ArrayList<>(allowedAlgorithms);
    ...
    public byte[] getPresharedKey() {
        return Arrays.copyOf(mPresharedKey, mPresharedKey.length);
    }
    ...
    public static final class Builder {
         ...
         * @param serverAddr the server that the VPN should connect to. The address will be parsed
