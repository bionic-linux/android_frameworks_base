...
public class VpnManager {
    /**
     * Use IConnectivityManager since these methods are hidden and not available in
     * ConnectivityManager.
     */
     ...
     *
     * @param profile the VpnProfile provided by this package. May be null to remove any previous
     *     profile provisioned by this package. Will override any previous VpnProfile stored for
     *     this package.
    ...
    public static class Ikev2VpnProfileBuilder {
         ...
         * @return this {@link Ikev2VpnProfileBuilder} object to facilitate chaining of method
         *     calls.
         */
        @NonNull
         ...
         *
         * @return a VpnProfile instance representing the current state of the {@link
         *     Ikev2VpnProfileBuilder}
         */
        @NonNull
