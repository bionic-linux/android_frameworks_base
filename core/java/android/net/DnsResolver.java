...
public final class DnsResolver {
    ...
    public static final int ERROR_INTERRUPT = 3;
     ...
     *
     * If at least one query succeeded, rcode will be 0
     *
     * The answer will be provided asynchronously through the provided {@link Callback}.
     *
     * @param network {@link Network} specifying which network to query on.
    ...
    public void query(@Nullable Network network, @NonNull String domain, @QueryFlag int flags,
        ...
        try {
            ...
            executor.execute(() -> callback.onError(new DnsException(ERROR_INTERRUPT, ex)));
            return;
        }
                    ...
                    executor.execute(() -> {
                        synchronized (lock) {
                            ...
                            try {
                                ...
                                answerCallback.onError(new DnsException(ERROR_SYSTEM, e));
                                return;
                            }
