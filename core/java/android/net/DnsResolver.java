...
public final class DnsResolver {
     ...
     * @param flags flags DNS query flags
    ...
    public void query(Network network, String domain, @QueryFlag int flags,
        ...
        InetAddressAnswerAccumulator accmulator = new InetAddressAnswerAccumulator(2, callback);
    ...
    private void registerFDListener(MessageQueue queue, FileDescriptor queryfd,
            InetAddressAnswerAccumulator accmulator) {
        queue.addOnFileDescriptorEventListener(
                queryfd,
                FD_EVENTS,
                (fd, events) -> {
    ...
    private List<InetAddress> parseAnswers(byte[] data) {
        try {
            return new DnsAddressAnswer(data).getAddresses();
    ...
    private class InetAddressAnswerAccumulator {
        private List<InetAddress> mAllAnswers;
        private final InetAddressAnswer mAnswerCB;
        private final int mTargetAnswerCount;
        private int mReceivedAnswerCount = 0;

        public InetAddressAnswerAccumulator(int size, InetAddressAnswer answer) {
            mTargetAnswerCount = size;
            mAllAnswers = new ArrayList<>();
            mAnswerCB = answer;
        }

        public void accumulate(List<InetAddress> answer) {
