...
public class NetworkUtils {
    ...
    public native static int addRoute(String interfaceName, String addr, int prefixLength);
     ...
     * @param address the IP address of the host/gateway to which the route is desired,
     ...
     */
    public static boolean addRoute(String interfaceName, InetAddress address, int prefixLength) {
        String addressString = address.getHostAddress();
        return addRoute(interfaceName, addressString, prefixLength) == 0;
    }
