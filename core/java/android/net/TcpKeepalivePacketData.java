...
public class TcpKeepalivePacketData extends KeepalivePacketData implements Parcelable {
    ...
    public TcpKeepalivePacketData(InetAddress srcAddress, int srcPort, InetAddress dstAddress,
        ...
        // TODO consider sequence number overflow problem
    ...
    public static byte[] buildV4Packet(InetAddress srcAddress,
    ...
    public static byte[] buildV6Packet(InetAddress srcAddress,
            int srcPort, InetAddress dstAddress, int dstPort, int sequence, int ack) {
        ...
        int tcpChecksumOffset = buf.position();
        buf.putShort((short) 0);                  // TCP checksum
        buf.putShort(tcpChecksumOffset, IpUtils.tcpChecksum(buf, 0, IPV6_HEADER_LENGTH, TCP_HEADER_LENGTH));
