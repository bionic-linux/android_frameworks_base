...
public final class QosSocketInfo implements Parcelable {
    ...
    private InetSocketAddress readSocketAddress(Parcel in, int addressLength) {
    ...
    public void writeToParcel(@NonNull final Parcel dest, final int flags) {
        ...
        if (mLocalSocketAddress != null) {
            byte[] address = mLocalSocketAddress.getAddress().getAddress();
