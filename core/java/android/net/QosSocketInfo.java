...
public final class QosSocketInfo implements Parcelable {
    ...
    private InetSocketAddress readSocketAddress(final Parcel in, final int addressLength) {
        ...
        try {
            ...
            /* Nothing we can do here since we already checked that the address
               was not null and numeric ahead of time. */
        }
    ...
    /**
     * Thrown when an event is being delivered to {@link QosCallback} and the local address
