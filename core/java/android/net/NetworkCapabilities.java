...
public final class NetworkCapabilities implements Parcelable {
     ...
     * its lifecycle. This could be the UID of apps such as the Wifi network suggestor, the
     ...
     * know where the device are if they can tell for sure the system has connected to the network
     * they requested.
     *
     * <p>When a NetworkCapabilities instance is sent by an app to the System Server, the value MUST
     * be reset to Process.INVALID_UID by the system serve.
     */
