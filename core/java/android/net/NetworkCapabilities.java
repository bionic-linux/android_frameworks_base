...
public final class NetworkCapabilities implements Parcelable {
     ...
     * this network. To avoid apps being able to set this to whatever they want, this field is
     * not be able to parcelled from user apps.
     *
     */
    ...
    /**
     * Returns whether the caller is the owner of the network or not. Please note that, when the
     * caller does not have the permission to get the owner's UID or the platform does not have the
     * information of the owner's UID, {@code false} will be returned (see {@link #mOwnerUid}).
     */
    public boolean isNetworkOwner() {
        return Binder.getCallingUid() == mOwnerUid;
    }
