...
/**
 * APF stands for Android Packet Filtering and it it a flexible way to drop unwanted network packets
 * to save power. Some documentation is at hardware/google/apf/apf.h
 *
 * This class represents an APF program support capabilities.
 *
