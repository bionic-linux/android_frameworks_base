...
public interface EncryptedTunnelParams {
    /** @hide */
    String PARAMS_TYPE_KEY = "PARAMS_TYPE_KEY";
    /** @hide */
    String PARAMS_KEY = "PARAMS_KEY";

    /** @hide */
    int PARAMS_TYPE_IKE = 1;

    /** @hide */
    PersistableBundle toPersistableBundle(@NonNull EncryptedTunnelParams params) {
    ...
    /** @hide */
    EncryptedTunnelParams fromPersistableBundle(@NonNull PersistableBundle in) {
    ...
    /** @hide */
    final class IkeTunnelParamsUtils {
        static final String IKE_PARAMS_KEY = "IKE_PARAMS_KEY";
        static final String CHILD_PARAMS_KEY = "CHILD_PARAMS_KEY";

        static PersistableBundle serializeIkeParams(IkeTunnelParams ikeParams) {
            final PersistableBundle result = new PersistableBundle();
        ...
        static IkeTunnelParams deserializeIkeParams(@NonNull PersistableBundle in) {
