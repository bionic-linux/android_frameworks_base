...
public class NetworkIdentity implements Comparable<NetworkIdentity> {
    ...
    public static NetworkIdentity buildNetworkIdentity(Context context,
        ...
        return buildNetworkIdentity(context, new NetworkStateSnapshot(state), defaultNetwork,
                subType);
    }
    ...
    public static NetworkIdentity buildNetworkIdentity(Context context,
        ...
        final int legacyType = snapshot.legacyNetworkType;
        ...
        subscriberId = snapshot.networkCapabilities.getSubscriberId();
