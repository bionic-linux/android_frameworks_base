...
public final class RouteInfo implements Parcelable {
    ...
    public void dump(ProtoOutputStream proto) {
        ...
        if (mDestination != null) {
            proto.write(RouteInfoProto.DESTINATION, mDestination.toString());
        }
        if (mGateway != null) {
            proto.write(RouteInfoProto.GATEWAY, mGateway.toString());
        }
        if (mInterface != null) {
            proto.write(RouteInfoProto.INTERFACE, mInterface);
        }
    }
