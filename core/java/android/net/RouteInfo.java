...
public final class RouteInfo implements Parcelable {
    ...
    /**
     * A helper object that contains the destination and the gateway in a {@code RouteInfo},
     * used by {@link LinkPropertiesUtils#CompareOrUpdateResult} or
     * {@link LinkProperties#addRoute} to calculate the list to be updated.
     *
     * @hide
     */
    public class RouteKey extends Pair<IpPrefix, InetAddress> {
