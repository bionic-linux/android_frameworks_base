...
public class NetworkRequest implements Parcelable {
     ...
     *
     *     - TRACK_SYSTEM_DEFAULT, which causes the framework to callbacks for
     *       the single, highest scoring current network (if any) that matches
     *       the capabilities of the default Internet request (mDefaultRequest),
     *       but which cannot cause the framework to either create or retain the
     *       existence of any specific network.
     *
