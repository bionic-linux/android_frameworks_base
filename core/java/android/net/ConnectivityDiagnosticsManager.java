...
public class ConnectivityDiagnosticsManager {
    ...
    public abstract static class ConnectivityDiagnosticsCallback {
        ...
        /** @hide */
        @VisibleForTesting public ConnectivityDiagnosticsBinder mBinder;
        ...
        /** @hide */
        @VisibleForTesting
        public void setBinder(ConnectivityDiagnosticsBinder binder) {
            synchronized (this) {
                mBinder = binder;
            }
        }
        ...
        public class ConnectivityDiagnosticsBinder extends IConnectivityDiagnosticsCallback.Stub {
            ...
            public void onNetworkConnectivityReported(
                ...
                Binder.withCleanCallingIdentity(() -> {
                    mExecutor.execute(() -> {
                        ConnectivityDiagnosticsCallback.this
                                .onNetworkConnectivityReported(network, hasConnectivity);
                    });
                });
            }
        }
    ...
    public void registerConnectivityDiagnosticsCallback(
        ...
        synchronized (callback) {
            ...
            callback.setBinder(callback.new ConnectivityDiagnosticsBinder());
        }
     ...
     * a no-op.
     *
     * <p>Callbacks cannot be reused after they are unregistered with the System.
     *
    ...
    public void unregisterConnectivityDiagnosticsCallback(
        ...
        synchronized (callback) {
            if (callback.mExecutor == null) {
                // If executor is already null, it is not currently registered with the system.
                // There is no need to call into ConnectivityService to ensure it is unregistered.
                return;
            }
        }
