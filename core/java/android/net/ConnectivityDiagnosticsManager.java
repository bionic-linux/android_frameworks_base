...
public class ConnectivityDiagnosticsManager {
     ...
     *
     * <p>Each register() call <b>MUST</b> use an unregistered ConnectivityDiagnosticsCallback
     * instance. If a ConnectivityDiagnosticsCallback instance is registered with multiple
     * NetworkRequests, an IllegalArgumentException will be thrown.
     *
