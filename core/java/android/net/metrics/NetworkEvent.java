...
/**
 * {@hide}
 * @deprecated This API is deprecated. The event may not be sent in Android
 * S and above. The events are logged by a single caller in the system using
 * signature permissions and that caller is migrated to statsd.
 */
@Deprecated
@SystemApi
