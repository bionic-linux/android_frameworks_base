...
public abstract class AbstractNetworkStatsProvider {
     ...
     * {@link NetworkStatsProviderCallback#onStatsUpdated} within 1  minute, a late response might
     * cause the system failed to record the given statistics, and results in data lost.
     *
     * @param token a positive number that used by the system to associate with
     *              {@link NetworkStatsParcelableWrapper}. Note that custom implementation of
     *              providers MUST report locally stored token with current
     *              {@link NetworkStatsParcelableWrapper} via
