...
public class NetworkStatsProviderCallback {
     ...
     * reflect the update.
     *
     * @param token the latest token sent by the system in {@code #requestStatsUpdate()}. It is fine
     *              to send multiple updates with the same token until the system calls
     *              {@code #requestStatsUpdate()} with a new token.
