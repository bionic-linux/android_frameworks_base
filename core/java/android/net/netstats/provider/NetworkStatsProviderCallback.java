...
public class NetworkStatsProviderCallback {
     ...
     * @param ifaceStats the {@link NetworkStatsParcelableWrapper} per interface to be reported.
     *                   The provider should not include any traffic that is already counted by
     *                   kernel interface counters.
     * @param uidStats the same stats as above, but counts {@link NetworkStatsParcelableWrapper}
     *                 per uid.
     */
    public void onStatsUpdated(int token, @NonNull NetworkStatsParcelableWrapper ifaceStats,
            @NonNull NetworkStatsParcelableWrapper uidStats) {
        try {
            mBinder.onStatsUpdated(token, ifaceStats.toParcelable(), uidStats.toParcelable());
