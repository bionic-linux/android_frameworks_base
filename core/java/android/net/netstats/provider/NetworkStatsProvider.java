...
public abstract class NetworkStatsProvider {
    ...
    /**
     * Store the binder that given by the service when successfully registering. Note that the
     * provider cannot be re-registered. Hence this method can only be called once per provider.
     *
     * @hide
     */
    ...
    /**
     * Get the binder that given by the service when successfully registering. Or null if the
    ...
    /**
     * Get the binder that given by the service when successfully registering. Throw an
     ...
     *
     * Send the network statistics recorded since the last call to {@link #notifyStatsUpdated}.
     * Must be called within one minute of {@link NetworkStatsProvider#onRequestStatsUpdate(int)}
     ...
     * {@link NetworkStatsProvider#notifyStatsUpdated} within one minute. Responding
