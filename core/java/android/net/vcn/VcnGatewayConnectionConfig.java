...
public final class VcnGatewayConnectionConfig {
    ...
    /** Retrieves the meteredness of the Gateway Connection. */
    public boolean isMetered() {
        return mIsMetered;
    }

    /** Retrieves the roaming state of the Gateway Connection. */
    ...
    public static class Builder {
        ...
        // TODO: Consider VCN-exposed capabilities that may be transport dependent. Consider the
        //       case where the VCN might only expose MMS on WiFi, but defer to MMS when on Cell.
        ...
        /**
         * Sets whether this VCN Gateway Connection should be considered metered.
         *
         * @param isMetered whether or not this Gateway Connection should have the {@link
        ...
        /**
         * Sets whether this VCN Gateway Connection should be considered roaming.
         *
         * @param isRoaming whether or not this Gateway Connection should have the {@link
