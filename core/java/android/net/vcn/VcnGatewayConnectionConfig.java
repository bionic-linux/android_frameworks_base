...
public final class VcnGatewayConnectionConfig {
    ...
    @IntDef(
            ...
            value = {
                // TODO: b/261499808 Add VCN_GATEWAY_OPTION_RECOVER_FROM_DATA_STALL_WITH_MOBIKE when
                // it is exposed
            })
    ...
    public VcnGatewayConnectionConfig(@NonNull PersistableBundle in) {
        ...
        if (gatewayOptionsBundle == null) {
            // GATEWAY_OPTIONS_KEY was added in Android U. Thus
            // VcnGatewayConnectionConfig created on old platforms will not have this data and will
            // be assigned with the default value
    ...
    /** @hide */
    public Set<Integer> getGatewayOptions() {
        return mGatewayOptions;
    }
    ...
    public String toString() {
        return " mGatewayOptions " + mGatewayOptions;
    }
