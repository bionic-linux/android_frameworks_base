...
public final class VcnGatewayConnectionConfig {
    ...
    private int[] setToIntArray(Set<Integer> set) {
        final int[] arr = new int[set.size()];
    ...
    public int[] getExposedCapabilities() {
        final int[] result = ArrayUtils.convertToIntArray(new ArrayList<>(mExposedCapabilities));
        Arrays.sort(result);
        return result;
    }
    ...
    public int[] getRequiredUnderlyingCapabilities() {
        final int[] result = ArrayUtils.convertToIntArray(new ArrayList<>(mUnderlyingCapabilities));
        Arrays.sort(result);
        return result;
    }
