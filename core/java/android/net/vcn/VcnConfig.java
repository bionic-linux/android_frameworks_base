...
public final class VcnConfig implements Parcelable {
    ...
    public static final class Builder {
        ...
        /**
         * Sets transports that should be restricted by VCN.
         *
         * @param transports transports that need to be restricted by VCN. Networks that include
         *     any of the transports will be marked restricted. Only {@link TRANSPORT_WIFI} and
         *     {@link TRANSPORT_CELLULAR} are allowed. {@link TRANSPORT_WIFI} is marked
         *     restricted by default.
         * @return this {@link Builder} instance, for chaining
         * @throws IllegalArgumentException if the input is null or contains unsupported
         *     transport types.
         * @hide
         */
        @NonNull
