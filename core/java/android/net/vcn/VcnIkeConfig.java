...
/**
 * This class will be exposed as public API
 *
 * @hide
 */
public final class VcnIkeConfig {
    ...
    /** TODO: documentation */
    public VcnIkeConfig(@NonNull PersistableBundle bundle) {
        this.mIkeParams = IkeSessionParams.fromPersistableBundle(bundle);
    }
