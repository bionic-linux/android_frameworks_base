...
public final class VcnWifiUnderlyingNetworkTemplate extends VcnUnderlyingNetworkTemplate {
    ...
    private VcnWifiUnderlyingNetworkTemplate(
            Set<VcnLinkCriterion> linkCriteria, int meteredMatchCriteria, Set<String> ssids) {
        super(NETWORK_PRIORITY_TYPE_WIFI, linkCriteria, meteredMatchCriteria);
    ...
    public static VcnWifiUnderlyingNetworkTemplate fromPersistableBundle(
        ...
        final PersistableBundle linkCriteriaBundle = in.getPersistableBundle(LINK_CRITERIA_KEY);
        Objects.requireNonNull(LinkCriteriaBundle, "LinkCriteriaBundle is null");
        final Set<VcnLinkCriterion> linkCriteria =
                new ArraySet<VcnLinkCriterion>(
                        PersistableBundleUtils.toList(
                                linkCriteriaBundle, VcnLinkCriterion::fromPersistableBundle));
        ...
        return new VcnWifiUnderlyingNetworkTemplate(LinkCriteria, meteredMatchCriteria, ssids);
    }
    ...
    public static final class Builder {
        ...
        @NonNull private final Set<VcnLinkCriterion> mLinkCriteria = new ArraySet<>();
         ...
         *
         * @param linkCriteria the criteria required of the underlying network. A network must meet
        ...
        public Builder setLinkCriteria(@NonNull Set<VcnLinkCriterion> linkCriteria) {
            validateLinkCriteria(LinkCriteria);

            mLinkCriteria.clear();
            mLinkCriteria.addAll(LinkCriteria);
            return this;
        }
        ...
        public VcnWifiUnderlyingNetworkTemplate build() {
            return new VcnWifiUnderlyingNetworkTemplate(
                    mLinkCriteria, mMeteredMatchCriteria, mSsids);
        }
    }
}
