...
// TODO: Add documents
/** @hide */
public final class CellNetworkPriority extends NetworkPriority {
    ...
    private CellNetworkPriority(
        ...
        mAllowedNetworkPlmnIds = allowedNetworkPlmnIds;
        mAllowedSpecificCarrierIds = allowedSpecificCarrierIds;
    ...
    public static CellNetworkPriority fromPersistableBundle(@NonNull PersistableBundle in) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof CellNetworkPriority)) {
            return false;
        }

        final CellNetworkPriority rhs = (CellNetworkPriority) other;
