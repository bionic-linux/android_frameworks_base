...
public class VcnManager {
    ...
    /**
     * GatewayConnectionError value indicating that an internal failure occurred in the specified
     * Gateway Connection.
     *
     * @hide
     */
    ...
    /**
     * GatewayConnectionError value indicating that an authentication failure occurred when
     * establishing the specified Gateway Connection.
     *
     * @hide
     */
    ...
    /**
     * GatewayConnectionError value indicating that the specified Gateway Connection died
     * unexpectedly.
     *
     * @hide
     */
    ...
    /**
     * GatewayConnectionError value indicating that the specified Gateway Connection was unable to
     * resolve the connection's domain name.
     *
     * @hide
     */
    ...
    public interface VcnStatusCallback {
         ...
         *     exactly match one of the {@link VcnGatewayConnectionConfig}s set in the {@link
         *     VcnConfig} for this
