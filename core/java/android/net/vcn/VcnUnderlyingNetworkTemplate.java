...
public abstract class VcnUnderlyingNetworkTemplate {
    ...
    /** @hide */
    static final String LINK_CRITERIA_KEY = "mLinkCriterion";
    ...
    PersistableBundle toPersistableBundle() {
        ...
        final PersistableBundle linkCriterionBundle =
                PersistableBundleUtils.fromList(
                        new ArrayList<>(mLinkCritieron), VcnLinkCriteria::toPersistableBundle);
    ...
    @Override
    public int hashCode() {
        return Objects.hash(mNetworkPriorityType, mLinkCritieron, mMeteredMatchCriteria);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return mNetworkPriorityType == rhs.mNetworkPriorityType
                && mLinkCritieron.equals(rhs.mLinkCritieron)
    ...
    /**
     * Return the link criteria for metered networks.
     *
