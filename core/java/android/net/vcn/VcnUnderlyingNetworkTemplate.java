...
public abstract class VcnUnderlyingNetworkTemplate {
    ...
    /** @hide */
    static final String LINK_CRITERIA_KEY = "mLinkCriteria";

    private final Set<VcnLinkCriterion> mLinkCriteria;
    ...
    VcnUnderlyingNetworkTemplate(
            int networkPriorityType, Set<VcnLinkCriterion> linkCriteria, int meteredMatchCriteria) {
        mNetworkPriorityType = networkPriorityType;
        mLinkCriteria = linkCriteria;
        mMeteredMatchCriteria = meteredMatchCriteria;
    }

    /** @hide */
    static void validateLinkCriteria(Set<VcnLinkCriterion> linkCriteria) {
        Objects.requireNonNull(LinkCriteria, "LinkCriteria is null");

        for (VcnLinkCriterion criteria : linkCriteria) {
            criteria.validate();
        }
    }
    ...
    protected void validate() {
        validateLinkCriteria(mLinkCriteria);
    ...
    PersistableBundle toPersistableBundle() {
        ...
        final PersistableBundle linkCriteriaBundle =
                PersistableBundleUtils.fromList(
                        new ArrayList<>(mLinkCriteria), VcnLinkCriterion::toPersistableBundle);
        result.putPersistableBundle(LINK_CRITERIA_KEY, linkCriteriaBundle);
    ...
    @Override
    public int hashCode() {
        return Objects.hash(mNetworkPriorityType, mLinkCriteria, mMeteredMatchCriteria);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return mNetworkPriorityType == rhs.mNetworkPriorityType
                && mLinkCriteria.equals(rhs.mLinkCriteria)
    ...
    public void dump(IndentingPrintWriter pw) {
        ...
        pw.println("mLinkCriteria:");
        pw.increaseIndent();
        for (VcnLinkCriterion criteria : mLinkCriteria) {
            criteria.dump(pw);
        }
        pw.decreaseIndent();
