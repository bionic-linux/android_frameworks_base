...
// TODO: Add documents
/** @hide */
public final class WifiUnderlyingNetworkPriority extends VcnUnderlyingNetworkPriority {
    private static final String SSID_KEY = "mSsid";
    @Nullable private final String mSsid;

    private WifiUnderlyingNetworkPriority(int networkQuality, boolean allowMetered, String ssid) {
    ...
    public static WifiUnderlyingNetworkPriority fromPersistableBundle(
        ...
        return new WifiUnderlyingNetworkPriority(networkQuality, allowMetered, ssid);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof WifiUnderlyingNetworkPriority)) {
            return false;
        }

        final WifiUnderlyingNetworkPriority rhs = (WifiUnderlyingNetworkPriority) other;
    ...
    /** This class is used to incrementally build WifiUnderlyingNetworkPriority objects. */
    public static class Builder extends VcnUnderlyingNetworkPriority.Builder<Builder> {
        ...
        /** Build the WifiUnderlyingNetworkPriority. */
        @NonNull
        public WifiUnderlyingNetworkPriority build() {
            return new WifiUnderlyingNetworkPriority(mNetworkQuality, mAllowMetered, mSsid);
        }
