...
public final class IkeSessionParamsUtils {
    ...
    public static IkeSessionParams fromPersistableBundle(@NonNull PersistableBundle in) {
        ...
        final PersistableBundle localAuthBundle = in.getPersistableBundle(LOCAL_AUTH_KEY);
        final PersistableBundle remoteAuthBundle = in.getPersistableBundle(REMOTE_AUTH_KEY);
        ...
        AuthConfigUtils.setBuilderByReadingPersistableBundle(localAuthBundle, builder);
        AuthConfigUtils.setBuilderByReadingPersistableBundle(remoteAuthBundle, builder);
