...
public final class ChildSaProposalUtils extends SaProposalUtilsBase {
    /** Serializes this ChildSaProposal to a PersistableBundle. */
    @NonNull
    ...
    /**
     * Constructs ChildSaProposal by deserializing a PersistableBundle
     *
    ...
    public static ChildSaProposal fromPersistableBundle(@NonNull PersistableBundle in) {
        ...
        final List<EncryptionAlgoKeyPair> encryptList =
                PersistableBundleUtils.toList(encryptionBundle, EncryptionAlgoKeyPair::new);
        for (EncryptionAlgoKeyPair t : encryptList) {
