...
public final class IkeSaProposalUtils extends SaProposalUtilsBase {
    ...
    /** Serializes this IkeSaProposal to a PersistableBundle. */
    @NonNull
    public static PersistableBundle toPersistableBundle(IkeSaProposal proposal) {
        final PersistableBundle result =
                SaProposalUtilsBase.toPersistableBundle(proposal, true /* isIkeProposal */);
    ...
    /**
     * Constructs IkeSaProposal by deserializing a PersistableBundle.
     *
