...
public final class EapSessionConfigUtils {
    ...
    private static class EapMethodConfigUtils {
        ...
        /**
         * Constructs an EapMethodConfig by deserializing a PersistableBundle and set it to the
        ...
        public static void setBuilderByReadingPersistableBundle(
            ...
            switch (methodType) {
                case EAP_TYPE_SIM:
                    ...
                    break;
                case EAP_TYPE_TTLS:
                    EapTtlsConfigUtils.setBuilderByReadingPersistableBundle(in, builder);
                    break;
                case EAP_TYPE_AKA:
