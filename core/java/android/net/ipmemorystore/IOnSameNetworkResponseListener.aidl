...
import android.net.ipmemorystore.SameL3NetworkResponseParceled;
...
oneway interface IOnSameNetworkResponseListener {
     ...
     */
     void onSameNetworkResponse(in StatusParceled status,
             in SameL3NetworkResponseParceled response);
}
