...
public class NetworkAttributes implements Parcelable {
    ...
    // Typically v4 addressed obtained through DHCP
    @Nullable
    public final InetAddress assignedAddress;
    ...
    private NetworkAttributes(
            @Nullable final InetAddress assignedAddress,
        ...
        this.dnsAddresses = Collections.unmodifiableList(new ArrayList<>(dnsAddresses));
        this.mtu = mtu;
    }
    ...
    public static class Builder {
         ...
         * @param assignedAddress The assigned address.
         * @return This builder.
         */
        public Builder setAssignedAddress(@Nullable final InetAddress assignedAddress) {
    ...
    public void writeToParcel(@Nullable final Parcel dest, final int flags) {
        if (null == assignedAddress) {
            dest.writeBoolean(false);
        } else {
            dest.writeBoolean(true);
            dest.writeByteArray(assignedAddress.getAddress());
        }
    ...
    public static final Creator<NetworkAttributes> CREATOR = new Creator<NetworkAttributes>() {
        ...
        public NetworkAttributes createFromParcel(@NonNull final Parcel in) {
            ...
            builder.setGroupInt(in.readString());
