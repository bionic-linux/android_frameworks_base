...
public class SameL3NetworkResponse {
    ...
    @VisibleForTesting
    public SameL3NetworkResponse(@NonNull final SameL3NetworkResponseParceled parceled) {
        this(parceled.l2Key1, parceled.l2Key2, parceled.confidence);
    }

    /** Converts this SameL3NetworkResponse to a parcelable object */
    @NonNull
    public SameL3NetworkResponseParceled toParcelable() {
        final SameL3NetworkResponseParceled parceled = new SameL3NetworkResponseParceled();
        parceled.l2Key1 = l2Key1;
        parceled.l2Key2 = l2Key2;
        parceled.confidence = confidence;
        return parceled;
    }
