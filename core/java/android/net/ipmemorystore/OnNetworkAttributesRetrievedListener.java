 ...
 * @hide
 */
public abstract class OnNetworkAttributesRetrievedListener {
    /**
     * The memory store has come up with the answer to a query that was sent.
     */
    public abstract void onNetworkAttributesRetrieved(Status status, String l2Key,
            NetworkAttributes attributes);

    /** Converts this OnNetworkAttributesRetrievedListener to a parcelable object */
    @NonNull
    public IOnNetworkAttributesRetrievedListener.Stub toParcelable() {
        return new IOnNetworkAttributesRetrievedListener.Stub() {
            ...
            public void onNetworkAttributesRetrieved(final StatusParcelable statusParcelable,
                ...
                OnNetworkAttributesRetrievedListener.this.onNetworkAttributesRetrieved(
