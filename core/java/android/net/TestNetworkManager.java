...
public class TestNetworkManager {
    ...
    @NonNull private final String mOpPkg;
     ...
     */
    @TestApi
    public void buildTestNetwork(@NonNull String iface, @NonNull IBinder binder) {
        try {
            mService.buildTestNetwork(iface, binder, mOpPkg);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
     ...
     *
     * @param iface the name to assign to the created TUN
     ...
     */
    @TestApi
    public ParcelFileDescriptor buildTun(@NonNull String iface, @NonNull LinkAddress[] linkAddrs) {
        try {
            return mService.buildTun(iface, linkAddrs, mOpPkg);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
