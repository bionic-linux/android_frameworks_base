...
public class CaptivePortal implements Parcelable {
    ...
    /**
     * Response code from the captive portal application, indicating that the the user did not login
     * and does not want to use the network.
     * @see ICaptivePortal#appResponse(int)
     * @see android.net.INetworkMonitor#notifyCaptivePortalAppFinished(int)
     * @hide */
    @SystemApi
    ...
    /**
     * Response code from the captive portal application, indicating that the the user does not wish
     * to login but wants to use the network as-is.
     * @see ICaptivePortal#appResponse(int)
     * @see android.net.INetworkMonitor#notifyCaptivePortalAppFinished(int)
     * @hide */
    @SystemApi
