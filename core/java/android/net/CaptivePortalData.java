...
public final class CaptivePortalData implements Parcelable {
    ...
    private final boolean mCanExtendSession;
    private final long mByteLimit;
    private final long mExpiryTimeMillis;
    private final boolean mCaptive;

    private CaptivePortalData(long refreshTimeMillis, Uri userPortalUrl, Uri venueInfoUrl,
            boolean canExtendSession, long byteLimit, long expiryTimeMillis, boolean captive) {
        mRefreshTimeMillis = refreshTimeMillis;
        mUserPortalUrl = userPortalUrl;
        mVenueInfoUrl = venueInfoUrl;
        mCanExtendSession = canExtendSession;
    ...
    private CaptivePortalData(Parcel p) {
        this(p.readLong(), readUri(p), readUri(p), p.readBoolean(), p.readLong(), p.readLong(),
                p.readBoolean());
    }
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeBoolean(mCanExtendSession);
    ...
    public static class Builder {
        ...
        private boolean mCanExtendSession;
        ...
        public Builder(@Nullable CaptivePortalData data) {
            ...
            setRefreshTime(data.mRefreshTimeMillis)
                    ...
                    .setCanExtendSession(data.mCanExtendSession)
         ...
         */
        @NonNull
        public Builder setCanExtendSession(boolean canExtendSession) {
            mCanExtendSession = canExtendSession;
            return this;
        }
        ...
        public CaptivePortalData build() {
            return new CaptivePortalData(mRefreshTime, mUserPortalUrl, mVenueInfoUrl,
                    mCanExtendSession, mBytesRemaining, mExpiryTime, mCaptive);
        }
    }
     ...
     * in and sessions have a time or byte limit.
     */
    public boolean canExtendSession() {
        return mCanExtendSession;
    }
    ...
    public int hashCode() {
        return Objects.hash(mRefreshTimeMillis, mUserPortalUrl, mVenueInfoUrl,
                mCanExtendSession, mByteLimit, mExpiryTimeMillis, mCaptive);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return mRefreshTimeMillis == other.mRefreshTimeMillis
                ...
                && mCanExtendSession == other.mCanExtendSession
    ...
    public String toString() {
        return "CaptivePortalData {"
                ...
                + ", canExtendSession: " + mCanExtendSession
