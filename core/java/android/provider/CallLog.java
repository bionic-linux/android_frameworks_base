...
public class CallLog {
    ...
    public static class Calls implements BaseColumns {
         ...
         * not missed.
         */
        public static final int MISSED_REASON_NOT_MISSED = 0;
         ...
         * system because new outgoing emergency call placed (in
         * {@link android.telecom.Call#STATE_RINGING},
         * {@link android.telecom.Call#STATE_SIMULATED_RINGING})
         * or an emergency call disconnected (in {@link android.telecom.Call#STATE_AUDIO_PROCESSING}
         * state).
         */
         ...
         * this call was missed because user didn't answer the call.
         */
        public static final int USER_MISSED = 0x10000000;

        /**
         * When {@link CallLog.Calls#TYPE} is {@link CallLog.Calls#MISSED_TYPE} and
         * {@link CallLog.Calls#USER_MISSED} is set, set this bit when this call rings less than
         * {@link CallLog.Calls#SHORT_RING_THRESHOLD} millisecond.
         */
        public static final int USER_MISSED_SHORT_RING = 1 << 0;

        /**
         * When {@link CallLog.Calls#TYPE} is {@link CallLog.Calls#MISSED_TYPE} and
         * {@link CallLog.Calls#USER_MISSED} is set, when this call rings less than this defined
         * time in millisecond, set {@link CallLog.Calls#USER_MISSED_SHORT_RING} bit.
         */
        public static final long SHORT_RING_THRESHOLD = 5000L;

        /**
         * When {@link CallLog.Calls#TYPE} is {@link CallLog.Calls#MISSED_TYPE} and
         * {@link CallLog.Calls#USER_MISSED} is set, set this bit when this call is silenced because
         * the phone is in 'do not disturb mode'.
         */
        public static final int USER_MISSED_DND_MODE = 1 << 1;

        /**
         * When {@link CallLog.Calls#TYPE} is {@link CallLog.Calls#MISSED_TYPE} and
         * {@link CallLog.Calls#USER_MISSED} is set, set this bit when this call rings with volume
         * that is equal or below {@link CallLog.Calls#LOW_RING_VOLUME}.
         */
        public static final int USER_MISSED_LOW_RING_VOLUME = 1 << 2;

        /**
         * When {@link CallLog.Calls#TYPE} is {@link CallLog.Calls#MISSED_TYPE} and
         * {@link CallLog.Calls#USER_MISSED} is set, when this call rings in volume less than this
         * defined volume threshold, set {@link CallLog.Calls#USER_MISSED_LOW_RING_VOLUME} bit.
         */
        public static final int LOW_RING_VOLUME = 0;

        /**
         * When {@link CallLog.Calls#TYPE} is {@link CallLog.Calls#MISSED_TYPE} and
         * {@link CallLog.Calls#USER_MISSED} is set, set this bit when this call rings without
         * vibration.
         */
        public static final int USER_MISSED_NO_VIBRATE = 1 << 3;

        /**
         * When {@link CallLog.Calls#TYPE} is {@link CallLog.Calls#MISSED_TYPE} and
         * {@link CallLog.Calls#USER_MISSED} is set, set this bit when this call is silenced by
         * the call screening service.
         */
        public static final int USER_MISSED_CALL_SCREENING_SERVICE_SILENCED = 1 << 4;

        /**
         * When {@link CallLog.Calls#TYPE} is {@link CallLog.Calls#MISSED_TYPE} and
         * {@link CallLog.Calls#USER_MISSED} is set, set this bit when the call filters timed out.
         */
        public static final int USER_MISSED_CALL_FILTERS_TIMEOUT = 1 << 5;
         ...
         * </p>
         * <P>
         * Allowed values for auto missed cases:
         * <ul>
         * <li>{@link CallLog.Calls#AUTO_MISSED_EMERGENCY_CALL_PLACING}</li>
         * <li>{@link CallLog.Calls#AUTO_MISSED_MAXIMUM_RINGING}</li>
         * <li>{@link CallLog.Calls#AUTO_MISSED_MAXIMUM_DIALING}</li>
         * </ul>
         * </P>
         * <P>
         * When {@link CallLog.Calls#USER_MISSED} is set, the call is missed because user didn't
         * answer the call. Following bits can be set to indicate possible reasons for this:
         * <ul>
        ...
        public static Uri addCall(CallerInfo ci, Context context, String number,
                ...
                long start, int duration, Long dataUsage, int missedReason) {
        ...
        public static Uri addCall(CallerInfo ci, Context context, String number,
                ...
                String callScreeningComponentName, int missedReason) {
            if (VERBOSE_LOG) {
            ...
            values.put(MISSED_REASON, Integer.valueOf(missedReason));
         ...
         *
         * @param missedReason
         * @result The result of this check. The result is true if the call was user missed, false
         * if the call was automatically rejected by system.
         */
        public static boolean isUserMissed(int missedReason) {
            return (missedReason | USER_MISSED) > 0;
        }
    }
}
