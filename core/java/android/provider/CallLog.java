...
public class CallLog {
    ...
    public static class Calls implements BaseColumns {
         ...
         * state).
         */
        public static final long AUTO_MISSED_EMERGENCY_CALL_PLACING = 1;
         ...
         */
        public static final long AUTO_MISSED_MAXIMUM_DIALING = 3;
         ...
         */
        public static final long USER_MISSED_NO_ANSWER = 1 << 5;

        /**
         * When {@link CallLog.Calls#TYPE} is {@link CallLog.Calls#MISSED_TYPE}, set this bit when
         * this call rings less than {@link CallLog.Calls#SHORT_RING_THRESHOLD} millisecond.
         */
        public static final long USER_MISSED_SHORT_RING = 1 << 6;
         ...
         */
        public static final long USER_MISSED_DND_MODE = 1 << 7;

        /**
         * When {@link CallLog.Calls#TYPE} is {@link CallLog.Calls#MISSED_TYPE}, set this bit when
         * this call rings with volume that is equal or below {@link CallLog.Calls#LOW_RING_VOLUME}.
         */
        public static final long USER_MISSED_LOW_RING_VOLUME = 1 << 8;
         ...
         */
        public static final long USER_MISSED_NO_VIBRATE = 1 << 9;

        /**
         * When {@link CallLog.Calls#TYPE} is {@link CallLog.Calls#MISSED_TYPE}, set this bit when
         * this call is silenced by the call screening service.
         */
        public static final long USER_MISSED_CALL_SCREENING_SERVICE_SILENCED = 1 << 10;

        /**
         * When {@link CallLog.Calls#TYPE} is {@link CallLog.Calls#MISSED_TYPE}, set this bit when
         * the call filters timed out.
         */
        public static final long USER_MISSED_CALL_FILTERS_TIMEOUT = 1 << 11;
         ...
         * </P>
         * <P>
         * When the call is missed because user didn't answer the call. Following bits can be set to
         * indicate possible reasons for this:
         * <ul>
