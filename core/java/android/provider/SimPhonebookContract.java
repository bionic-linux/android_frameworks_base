...
public final class SimPhonebookContract {
    ...
    public static final class SimPhonebookException extends AndroidRuntimeException implements
        ...
        private final ContentValues mSupportedValues;
        ...
        public SimPhonebookException(
                int errorCode, @Nullable String message, @NonNull ContentValues supportedValues) {
            this(errorCode, message, null, supportedValues);
        }
        ...
        private SimPhonebookException(int errorCode,
                ...
                @Nullable Throwable cause,
                ContentValues supportedValues) {
            super(message, cause);
            this.errorCode = errorCode;
            this.mSupportedValues = supportedValues;
        }
        ...
        /**
         * Returns modified values that are supported by the SIM when the error code is
         * {@link #ERROR_INVALID_DATA}.
         *
         * <p>Comparing the original values against those returned by this method can be used to
         * detect unsupported input.
         *
         * <p>Unsupported keys are omitted. The string for the value of a  supported key is
         * truncated to the max supported length of the field and any unsupported characters are
         * replaced with spaces (for {@link SimContacts#NAME}) or omitted (for
         * {@link SimContacts#PHONE_NUMBER}).
         */
        @NonNull
        public ContentValues getSupportedValues() {
        ...
        public void writeToParcel(@NonNull Parcel dest, int flags) {
            ...
            dest.writeParcelable(mSupportedValues, 0);
        }
