...
public final class SimPhonebookContract {
    ...
    public static final class SimPhonebookException extends AndroidRuntimeException implements
         ...
         * phonebook already has the maximum number of contacts it can support.
         */
         ...
         * {@link SimContacts#NAME} was longer than the maximum length supported by the target EF.
         */
        public static final int ERROR_NAME_TOO_LONG = 5;
        /**
         * An insert or update operation could not be performed because the value provided for
         * {@link SimContacts#PHONE_NUMBER} was longer than the maximum length supported by the
         * target EF.
         */
        public static final int ERROR_PHONE_NUMBER_TOO_LONG = 6;
        /**
         * An insert or update operation could not be performed because the value provided for
         * {@link SimContacts#PHONE_NUMBER} contained unsupported (non-numeric) characters.
         */
        public static final int ERROR_INVALID_PHONE_NUMBER = 7;

        /** A write operation timed out waiting for the SIM card to be available. */
