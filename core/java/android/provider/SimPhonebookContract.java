...
public final class SimPhonebookContract {
    ...
    public static final class SimRecords {
         ...
         * length could not be determined because the provider is malfunctioning or because the name
         * can not be encoded.
         */
        public static final int NAME_LENGTH_UNAVAILABLE = -1;
        ...
        /**
         * The key for an integer cursor extra that contains the length in bytes of an encoded name.
         *
         * @hide
         * @see #getEncodedNameLength(ContentResolver, String)
         ...
         *
         * @return the number bytes required by the encoded name or {@link #NAME_LENGTH_UNAVAILABLE}
        ...
        public static int getEncodedNameLength(
            ...
            Bundle result = resolver.call(AUTHORITY, GET_ENCODED_NAME_LENGTH_METHOD_NAME, name,
                    null);
            if (result == null) {
                // A null return is probably a buggy provider.
                return NAME_LENGTH_UNAVAILABLE;
            }
            return result.getInt(EXTRA_ENCODED_NAME_LENGTH, NAME_LENGTH_UNAVAILABLE);
        }
