...
public class Intent implements Parcelable, Cloneable {
     ...
     * extra field {@link #EXTRA_KEY_USER_REQUESTED_SHUTDOWN} can be set to true to
   ...
   /**
     ...
     * {@hide}
     */
    public static final String EXTRA_KEY_USER_REQUESTED_SHUTDOWN =
            "android.intent.extra.KEY_USER_REQUESTED_SHUTDOWN";
