...
public final class AttributionSource implements Parcelable {
    ...
    /**
     * Tries to retrieve the attribution source of the calling process.
     *
     * <p>This method will first try to get the global AttributionSource for the entire
     * calling process from {@link ActivityThread}, then if this fails, try to build a new
     * AttributionSource with the package name retrieved from the {@link PackageManager},
     * based on the UID that the calling process is running as.
     * <p>It is strongly discouraged to use this method, as the returned AttributionSource
     * might miss some features (like attribution tags). Applications should use
     * {@link Context#getAttributionSource} whenever possible instead, since it enables
     * better scoped controls over the features of AttributionSource.
     *
     * @return the AttributionSource of the calling process
     * @throws IllegalStateException when no AttributionSource can be found
     */
