...
public abstract class PackageManager {
     ...
     * {@link ConnectivityManager#requestNetwork} require the application to declares its usage
     * of that particular capabilities in this resource. Only some capabilities require a
     * declaration. Please look up the specific capability you want to use in
     * {@link NetworkCapabilities} to see if it needs declaration in this property.
     *
     * For example:
     * &lt;application&gt;
     ...
     * &lt;application&gt;
     *
     * <p> The detail format of network_capabilities.xml is described in
