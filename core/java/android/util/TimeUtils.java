...
public class TimeUtils {
    ...
    private static List<TimeZone> sLastUniqueZoneOffsets = null;
    ...
    public static java.util.TimeZone getTimeZone(
        ...
        TimeZone timeZone = TimeZoneFinder.getInstance()
        ...
        // API method.
        return timeZone != null ? java.util.TimeZone.getTimeZone(timeZone.getID()) : null;
    }
    ...
    private static List<TimeZone> getTimeZones(String countryIso) {
        ...
        if (timeZones == null) {
            if (DBG) {
                Log.d(TAG, "getTimeZones(" + countryIso
