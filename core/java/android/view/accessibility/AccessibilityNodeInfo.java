...
public class AccessibilityNodeInfo implements Parcelable {
    ...
    public static final class AccessibilityAction implements Parcelable {
         ...
         * changing focus can confuse screen readers, and the resulting behavior can vary by device
         * and screen reader version.
         * <p>This is distinct from {@link #ACTION_FOCUS}, which refers to system focus. System focus
         * is typically used to convey targets for keyboard navigation.
         */
