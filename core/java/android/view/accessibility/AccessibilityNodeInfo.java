...
public class AccessibilityNodeInfo implements Parcelable {
    ...
    public static final class AccessibilityAction implements Parcelable {
         ...
         * <p>This is distinct from {@link #ACTION_FOCUS}, which refers to input focus. Input focus
         * is typically used to convey targets for keyboard navigation and elements that can receive
