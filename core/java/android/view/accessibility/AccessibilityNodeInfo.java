...
public class AccessibilityNodeInfo implements Parcelable {
    ...
    public static final class AccessibilityAction implements Parcelable {
         ...
         *
         * <p>This action refers to accessibility focus, which is usually used by screen readers to
         * follow user navigation, such as touch exploration of the screen. This is distinct from
