...
public abstract class LayoutInflater {
     ...
     * method is used by {@link LayoutInflater#inflate} to create {@code View} objects. If this
     * method returns {@code null}, the {@link LayoutInflater} will attempt to create the
     * {@code View} object through some other means, such as by using reflection.
     *
     * @param parent the parent view, used to inflate layout params
     * @param name the name of the XML tag used to define the view
     * @param context the inflation context for the view, typically the
