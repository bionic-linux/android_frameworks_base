...
public abstract class LayoutInflater {
     ...
     *
     * This method gives the factory provided by {@link setFactory} and {@link setFactory2} a chance
     * to create a view. However, it does not apply all of the general view creation logic, and thus
     * may return {@code null} for some tags. This method is used by {@link LayoutInflater#inflate}
     * to create {@code View} objects. If this method returns null, the {@link LayoutInflater} will
     * attempt to create the {@code View} object through some other means, such as by using
     * reflection.
     *
     * @param parent the parent view, used to inflate layout params
     * @param name the name of the XML tag used to define the view
