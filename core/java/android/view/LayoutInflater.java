...
public abstract class LayoutInflater {
    ...
    private static final boolean USE_FAST_CREATE_VIEW = new File("/data/system/preload-constructors").exists();
    ...
    public final View createView(String name, String prefix, AttributeSet attrs)
        ...
        try {
            ...
            View view = null;
            if (USE_FAST_CREATE_VIEW) {
                view = fastCreateView(name, (Context) args[0], attrs);
            }
