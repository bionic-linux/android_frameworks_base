    ...
    public static class LayoutParams extends ViewGroup.LayoutParams implements Parcelable {
        ...
        @ViewDebug.ExportedProperty(mapping = {
                ...
                @ViewDebug.IntToString(from = TYPE_STATUS_BAR_PANEL,
                        to = "STATUS_BAR_PANEL"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 15,
                        to = "SECURE_SYSTEM_OVERLAY"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 16,
                        to = "DRAG"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 17,
                        to = "STATUS_BAR_SUB_PANEL"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 18,
                        to = "POINTER"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 19,
                        to = "NAVIGATION_BAR"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 20,
                        to = "VOLUME_OVERLAY"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 21,
                        to = "BOOT_PROGRESS"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 22,
                        to = "INPUT_CONSUMER"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 24,
                        to = "NAVIGATION_BAR_PANEL"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 26,
                        to = "DISPLAY_OVERLAY"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 27,
                        to = "MAGNIFICATION_OVERLAY"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 37,
                        to = "PRESENTATION"),
                @ViewDebug.IntToString(from = TYPE_PRIVATE_PRESENTATION,
                        to = "PRIVATE_PRESENTATION"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 31,
                        to = "VOICE_INTERACTION"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 33,
                        to = "VOICE_INTERACTION_STARTING"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 34,
                        to = "DOCK_DIVIDER"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 35,
                        to = "QS_DIALOG"),
                @ViewDebug.IntToString(from = FIRST_SYSTEM_WINDOW + 36,
                        to = "SCREENSHOT"),
        ...
        @ViewDebug.ExportedProperty(flagMapping = {
            ...
            @ViewDebug.FlagToString(mask = FLAG_LOCAL_FOCUS_MODE, equals = FLAG_LOCAL_FOCUS_MODE,
                    name = "LOCAL_FOCUS_MODE"),
            @ViewDebug.FlagToString(mask = 0x20000000, equals = 0x20000000,
                    name = "FLAG_SLIPPERY"),
