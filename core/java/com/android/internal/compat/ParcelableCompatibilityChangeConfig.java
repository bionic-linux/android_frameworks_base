 ...
 * @hide
 */
public class ParcelableCompatibilityChangeConfig implements Parcelable {
    private final ChangeConfig mChangeConfig;

    public ParcelableCompatibilityChangeConfig(Set<Long> enabled, Set<Long> disabled) {
    ...
    private ParcelableCompatibilityChangeConfig(Parcel in) {
    ...
    public static final Parcelable.Creator<ParcelableCompatibilityChangeConfig> CREATOR =
            new Parcelable.Creator<ParcelableCompatibilityChangeConfig>() {

                @Override
                public ParcelableCompatibilityChangeConfig createFromParcel(Parcel in) {
                    return new ParcelableCompatibilityChangeConfig(in);
                }

                @Override
                public ParcelableCompatibilityChangeConfig[] newArray(int size) {
                    return new ParcelableCompatibilityChangeConfig[size];
                }
            };
}
