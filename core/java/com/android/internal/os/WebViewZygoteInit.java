...
class WebViewZygoteInit {
    ...
    private static class WebViewZygoteConnection extends ZygoteConnection {
        ...
        protected boolean handlePreloadPackage(String packagePath, String libsPath) {
            ...
            // This enables us to preload Java and native code in the zygote process and have the
            // preloaded versions actually be used post-fork.
            ClassLoader loader = ApplicationLoaders.getDefault().createWebViewClassLoaderForZygote(
