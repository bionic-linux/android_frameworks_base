...
import static com.android.internal.os.ZygoteConnectionConstants.WRAPPED_PID_TIMEOUT_IN_MS;
    ...
    private boolean handleParentProc(int pid,
        ...
        if (pipeFd != null && pid > 0) {
            ...
            try {
                ...
                int remainingSleepTime = WRAPPED_PID_TIMEOUT_IN_MS;
                int dataIndex = 0;
                ...
                while (dataIndex < data.length && remainingSleepTime > 0) {
                    ...
                    remainingSleepTime = WRAPPED_PID_TIMEOUT_IN_MS - elapsedTimeMs;
