...
import static com.android.internal.os.ZygoteConnectionConstants.WRAPPED_PID_SLEEP_IN_MS;
    ...
    private boolean handleParentProc(int pid,
        ...
        if (pipeFd != null && pid > 0) {
            ...
            try {
                ...
                //
                // We'll wait up to thirty seconds. This should give enough time for the fork to go
                // through, but not to trigger the watchdog in the system server (by default sixty
                // seconds).
                //
