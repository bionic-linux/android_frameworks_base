...
public class MobileRadioPowerCalculator extends PowerCalculator {
    ...
    private double getMobilePowerPerPacket(long rawRealtimeUs, int statsType) {
        ...
        final long radioDataUptime =
                mStats.getMobileRadioActiveTime(rawRealtimeUs, statsType);
        final double mobilePps = (mobileData != 0 && radioDataUptime != 0)
                ? (mobileData / (double)radioDataUptime)
