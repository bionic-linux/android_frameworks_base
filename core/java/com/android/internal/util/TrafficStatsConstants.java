...
public class TrafficStatsConstants {
    ...
    public static final int TAG_SYSTEM_NTP = 0xFFFFFE02;
    public static final int TAG_SYSTEM_NEIGHBOR = 0xFFFFFE03;
    public static final int TAG_SYSTEM_GPS = 0xFFFFFE04;
    public static final int TAG_SYSTEM_PAC = 0xFFFFFE05;
    public static final int TAG_SYSTEM_DHCP_SERVER = 0xFFFFFE06;
    ...
    // {@link android.net.TrafficStats#TAG_SYSTEM_NETWORK_STACK_APP_SURROGATE_RANGE_START} and
    // {@link android.net.TrafficStats#TAG_SYSTEM_NETWORK_STACK_APP_SURROGATE_RANGE_END}.
