...
/**
 * @hide <p>A util to dump internal state of a {@link StateMachine} as a {@link StateMachineProto}
 * for debugging purposes.
 *
 * <p>Note: it is created to avoid adding extra dependencies (mainly platform protos and
 * {@link android.util.proto.ProtoOutputStream}) to every build target that uses StateMachine. Only
 * include it case by case when a target needs to dump {@link StateMachineProto}.
 */
