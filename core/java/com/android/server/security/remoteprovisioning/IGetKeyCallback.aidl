...
package com.android.server.security.remoteprovisioning;

import com.android.server.security.remoteprovisioning.RemotelyProvisionedKey;
...
oneway interface IGetKeyCallback {
     ...
     *
     * @param key The key that was recieved from the remote provisioning service.
     */
