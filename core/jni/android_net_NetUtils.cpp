...
static void android_net_utils_attachDropAllPacketFilter(JNIEnv *env, jobject clazz, jobject javaFd)
{
    struct sock_filter filter_code[] = {
        // Reject all.
        BPF_STMT(BPF_RET | BPF_K,              0)
...
static void android_net_utils_detachFilter(JNIEnv *env, jobject clazz, jobject javaFd)
{
    int dummy = 0;
    int fd = jniGetFDFromFileDescriptor(env, javaFd);
...
static const JNINativeMethod gNetworkUtilMethods[] = {
    ...
    { "attachDropAllPacketFilter", "(Ljava/io/FileDescriptor;)V", (void*) android_net_utils_attachDropAllPacketFilter },
    { "detachFilter", "(Ljava/io/FileDescriptor;)V", (void*) android_net_utils_detachFilter },
