               ...
               uint32_t typeSpecFlags, ResTable_config* config)
{
    ...
    env->SetIntField(outValue, gTypedValueOffsets.mAssetCookie,
                     reinterpret_cast<jint>(table->getTableCookie(block)));
                                                         ...
                                                         jint mode)
{
    ...
    Asset* a = cookie
        ? am->openNonAsset(reinterpret_cast<void*>(cookie), fileName8.c_str(), (Asset::AccessMode)mode)
                                                         ...
                                                         jlongArray outOffsets)
{
    ...
    Asset* a = cookie
        ? am->openNonAsset(reinterpret_cast<void*>(cookie), fileName8.c_str(), Asset::ACCESS_RANDOM)
                                                       ...
                                                       jstring path)
{
    ...
    return (res) ? reinterpret_cast<jint>(cookie) : 0;
}
