...
#define MAKE_AUDIO_SYSTEM_METHOD(x) MAKE_JNI_NATIVE_METHOD_AUTOSIG(#x, android_media_AudioSystem_##x)
...
static const JNINativeMethod gMethods[] =
        {MAKE_AUDIO_SYSTEM_METHOD(setParameters),
         ...
         MAKE_JNI_NATIVE_METHOD_AUTOSIG("native_register_dynamic_policy_callback", android_media_AudioSystem_registerDynPolicyCallback),
         MAKE_JNI_NATIVE_METHOD_AUTOSIG("native_register_recording_callback", android_media_AudioSystem_registerRecordingCallback),
         MAKE_JNI_NATIVE_METHOD_AUTOSIG("native_register_routing_callback", android_media_AudioSystem_registerRoutingCallback),
         MAKE_JNI_NATIVE_METHOD_AUTOSIG("native_register_vol_range_init_req_callback", android_media_AudioSystem_registerVolRangeInitReqCallback),
         MAKE_AUDIO_SYSTEM_METHOD(systemReady),
         MAKE_AUDIO_SYSTEM_METHOD(getStreamVolumeDB),
         MAKE_JNI_NATIVE_METHOD_AUTOSIG("native_get_offload_support", android_media_AudioSystem_getOffloadSupport),
