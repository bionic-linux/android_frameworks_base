...
static jint android_media_AudioSystem_getHwOffloadFormatsSupported(JNIEnv *env, jobject thiz,
                                                                   jint deviceType,
                                                                   jobject jEncodingFormatList) {
    ...
    status_t status = AudioSystem::getHwOffloadFormatsSupported((int)deviceType, &encodingFormats);
    if (status != NO_ERROR) {
...
static const JNINativeMethod gMethods[] =
        {{"setParameters", "(Ljava/lang/String;)I",
         ...
         {"getHwOffloadFormatsSupported", "(ILjava/util/ArrayList;)I",
          (void *)android_media_AudioSystem_getHwOffloadFormatsSupported},
