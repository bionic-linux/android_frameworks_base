                                                 ...
                                                 const struct audio_port_config *nAudioPortConfig)
{
    ...
    ScopedLocalRef<jobject> jAudioPortDeleter(env, nullptr);
    if (jAudioPort == nullptr) {
        ...
        jAudioPort = env->NewObject(gAudioPortClass, gAudioPortCstor,
                                           ...
                                           NULL,    // formats
                                           NULL);   // gains
        jAudioPortDeleter.reset(jAudioPort);
    ...
    if (gainIndex >= 0) {
        ...
        if (audioportCreated) {
            ...
            jobjectArray jGains = static_cast<jobjectArray>(
                    env->GetObjectField(jAudioPort, gAudioPortFields.mGains));
            if (jGains == NULL) {
                ALOGV("convertAudioPortConfigFromNative could not get gains from port");
                return AUDIO_JAVA_ERROR;
            }
            jAudioGain.reset(env->GetObjectArrayElement(jGains, gainIndex));
...
static jint convertAudioPortFromNative(JNIEnv *env, jobject *jAudioPort,
    ...
    if (nAudioPort->type == AUDIO_PORT_TYPE_DEVICE) {
        ...
        *jAudioPort = env->NewObject(gAudioMixPortClass, gAudioMixPortCstor, jHandle.get(),
    ...
    jobject jAudioPortConfigTmp = nullptr;

    jStatus = convertAudioPortConfigFromNative(env, *jAudioPort, &jAudioPortConfigTmp,
                                               &nAudioPort->active_config);
    ScopedLocalRef<jobject> jAudioPortConfig(env, jAudioPortConfigTmp);
    if (jStatus != AUDIO_JAVA_SUCCESS) {
        return jStatus;
    }

    env->SetObjectField(*jAudioPort, gAudioPortFields.mActiveConfig, jAudioPortConfig.get());
    return jStatus;
}
                                 ...
                                 jobjectArray jPatches, jobjectArray jSources, jobjectArray jSinks)
{
    ...
    audio_patch_handle_t handle = static_cast<audio_patch_handle_t>(0);
                                           ...
                                           jobject jPatches, jintArray jGeneration)
{
    ...
    for (size_t i = 0; i < numPatches; i++) {
        ...
        for (size_t j = 0; j < nPatches[i].num_sources; j++) {
            jobject jSourceTmp = nullptr;
            jStatus = convertAudioPortConfigFromNative(env, NULL, &jSourceTmp,
                                                       &nPatches[i].sources[j]);
            ScopedLocalRef<jobject> jSource(env, jSourceTmp);
            if (jStatus != AUDIO_JAVA_SUCCESS) {
                if (!setGeneration(env, jGeneration, generation1)) {
                    jStatus = AUDIO_JAVA_ERROR;
                }
        ...
        for (size_t j = 0; j < nPatches[i].num_sinks; j++) {
            jobject jSinkTmp = nullptr;
            jStatus = convertAudioPortConfigFromNative(env, NULL, &jSinkTmp, &nPatches[i].sinks[j]);
            ScopedLocalRef<jobject> jSink(env, jSinkTmp);
                                              ...
                                              jobject jMixesList, jboolean registration)
{
    ...
    for (jint i = 0; i < numMixes; i++) {
        ...
        AudioMix mix;
        jStatus = convertAudioMixToNative(env, &mix, jAudioMix.get());
        if (jStatus != AUDIO_JAVA_SUCCESS) {
            return jStatus;
        }
        mixes.add(mix);
...
static const JNINativeMethod gMethods[] =
        {{"setParameters", "(Ljava/lang/String;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setParameters)},
         {"getParameters", "(Ljava/lang/String;)Ljava/lang/String;",
          reinterpret_cast<void *>(android_media_AudioSystem_getParameters)},
         {"muteMicrophone", "(Z)I",
          reinterpret_cast<void *>(android_media_AudioSystem_muteMicrophone)},
         {"isMicrophoneMuted", "()Z",
          reinterpret_cast<void *>(android_media_AudioSystem_isMicrophoneMuted)},
         {"isStreamActive", "(II)Z",
          reinterpret_cast<void *>(android_media_AudioSystem_isStreamActive)},
         {"isStreamActiveRemotely", "(II)Z",
          reinterpret_cast<void *>(android_media_AudioSystem_isStreamActiveRemotely)},
         {"isSourceActive", "(I)Z",
          reinterpret_cast<void *>(android_media_AudioSystem_isSourceActive)},
         {"newAudioSessionId", "()I",
          reinterpret_cast<void *>(android_media_AudioSystem_newAudioSessionId)},
         {"newAudioPlayerId", "()I",
          reinterpret_cast<void *>(android_media_AudioSystem_newAudioPlayerId)},
         {"newAudioRecorderId", "()I",
          reinterpret_cast<void *>(android_media_AudioSystem_newAudioRecorderId)},
         {"setDeviceConnectionState", "(ILandroid/os/Parcel;I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setDeviceConnectionState)},
         {"getDeviceConnectionState", "(ILjava/lang/String;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getDeviceConnectionState)},
         {"handleDeviceConfigChange", "(ILjava/lang/String;Ljava/lang/String;I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_handleDeviceConfigChange)},
         {"setPhoneState", "(II)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setPhoneState)},
         {"setForceUse", "(II)I", reinterpret_cast<void *>(android_media_AudioSystem_setForceUse)},
         {"getForceUse", "(I)I", reinterpret_cast<void *>(android_media_AudioSystem_getForceUse)},
         {"initStreamVolume", "(III)I",
          reinterpret_cast<void *>(android_media_AudioSystem_initStreamVolume)},
         {"setStreamVolumeIndex", "(III)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setStreamVolumeIndex)},
         {"getStreamVolumeIndex", "(II)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getStreamVolumeIndex)},
         {"setVolumeIndexForAttributes", "(Landroid/media/AudioAttributes;II)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setVolumeIndexForAttributes)},
         {"getVolumeIndexForAttributes", "(Landroid/media/AudioAttributes;I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getVolumeIndexForAttributes)},
         {"getMinVolumeIndexForAttributes", "(Landroid/media/AudioAttributes;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getMinVolumeIndexForAttributes)},
         {"getMaxVolumeIndexForAttributes", "(Landroid/media/AudioAttributes;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getMaxVolumeIndexForAttributes)},
         {"setMasterVolume", "(F)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setMasterVolume)},
         {"getMasterVolume", "()F",
          reinterpret_cast<void *>(android_media_AudioSystem_getMasterVolume)},
         {"setMasterMute", "(Z)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setMasterMute)},
         {"getMasterMute", "()Z",
          reinterpret_cast<void *>(android_media_AudioSystem_getMasterMute)},
         {"setMasterMono", "(Z)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setMasterMono)},
         {"getMasterMono", "()Z",
          reinterpret_cast<void *>(android_media_AudioSystem_getMasterMono)},
         {"setMasterBalance", "(F)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setMasterBalance)},
         {"getMasterBalance", "()F",
          reinterpret_cast<void *>(android_media_AudioSystem_getMasterBalance)},
         {"getPrimaryOutputSamplingRate", "()I",
          reinterpret_cast<void *>(android_media_AudioSystem_getPrimaryOutputSamplingRate)},
         {"getPrimaryOutputFrameCount", "()I",
          reinterpret_cast<void *>(android_media_AudioSystem_getPrimaryOutputFrameCount)},
         {"getOutputLatency", "(I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getOutputLatency)},
         {"setLowRamDevice", "(ZJ)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setLowRamDevice)},
         {"checkAudioFlinger", "()I",
          reinterpret_cast<void *>(android_media_AudioSystem_checkAudioFlinger)},
         {"setAudioFlingerBinder", "(Landroid/os/IBinder;)V",
          reinterpret_cast<void *>(android_media_AudioSystem_setAudioFlingerBinder)},
         {"listAudioPorts", "(Ljava/util/ArrayList;[I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_listAudioPorts)},
         {"createAudioPatch",
          "([Landroid/media/AudioPatch;[Landroid/media/AudioPortConfig;[Landroid/media/"
          "AudioPortConfig;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_createAudioPatch)},
         {"releaseAudioPatch", "(Landroid/media/AudioPatch;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_releaseAudioPatch)},
         {"listAudioPatches", "(Ljava/util/ArrayList;[I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_listAudioPatches)},
         {"setAudioPortConfig", "(Landroid/media/AudioPortConfig;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setAudioPortConfig)},
         {"startAudioSource", "(Landroid/media/AudioPortConfig;Landroid/media/AudioAttributes;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_startAudioSource)},
         {"stopAudioSource", "(I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_stopAudioSource)},
         {"getAudioHwSyncForSession", "(I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getAudioHwSyncForSession)},
         {"registerPolicyMixes", "(Ljava/util/ArrayList;Z)I",
          reinterpret_cast<void *>(android_media_AudioSystem_registerPolicyMixes)},
         {"setUidDeviceAffinities", "(I[I[Ljava/lang/String;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setUidDeviceAffinities)},
         {"removeUidDeviceAffinities", "(I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_removeUidDeviceAffinities)},
         {"native_register_dynamic_policy_callback", "()V",
          reinterpret_cast<void *>(android_media_AudioSystem_registerDynPolicyCallback)},
         {"native_register_recording_callback", "()V",
          reinterpret_cast<void *>(android_media_AudioSystem_registerRecordingCallback)},
         {"native_register_routing_callback", "()V",
          reinterpret_cast<void *>(android_media_AudioSystem_registerRoutingCallback)},
         {"native_register_vol_range_init_req_callback", "()V",
          reinterpret_cast<void *>(android_media_AudioSystem_registerVolRangeInitReqCallback)},
         {"systemReady", "()I", reinterpret_cast<void *>(android_media_AudioSystem_systemReady)},
         {"getStreamVolumeDB", "(III)F",
          reinterpret_cast<void *>(android_media_AudioSystem_getStreamVolumeDB)},
         {"native_get_offload_support", "(IIIII)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getOffloadSupport)},
         {"getMicrophones", "(Ljava/util/ArrayList;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getMicrophones)},
         {"getSurroundFormats", "(Ljava/util/Map;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getSurroundFormats)},
         {"getReportedSurroundFormats", "(Ljava/util/ArrayList;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getReportedSurroundFormats)},
         {"setSurroundFormatEnabled", "(IZ)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setSurroundFormatEnabled)},
         {"setAssistantServicesUids", "([I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setAssistantServicesUids)},
         {"setActiveAssistantServicesUids", "([I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setActiveAssistantServicesUids)},
         {"setA11yServicesUids", "([I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setA11yServicesUids)},
         {"isHapticPlaybackSupported", "()Z",
          reinterpret_cast<void *>(android_media_AudioSystem_isHapticPlaybackSupported)},
         {"isUltrasoundSupported", "()Z",
          reinterpret_cast<void *>(android_media_AudioSystem_isUltrasoundSupported)},
         ...
         {"setSupportedSystemUsages", "([I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setSupportedSystemUsages)},
         {"setAllowedCapturePolicy", "(II)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setAllowedCapturePolicy)},
         {"setRttEnabled", "(Z)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setRttEnabled)},
         {"setAudioHalPids", "([I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setAudioHalPids)},
         {"isCallScreeningModeSupported", "()Z",
          reinterpret_cast<void *>(android_media_AudioSystem_isCallScreeningModeSupported)},
         {"setDevicesRoleForStrategy", "(II[I[Ljava/lang/String;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setDevicesRoleForStrategy)},
         {"removeDevicesRoleForStrategy", "(II)I",
          reinterpret_cast<void *>(android_media_AudioSystem_removeDevicesRoleForStrategy)},
         {"getDevicesForRoleAndStrategy", "(IILjava/util/List;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getDevicesForRoleAndStrategy)},
         {"setDevicesRoleForCapturePreset", "(II[I[Ljava/lang/String;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setDevicesRoleForCapturePreset)},
         {"addDevicesRoleForCapturePreset", "(II[I[Ljava/lang/String;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_addDevicesRoleForCapturePreset)},
         {"removeDevicesRoleForCapturePreset", "(II[I[Ljava/lang/String;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_removeDevicesRoleForCapturePreset)},
         {"clearDevicesRoleForCapturePreset", "(II)I",
          reinterpret_cast<void *>(android_media_AudioSystem_clearDevicesRoleForCapturePreset)},
         {"getDevicesForRoleAndCapturePreset", "(IILjava/util/List;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getDevicesForRoleAndCapturePreset)},
         {"getDevicesForAttributes",
          "(Landroid/media/AudioAttributes;[Landroid/media/AudioDeviceAttributes;Z)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getDevicesForAttributes)},
         {"setUserIdDeviceAffinities", "(I[I[Ljava/lang/String;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setUserIdDeviceAffinities)},
         {"removeUserIdDeviceAffinities", "(I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_removeUserIdDeviceAffinities)},
         {"setCurrentImeUid", "(I)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setCurrentImeUid)},
         {"setVibratorInfos", "(Ljava/util/List;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setVibratorInfos)},
         {"nativeGetSpatializer",
          "(Landroid/media/INativeSpatializerCallback;)Landroid/os/IBinder;",
          reinterpret_cast<void *>(android_media_AudioSystem_getSpatializer)},
         {"canBeSpatialized",
          "(Landroid/media/AudioAttributes;Landroid/media/AudioFormat;"
          "[Landroid/media/AudioDeviceAttributes;)Z",
          reinterpret_cast<void *>(android_media_AudioSystem_canBeSpatialized)},
         {"getDirectPlaybackSupport",
          "(Landroid/media/AudioFormat;Landroid/media/AudioAttributes;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getDirectPlaybackSupport)},
         {"getDirectProfilesForAttributes",
          "(Landroid/media/AudioAttributes;Ljava/util/ArrayList;)I",
          reinterpret_cast<void *>(android_media_AudioSystem_getDirectProfilesForAttributes)},
         {"supportsBluetoothVariableLatency", "()Z",
          reinterpret_cast<void *>(android_media_AudioSystem_supportsBluetoothVariableLatency)},
         {"setBluetoothVariableLatencyEnabled", "(Z)I",
          reinterpret_cast<void *>(android_media_AudioSystem_setBluetoothVariableLatencyEnabled)},
         {"isBluetoothVariableLatencyEnabled", "()Z",
          reinterpret_cast<void *>(android_media_AudioSystem_isBluetoothVariableLatencyEnabled)}};

static const JNINativeMethod gEventHandlerMethods[] = {
        {"native_setup", "(Ljava/lang/Object;)V",
         reinterpret_cast<void *>(android_media_AudioSystem_eventHandlerSetup)},
        {"native_finalize", "()V",
         reinterpret_cast<void *>(android_media_AudioSystem_eventHandlerFinalize)},
};

static const JNINativeMethod gFrameworkCapabilities[] = {
        {"native_getMaxChannelCount", "()I",
         reinterpret_cast<void *>(android_media_AudioSystem_getMaxChannelCount)},
        {"native_getMaxSampleRate", "()I",
         reinterpret_cast<void *>(android_media_AudioSystem_getMaxSampleRate)},
        {"native_getMinSampleRate", "()I",
         reinterpret_cast<void *>(android_media_AudioSystem_getMinSampleRate)},
};
