    ...
    class AnimationListenerBridge : public AnimationListener {
      public:
        ...
        virtual void onAnimationFinished(BaseRenderNodeAnimator*) {
            ...
            env->CallStaticVoidMethod(gVectorDrawableAnimatorClassInfo.clazz,
...
static jlong createGroupPropertyHolder(JNIEnv*, jobject, jlong nativePtr, jint propertyId,
    ...
    GroupPropertyValuesHolder* newHolder =
            new GroupPropertyValuesHolder(group, propertyId, startValue, endValue);
...
static jlong createPathDataPropertyHolder(JNIEnv*, jobject, jlong nativePtr, jlong startValuePtr,
    ...
    PathDataPropertyValuesHolder* newHolder =
            new PathDataPropertyValuesHolder(path, startData, endData);
    return reinterpret_cast<jlong>(newHolder);
}
...
static jlong createPathColorPropertyHolder(JNIEnv*, jobject, jlong nativePtr, jint propertyId,
    ...
    FullPathColorPropertyValuesHolder* newHolder =
            new FullPathColorPropertyValuesHolder(fullPath, propertyId, startValue, endValue);
    return reinterpret_cast<jlong>(newHolder);
}
...
static jlong createPathPropertyHolder(JNIEnv*, jobject, jlong nativePtr, jint propertyId,
    ...
    VectorDrawable::FullPath* fullPath = reinterpret_cast<VectorDrawable::FullPath*>(nativePtr);
    FullPathPropertyValuesHolder* newHolder =
            new FullPathPropertyValuesHolder(fullPath, propertyId, startValue, endValue);
    return reinterpret_cast<jlong>(newHolder);
}
...
static jlong createRootAlphaPropertyHolder(JNIEnv*, jobject, jlong nativePtr, jfloat startValue,
    ...
    RootAlphaPropertyValuesHolder* newHolder =
            new RootAlphaPropertyValuesHolder(tree, startValue, endValue);
    return reinterpret_cast<jlong>(newHolder);
}
...
static const JNINativeMethod gMethods[] = {
        ...
        {"nStart",
         "(JLandroid/graphics/drawable/AnimatedVectorDrawable$VectorDrawableAnimatorRT;I)V",
         (void*)start},
        {"nReverse",
         "(JLandroid/graphics/drawable/AnimatedVectorDrawable$VectorDrawableAnimatorRT;I)V",
         (void*)reverse},
...
int register_android_graphics_drawable_AnimatedVectorDrawable(JNIEnv* env) {
    ...
    gVectorDrawableAnimatorClassInfo.clazz =
            MakeGlobalRefOrDie(env, gVectorDrawableAnimatorClassInfo.clazz);
    ...
    return RegisterMethodsOrDie(env, "android/graphics/drawable/AnimatedVectorDrawable", gMethods,
                                NELEM(gMethods));
}
