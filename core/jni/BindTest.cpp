...
static uintptr_t* getString(Class* clazz, MethodBlock* mb, uintptr_t* ostack) {
    RETURN_OBJ(createString("String"));
}

/* native String getNullString(); */
static uintptr_t* getNullString(Class* clazz, MethodBlock* mb, uintptr_t* ostack) {
    RETURN_OBJ(createString(NULL));
}

/* native String getBooleanTrue(); */
static uintptr_t* getBooleanTrue(Class* clazz, MethodBlock* mb, uintptr_t* ostack) {
    RETURN_BOOLEAN(TRUE);
}

/* native String getBooleanFalse(); */
static uintptr_t* getBooleanFalse(Class* clazz, MethodBlock* mb, uintptr_t* ostack) {
    RETURN_BOOLEAN(FALSE);
}

/* native Object nonvoidThrowsException() */
static uintptr_t* nonvoidThrowsException(Class* clazz, MethodBlock* mb, uintptr_t* ostack) {
    if (1) {
...
static uintptr_t* setInstanceString(Class* clazz, MethodBlock* mb, uintptr_t* ostack) {
...
static uintptr_t* setClassString(Class* clazz, MethodBlock* mb, uintptr_t* ostack) {
    //    Object *jthis = (Object *) ostack[0];
...
static uintptr_t* makeStringFromThreeChars(Class* clazz, MethodBlock* mb, uintptr_t* ostack) {
...
static uintptr_t* makeReturnedObject(Class* clazz, MethodBlock* mb, uintptr_t* ostack) {
    // Object *jthis = (Object*)ostack[0];
...
static uintptr_t* addDoubles(Class* clazz, MethodBlock* mb, uintptr_t* ostack) {
    // Object *jthis = (Object*)ostack[0];
...
static uintptr_t* setAll(Class* clazz, MethodBlock* mb, uintptr_t* ostack) {
...
static uintptr_t* compareAll(Class* clazz, MethodBlock* mb, uintptr_t* ostack) {
    Object* jthis = JARG_get_obj(0);
    ...
    ret = (*(uintptr_t*)result != 0) && (obj == JOBJ_get_obj(jthis, offset_mObj)) &&
          (b == JOBJ_get_bool(jthis, offset_mBool)) && (i == JOBJ_get_int(jthis, offset_mInt)) &&
...
static VMMethod methods[] = {{"getString", getString},
