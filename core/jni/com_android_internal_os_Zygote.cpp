...
static pid_t ForkAndSpecializeCommon(JNIEnv* env, uid_t uid, gid_t gid, jintArray javaGids,
  ...
  if (pid == 0) {
    ...
    env->CallStaticVoidMethod(gZygoteClass, gCallPostForkChildHooks, debug_flags,
                              !is_system_server && initialize_native_bridge);
...
static jint com_android_internal_os_Zygote_nativeForkAndSpecialize(
        ...
        jintArray fdsToClose, jboolean initialize_native_bridge) {
    return ForkAndSpecializeCommon(env, uid, gid, gids, debug_flags,
            rlimits, 0, 0, mount_external, se_info, se_name, false, fdsToClose,
            initialize_native_bridge == JNI_TRUE);
}
...
static jint com_android_internal_os_Zygote_nativeForkSystemServer(
  ...
  pid_t pid = ForkAndSpecializeCommon(env, uid, gid, gids,
                                      ...
                                      MOUNT_EXTERNAL_NONE, NULL, NULL, true, NULL, false);
  if (pid > 0) {
...
static JNINativeMethod gMethods[] = {
    { "nativeForkAndSpecialize", "(II[II[[IILjava/lang/String;Ljava/lang/String;[IZ)I",
...
int register_com_android_internal_os_Zygote(JNIEnv* env) {
  ...
  gCallPostForkChildHooks = env->GetStaticMethodID(gZygoteClass, "callPostForkChildHooks", "(IZ)V");
