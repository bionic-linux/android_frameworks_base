...
static pid_t ForkCommon(JNIEnv* env, bool is_system_server,
  ...
  auto fail_fn = std::bind(ZygoteFailure, env, is_system_server ? "system_server" : "zygote", nullptr, _1);
...
static void SpecializeCommon(JNIEnv* env, uid_t uid, gid_t gid, jintArray gids,
  ...
  auto fail_fn = std::bind(ZygoteFailure, env, is_system_server ? "system_server" : "zygote", managed_nice_name, _1);
  auto extract_fn = std::bind(ExtractJString, env, is_system_server ? "system_server" : "zygote", managed_nice_name, _1);
