...
static jboolean android_app_admin_SecurityLog_isLoggingEnabled(JNIEnv* env, jobject /* clazz */) {
...
int register_android_app_admin_SecurityLog(JNIEnv* env) {
    ...
    return RegisterMethodsOrDie(env, "android/app/admin/SecurityLog", gRegisterMethods,
