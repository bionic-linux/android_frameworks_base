...
static jint android_media_AudioTrack_native_write_short(JNIEnv *env,  jobject thiz,
                                                  ...
                                                  jint javaAudioFormat) {
    //ALOGV("android_media_AudioTrack_native_write_short(offset=%d, sizeInShorts=%d) called",
    ...
    //ALOGV("write wrote %d (tried %d) short in the native AudioTrack with offset %d",
