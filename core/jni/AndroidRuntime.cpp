...
int AndroidRuntime::startVm(JavaVM** pJavaVM, JNIEnv** pEnv, bool zygote)
{
    ...
    char jitsensitivethreadweightOptBuf[sizeof("-Xjitsensitivethreadweight:")-1 + PROPERTY_VALUE_MAX];
    ...
    // Property name abbreviates `sensitive` to `sens` to meet length constraints.
    parseRuntimeOption("dalvik.vm.jitsensthreadweight",
                       jitsensitivethreadweightOptBuf,
                       "-Xjitsensitivethreadweight:");
