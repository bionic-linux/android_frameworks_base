...
static void movie_draw(JNIEnv* env, jobject movie, jlong canvasHandle, jfloat fx, jfloat fy,
                       jlong paintHandle) {
...
static jobject movie_decodeStream(JNIEnv* env, jobject clazz, jobject istream) {
    ...
    std::unique_ptr<SkStreamRewindable> bufferedStream(
            SkFrontBufferedStream::Make(std::unique_ptr<SkStream>(strm), 6));
...
static jobject movie_decodeByteArray(JNIEnv* env, jobject clazz, jbyteArray byteArray, jint offset,
                                     jint length) {
...
static const JNINativeMethod gMethods[] = {
        ...
        {"nDraw", "(JFFJ)V", (void*)movie_draw},
        {"nativeDecodeAsset", "(J)Landroid/graphics/Movie;", (void*)movie_decodeAsset},
