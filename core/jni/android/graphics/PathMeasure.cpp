...
class SkPathMeasureGlue {
  public:
    static jlong create(JNIEnv* env, jobject clazz, jlong pathHandle, jboolean forceClosedHandle) {
    ...
    static void setPath(JNIEnv* env, jobject clazz, jlong pairHandle, jlong pathHandle,
    ...
    static jboolean getPosTan(JNIEnv* env, jobject clazz, jlong pairHandle, jfloat dist,
                              jfloatArray pos, jfloatArray tan) {
        PathMeasurePair* pair = reinterpret_cast<PathMeasurePair*>(pairHandle);
