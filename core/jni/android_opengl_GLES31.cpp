...
static void android_glDispatchCompute__III(JNIEnv* _env, jobject _this, jint num_groups_x,
...
static void android_glDrawElementsIndirect(JNIEnv* _env, jobject, jint mode, jint type,
                                           jlong indirect) {
    // In OpenGL ES, 'indirect' is a byte offset into a buffer, not a raw pointer.
    // GL checks for too-large values. Here we only need to check for successful signed 64-bit
    // to unsigned 32-bit conversion.
...
static void android_glFramebufferParameteri__III(JNIEnv* _env, jobject _this, jint target,
                                                 jint pname, jint param) {
    glFramebufferParameteri((GLenum)target, (GLenum)pname, (GLint)param);
}

/* void glGetFramebufferParameteriv ( GLenum target, GLenum pname, GLint *params ) */
static void android_glGetFramebufferParameteriv__II_3II(JNIEnv* _env, jobject _this, jint target,
...
/* void glGetFramebufferParameteriv ( GLenum target, GLenum pname, GLint *params ) */
static void android_glGetFramebufferParameteriv__IILjava_nio_IntBuffer_2(JNIEnv* _env,
...
/* void glGetProgramInterfaceiv ( GLuint program, GLenum programInterface, GLenum pname, GLint
 * *params ) */
static void android_glGetProgramInterfaceiv__III_3II(JNIEnv* _env, jobject _this, jint program,
                                                     jint programInterface, jint pname,
...
/* void glGetProgramInterfaceiv ( GLuint program, GLenum programInterface, GLenum pname, GLint
 * *params ) */
static void android_glGetProgramInterfaceiv__IIILjava_nio_IntBuffer_2(JNIEnv* _env, jobject _this,
                                                                      jint program,
 ...
 */
static jint android_glGetProgramResourceIndex__IILjava_lang_String_2(JNIEnv* _env, jobject _this,
                                                                     jint program,
                                                                     jint programInterface,
                                                                     jstring name) {
    jint _exception = 0;
    ...
    _returnValue = glGetProgramResourceIndex((GLuint)program, (GLenum)programInterface,
                                             (GLchar*)_nativename);
...
/* void glGetProgramResourceName ( GLuint program, GLenum programInterface, GLuint index, GLsizei
 * bufSize, GLsizei *length, GLchar *name ) */
static jstring android_glGetProgramResourceName(JNIEnv* _env, jobject _this, jint program,
                                                jint programInterface, jint index) {
    jniThrowException(_env, "java/lang/UnsupportedOperationException", "not yet implemented");
    return NULL;
}

/* void glGetProgramResourceiv ( GLuint program, GLenum programInterface, GLuint index, GLsizei
 * propCount, const GLenum *props, GLsizei bufSize, GLsizei *length, GLint *params ) */
static void android_glGetProgramResourceiv__IIII_3III_3II_3II(
        JNIEnv* _env, jobject _this, jint program, jint programInterface, jint index,
        jint propCount, jintArray props_ref, jint propsOffset, jint bufSize, jintArray length_ref,
        jint lengthOffset, jintArray params_ref, jint paramsOffset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    const char* _exceptionMessage = NULL;
    ...
    props_base = (GLenum*)_env->GetIntArrayElements(props_ref, (jboolean*)0);
    ...
    glGetProgramResourceiv((GLuint)program, (GLenum)programInterface, (GLuint)index,
                           (GLsizei)propCount, (GLenum*)props, (GLsizei)bufSize, (GLsizei*)length,
                           (GLint*)params);
...
exit:
    ...
    if (props_base) {
        _env->ReleaseIntArrayElements(props_ref, (jint*)props_base, JNI_ABORT);
    }
    if (_exception) {
        jniThrowException(_env, _exceptionType, _exceptionMessage);
    }
...
android_glGetProgramResourceiv__IIIILjava_nio_IntBuffer_2ILjava_nio_IntBuffer_2Ljava_nio_IntBuffer_2(
        JNIEnv* _env, jobject _this, jint program, jint programInterface, jint index,
        jint propCount, jobject props_buf, jint bufSize, jobject length_buf, jobject params_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    const char* _exceptionMessage = NULL;
    ...
    props = (GLenum*)getPointer(_env, props_buf, (jarray*)&_propsArray, &_propsRemaining,
                                &_propsBufferOffset);
    if (length_buf) {
    ...
    params = (GLint*)getPointer(_env, params_buf, (jarray*)&_paramsArray, &_paramsRemaining,
                                &_paramsBufferOffset);
    if (props == NULL) {
 ...
 * ) */
static jint android_glGetProgramResourceLocation__IILjava_lang_String_2(JNIEnv* _env, jobject _this,
                                                                        jint program,
                                                                        jint programInterface,
                                                                        jstring name) {
    jint _exception = 0;
    ...
    _returnValue = glGetProgramResourceLocation((GLuint)program, (GLenum)programInterface,
                                                (GLchar*)_nativename);
...
static void android_glUseProgramStages__III(JNIEnv* _env, jobject _this, jint pipeline, jint stages,
                                            jint program) {
    glUseProgramStages((GLuint)pipeline, (GLbitfield)stages, (GLuint)program);
}

/* void glActiveShaderProgram ( GLuint pipeline, GLuint program ) */
static void android_glActiveShaderProgram__II(JNIEnv* _env, jobject _this, jint pipeline,
                                              jint program) {
    glActiveShaderProgram((GLuint)pipeline, (GLuint)program);
}

/* GLuint glCreateShaderProgramv ( GLenum type, GLsizei count, const GLchar *const *strings ) */
static jint android_glCreateShaderProgramv(JNIEnv* _env, jobject _this, jint type,
...
static void android_glBindProgramPipeline__I(JNIEnv* _env, jobject _this, jint pipeline) {
    glBindProgramPipeline((GLuint)pipeline);
}

/* void glDeleteProgramPipelines ( GLsizei n, const GLuint *pipelines ) */
static void android_glDeleteProgramPipelines__I_3II(JNIEnv* _env, jobject _this, jint n,
                                                    jintArray pipelines_ref, jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    const char* _exceptionMessage = NULL;
    ...
    pipelines_base = (GLuint*)_env->GetIntArrayElements(pipelines_ref, (jboolean*)0);
    pipelines = pipelines_base + offset;

    glDeleteProgramPipelines((GLsizei)n, (GLuint*)pipelines);

exit:
    if (pipelines_base) {
        _env->ReleaseIntArrayElements(pipelines_ref, (jint*)pipelines_base, JNI_ABORT);
    }
    if (_exception) {
        jniThrowException(_env, _exceptionType, _exceptionMessage);
    }
...
/* void glDeleteProgramPipelines ( GLsizei n, const GLuint *pipelines ) */
static void android_glDeleteProgramPipelines__ILjava_nio_IntBuffer_2(JNIEnv* _env, jobject _this,
                                                                     jint n,
                                                                     jobject pipelines_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    const char* _exceptionMessage = NULL;
    jintArray _array = (jintArray)0;
    ...
    pipelines =
            (GLuint*)getPointer(_env, pipelines_buf, (jarray*)&_array, &_remaining, &_bufferOffset);
    if (pipelines == NULL) {
...
static void android_glGenProgramPipelines__I_3II(JNIEnv* _env, jobject _this, jint n,
                                                 jintArray pipelines_ref, jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    const char* _exceptionMessage = NULL;
...
/* void glGenProgramPipelines ( GLsizei n, GLuint *pipelines ) */
static void android_glGenProgramPipelines__ILjava_nio_IntBuffer_2(JNIEnv* _env, jobject _this,
                                                                  jint n, jobject pipelines_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    const char* _exceptionMessage = NULL;
    jintArray _array = (jintArray)0;
...
static jboolean android_glIsProgramPipeline__I(JNIEnv* _env, jobject _this, jint pipeline) {
    GLboolean _returnValue;
    _returnValue = glIsProgramPipeline((GLuint)pipeline);
    return (jboolean)_returnValue;
}

/* void glGetProgramPipelineiv ( GLuint pipeline, GLenum pname, GLint *params ) */
static void android_glGetProgramPipelineiv__II_3II(JNIEnv* _env, jobject _this, jint pipeline,
...
/* void glGetProgramPipelineiv ( GLuint pipeline, GLenum pname, GLint *params ) */
static void android_glGetProgramPipelineiv__IILjava_nio_IntBuffer_2(JNIEnv* _env, jobject _this,
                                                                    jint pipeline, jint pname,
                                                                    jobject params_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    const char* _exceptionMessage = NULL;
...
static void android_glProgramUniform1i__III(JNIEnv* _env, jobject _this, jint program,
                                            jint location, jint v0) {
    glProgramUniform1i((GLuint)program, (GLint)location, (GLint)v0);
}

/* void glProgramUniform2i ( GLuint program, GLint location, GLint v0, GLint v1 ) */
static void android_glProgramUniform2i__IIII(JNIEnv* _env, jobject _this, jint program,
                                             jint location, jint v0, jint v1) {
    glProgramUniform2i((GLuint)program, (GLint)location, (GLint)v0, (GLint)v1);
}

/* void glProgramUniform3i ( GLuint program, GLint location, GLint v0, GLint v1, GLint v2 ) */
static void android_glProgramUniform3i__IIIII(JNIEnv* _env, jobject _this, jint program,
                                              jint location, jint v0, jint v1, jint v2) {
    glProgramUniform3i((GLuint)program, (GLint)location, (GLint)v0, (GLint)v1, (GLint)v2);
}

/* void glProgramUniform4i ( GLuint program, GLint location, GLint v0, GLint v1, GLint v2, GLint v3
 * ) */
static void android_glProgramUniform4i__IIIIII(JNIEnv* _env, jobject _this, jint program,
                                               jint location, jint v0, jint v1, jint v2, jint v3) {
    glProgramUniform4i((GLuint)program, (GLint)location, (GLint)v0, (GLint)v1, (GLint)v2,
                       (GLint)v3);
}

/* void glProgramUniform1ui ( GLuint program, GLint location, GLuint v0 ) */
static void android_glProgramUniform1ui__III(JNIEnv* _env, jobject _this, jint program,
                                             jint location, jint v0) {
    glProgramUniform1ui((GLuint)program, (GLint)location, (GLuint)v0);
}

/* void glProgramUniform2ui ( GLuint program, GLint location, GLuint v0, GLuint v1 ) */
static void android_glProgramUniform2ui__IIII(JNIEnv* _env, jobject _this, jint program,
                                              jint location, jint v0, jint v1) {
    glProgramUniform2ui((GLuint)program, (GLint)location, (GLuint)v0, (GLuint)v1);
}

/* void glProgramUniform3ui ( GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2 ) */
static void android_glProgramUniform3ui__IIIII(JNIEnv* _env, jobject _this, jint program,
                                               jint location, jint v0, jint v1, jint v2) {
 ...
 * GLuint v3 ) */
static void android_glProgramUniform4ui__IIIIII(JNIEnv* _env, jobject _this, jint program,
                                                jint location, jint v0, jint v1, jint v2, jint v3) {
    glProgramUniform4ui((GLuint)program, (GLint)location, (GLuint)v0, (GLuint)v1, (GLuint)v2,
                        (GLuint)v3);
}

/* void glProgramUniform1f ( GLuint program, GLint location, GLfloat v0 ) */
static void android_glProgramUniform1f__IIF(JNIEnv* _env, jobject _this, jint program,
                                            jint location, jfloat v0) {
    glProgramUniform1f((GLuint)program, (GLint)location, (GLfloat)v0);
}

/* void glProgramUniform2f ( GLuint program, GLint location, GLfloat v0, GLfloat v1 ) */
static void android_glProgramUniform2f__IIFF(JNIEnv* _env, jobject _this, jint program,
                                             jint location, jfloat v0, jfloat v1) {
    glProgramUniform2f((GLuint)program, (GLint)location, (GLfloat)v0, (GLfloat)v1);
}

/* void glProgramUniform3f ( GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2 ) */
static void android_glProgramUniform3f__IIFFF(JNIEnv* _env, jobject _this, jint program,
                                              jint location, jfloat v0, jfloat v1, jfloat v2) {
    glProgramUniform3f((GLuint)program, (GLint)location, (GLfloat)v0, (GLfloat)v1, (GLfloat)v2);
}

/* void glProgramUniform4f ( GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2,
 * GLfloat v3 ) */
static void android_glProgramUniform4f__IIFFFF(JNIEnv* _env, jobject _this, jint program,
                                               jint location, jfloat v0, jfloat v1, jfloat v2,
                                               jfloat v3) {
...
static void android_glProgramUniform1iv__III_3II(JNIEnv* _env, jobject _this, jint program,
                                                 jint location, jint count, jintArray value_ref,
                                                 jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    const char* _exceptionMessage = NULL;
    ...
    value_base = (GLint*)_env->GetIntArrayElements(value_ref, (jboolean*)0);
    value = value_base + offset;

    glProgramUniform1iv((GLuint)program, (GLint)location, (GLsizei)count, (GLint*)value);

exit:
    if (value_base) {
        _env->ReleaseIntArrayElements(value_ref, (jint*)value_base, JNI_ABORT);
    }
    if (_exception) {
        jniThrowException(_env, _exceptionType, _exceptionMessage);
    }
...
/* void glProgramUniform1iv ( GLuint program, GLint location, GLsizei count, const GLint *value ) */
static void android_glProgramUniform1iv__IIILjava_nio_IntBuffer_2(JNIEnv* _env, jobject _this,
                                                                  jint program, jint location,
                                                                  jint count, jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    const char* _exceptionMessage = NULL;
    jintArray _array = (jintArray)0;
...
static void android_glProgramUniform2iv__III_3II(JNIEnv* _env, jobject _this, jint program,
                                                 jint location, jint count, jintArray value_ref,
                                                 jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    ...
    glProgramUniform2iv((GLuint)program, (GLint)location, (GLsizei)count, (GLint*)value);
...
/* void glProgramUniform2iv ( GLuint program, GLint location, GLsizei count, const GLint *value ) */
static void android_glProgramUniform2iv__IIILjava_nio_IntBuffer_2(JNIEnv* _env, jobject _this,
                                                                  jint program, jint location,
                                                                  jint count, jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
...
static void android_glProgramUniform3iv__III_3II(JNIEnv* _env, jobject _this, jint program,
                                                 jint location, jint count, jintArray value_ref,
                                                 jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    ...
    glProgramUniform3iv((GLuint)program, (GLint)location, (GLsizei)count, (GLint*)value);
...
/* void glProgramUniform3iv ( GLuint program, GLint location, GLsizei count, const GLint *value ) */
static void android_glProgramUniform3iv__IIILjava_nio_IntBuffer_2(JNIEnv* _env, jobject _this,
                                                                  jint program, jint location,
                                                                  jint count, jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
...
static void android_glProgramUniform4iv__III_3II(JNIEnv* _env, jobject _this, jint program,
                                                 jint location, jint count, jintArray value_ref,
                                                 jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    ...
    glProgramUniform4iv((GLuint)program, (GLint)location, (GLsizei)count, (GLint*)value);
...
/* void glProgramUniform4iv ( GLuint program, GLint location, GLsizei count, const GLint *value ) */
static void android_glProgramUniform4iv__IIILjava_nio_IntBuffer_2(JNIEnv* _env, jobject _this,
                                                                  jint program, jint location,
                                                                  jint count, jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
 ...
 */
static void android_glProgramUniform1uiv__III_3II(JNIEnv* _env, jobject _this, jint program,
                                                  jint location, jint count, jintArray value_ref,
                                                  jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    ...
    _remaining = _env->GetArrayLength(value_ref) - offset;
    value_base = (GLuint*)_env->GetIntArrayElements(value_ref, (jboolean*)0);
    value = value_base + offset;

    glProgramUniform1uiv((GLuint)program, (GLint)location, (GLsizei)count, (GLuint*)value);
...
/* void glProgramUniform1uiv ( GLuint program, GLint location, GLsizei count, const GLuint *value )
 */
static void android_glProgramUniform1uiv__IIILjava_nio_IntBuffer_2(JNIEnv* _env, jobject _this,
                                                                   jint program, jint location,
                                                                   jint count, jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
 ...
 */
static void android_glProgramUniform2uiv__III_3II(JNIEnv* _env, jobject _this, jint program,
                                                  jint location, jint count, jintArray value_ref,
                                                  jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    ...
    glProgramUniform2uiv((GLuint)program, (GLint)location, (GLsizei)count, (GLuint*)value);
...
/* void glProgramUniform2uiv ( GLuint program, GLint location, GLsizei count, const GLuint *value )
 */
static void android_glProgramUniform2uiv__IIILjava_nio_IntBuffer_2(JNIEnv* _env, jobject _this,
                                                                   jint program, jint location,
                                                                   jint count, jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
 ...
 */
static void android_glProgramUniform3uiv__III_3II(JNIEnv* _env, jobject _this, jint program,
                                                  jint location, jint count, jintArray value_ref,
                                                  jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    ...
    glProgramUniform3uiv((GLuint)program, (GLint)location, (GLsizei)count, (GLuint*)value);
...
/* void glProgramUniform3uiv ( GLuint program, GLint location, GLsizei count, const GLuint *value )
 */
static void android_glProgramUniform3uiv__IIILjava_nio_IntBuffer_2(JNIEnv* _env, jobject _this,
                                                                   jint program, jint location,
                                                                   jint count, jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
 ...
 */
static void android_glProgramUniform4uiv__III_3II(JNIEnv* _env, jobject _this, jint program,
                                                  jint location, jint count, jintArray value_ref,
                                                  jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    ...
    glProgramUniform4uiv((GLuint)program, (GLint)location, (GLsizei)count, (GLuint*)value);
...
/* void glProgramUniform4uiv ( GLuint program, GLint location, GLsizei count, const GLuint *value )
 */
static void android_glProgramUniform4uiv__IIILjava_nio_IntBuffer_2(JNIEnv* _env, jobject _this,
                                                                   jint program, jint location,
                                                                   jint count, jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
 ...
 */
static void android_glProgramUniform1fv__III_3FI(JNIEnv* _env, jobject _this, jint program,
                                                 jint location, jint count, jfloatArray value_ref,
                                                 jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    const char* _exceptionMessage = NULL;
    ...
    glProgramUniform1fv((GLuint)program, (GLint)location, (GLsizei)count, (GLfloat*)value);
...
/* void glProgramUniform1fv ( GLuint program, GLint location, GLsizei count, const GLfloat *value )
 */
static void android_glProgramUniform1fv__IIILjava_nio_FloatBuffer_2(JNIEnv* _env, jobject _this,
                                                                    jint program, jint location,
                                                                    jint count, jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
 ...
 */
static void android_glProgramUniform2fv__III_3FI(JNIEnv* _env, jobject _this, jint program,
                                                 jint location, jint count, jfloatArray value_ref,
                                                 jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    ...
    glProgramUniform2fv((GLuint)program, (GLint)location, (GLsizei)count, (GLfloat*)value);
...
/* void glProgramUniform2fv ( GLuint program, GLint location, GLsizei count, const GLfloat *value )
 */
static void android_glProgramUniform2fv__IIILjava_nio_FloatBuffer_2(JNIEnv* _env, jobject _this,
                                                                    jint program, jint location,
                                                                    jint count, jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
 ...
 */
static void android_glProgramUniform3fv__III_3FI(JNIEnv* _env, jobject _this, jint program,
                                                 jint location, jint count, jfloatArray value_ref,
                                                 jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    ...
    glProgramUniform3fv((GLuint)program, (GLint)location, (GLsizei)count, (GLfloat*)value);
...
/* void glProgramUniform3fv ( GLuint program, GLint location, GLsizei count, const GLfloat *value )
 */
static void android_glProgramUniform3fv__IIILjava_nio_FloatBuffer_2(JNIEnv* _env, jobject _this,
                                                                    jint program, jint location,
                                                                    jint count, jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
 ...
 */
static void android_glProgramUniform4fv__III_3FI(JNIEnv* _env, jobject _this, jint program,
                                                 jint location, jint count, jfloatArray value_ref,
                                                 jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    ...
    glProgramUniform4fv((GLuint)program, (GLint)location, (GLsizei)count, (GLfloat*)value);
...
/* void glProgramUniform4fv ( GLuint program, GLint location, GLsizei count, const GLfloat *value )
 */
static void android_glProgramUniform4fv__IIILjava_nio_FloatBuffer_2(JNIEnv* _env, jobject _this,
                                                                    jint program, jint location,
                                                                    jint count, jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
...
/* void glProgramUniformMatrix2fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix2fv__IIIZ_3FI(JNIEnv* _env, jobject _this, jint program,
                                                        jint location, jint count,
                                                        jboolean transpose, jfloatArray value_ref,
                                                        jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    const char* _exceptionMessage = NULL;
...
/* void glProgramUniformMatrix2fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix2fv__IIIZLjava_nio_FloatBuffer_2(
        JNIEnv* _env, jobject _this, jint program, jint location, jint count, jboolean transpose,
        jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    const char* _exceptionMessage = NULL;
...
/* void glProgramUniformMatrix3fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix3fv__IIIZ_3FI(JNIEnv* _env, jobject _this, jint program,
                                                        jint location, jint count,
                                                        jboolean transpose, jfloatArray value_ref,
                                                        jint offset) {
    jint _exception = 0;
...
/* void glProgramUniformMatrix3fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix3fv__IIIZLjava_nio_FloatBuffer_2(
        JNIEnv* _env, jobject _this, jint program, jint location, jint count, jboolean transpose,
        jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
...
/* void glProgramUniformMatrix4fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix4fv__IIIZ_3FI(JNIEnv* _env, jobject _this, jint program,
                                                        jint location, jint count,
                                                        jboolean transpose, jfloatArray value_ref,
                                                        jint offset) {
    jint _exception = 0;
...
/* void glProgramUniformMatrix4fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix4fv__IIIZLjava_nio_FloatBuffer_2(
        JNIEnv* _env, jobject _this, jint program, jint location, jint count, jboolean transpose,
        jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
...
/* void glProgramUniformMatrix2x3fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix2x3fv__IIIZ_3FI(JNIEnv* _env, jobject _this, jint program,
                                                          jint location, jint count,
                                                          jboolean transpose, jfloatArray value_ref,
                                                          jint offset) {
    jint _exception = 0;
...
/* void glProgramUniformMatrix2x3fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix2x3fv__IIIZLjava_nio_FloatBuffer_2(
        JNIEnv* _env, jobject _this, jint program, jint location, jint count, jboolean transpose,
        jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
...
/* void glProgramUniformMatrix3x2fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix3x2fv__IIIZ_3FI(JNIEnv* _env, jobject _this, jint program,
                                                          jint location, jint count,
                                                          jboolean transpose, jfloatArray value_ref,
                                                          jint offset) {
    jint _exception = 0;
...
/* void glProgramUniformMatrix3x2fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix3x2fv__IIIZLjava_nio_FloatBuffer_2(
        JNIEnv* _env, jobject _this, jint program, jint location, jint count, jboolean transpose,
        jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
...
/* void glProgramUniformMatrix2x4fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix2x4fv__IIIZ_3FI(JNIEnv* _env, jobject _this, jint program,
                                                          jint location, jint count,
                                                          jboolean transpose, jfloatArray value_ref,
                                                          jint offset) {
    jint _exception = 0;
...
/* void glProgramUniformMatrix2x4fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix2x4fv__IIIZLjava_nio_FloatBuffer_2(
        JNIEnv* _env, jobject _this, jint program, jint location, jint count, jboolean transpose,
        jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
...
/* void glProgramUniformMatrix4x2fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix4x2fv__IIIZ_3FI(JNIEnv* _env, jobject _this, jint program,
                                                          jint location, jint count,
                                                          jboolean transpose, jfloatArray value_ref,
                                                          jint offset) {
    jint _exception = 0;
...
/* void glProgramUniformMatrix4x2fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix4x2fv__IIIZLjava_nio_FloatBuffer_2(
        JNIEnv* _env, jobject _this, jint program, jint location, jint count, jboolean transpose,
        jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
...
/* void glProgramUniformMatrix3x4fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix3x4fv__IIIZ_3FI(JNIEnv* _env, jobject _this, jint program,
                                                          jint location, jint count,
                                                          jboolean transpose, jfloatArray value_ref,
                                                          jint offset) {
    jint _exception = 0;
...
/* void glProgramUniformMatrix3x4fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix3x4fv__IIIZLjava_nio_FloatBuffer_2(
        JNIEnv* _env, jobject _this, jint program, jint location, jint count, jboolean transpose,
        jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
...
/* void glProgramUniformMatrix4x3fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix4x3fv__IIIZ_3FI(JNIEnv* _env, jobject _this, jint program,
                                                          jint location, jint count,
                                                          jboolean transpose, jfloatArray value_ref,
                                                          jint offset) {
    jint _exception = 0;
...
/* void glProgramUniformMatrix4x3fv ( GLuint program, GLint location, GLsizei count, GLboolean
 * transpose, const GLfloat *value ) */
static void android_glProgramUniformMatrix4x3fv__IIIZLjava_nio_FloatBuffer_2(
        JNIEnv* _env, jobject _this, jint program, jint location, jint count, jboolean transpose,
        jobject value_buf) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
...
static void android_glValidateProgramPipeline__I(JNIEnv* _env, jobject _this, jint pipeline) {
    glValidateProgramPipeline((GLuint)pipeline);
}

#include <stdlib.h>

/* void glGetProgramPipelineInfoLog ( GLuint shader, GLsizei maxLength, GLsizei* length, GLchar*
 * infoLog ) */
...
/* void glBindImageTexture ( GLuint unit, GLuint texture, GLint level, GLboolean layered, GLint
 * layer, GLenum access, GLenum format ) */
static void android_glBindImageTexture__IIIZIII(JNIEnv* _env, jobject _this, jint unit,
                                                jint texture, jint level, jboolean layered,
                                                jint layer, jint access, jint format) {
    glBindImageTexture((GLuint)unit, (GLuint)texture, (GLint)level, (GLboolean)layered,
                       (GLint)layer, (GLenum)access, (GLenum)format);
}

/* void glGetBooleani_v ( GLenum target, GLuint index, GLboolean *data ) */
static void android_glGetBooleani_v__II_3ZI(JNIEnv* _env, jobject _this, jint target, jint index,
                                            jbooleanArray data_ref, jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    const char* _exceptionMessage = NULL;
    ...
    data_base = (GLboolean*)_env->GetBooleanArrayElements(data_ref, (jboolean*)0);
...
/* void glGetBooleani_v ( GLenum target, GLuint index, GLboolean *data ) */
static void android_glGetBooleani_v__IILjava_nio_IntBuffer_2(JNIEnv* _env, jobject _this,
...
static void android_glMemoryBarrier__I(JNIEnv* _env, jobject _this, jint barriers) {
    glMemoryBarrier((GLbitfield)barriers);
}

/* void glMemoryBarrierByRegion ( GLbitfield barriers ) */
static void android_glMemoryBarrierByRegion__I(JNIEnv* _env, jobject _this, jint barriers) {
    glMemoryBarrierByRegion((GLbitfield)barriers);
}

/* void glTexStorage2DMultisample ( GLenum target, GLsizei samples, GLenum internalformat, GLsizei
 * width, GLsizei height, GLboolean fixedsamplelocations ) */
static void android_glTexStorage2DMultisample__IIIIIZ(JNIEnv* _env, jobject _this, jint target,
                                                      jint samples, jint internalformat, jint width,
                                                      jint height, jboolean fixedsamplelocations) {
    glTexStorage2DMultisample((GLenum)target, (GLsizei)samples, (GLenum)internalformat,
                              (GLsizei)width, (GLsizei)height, (GLboolean)fixedsamplelocations);
}

/* void glGetMultisamplefv ( GLenum pname, GLuint index, GLfloat *val ) */
static void android_glGetMultisamplefv__II_3FI(JNIEnv* _env, jobject _this, jint pname, jint index,
                                               jfloatArray val_ref, jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    const char* _exceptionMessage = NULL;
    ...
    val_base = (GLfloat*)_env->GetFloatArrayElements(val_ref, (jboolean*)0);
    val = val_base + offset;
...
exit:
    if (val_base) {
        _env->ReleaseFloatArrayElements(val_ref, (jfloat*)val_base, _exception ? JNI_ABORT : 0);
    }
    if (_exception) {
        jniThrowException(_env, _exceptionType, _exceptionMessage);
    }
...
/* void glGetMultisamplefv ( GLenum pname, GLuint index, GLfloat *val ) */
static void android_glGetMultisamplefv__IILjava_nio_FloatBuffer_2(JNIEnv* _env, jobject _this,
...
static void android_glSampleMaski__II(JNIEnv* _env, jobject _this, jint maskNumber, jint mask) {
    glSampleMaski((GLuint)maskNumber, (GLbitfield)mask);
}

/* void glGetTexLevelParameteriv ( GLenum target, GLint level, GLenum pname, GLint *params ) */
static void android_glGetTexLevelParameteriv__III_3II(JNIEnv* _env, jobject _this, jint target,
                                                      jint level, jint pname, jintArray params_ref,
                                                      jint offset) {
    jint _exception = 0;
    const char* _exceptionType = NULL;
    const char* _exceptionMessage = NULL;
...
/* void glGetTexLevelParameteriv ( GLenum target, GLint level, GLenum pname, GLint *params ) */
static void android_glGetTexLevelParameteriv__IIILjava_nio_IntBuffer_2(JNIEnv* _env, jobject _this,
...
static void android_glGetTexLevelParameterfv__III_3FI(JNIEnv* _env, jobject _this, jint target,
                                                      jint level, jint pname,
...
/* void glGetTexLevelParameterfv ( GLenum target, GLint level, GLenum pname, GLfloat *params ) */
static void android_glGetTexLevelParameterfv__IIILjava_nio_FloatBuffer_2(JNIEnv* _env,
                                                                         jobject _this, jint target,
                                                                         jint level, jint pname,
                                                                         jobject params_buf) {
    jint _exception = 0;
 ...
 */
static void android_glBindVertexBuffer__IIJI(JNIEnv* _env, jobject _this, jint bindingindex,
...
static void android_glVertexAttribFormat__IIIZI(JNIEnv* _env, jobject _this, jint attribindex,
                                                jint size, jint type, jboolean normalized,
                                                jint relativeoffset) {
    glVertexAttribFormat((GLuint)attribindex, (GLint)size, (GLenum)type, (GLboolean)normalized,
                         (GLuint)relativeoffset);
}

/* void glVertexAttribIFormat ( GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset )
 */
static void android_glVertexAttribIFormat__IIII(JNIEnv* _env, jobject _this, jint attribindex,
...
static void android_glVertexAttribBinding__II(JNIEnv* _env, jobject _this, jint attribindex,
                                              jint bindingindex) {
    glVertexAttribBinding((GLuint)attribindex, (GLuint)bindingindex);
}

/* void glVertexBindingDivisor ( GLuint bindingindex, GLuint divisor ) */
static void android_glVertexBindingDivisor__II(JNIEnv* _env, jobject _this, jint bindingindex,
                                               jint divisor) {
...
static const JNINativeMethod methods[] = {
        ...
        {"glGetFramebufferParameteriv", "(II[II)V",
         (void*)android_glGetFramebufferParameteriv__II_3II},
        {"glGetFramebufferParameteriv", "(IILjava/nio/IntBuffer;)V",
         (void*)android_glGetFramebufferParameteriv__IILjava_nio_IntBuffer_2},
        {"glGetProgramInterfaceiv", "(III[II)V", (void*)android_glGetProgramInterfaceiv__III_3II},
        {"glGetProgramInterfaceiv", "(IIILjava/nio/IntBuffer;)V",
         (void*)android_glGetProgramInterfaceiv__IIILjava_nio_IntBuffer_2},
        {"glGetProgramResourceIndex", "(IILjava/lang/String;)I",
         (void*)android_glGetProgramResourceIndex__IILjava_lang_String_2},
        {"glGetProgramResourceName", "(III)Ljava/lang/String;",
         (void*)android_glGetProgramResourceName},
        {"glGetProgramResourceiv", "(IIII[III[II[II)V",
         (void*)android_glGetProgramResourceiv__IIII_3III_3II_3II},
        {"glGetProgramResourceiv",
         "(IIIILjava/nio/IntBuffer;ILjava/nio/IntBuffer;Ljava/nio/IntBuffer;)V",
         (void*)android_glGetProgramResourceiv__IIIILjava_nio_IntBuffer_2ILjava_nio_IntBuffer_2Ljava_nio_IntBuffer_2},
        {"glGetProgramResourceLocation", "(IILjava/lang/String;)I",
         (void*)android_glGetProgramResourceLocation__IILjava_lang_String_2},
        ...
        {"glCreateShaderProgramv", "(I[Ljava/lang/String;)I",
         (void*)android_glCreateShaderProgramv},
        ...
        {"glDeleteProgramPipelines", "(ILjava/nio/IntBuffer;)V",
         (void*)android_glDeleteProgramPipelines__ILjava_nio_IntBuffer_2},
        {"glGenProgramPipelines", "(I[II)V", (void*)android_glGenProgramPipelines__I_3II},
        {"glGenProgramPipelines", "(ILjava/nio/IntBuffer;)V",
         (void*)android_glGenProgramPipelines__ILjava_nio_IntBuffer_2},
        ...
        {"glGetProgramPipelineiv", "(IILjava/nio/IntBuffer;)V",
         (void*)android_glGetProgramPipelineiv__IILjava_nio_IntBuffer_2},
        ...
        {"glProgramUniform1iv", "(IIILjava/nio/IntBuffer;)V",
         (void*)android_glProgramUniform1iv__IIILjava_nio_IntBuffer_2},
        {"glProgramUniform2iv", "(III[II)V", (void*)android_glProgramUniform2iv__III_3II},
        {"glProgramUniform2iv", "(IIILjava/nio/IntBuffer;)V",
         (void*)android_glProgramUniform2iv__IIILjava_nio_IntBuffer_2},
        {"glProgramUniform3iv", "(III[II)V", (void*)android_glProgramUniform3iv__III_3II},
        {"glProgramUniform3iv", "(IIILjava/nio/IntBuffer;)V",
         (void*)android_glProgramUniform3iv__IIILjava_nio_IntBuffer_2},
        {"glProgramUniform4iv", "(III[II)V", (void*)android_glProgramUniform4iv__III_3II},
        {"glProgramUniform4iv", "(IIILjava/nio/IntBuffer;)V",
         (void*)android_glProgramUniform4iv__IIILjava_nio_IntBuffer_2},
        {"glProgramUniform1uiv", "(III[II)V", (void*)android_glProgramUniform1uiv__III_3II},
        {"glProgramUniform1uiv", "(IIILjava/nio/IntBuffer;)V",
         (void*)android_glProgramUniform1uiv__IIILjava_nio_IntBuffer_2},
        {"glProgramUniform2uiv", "(III[II)V", (void*)android_glProgramUniform2uiv__III_3II},
        {"glProgramUniform2uiv", "(IIILjava/nio/IntBuffer;)V",
         (void*)android_glProgramUniform2uiv__IIILjava_nio_IntBuffer_2},
        {"glProgramUniform3uiv", "(III[II)V", (void*)android_glProgramUniform3uiv__III_3II},
        {"glProgramUniform3uiv", "(IIILjava/nio/IntBuffer;)V",
         (void*)android_glProgramUniform3uiv__IIILjava_nio_IntBuffer_2},
        {"glProgramUniform4uiv", "(III[II)V", (void*)android_glProgramUniform4uiv__III_3II},
        {"glProgramUniform4uiv", "(IIILjava/nio/IntBuffer;)V",
         (void*)android_glProgramUniform4uiv__IIILjava_nio_IntBuffer_2},
        {"glProgramUniform1fv", "(III[FI)V", (void*)android_glProgramUniform1fv__III_3FI},
        {"glProgramUniform1fv", "(IIILjava/nio/FloatBuffer;)V",
         (void*)android_glProgramUniform1fv__IIILjava_nio_FloatBuffer_2},
        {"glProgramUniform2fv", "(III[FI)V", (void*)android_glProgramUniform2fv__III_3FI},
        {"glProgramUniform2fv", "(IIILjava/nio/FloatBuffer;)V",
         (void*)android_glProgramUniform2fv__IIILjava_nio_FloatBuffer_2},
        {"glProgramUniform3fv", "(III[FI)V", (void*)android_glProgramUniform3fv__III_3FI},
        {"glProgramUniform3fv", "(IIILjava/nio/FloatBuffer;)V",
         (void*)android_glProgramUniform3fv__IIILjava_nio_FloatBuffer_2},
        {"glProgramUniform4fv", "(III[FI)V", (void*)android_glProgramUniform4fv__III_3FI},
        {"glProgramUniform4fv", "(IIILjava/nio/FloatBuffer;)V",
         (void*)android_glProgramUniform4fv__IIILjava_nio_FloatBuffer_2},
        {"glProgramUniformMatrix2fv", "(IIIZ[FI)V",
         (void*)android_glProgramUniformMatrix2fv__IIIZ_3FI},
        {"glProgramUniformMatrix2fv", "(IIIZLjava/nio/FloatBuffer;)V",
         (void*)android_glProgramUniformMatrix2fv__IIIZLjava_nio_FloatBuffer_2},
        {"glProgramUniformMatrix3fv", "(IIIZ[FI)V",
         (void*)android_glProgramUniformMatrix3fv__IIIZ_3FI},
        {"glProgramUniformMatrix3fv", "(IIIZLjava/nio/FloatBuffer;)V",
         (void*)android_glProgramUniformMatrix3fv__IIIZLjava_nio_FloatBuffer_2},
        {"glProgramUniformMatrix4fv", "(IIIZ[FI)V",
         (void*)android_glProgramUniformMatrix4fv__IIIZ_3FI},
        {"glProgramUniformMatrix4fv", "(IIIZLjava/nio/FloatBuffer;)V",
         (void*)android_glProgramUniformMatrix4fv__IIIZLjava_nio_FloatBuffer_2},
        {"glProgramUniformMatrix2x3fv", "(IIIZ[FI)V",
         (void*)android_glProgramUniformMatrix2x3fv__IIIZ_3FI},
        {"glProgramUniformMatrix2x3fv", "(IIIZLjava/nio/FloatBuffer;)V",
         (void*)android_glProgramUniformMatrix2x3fv__IIIZLjava_nio_FloatBuffer_2},
        {"glProgramUniformMatrix3x2fv", "(IIIZ[FI)V",
         (void*)android_glProgramUniformMatrix3x2fv__IIIZ_3FI},
        {"glProgramUniformMatrix3x2fv", "(IIIZLjava/nio/FloatBuffer;)V",
         (void*)android_glProgramUniformMatrix3x2fv__IIIZLjava_nio_FloatBuffer_2},
        {"glProgramUniformMatrix2x4fv", "(IIIZ[FI)V",
         (void*)android_glProgramUniformMatrix2x4fv__IIIZ_3FI},
        {"glProgramUniformMatrix2x4fv", "(IIIZLjava/nio/FloatBuffer;)V",
         (void*)android_glProgramUniformMatrix2x4fv__IIIZLjava_nio_FloatBuffer_2},
        {"glProgramUniformMatrix4x2fv", "(IIIZ[FI)V",
         (void*)android_glProgramUniformMatrix4x2fv__IIIZ_3FI},
        {"glProgramUniformMatrix4x2fv", "(IIIZLjava/nio/FloatBuffer;)V",
         (void*)android_glProgramUniformMatrix4x2fv__IIIZLjava_nio_FloatBuffer_2},
        {"glProgramUniformMatrix3x4fv", "(IIIZ[FI)V",
         (void*)android_glProgramUniformMatrix3x4fv__IIIZ_3FI},
        {"glProgramUniformMatrix3x4fv", "(IIIZLjava/nio/FloatBuffer;)V",
         (void*)android_glProgramUniformMatrix3x4fv__IIIZLjava_nio_FloatBuffer_2},
        {"glProgramUniformMatrix4x3fv", "(IIIZ[FI)V",
         (void*)android_glProgramUniformMatrix4x3fv__IIIZ_3FI},
        {"glProgramUniformMatrix4x3fv", "(IIIZLjava/nio/FloatBuffer;)V",
         (void*)android_glProgramUniformMatrix4x3fv__IIIZLjava_nio_FloatBuffer_2},
        {"glValidateProgramPipeline", "(I)V", (void*)android_glValidateProgramPipeline__I},
        {"glGetProgramPipelineInfoLog", "(I)Ljava/lang/String;",
         (void*)android_glGetProgramPipelineInfoLog},
        ...
        {"glGetBooleani_v", "(IILjava/nio/IntBuffer;)V",
        ...
        {"glTexStorage2DMultisample", "(IIIIIZ)V",
         (void*)android_glTexStorage2DMultisample__IIIIIZ},
        {"glGetMultisamplefv", "(II[FI)V", (void*)android_glGetMultisamplefv__II_3FI},
        {"glGetMultisamplefv", "(IILjava/nio/FloatBuffer;)V",
         (void*)android_glGetMultisamplefv__IILjava_nio_FloatBuffer_2},
        ...
        {"glGetTexLevelParameteriv", "(IIILjava/nio/IntBuffer;)V",
         (void*)android_glGetTexLevelParameteriv__IIILjava_nio_IntBuffer_2},
        {"glGetTexLevelParameterfv", "(III[FI)V", (void*)android_glGetTexLevelParameterfv__III_3FI},
        {"glGetTexLevelParameterfv", "(IIILjava/nio/FloatBuffer;)V",
         (void*)android_glGetTexLevelParameterfv__IIILjava_nio_FloatBuffer_2},
