...
public class NfcControllerAlwaysOnStateListenerTest {
    ...
    private static void verifyCallbackStateChangedInvoked(
            ControllerAlwaysOnStateCallback callback) {
        verify(callback, times(1)).onStateChanged(anyBoolean());
    }

    private static void verifyCallbackStateChangedInvoked(
            ControllerAlwaysOnStateCallback callback, int numTimes, boolean isEnabled) {
        verify(callback, times(numTimes)).onStateChanged(isEnabled);
    }
    ...
    public void testRegister_FirstRegisterFails() throws RemoteException {
        ...
        verifyCallbackStateChangedInvoked(callback1, 1, true);
        verifyCallbackStateChangedInvoked(callback2, 1, true);
        verifyCallbackStateChangedInvoked(callback1, 0, false);
        verifyCallbackStateChangedInvoked(callback2, 0, false);
        mListener.onControllerAlwaysOnStateChanged(false);
        verifyCallbackStateChangedInvoked(callback1, 1, true);
        verifyCallbackStateChangedInvoked(callback2, 1, true);
        verifyCallbackStateChangedInvoked(callback1, 1, false);
        verifyCallbackStateChangedInvoked(callback2, 1, false);
    }
    ...
    public void testRegister_RegisterSameCallbackTwice() throws RemoteException {
        ...
        mListener.onControllerAlwaysOnStateChanged(true);
        verifyCallbackStateChangedInvoked(callback);
    }
    ...
    private void runStateChangeValue(boolean isEnabledIn, boolean isEnabledOut) {
        ...
        verifyCallbackStateChangedInvoked(callback, 1, isEnabledOut);
        verifyCallbackStateChangedInvoked(callback, 0, !isEnabledOut);
    }
}
