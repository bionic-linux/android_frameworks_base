...
public class ReadUtils {
    ...
    public static ReadOperation[] READ_OPERATIONS =
            new ReadOperation[] {
                    ...
                    (parcel, provider) -> {
                        byte[] array = new byte[provider.consumeInt(MIN_LEN, MAX_LEN)];
                        parcel.readByteArray(array);
                    },
                    (parcel, provider) -> {
                        char[] array = new char[provider.consumeInt(MIN_LEN, MAX_LEN)];
                        parcel.readCharArray(array);
                    },
                    (parcel, provider) -> {
                        int[] array = new int[provider.consumeInt(MIN_LEN, MAX_LEN)];
                        parcel.readIntArray(array);
                    },
                    (parcel, provider) -> {
                        double[] array = new double[provider.consumeInt(MIN_LEN, MAX_LEN)];
                        parcel.readDoubleArray(array);
                    },
                    (parcel, provider) -> {
                        float[] array = new float[provider.consumeInt(MIN_LEN, MAX_LEN)];
                        parcel.readFloatArray(array);
                    },
                    (parcel, provider) -> {
                        boolean[] array = new boolean[provider.consumeInt(MIN_LEN, MAX_LEN)];
                        parcel.readBooleanArray(array);
                    },
                    (parcel, provider) -> {
                        long[] array = new long[provider.consumeInt(MIN_LEN, MAX_LEN)];
                        parcel.readLongArray(array);
                    },
                    (parcel, provider) -> {
                        IBinder[] array = new IBinder[provider.consumeInt(MIN_LEN, MAX_LEN)];
                    ...
                    (parcel, provider) -> {
                        SingleDataParcelable[] array =
                                new SingleDataParcelable[provider.consumeInt(MIN_LEN, MAX_LEN)];
                    ...
                    (parcel, provider) -> {
                        EmptyParcelable[] array =
                                new EmptyParcelable[provider.consumeInt(MIN_LEN, MAX_LEN)];
                    ...
                    (parcel, provider) -> {
                        GenericDataParcelable[] array =
                                new GenericDataParcelable[provider.consumeInt(MIN_LEN, MAX_LEN)];
                    ...
                    (parcel, provider) -> {
                        SomeParcelable[] array =
                                new SomeParcelable[provider.consumeInt(MIN_LEN, MAX_LEN)];
                    ...
                    (parcel, provider) -> {
                        TestInterface[] array =
                                new TestInterface[provider.consumeInt(MIN_LEN, MAX_LEN)];
