...
public class TimeMigrationUtilsTest {
    ...
    @Test
    public void formatMillisAsDateTime_fixes2038Issue() {
        ...
        assertEquals("1901-12-12 20:45:52", TimeMigrationUtils.formatMillisAsDateTime(y2038Issue1));
        long y2038Issue2 = (((long) Integer.MAX_VALUE) + ONE_DAY_IN_SECONDS) * 1000L;
        assertEquals("2038-01-20 03:14:07", TimeMigrationUtils.formatMillisAsDateTime(y2038Issue2));
    }
        ...
        for (Locale locale : locales) {
            ...
            for (String timeZoneId : timeZoneIds) {
                ...
                for (long timeMillis : timesMillis) {
                    ...
                    String newResult = TimeMigrationUtils.formatMillisAsDateTime(timeMillis);
                    assertEquals(
