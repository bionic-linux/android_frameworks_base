...
finalized_sdks := $(wildcard $(HISTORICAL_SDK_VERSIONS_ROOT)/*/public/api/android.xml)
finalized_sdks += $(wildcard $(HISTORICAL_SDK_VERSIONS_ROOT)/*/public/api/android.txt)
finalized_sdks := $(patsubst $(HISTORICAL_SDK_VERSIONS_ROOT)/%/public/api/android.xml,%,$(finalized_sdks))
finalized_sdks := $(patsubst $(HISTORICAL_SDK_VERSIONS_ROOT)/%/public/api/android.txt,%,$(finalized_sdks))
