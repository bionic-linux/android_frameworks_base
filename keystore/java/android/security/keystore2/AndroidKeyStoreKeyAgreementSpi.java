...
public class AndroidKeyStoreKeyAgreementSpi extends KeyAgreementSpi
    ...
    public static class ECDH extends AndroidKeyStoreKeyAgreementSpi {
        public ECDH() {
            // TODO(brambonne): replace with KeymasterDefs.KM_ALGORITHM_ECDH when available.
    ...
    protected byte[] engineGenerateSecret() throws IllegalStateException {
        ...
        try {
            return mChunkedStreamer.doFinal(
                    otherPartyKeyEncoded, 0, otherPartyKeyEncoded.length, null);
    ...
    private void ensureKeystoreOperationInitialized()
        ...
        // We don't need to explicitly pass in any parameters here, as they're part of the private
        // key that is available to Keymint.
        ...
        mChunkedStreamer =
                new KeyStoreCryptoOperationChunkedStreamer(
                        new KeyStoreCryptoOperationChunkedStreamer.MainDataStream(mOperation));
    }
}
