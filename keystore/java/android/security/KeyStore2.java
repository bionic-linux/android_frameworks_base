...
public class KeyStore2 {
     ...
     * with system/security/keystore-engine.
     * @hide
     */
    private static final String KEYSTORE_ENGINE_GRANT_ALIAS_PREFIX =
            "ks2_keystore-engine_grant_id:";
    ...
    public static String makeKeystoreEngineGrantString(long grantId) {
        return String.format("%s0x%016X", KEYSTORE_ENGINE_GRANT_ALIAS_PREFIX, grantId);
    }
    ...
    public static KeyDescriptor keystoreEngineGrantString2KeyDescriptor(String grantString) {
        ...
        key.nspace = Long.decode(
                grantString.substring(KEYSTORE_ENGINE_GRANT_ALIAS_PREFIX.length()));
        key.alias = null;
        key.blob = null;
        return key;
    }
