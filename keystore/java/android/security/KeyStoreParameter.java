...
public final class KeyStoreParameter implements ProtectionParameter {
    ...
    /**
     * Returns {@code true} if the set of digest with which the key can be used has been specified.
     *
     * @see #getDigests()
     *
     * @hide
    ...
    public final static class Builder {
        ...
        /**
         * Sets the set of digests with which the key may be used when signing/verifying or
