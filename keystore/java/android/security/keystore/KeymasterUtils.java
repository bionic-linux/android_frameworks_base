...
public abstract class KeymasterUtils {
    ...
    public static void addUserAuthArgs(KeymasterArguments args, UserAuthArgs spec) {
        ...
        if (spec.getUserAuthenticationValidityDurationSeconds() == 0) {
            ...
            ///////
            /*if (spec.getUserAuthenticationType() == BIOMETRIC) {
                args.addEnum(KeymasterDefs.KM_TAG_USER_AUTH_TYPE,
                        KeymasterDefs.HW_AUTH_BIOMETRIC | KeymasterDefs.HW_AUTH_PASSWORD);
            } else {
                args.addEnum(KeymasterDefs.KM_TAG_USER_AUTH_TYPE, KeymasterDefs.HW_AUTH_PASSWORD);
            }*/
