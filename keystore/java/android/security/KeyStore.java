...
public class KeyStore {
    ...
    public int[] listUidsOfAuthBoundKeys() {
        // uids are returned as a list of strings because list of intergers
        ...
        int[] uidsIntArrayOut = new int[uidsOut.size()];
        for(int i=0; i<uidsOut.size(); i++) {
            uidsIntArrayOut[i] = Integer.parseInt(uidsOut.get(i));
        }
        return uidsIntArrayOut;
   }
