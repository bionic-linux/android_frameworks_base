...
class Instruction {
 public:
  ...
  static inline Instruction OpWithArgs(Op opcode, std::optional<const Value> dest, T... args) {
    return Instruction{opcode, /*method_id*/ 0, false, dest, args...};
  }
  // For method calls.
  template <typename... T>
  static inline Instruction InvokeVirtual(size_t method_id, std::optional<const Value> dest,
                                          Value this_arg, T... args) {
    return Instruction{Op::kInvokeVirtual, method_id, false, dest, this_arg, args...};
  }
  // Returns an object
  template <typename... T>
  ...
  static inline Instruction InvokeDirect(size_t method_id, std::optional<const Value> dest,
                                         Value this_arg, T... args) {
    return Instruction{Op::kInvokeDirect, method_id, false, dest, this_arg, args...};
  }
  // Returns an object
  template <typename... T>
  ...
  static inline Instruction InvokeStatic(size_t method_id, std::optional<const Value> dest,
                                         T... args) {
    return Instruction{Op::kInvokeStatic, method_id, false, dest, args...};
  }
  // Returns an object
  template <typename... T>
  ...
  static inline Instruction InvokeInterface(size_t method_id, std::optional<const Value> dest,
                                            T... args) {
    return Instruction{Op::kInvokeInterface, method_id, false, dest, args...};
  }
