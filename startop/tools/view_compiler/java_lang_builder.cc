...
void JavaViewBuilder::Start() const {
...
void JavaViewBuilder::Finish() const {
...
void JavaViewBuilder::StartView(const string& class_name) {
...
void JavaViewBuilder::FinishView() {
...
const std::string JavaViewBuilder::MakeVar(std::string prefix) {
  std::stringstream v;
  v << prefix << view_id_++;
  return v.str();
}
