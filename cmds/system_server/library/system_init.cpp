...
#define NO_SKIN_TAG (-1000)
    ...
    int idmap(const char* idmap_bin, const char* orig_apk,
            const char* skin_apk, const char* idmap_file, int priority)
    {
        int retval = -1;
    ...
    int parse_skin_tag(const ResXMLTree& parser, const char* target_package_name)
    {
    ...
    int parse_manifest(const void* data, size_t size, const char* target_package_name)
    {
        ...
        do {
            ...
            if (type == ResXMLParser::START_TAG) {
                ...
                if (tag == String16("skin")) {
                    return parse_skin_tag(parser, target_package_name);
                }
            }
