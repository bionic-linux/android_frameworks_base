...
int idmap(const char *orig_path, const char *skin_path, size_t priority, uid_t uid);
int enable_overlay(const char *orig_path, const char *skin_path, size_t priority);
