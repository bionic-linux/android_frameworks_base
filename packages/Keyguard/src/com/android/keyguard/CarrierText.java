...
public class CarrierText extends LinearLayout {
    ...
    private KeyguardUpdateMonitorCallback mCallback = new KeyguardUpdateMonitorCallback() {
        ...
        public void onScreenTurnedOff(int why) {
            for (int i = PhoneConstants.SIM_ID_1; i < mNumOfSim; i++) {
    ...
    protected void onFinishInflate() {
        ...
        mCarrierView[PhoneConstants.SIM_ID_1] = (TextView) findViewById(R.id.carrier_1);
        mCarrierView[PhoneConstants.SIM_ID_2] = (TextView) findViewById(R.id.carrier_2);
        mCarrierView[PhoneConstants.SIM_ID_3] = (TextView) findViewById(R.id.carrier_3);
        mCarrierView[PhoneConstants.SIM_ID_4] = (TextView) findViewById(R.id.carrier_4);
        mCarrierDivider[PhoneConstants.SIM_ID_1] = (TextView) findViewById(R.id.carrier_divider_1);
        mCarrierDivider[PhoneConstants.SIM_ID_2] = (TextView) findViewById(R.id.carrier_divider_2);
        mCarrierDivider[PhoneConstants.SIM_ID_3] = (TextView) findViewById(R.id.carrier_divider_3);
        mCarrierView[PhoneConstants.SIM_ID_1].setSelected(true);
        mCarrierView[PhoneConstants.SIM_ID_2].setSelected(true);
        mCarrierView[PhoneConstants.SIM_ID_3].setSelected(true);
        mCarrierView[PhoneConstants.SIM_ID_4].setSelected(true);
