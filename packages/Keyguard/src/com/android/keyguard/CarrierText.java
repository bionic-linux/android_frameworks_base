...
public class CarrierText extends LinearLayout {
    ...
    private KeyguardUpdateMonitorCallback mCallback = new KeyguardUpdateMonitorCallback() {
        @Override
        public void onRefreshCarrierInfo(CharSequence plmn, CharSequence spn, int subIdx) {
            mPlmn[subIdx] = plmn;
            mSpn[subIdx] = spn;
            updateCarrierText(mSimState[subIdx], mPlmn[subIdx], mSpn[subIdx], subIdx);
        }

        @Override
        public void onSimStateChanged(IccCardConstants.State simState, int subIdx) {
            mSimState[subIdx] = simState;
            updateCarrierText(mSimState[subIdx], mPlmn[subIdx], mSpn[subIdx], subIdx);
        }
    ...
    public CarrierText(Context context, AttributeSet attrs) {
        ...
        mSimState = new State[mNumOfSub];
        mPlmn = new CharSequence[mNumOfSub];
        mSpn = new CharSequence[mNumOfSub];
    }

    protected void updateCarrierText(State simState, CharSequence plmn, CharSequence spn, int subIdx) {
        Log.d(TAG, "updateCarrierText, simState=" + simState + " plmn=" + plmn + " spn=" + spn +" subIdx=" + subIdx);
        
        CharSequence text = getCarrierTextForSimState(simState, plmn, spn);
        TextView updateCarrierView = mCarrierView[subIdx];
