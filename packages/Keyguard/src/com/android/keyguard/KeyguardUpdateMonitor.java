...
public class KeyguardUpdateMonitor {
    ...
    private static class SimArgs {
        ...
        static SimArgs fromIntent(Intent intent) {
            ...
            String stateExtra = intent.getStringExtra(IccCardConstants.INTENT_KEY_ICC_STATE);
            int id = intent.getIntExtra(PhoneConstants.SLOT_KEY, 0);
    ...
    private KeyguardUpdateMonitor(Context context) {
        ...
        mSimState = new IccCardConstants.State[getNumOfPhone()];
        mTelephonyPlmn = new CharSequence[getNumOfPhone()];
        mTelephonySpn = new CharSequence[getNumOfPhone()];
    ...
    /// get the number of sim slots, currently support maximum 4 sim slots.
    public int getNumOfPhone() {
        if( mSimCount == 0) {
            mSimCount = TelephonyManager.getDefault().getPhoneCount();
    ...
    public boolean isValidSimId(int simId) {
        if((0 <= simId) && (simId < getNumOfPhone())) {
            return true;
        } else {
            return false;
        }
