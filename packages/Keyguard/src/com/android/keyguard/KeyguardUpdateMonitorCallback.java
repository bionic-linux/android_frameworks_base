...
class KeyguardUpdateMonitorCallback {
     ...
     * @param subIdx Which subscription's spn changed.
     */
    void onRefreshCarrierInfo(CharSequence plmn, CharSequence spn, int subIdx) { }
     ...
     * @param simState
     * @param subIdx Which subscription's SIM state changed.
     */
    void onSimStateChanged(IccCardConstants.State simState, int subIdx) {}
