...
public class KeyguardSimPinView extends KeyguardAbsKeyInputView
    ...
    protected void onFinishInflate() {
        ...
        mSimId = mUpdateMonitor.getSimPinSimId();
    ...
    private abstract class CheckSimPin extends Thread {
        ...
        public void run() {
            try {
                ...
                Log.v(TAG, "call supplyPinReportResultUsingSub() subId = " + subId[0]);
                final int[] result = ITelephony.Stub.asInterface(ServiceManager
                        .checkService("phone")).supplyPinReportResultUsingSub(subId[0], mPin);
