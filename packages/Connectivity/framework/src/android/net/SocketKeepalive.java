...
public abstract class SocketKeepalive implements AutoCloseable {
    ...
    /**
     * Success. This should only be internally as it indicates there is no any error. It should
     * not propagate to applications.
     * @hide
     */
    @SystemApi
    ...
    /**
     * The Binder is Died. This should only be internally as it indicates the Binder is Died.
     * It should not propagate to applications.
     * @hide
     */
     ...
     * {@code Network} is not connected. It should not propagate to applications.
     */
     ...
     * is not configured on the specified {@code Network}. It should not propagate to applications.
     */
    public static final int ERROR_INVALID_IP_ADDRESS = -21;

    /**
     * The invalid port. This should only be internally as it indicates the requested
     * port is invalid. It should not propagate to applications.
     */
    public static final int ERROR_INVALID_PORT = -22;

    /**
     * The invalid length. This should only be internally as it indicates the packet length
     * is invalid (e.g., too long). It should not propagate to applications.
     */
    public static final int ERROR_INVALID_LENGTH = -23;

    /**
     * The invalid interval. This should only be internally as it indicates the packet
     * transmission interval is invalid (e.g., too short).  It should not propagate
     * to applications.
     */
     ...
     * the target socket is invalid. It should not propagate to applications.
     */
    public static final int ERROR_INVALID_SOCKET = -25;

    /**
     * The socket is not idle. This should only be internally as it indicates
     * the target socket is not idle. It should not propagate to applications.
     */
     ...
     * not support this request. It should not propagate to applications.
     */
    public static final int ERROR_UNSUPPORTED = -30;

    /**
     * The hardware was error. This should only be internally used as an error in hardware.
     * It should not propagate to application.
     */
    public static final int ERROR_HARDWARE_ERROR = -31;

    /**
     * The insufficent resouces. This should only be internally as it indicates the limitation of
     * resource is reached. It should not propagate to applications.
     */
