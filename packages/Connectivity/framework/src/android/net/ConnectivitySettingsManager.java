...
public class ConnectivitySettingsManager {
    ...
    /**
     * A list of apps that should grant netd system permission for using restricted networks.
     *
     * @hide
     */
    ...
    /**
     * Get the list of apps(from {@link Settings}) that should grant netd system permission for
     * using restricted networks.
     *
     * @param context The {@link Context} to query the setting.
     * @return A list of apps that should should grant netd system permission for using restricted
    ...
    public static Set<String> getRestrictedAllowedApps(@NonNull Context context) {
        ...
        return new HashSet<>(Arrays.asList(appList.split(";")));
    }

    /**
     * Set the list of apps(from {@link Settings}) that should grant netd system permission for
     * using restricted networks.
     *
     ...
     *
     * @param context The {@link Context} to set the setting.
     * @param list A list of apps that should should grant netd system permission for using
     *             restricted networks.
     */
