...
public final class NetworkCapabilities implements Parcelable {
    ...
    public static final @android.annotation.NonNull Creator<NetworkCapabilities> CREATOR =
        new Creator<NetworkCapabilities>() {
            ...
            public NetworkCapabilities createFromParcel(Parcel in) {
                ...
                netCap.mSubIds = (ArraySet<Integer>) in.readArraySet(null /* ClassLoader */);
                return netCap;
            }
            @Override
    ...
    /**
     * Sets the subscription id set that associated to this network or request. Pass empty set for
     * clean up.
     *
     * @hide
     */
    @NonNull
    public NetworkCapabilities setSubIds(
     ...
     * If specified in the request, the passed one need to have at least one subId and all of them
     * needs to be in the request set.
     */
    private boolean satisfiedBySubIds(@NonNull NetworkCapabilities nc) {
        return mSubIds.isEmpty() || (nc.mSubIds.size() >= 1 && mSubIds.containsAll(nc.mSubIds));
    }
    ...
    private void combineSubIds(@NonNull NetworkCapabilities nc) {
        if (!Objects.equals(mSubIds, nc.mSubIds)) {
            throw new IllegalStateException("Can't combine two subscription Ids");
        }
    }
