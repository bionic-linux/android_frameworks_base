...
public class NsdService extends INsdManager.Stub {
                ...
                switch (code) {
                    case NativeResponseCode.SERVICE_FOUND:
                        ...
                        try {
                            ...
                            servInfo.setNetwork(new Network(netId));
    ...
    private boolean discoverServices(int discoveryId, NsdServiceInfo serviceInfo) {
        ...
        final String discoverInterface = network == null ? "" : getNetworkInterface(network);
    ...
    private boolean resolveService(int resolveId, NsdServiceInfo service) {
        ...
        final String resolveInterface = network == null ? "" : getNetworkInterface(network);
     ...
     */
    private String getNetworkInterface(Network network) {
