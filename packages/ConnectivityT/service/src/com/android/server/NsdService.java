            ...
            private boolean handleNativeEvent(int code, String raw, String[] cooked) {
                ...
                switch (code) {
                    case NativeResponseCode.SERVICE_FOUND:
                        ...
                        try {
                            final long netHandle = Long.parseUnsignedLong(cooked[5]);
                            if (netHandle == 0L) {
                            ...
                            servInfo.setNetwork(Network.fromNetworkHandle(netHandle));
                            clientInfo.onServiceFound(clientId, servInfo);
                        } catch (IllegalArgumentException e) {
                            // fromNetworkHandle or parseUnsignedLong failed
                    ...
                    case NativeResponseCode.SERVICE_RESOLVED:
                        ...
                        try {
                            ...
                            // getByIndex or parseInt failed
                            Log.wtf(TAG, "Invalid interface index: " + cooked[7], e);
                            // Fall through
                    ...
                    case NativeResponseCode.SERVICE_GET_ADDR_SUCCESS:
                        ...
                        try {
                            final long netHandle = Long.parseLong(cooked[5]);
                            network = netHandle == 0L ? null : Network.fromNetworkHandle(netHandle);
                        } catch (IllegalArgumentException e) {
                            Log.wtf(TAG, "Invalid netHandle in getAddr: " + cooked[5], e);
                        }
                        ...
                        try {
                            ...
                            Log.wtf(TAG, "Invalid host in getAddr", e);
                        }
