...
public class NetworkStatsFactory {
    ...
    public static class Dependencies {
         ...
         */
        @NonNull
        public NetworkStats getNativeReadNetworkStatsDetail(int limitUid, String[] limitIfaces,
         ...
         */
        @NonNull
        public NetworkStats getNativeReadNetworkStatsDev() throws IOException {
    ...
    public NetworkStats readNetworkStatsSummaryDev() throws IOException {
        return mDeps.getNativeReadNetworkStatsDev();
    }
    ...
    public NetworkStats readNetworkStatsDetail(
        ...
        synchronized (mPersistentDataLock) {
            ...
            // swap
            final NetworkStats stats = mDeps.getNativeReadNetworkStatsDetail(
