...
public final class NetworkTemplate implements Parcelable {
    ...
    private final String mWifiNetworkKey;
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeString(mWifiNetworkKey);
    ...
    @Override
    public int hashCode() {
        return Objects.hash(mMatchRule, mSubscriberId, mWifiNetworkKey,
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof NetworkTemplate) {
            ...
            return mMatchRule == other.mMatchRule
                    ...
                    && Objects.equals(mWifiNetworkKey, other.mWifiNetworkKey)
    ...
    public static final class Builder {
        ...
        @NonNull
        private final SortedSet<String> mMatchWifiNetworkKeys =
                new TreeSet<>(Comparator.nullsFirst(Comparator.naturalOrder()));
