...
public final class NetworkTemplate implements Parcelable {
    ...
    /** @hide */
    public NetworkTemplate(int matchRule, String subscriberId, String[] matchSubscriberIds,
            String wifiNetworkKey, String[] matchNetworkIds, int metered, int roaming,
        ...
        mMatchWifiNetworkKeys = matchNetworkIds;
        mMetered = metered;
        mRoaming = roaming;
    ...
    public String toString() {
        ...
        if (mMatchWifiNetworkKeys != null) {
            builder.append(", matchNetworkIds=").append(Arrays.toString(mMatchWifiNetworkKeys));
        }
