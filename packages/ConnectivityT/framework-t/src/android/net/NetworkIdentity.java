...
public class NetworkIdentity implements Comparable<NetworkIdentity> {
    ...
    //  {@link TelephonyManager#NETWORK_TYPE_UNKNOWN} instead.
    ...
    /**
     * Construct a {@link NetworkIdentity} object.
     *
     * @param type The legacy type of the network. See {@code ConnectivityManager#TYPE_*}.
     ...
     * @param subscriberId Subscriber Id of the network, see
     *                     {@link android.telephony.TelephonyManager#getSubscriberId(int)}.
     * @param wifiNetworkKey Wifi Network Key of the network, see
     *                       {@link WifiInfo#getCurrentNetworkKey()}.
     * @param roaming whether the network is roaming.
     * @param metered whether the network is roaming.
     * @param defaultNetwork whether the network is a default network.
     * @param oemManaged whether the network is OEM managed, see
     *                   {@code NetworkTemplate#OEM_MANAGED_*}.
     */
     ...
     * {@code ratType}, assuming that any mobile networks are using the current IMSI.
     *
     ...
     *                See {@code TelephonyManager.NETWORK_TYPE_*}.
     */
    // TODO: Put this in the static library instead of exposing Api.
    @NonNull
    public static NetworkIdentity buildNetworkIdentity(@NonNull NetworkStateSnapshot snapshot,
     ...
     * {@code ratType}, assuming that any mobile networks are using the current IMSI.
     *
     * @deprecated Use {@link #buildNetworkIdentity(NetworkStateSnapshot, boolean, int)} instead.
     * @hide
     */
    // TODO: Remove this after all callers are migrated to use new Api.
    @Deprecated
    public static NetworkIdentity buildNetworkIdentity(@NonNull Context unused,
            @NonNull NetworkStateSnapshot snapshot, boolean defaultNetwork,
            @Annotation.NetworkType int ratType) {
        return buildNetworkIdentity(snapshot, defaultNetwork, ratType);
    }
