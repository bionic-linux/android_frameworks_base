...
public class NetworkIdentity implements Comparable<NetworkIdentity> {
    ...
    /** Return roaming of this instance. */
    public boolean isRoaming() {
        return mRoaming;
    }

    /** Return meteredness of this instance. */
    public boolean isMeteredness() {
        return mMetered;
    }

    /** Return default network status of this instance. */
    public boolean isDefaultNetwork() {
        return mDefaultNetwork;
    }

    /** Get the the OEM managed type of this instance. */
    ...
    public static NetworkIdentity buildNetworkIdentity(Context context,
        ...
        return new NetworkIdentity.Builder().setNetworkStateSnapshot(snapshot)
                .setDefaultNetworkStatus(defaultNetwork).setRatType(ratType).build();
    }
