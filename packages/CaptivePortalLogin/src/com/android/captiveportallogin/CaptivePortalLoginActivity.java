...
public class CaptivePortalLoginActivity extends Activity {
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
            ...
            Log.d(TAG, String.format("SSL error: %s, sslUrl: %s, certificate: %s",
                    sslErrorName(error), sanitizeURL(makeURL(errorUrl)), error.getCertificate()));
            if (TextUtils.isEmpty(errorUrl)
                    // Ignore SSL errors from resources by comparing the main frame url with SSL
                    // error url.
                    || !TextUtils.equals(errorUrl, mMainFrameUrl)) {
