...
fun <T : Exception> assertException(block: Runnable, expected: Class<T>): T {
...
fun assertContains(got: String, want: String) {
...
fun assertLinkPropertiesEqual(source: LinkProperties, target: LinkProperties) {
    ...
    assertEqualBothWays(source, target)
