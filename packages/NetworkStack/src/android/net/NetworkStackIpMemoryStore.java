...
public class NetworkStackIpMemoryStore extends IpMemoryStoreClient {
    ...
    public void isSameNetwork(@NonNull final String l2Key1, @NonNull final String l2Key2,
        ...
        try {
            ...
            Log.e(TAG, "Error checking if it's the same network", e);
        }
    }
