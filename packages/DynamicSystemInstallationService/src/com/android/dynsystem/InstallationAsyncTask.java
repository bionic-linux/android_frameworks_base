...
class InstallationAsyncTask extends AsyncTask<String, InstallationAsyncTask.Progress, Throwable> {
    ...
    protected Throwable doInBackground(String... voids) {
        ...
        try {
            ...
            // getStackTraceString returns an empty string if |e| is caused directly or indirectly
            // by a UnknownHostException. Log the string representation of |e| if that's the case.
