...
class InstallationAsyncTask extends AsyncTask<String, InstallationAsyncTask.Progress, Throwable> {
    ...
    private void verifyAndPrepare() throws IOException {
    ...
    private void installGzUpdate() throws IOException, InterruptedException {
    ...
    private boolean installImageFromAnEntry(ZipEntry entry, InputStream is,
        ...
        if (UNSUPPORTED_PARTITIONS.contains(partitionName)) {
            Log.d(TAG, name + " is found in the zip release, skip it.");
            return false;
        }
    ...
    private void installImage(String partitionName, long uncompressedSize, InputStream is,
        ...
        final long partitionSize =  unsparseSize == -1 ? uncompressedSize : unsparseSize;
