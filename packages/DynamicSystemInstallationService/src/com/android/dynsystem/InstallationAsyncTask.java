...
class InstallationAsyncTask extends AsyncTask<String, InstallationAsyncTask.Progress, Throwable> {
    ...
    private void installUserdata() throws Exception {
        ...
        while (thread.isAlive()) {
            ...
            if (installedSize > publishedProgress + MIN_PROGRESS_TO_PUBLISH) {
                publishProgress(new Progress("userdata", mUserdataSize, installedSize, 0));
                publishedProgress = installedSize;
            }
