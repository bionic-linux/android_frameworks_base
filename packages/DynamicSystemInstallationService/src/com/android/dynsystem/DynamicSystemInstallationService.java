...
public class DynamicSystemInstallationService extends Service
    ...
    public void onCreate() {
        ...
        // Install an HttpResponseCache in the application cache directory so we can cache http(s)
        // responses to save bandwidth. The http(s) protocol handler uses this transparently.
