...
public class DynamicSystemInstallationService extends Service
    ...
    private Notification buildNotification(int status, int cause) {
        ...
        switch (status) {
            ...
            case STATUS_READY:
                String msg_completed = getString(R.string.notification_install_completed);
                builder.setContentText(msg_completed)
                        .setStyle(new Notification.BigTextStyle().bigText(msg_completed));
            ...
            case STATUS_IN_USE:
                String msg_in_use = getString(R.string.notification_dynsystem_in_use);
                builder.setContentText(msg_in_use)
                        .setStyle(new Notification.BigTextStyle().bigText(msg_in_use));
