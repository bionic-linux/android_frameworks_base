...
class DynamicSystemKeyRevocationList {
    ...
    void fetch(URL url) throws IOException, JSONException {
        Log.i(TAG, "Fetch from URL: " + url.toString());
        ...
        try {
            ...
            Log.e(TAG, "Failed to fetch: " + e.toString());
            throw e;
        } finally {
            if (stream != null) {
                stream.close();
        ...
        Log.d(TAG, "Fetched json content: " + content);
        ...
        if (jsonObject.has(ENTRIES)) {
            ...
            for (int i = 0; i < entries.length(); ++i) {
                ...
                Log.i(TAG, "RevocationEntry: " + entry.toString());
