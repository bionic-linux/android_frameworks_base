...
public final class TetheredClient implements Parcelable {
    ...
    public TetheredClient(@NonNull MacAddress macAddress,
            @NonNull List<AddressInfo> addresses, int tetheringType) {
    ...
    private TetheredClient(@NonNull Parcel in) {
        this(in.readParcelable(MacAddress.class.getClassLoader()),
                in.createTypedArrayList(AddressInfo.CREATOR), in.readInt());
    }
    ...
    public TetheredClient addAddresses(@NonNull TetheredClient other) {
        final ArrayList<AddressInfo> newAddresses = new ArrayList<>(
    ...
    /**
     * Information on an address assigned to a tethered client.
     */
    public static final class AddressInfo implements Parcelable {
        ...
        /** @hide */
        public AddressInfo(@NonNull LinkAddress address, String hostname, int expirationTime) {
        ...
        private AddressInfo(Parcel in) {
            this(in.readParcelable(LinkAddress.class.getClassLoader()),  in.readStringNoHelper());
        }

        @Override
        public void writeToParcel(@NonNull Parcel dest, int flags) {
            dest.writeParcelable(mAddress, flags);
            dest.writeStringNoHelper(mHostname);
        }
