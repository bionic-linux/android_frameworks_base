...
public class TetheringManager {
    ...
    private class ConditionWaiting {
        ...
        public boolean waitOrTimeout() {
            return mWaiting.block(DEFAULT_TIMEOUT_MS);
        }

    }

    private class RequestDispatcher {
        private final ConditionWaiting mWaiting;
        ...
        RequestDispatcher() {
            mWaiting = new ConditionWaiting();
        }

        int waitForResult(final RequestHelper request) {
            request.runRequest(mListener);
            if (!mWaiting.waitOrTimeout()) throw new IllegalStateException("Callback timeout");
    ...
    private class TetheringCallbackInternal extends ITetheringEventCallback.Stub {
        ...
        private final ConditionWaiting mWaitForCallback = new ConditionWaiting();
