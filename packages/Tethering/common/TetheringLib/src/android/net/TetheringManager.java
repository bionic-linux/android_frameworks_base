...
public class TetheringManager {
    ...
    private final RequestDispatcher mWaitForCallback = new RequestDispatcher();
    ...
    private class RequestDispatcher {
        ...
        RequestDispatcher(final int timeout) {
            mTimeout = timeout;
    ...
    public int tether(@NonNull final String iface) {
        ...
        final RequestDispatcher waitForCallback = new RequestDispatcher();
     ...
     * has no upstream or disabled, the argument of callback would be null. The same callback object
