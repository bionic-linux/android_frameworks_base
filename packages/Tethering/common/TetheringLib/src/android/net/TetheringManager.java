...
public class TetheringManager {
    ...
    private class IntResultListener extends IIntResultListener.Stub {
    ...
    private interface RequestHelper {
        void runRequest(IntResultListener listener);
    }
    ...
    private class WaitingUtil {
        ...
        private final IntResultListener mListener = new IntResultListener() {
                @Override
    ...
    public boolean isTetheringSupported() {
        ...
        WaitingUtil waitForCallback = new WaitingUtil();
        final int ret = waitForCallback.waitForResult(listener -> {
            try {
