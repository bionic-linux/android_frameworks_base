...
public class IpServer extends StateMachine {
    ...
    public IpServer(
            String ifaceName, Looper looper, int interfaceType, INetd netd,
            INetworkStatsService statsService, SharedLog log, Callback callback,
    ...
    class BaseServingState extends State {
        ...
        public void enter() {
            ...
            try {
                ...
                final int addFailures = modifyRouteToLocalNetwork(true/* add */, routes);
                if (addFailures > 0) {
                    throw new Exception(
                        String.format("Failed to add %d routes from local table.", addFailures));
                }
            } catch (Exception e) {
