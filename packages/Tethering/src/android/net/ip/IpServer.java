...
public class IpServer extends StateMachine {
    ...
    private boolean configureIPv4(boolean enabled) {
        ...
        int prefixLen = 0;
        try {
            if (mInterfaceType == TETHERING_USB) {
                srvAddr = (Inet4Address) parseNumericAddress(USB_NEAR_IFACE_ADDR);
                prefixLen = USB_PREFIX_LENGTH;
            } else if (mInterfaceType == TETHERING_WIFI) {
                srvAddr = (Inet4Address) parseNumericAddress(getRandomWifiIPv4Address());
                prefixLen = WIFI_HOST_IFACE_PREFIX_LENGTH;
            } else if (mInterfaceType == TETHERING_WIFI_P2P) {
        ...
        try {
            ...
            if (mInterfaceType == TETHERING_WIFI) {
                ...
                setIfaceUp = new Boolean(enabled);
            }
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case CMD_SET_DNS_FORWARDERS_ERROR:
                    mLastError = TETHER_ERROR_MASTER_ERROR;
                    transitionTo(mInitialState);
                    break;
                default:
                    return false;
                ...
                case CMD_TETHER_CONNECTION_CHANGED:
                    ...
                    for (String ifname : added) {
                        try {
                            ...
                            cleanupUpstream();
                            mLastError = TETHER_ERROR_ENABLE_NAT_ERROR;
                            transitionTo(mInitialState);
                            return true;
                        }
                    }
