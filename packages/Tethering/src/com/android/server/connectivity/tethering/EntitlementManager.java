...
public class EntitlementManager {
    ...
    protected void runSilentTetherProvisioning(int type, int subId) {
        ...
        // Only admin user can change tethering and silent provisioning have UI interactive,
        // it is fine to always start setting's background service as system user.
