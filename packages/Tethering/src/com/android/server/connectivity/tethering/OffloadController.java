...
public class OffloadController {
    ...
    public OffloadController(Handler h, OffloadHardwareInterface hwi,
        ...
        try {
            providerCallback = mNsm.registerNetworkStatsProvider(
    ...
    class OffloadTetheringStatsProvider extends NetworkStatsProviderBase {
        ...
        @NonNull final NetworkStats mIfaceStats = new NetworkStats(0L, 0);
        @NonNull final NetworkStats mUidStats = new NetworkStats(0L, 0);

        @VisibleForTesting
        @NonNull NetworkStats getTetherStats(@NonNull StatsType how) {
