...
public class ConnectedClientsTracker {
    ...
    public boolean updateConnectedClients(
        ...
        final List<TetheredClient> newClients =
                Collections.unmodifiableList(new ArrayList<>(clientsMap.values()));
        final boolean clientsChanged = !Objects.equals(mLastTetheredClients, newClients);
        mLastTetheredClients = newClients;
