...
public class OffloadHardwareInterface {
    ...
    public static class ControlCallback {
        ...
        /**
         * Offload stopped because of that an error has occurred in lower layer.
         */
        public void onStoppedError() {}
        /**
         * Offload stopped that device may be moved to a RAT on which hardware
         * offload is not supported. Subsequent calls to setUpstreamParameters
         ...
         * #onSupportAvailable(), the caller should reprogram the hardware
    ...
    /** Get default value indicated whether offload is supported. */
