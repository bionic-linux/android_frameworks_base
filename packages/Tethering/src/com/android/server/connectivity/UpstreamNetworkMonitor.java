...
public class UpstreamNetworkMonitor {
    ...
    /** Whether mobile network is reuqested. */
    ...
    /** Release mobile network reuqest. */
    ...
    /**
     * Get current default upstream network. If default network is cellular and DUN is required,
     * preferred upstream would be DUN. Returns null if no current upstream available.
     */
