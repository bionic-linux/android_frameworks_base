...
public class EthernetTetheringTest {
    ...
    // Similar to ThrowingRunnable in com.android.compatibility.common.util, but throws Exception
    // instead of RuntimeException.
    public interface ThrowingRunnable {
        public void run() throws Exception;
    }

    private void runWithShellPermissionIdentity(ThrowingRunnable r) throws Exception {
        try {
            mUiAutomation.adoptShellPermissionIdentity();
            r.run();
        } finally {
