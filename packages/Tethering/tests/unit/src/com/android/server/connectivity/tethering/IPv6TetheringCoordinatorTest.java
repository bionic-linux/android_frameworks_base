...
public class IPv6TetheringCoordinatorTest {
    ...
    private UpstreamNetworkState createIpv6Upstream(final int transportType) {
    ...
    private void assertIpv6OnlyLinkProperties(LinkProperties lp) {
    ...
    public void testUpdateIpv6Upstream() throws Exception {
        ...
        final UpstreamNetworkState mobileUpstream = createIpv6Upstream(TRANSPORT_CELLULAR);
        ArgumentCaptor<LinkProperties> lp = ArgumentCaptor.forClass(LinkProperties.class);
        ...
        assertIpv6OnlyLinkProperties(v6OnlyLink);
        verifyNoMoreInteractions(firstServer);
        verifyNoMoreInteractions(secondServer);
        reset(firstServer, secondServer);
