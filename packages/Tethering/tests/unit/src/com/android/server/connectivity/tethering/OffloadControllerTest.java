...
public class OffloadControllerTest {
    ...
    public void testGetForwardedStats() throws Exception {
        ...
        final NetworkStats expectedIfaceStats =
                new NetworkStats(0L, 2);
        expectedIfaceStats
                .addValues(new Entry(mobileIface, UID_ALL, SET_DEFAULT, TAG_NONE, METERED_NO,
                        ROAMING_NO, DEFAULT_NETWORK_NO, mobileStats.rxBytes, 0L,
                        mobileStats.txBytes, 0L, 0L))
                .addValues(new NetworkStats.Entry(ethernetIface, UID_ALL, SET_DEFAULT, TAG_NONE,
                        METERED_NO, ROAMING_NO, DEFAULT_NETWORK_NO, 12345 + 100000, 0L,
                        54321 + 100000, 0L, 0L));

        final NetworkStats expectedUidStats = new NetworkStats(0L, 2);
        expectedUidStats
                .addValues(new Entry(mobileIface, UID_TETHERING, SET_DEFAULT, TAG_NONE,
                        METERED_NO, ROAMING_NO, DEFAULT_NETWORK_NO, mobileStats.rxBytes, 0L,
                        mobileStats.txBytes, 0L, 0L))
                .addValues(new NetworkStats.Entry(ethernetIface, UID_TETHERING, SET_DEFAULT,
                        TAG_NONE, METERED_NO, ROAMING_NO, DEFAULT_NETWORK_NO, 12345 + 100000, 0L,
                        54321 + 100000, 0L, 0L));
