...
public class OffloadControllerTest {
    ...
    public void testGetForwardedStats() throws Exception {
        ...
        verify(mTetherStatsProviderCb, times(1)).onStatsUpdated(anyInt(), eq(expectedIfaceStats),
                eq(expectedUidStats));
        ...
        assertEquals(expectedIfaceStatsAccu, ifaceStatsAccu);
        assertEquals(expectedUidStatsAccu, uidStatsAccu);
        ...
        verify(mTetherStatsProviderCb, times(1)).onStatsUpdated(anyInt(),
                eq(expectedIfaceStatsDiff), eq(expectedUidStatsDiff));
    }
