...
public class OffloadControllerTest {
    ...
    public void testGetForwardedStats() throws Exception {
        ...
        verify(mTetherStatsProvider, times(1)).statsUpdated(anyInt(),
    ...
    public void testDataLimitCallback() throws Exception {
        ...
        verify(mTetherStatsProviderCb, times(1)).statsUpdated(anyInt(), any(), any());
    }
    ...
    public void testControlCallbackOnStoppedUnsupportedFetchesAllStats() throws Exception {
        ...
        verify(mTetherStatsProvider, times(1)).statsUpdated(anyInt(), any(), any());
        verifyNoMoreInteractions(mTetherStatsProvider);
