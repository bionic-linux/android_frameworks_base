...
import com.android.server.connectivity.IPv6TetheringCoordinator;
...
import com.android.server.connectivity.TetheringDependencies;
...
public class TetheringServiceTest extends ServiceTestCase<TetheringService> {
    ...
    public void setUp() throws Exception {
        ...
        when(mNetd.interfaceGetCfg(anyString()))
                .thenReturn(new InterfaceConfigurationParcel());
    ...
    private void verifyInterfaceServingModeStarted() throws Exception {
        verify(mNetd, times(1)).interfaceGetCfg(TEST_WLAN_IFNAME);
