...
public class IpServerTest {
    ...
    private static final String FLAG_IFACE_DOWN = "down";
    ...
    private void initStateMachine(int interfaceType, boolean usingLegacyDhcp) throws Exception {
        ...
        mIpServer = new IpServer(
                IFACE_NAME, mLooper.getLooper(), interfaceType, mNetd, mStatsService, mSharedLog,
    ...
    public void startsOutAvailable() {
        mIpServer = new IpServer(IFACE_NAME, mLooper.getLooper(), TETHERING_BLUETOOTH, mNetd,
                mStatsService, mSharedLog, mCallback, false /* usingLegacyDhcp */, mDependencies);
        mIpServer.start();
        mLooper.dispatchAll();
    ...
    public void interfaceDownLeadsToUnavailable() throws Exception {
        for (boolean shouldThrow : new boolean[]{true, false}) {
            ...
            assertMatchFlag(mInterfaceConfiguration.flags, FLAG_IFACE_DOWN);
