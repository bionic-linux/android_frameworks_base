...
public class IpServerTest {
    ...
    @Mock private NetworkStatsProviderCallback mStatsProviderCb;
    ...
    private void initStateMachine(int interfaceType, boolean usingLegacyDhcp) throws Exception {
        ...
        mIpServer = new IpServer(
                ...
                mNMService, mStatsProviderCb, mCallback, usingLegacyDhcp, mDependencies);
        mIpServer.start();
        // Starting the state machine always puts us in a consistent state and notifies
        // the rest of the world that we've changed from an unknown to available state.
        mLooper.dispatchAll();
        reset(mNMService, mStatsProviderCb, mCallback);
    ...
    public void startsOutAvailable() {
        mIpServer = new IpServer(IFACE_NAME, mLooper.getLooper(),
                TETHERING_BLUETOOTH, mSharedLog, mNMService, mStatsProviderCb, mCallback,
        ...
        verifyNoMoreInteractions(mCallback, mNMService, mStatsProviderCb);
    }
    ...
    public void shouldDoNothingUntilRequested() throws Exception {
        ...
        for (int command : noOp_commands) {
            ...
            verifyNoMoreInteractions(mNMService, mStatsProviderCb, mCallback);
        }
    }
    ...
    public void canUnrequestTethering() throws Exception {
        ...
        InOrder inOrder = inOrder(mNMService, mNetd, mStatsProviderCb, mCallback);
    ...
    public void handlesChangingUpstream() throws Exception {
        ...
        InOrder inOrder = inOrder(mNMService, mStatsProviderCb);
        inOrder.verify(mStatsProviderCb).onAlertReached();
