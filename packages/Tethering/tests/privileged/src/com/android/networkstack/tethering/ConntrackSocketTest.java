...
public class ConntrackSocketTest {
    ...
    public void testConntrackSocket() throws Exception {
        ...
        final InetSocketAddress anyAddress = new InetSocketAddress(InetAddress.getLocalHost(), 0);
        ...
        final Socket stillActiveSocket = serverSocket.accept();

        final NativeHandle handle = mDeps.createConntrackSocket(
                NF_NETLINK_CONNTRACK_NEW | NF_NETLINK_CONNTRACK_DESTROY);
        mOffloadHw.sendNfgenMessage(handle,
        ...
        try {
            ...
            socket.close();
            serverSocket.close();
            assertTrue(foundConntrackEntry);
        }
    }
}
