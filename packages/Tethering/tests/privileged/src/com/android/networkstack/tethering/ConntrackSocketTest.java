...
public class ConntrackSocketTest {
    ...
    public void testConntrackSocket() throws Exception {
        ...
        final InetSocketAddress anyAddress = new InetSocketAddress(InetAddress.getByName("127.0.0.1"), 0);
        ...
        assertTrue("Did not receive any NFNL_SUBSYS_CTNETLINK/IPCTNL_MSG_CT_NEW message",foundConntrackEntry);
    }
}
