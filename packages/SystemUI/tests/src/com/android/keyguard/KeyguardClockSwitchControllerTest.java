...
public class KeyguardClockSwitchControllerTest extends SysuiTestCase {
    ...
    public void testChangeToDoubleLineClockSetsSmallClock() {
        when(mSecureSettings.getIntForUser(Settings.Secure.LOCKSCREEN_USE_DOUBLE_LINE_CLOCK,
                mContext.getResources().getInteger(R.integer.config_doubleline_clock_default),
