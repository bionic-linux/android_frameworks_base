...
public class SecurityControllerTest extends SysuiTestCase implements SecurityControllerCallback {
    ...
    private boolean isNetworkRequestSuitableForSecurityController(NetworkRequest nr) {
        final NetworkCapabilities nc = nr.networkCapabilities;
        return nc.getUids() == null && nc.getCapabilities().length == 0;
    }
