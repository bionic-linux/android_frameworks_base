...
public class HeadsUpAppearanceController implements OnHeadsUpChangedListener,
    ...
    /**
     * Hides the view based on the end state.
     *
    ...
    private void hide(View view, int endState) {
        animateHide(view, endState, mAnimationsEnabled);
    }

    private void animateHide(View view, int endState, boolean animate) {
        if (animate) {
    ...
    private void show(View view) {
        animateShow(view, mAnimationsEnabled);
    }
