...
public class MobileSignalController extends SignalController<
    ...
    public MobileSignalController(Context context, Config config, boolean hasMobileData,
        ...
        mImsManagerConnector = new ImsManager.Connector(context,
                SubscriptionManager.getPhoneId(info.getSubscriptionId()), mImsConnectionListener);
    }
    ...
    private void stopListeningForImsCapabilities() {
        if (mImsManager != null) {
            try {
                mImsManager.removeRegistrationListener(mImsRegistrationStateListener);
                mImsManager.removeCapabilitiesCallback(mImsFeatureCapabilityListener);
