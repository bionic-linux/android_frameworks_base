...
public class SecurityControllerImpl implements SecurityController {
    ...
    public boolean isVpnValidated() {
        ...
        // Identify any invalidated status in each active VPN network within other profiles.
    ...
    private final NetworkCallback mNetworkCallback = new NetworkCallback() {
        ...
        public void onCapabilitiesChanged(Network network, NetworkCapabilities nc) {
            synchronized (mNetworkProperties) {
                ...
                // There should be a LinkPropertiesChanged event before
                // the onCapabilitiesChanged event with validation change.
                if (properties == null) {
                    return;
                }
        ...
        public void onLinkPropertiesChanged(Network network, LinkProperties linkProperties) {
            ...
            if (interfaceName == null) {
                Log.w(TAG, "onLinkPropertiesChanged event with null getInterfaceName()");
                return;
            }
            synchronized (mNetworkProperties) {
