...
public class NetworkController extends BroadcastReceiver implements DemoMode {
    ...
    public NetworkController(Context context) {
        ...
        mPhoneStateListener = new myPhoneStateListener[mSubCount];
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(WifiManager.RSSI_CHANGED_ACTION)
            ...
            int subscription = intent.getIntExtra(PhoneConstants.SIM_ID_KEY, PhoneConstants.SIM_ID_1);
    ...
    private class myPhoneStateListener extends PhoneStateListener {
        ...
        public void onSignalStrengthsChanged(SignalStrength signalStrength) {
            final int subscription = Arrays.asList(mPhoneStateListener).indexOf(this);
            if (DEBUG) {
