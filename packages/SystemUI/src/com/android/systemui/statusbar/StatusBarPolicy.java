...
public class StatusBarPolicy {
    ...
    private void updateConnectivity(Intent intent) {
        ...
        case ConnectivityManager.TYPE_MOBILE:
            ...
            updateDataIcon(PhoneFactory.getDataSubscription());
            updateSignalStrength(PhoneFactory.getDataSubscription()); // apply any change in connectionStatus
            break;
        case ConnectivityManager.TYPE_WIFI:
            ...
            updateSignalStrength(PhoneFactory.getDataSubscription()); // apply any change in mInetCondition
            break;
        }
    }
    ...
    private PhoneStateListener getPhoneStateListener(int subscription) {
        PhoneStateListener phoneStateListener = new PhoneStateListener(subscription) {
            ...
            public void onServiceStateChanged(ServiceState state) {
                ...
                updateSignalStrength(mSubscription);
                updateCdmaRoamingIcon(state, mSubscription);
    ...
    private final void updateSimState(Intent intent) {
        ...
        int subscription = intent.getIntExtra(IccCard.INTENT_KEY_SUBCRIPTION, 0);
    ...
    private boolean isEvdo(int subscription) {
        return ( (getServiceStateForSubscription(subscription) != null)
    ...
    private final void updateIcon(int sub, int signal) {
        mPhoneSignalIconId[sub] = signal;
        mService.setIcon(mSignalIcon[sub], mPhoneSignalIconId[sub], 0);
    }
    ...
    private final void updateDataIcon() {
        ...
        dataSub = Settings.System.getInt(mContext.getContentResolver(),Settings.System.DUAL_SIM_DATA_CALL, 0);
        // Update icon only if DDS in properly set and "subscription" matches DDS.
        if ((dataSub < 0) || (subscription != dataSub)) {
            return;
        }
