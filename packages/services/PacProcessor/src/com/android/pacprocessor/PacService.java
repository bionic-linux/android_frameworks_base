...
public class PacService extends Service {
    ...
    private static PacNative sPacNative = new PacNative();
    private ProxyServiceStub mStub = new ProxyServiceStub();

    @Override
    public void onCreate() {
        super.onCreate();
        sPacNative.startPacSupport();
    }

    @Override
    public void onDestroy() {
        sPacNative.stopPacSupport();
        super.onDestroy();
    }
    ...
    private static class ProxyServiceStub extends IProxyService.Stub {
        ...
        public String resolvePacFile(String host, String url) throws RemoteException {
            try {
                ...
                return sPacNative.makeProxyRequest(url, host);
        ...
        public void setPacFile(String script) throws RemoteException {
            ...
            sPacNative.setCurrentProxyScript(script);
        }
