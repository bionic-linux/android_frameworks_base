...
fun main(args: Array<String>) {
    ...
    cb.getPackages()
        ...
        .forEach {
            for (method in it.methods()) {
                if (method.modifiers.isAnnotatedWith("android.annotation.FlaggedApi")) {
                    val flagValue =
                        method.modifiers
                    ...
                    if (flagValue !is String) continue
    ...
    val fs = FileOutputStream(args[1])
    fs.use { flagApiMap.writeTo(fs) }
}
