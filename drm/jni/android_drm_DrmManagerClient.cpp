...
static void android_drm_DrmManagerClient_releaseResources(
        JNIEnv* env, jobject thiz, jint uniqueId) {
    ALOGV("releaseResources - Enter");

    getDrmManagerClientImpl(env, thiz)->setOnInfoListener(uniqueId, NULL);

    ALOGV("releaseResources - Exit");
}
...
static JNINativeMethod nativeMethods[] = {
    ...
    {"_releaseResources", "(I)V",
                                    (void*)android_drm_DrmManagerClient_releaseResources},
