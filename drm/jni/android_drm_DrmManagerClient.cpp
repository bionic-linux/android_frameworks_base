...
class Utility {
  public:
    ...
    static char* getByteArrayValue(JNIEnv* env, jobject object, const char* fieldName,
                                   int* dataLength);

    static char* getByteArrayValue(JNIEnv* env, jbyteArray byteArray, int* dataLength);
...
char* Utility::getByteArrayValue(JNIEnv* env, jobject object, const char* fieldName,
                                 int* dataLength) {
    *dataLength = 0;
...
static sp<DrmManagerClientImpl> setDrmManagerClientImpl(JNIEnv* env, jobject thiz,
...
static jint android_drm_DrmManagerClient_initialize(JNIEnv* env, jobject thiz) {
...
static void android_drm_DrmManagerClient_setListeners(JNIEnv* env, jobject thiz, jint uniqueId,
                                                      jobject weak_thiz) {
...
static void android_drm_DrmManagerClient_release(JNIEnv* env, jobject thiz, jint uniqueId) {
    ALOGV("release - Enter");
...
static jobject android_drm_DrmManagerClient_getConstraintsFromContent(JNIEnv* env, jobject thiz,
                                                                      jint uniqueId, jstring jpath,
                                                                      jint usage) {
        ...
        while (keyIt.hasNext()) {
            ...
            if (DrmConstraints::EXTENDED_METADATA == key) {
                ...
                if (NULL != value) {
                    ...
                    env->CallVoidMethod(constraints, ContentValues_putByteArray, keyString.get(),
                                        dataArray.get());
                }
            } else {
                ...
                env->CallVoidMethod(constraints, ContentValues_putString, keyString.get(),
                                    valueString.get());
            }
        }
    }
...
static jobject android_drm_DrmManagerClient_getMetadataFromContent(JNIEnv* env, jobject thiz,
                                                                   jint uniqueId, jstring jpath) {
    ALOGV("GetMetadata - Enter");
    const String8 pathString = Utility::getStringValue(env, jpath);
    DrmMetadata* pMetadata = getDrmManagerClientImpl(env, thiz)->getMetadata(uniqueId, &pathString);
        ...
        if (NULL != constructorId) {
            ...
            if (NULL != metadata) {
                ...
                while (keyIt.hasNext()) {
                    ...
                    ScopedLocalRef<jstring> keyString(env, env->NewStringUTF(key.string()));
                    ScopedLocalRef<jstring> valueString(env, env->NewStringUTF(value.string()));
                    env->CallVoidMethod(metadata, ContentValues_putString, keyString.get(),
                                        valueString.get());
                }
            }
        }
...
static jobjectArray android_drm_DrmManagerClient_getAllSupportInfo(JNIEnv* env, jobject thiz,
                                                                   jint uniqueId) {
    ...
    for (int i = 0; i < length; i++) {
        ...
        env->CallVoidMethod(drmSupportInfo,
    ...
    delete[] drmSupportInfoArray;
    drmSupportInfoArray = NULL;
    ALOGV("GetAllSupportInfo - Exit");
    return array;
}

static void android_drm_DrmManagerClient_installDrmEngine(JNIEnv* /* env */, jobject /* thiz */,
                                                          jint /* uniqueId */,
...
static jint android_drm_DrmManagerClient_saveRights(JNIEnv* env, jobject thiz, jint uniqueId,
                                                    jobject drmRights, jstring rightsPath,
                                                    jstring contentPath) {
    ...
    if (NULL != mData) {
        ...
        result = getDrmManagerClientImpl(env, thiz)->saveRights(
                uniqueId, rights, Utility::getStringValue(env, rightsPath),
...
static jboolean android_drm_DrmManagerClient_canHandle(JNIEnv* env, jobject thiz, jint uniqueId,
                                                       jstring path, jstring mimeType) {
    ALOGV("canHandle - Enter");
    jboolean result = getDrmManagerClientImpl(env, thiz)->canHandle(
            uniqueId, Utility::getStringValue(env, path), Utility::getStringValue(env, mimeType));
    ALOGV("canHandle - Exit");
    return result;
}

static jobject android_drm_DrmManagerClient_processDrmInfo(JNIEnv* env, jobject thiz, jint uniqueId,
    ...
    jmethodID DrmInfo_get =
            env->GetMethodID(clazz, "get", "(Ljava/lang/String;)Ljava/lang/Object;");
    jobject keyIterator = env->CallObjectMethod(
            drmInfoObject, env->GetMethodID(clazz, "keyIterator", "()Ljava/util/Iterator;"));
    ...
    while (env->CallBooleanMethod(keyIterator, Iterator_hasNext)) {
        ...
        ScopedLocalRef<jobject> valueObject(
                env, env->CallObjectMethod(drmInfoObject, DrmInfo_get, key.get()));
    ...
    if (NULL != localRef && NULL != pDrmInfoStatus) {
        ...
        if (NULL != pDrmInfoStatus->drmBuffer) {
            ...
            delete pDrmInfoStatus->drmBuffer;
            pDrmInfoStatus->drmBuffer = NULL;
        }
        ...
        jobject processedData = env->NewObject(
                clazz, constructorId, dataArray,
        ...
        constructorId = env->GetMethodID(localRef, "<init>",
                                         "(IILandroid/drm/ProcessedData;Ljava/lang/String;)V");

        drmInfoStatus = env->NewObject(localRef, constructorId, statusCode, infoType, processedData,
                                       env->NewStringUTF(pDrmInfoStatus->mimeType.string()));
    }

    delete[] mData;
    mData = NULL;
    delete pDrmInfoStatus;
    pDrmInfoStatus = NULL;
...
static jobject android_drm_DrmManagerClient_acquireDrmInfo(JNIEnv* env, jobject thiz, jint uniqueId,
    ...
    jobject keyIterator = env->CallObjectMethod(
            drmInfoRequest, env->GetMethodID(clazz, "keyIterator", "()Ljava/util/Iterator;"));
    jmethodID DrmInfoRequest_get =
            env->GetMethodID(clazz, "get", "(Ljava/lang/String;)Ljava/lang/Object;");
    ...
    while (env->CallBooleanMethod(keyIterator, Iterator_hasNext)) {
        ScopedLocalRef<jstring> key(env,
                                    (jstring)env->CallObjectMethod(keyIterator, Iterator_next));
        ScopedLocalRef<jstring> value(
                env, (jstring)env->CallObjectMethod(drmInfoRequest, DrmInfoRequest_get, key.get()));
    ...
    if (NULL != pDrmInfo) {
        ...
        if (NULL != localRef) {
            ...
            drmInfoObject = env->NewObject(
                    localRef, env->GetMethodID(localRef, "<init>", "(I[BLjava/lang/String;)V"),
            ...
            while (it.hasNext()) {
                ...
                ScopedLocalRef<jstring> keyString(env, env->NewStringUTF(key.string()));
                ScopedLocalRef<jstring> valueString(env, env->NewStringUTF(value.string()));
                env->CallVoidMethod(drmInfoObject, putMethodId, keyString.get(), valueString.get());
            }
        }
...
static jint android_drm_DrmManagerClient_getDrmObjectType(JNIEnv* env, jobject thiz, jint uniqueId,
                                                          jstring path, jstring mimeType) {
    ALOGV("getDrmObjectType Enter");
    int drmObjectType = getDrmManagerClientImpl(env, thiz)->getDrmObjectType(
            uniqueId, Utility::getStringValue(env, path), Utility::getStringValue(env, mimeType));
    ALOGV("getDrmObjectType Exit");
    return static_cast<jint>(drmObjectType);
}

static jstring android_drm_DrmManagerClient_getOriginalMimeType(JNIEnv* env, jobject thiz,
                                                                jint uniqueId, jstring path,
                                                                jobject fileDescriptor) {
    ALOGV("getOriginalMimeType Enter");

    int fd = (fileDescriptor == NULL) ? -1 : jniGetFDFromFileDescriptor(env, fileDescriptor);

    String8 mimeType = getDrmManagerClientImpl(env, thiz)->getOriginalMimeType(
            uniqueId, Utility::getStringValue(env, path), fd);
    ALOGV("getOriginalMimeType Exit");
    return env->NewStringUTF(mimeType.string());
}

static jint android_drm_DrmManagerClient_checkRightsStatus(JNIEnv* env, jobject thiz, jint uniqueId,
                                                           jstring path, int action) {
    ALOGV("checkRightsStatus Enter");
    int rightsStatus = getDrmManagerClientImpl(env, thiz)->checkRightsStatus(
            uniqueId, Utility::getStringValue(env, path), action);
    ALOGV("checkRightsStatus Exit");
    return static_cast<jint>(rightsStatus);
}

static jint android_drm_DrmManagerClient_removeRights(JNIEnv* env, jobject thiz, jint uniqueId,
                                                      jstring path) {
    ALOGV("removeRights");
    return static_cast<jint>(getDrmManagerClientImpl(env, thiz)->removeRights(
            uniqueId, Utility::getStringValue(env, path)));
}

static jint android_drm_DrmManagerClient_removeAllRights(JNIEnv* env, jobject thiz, jint uniqueId) {
    ALOGV("removeAllRights");
    return static_cast<jint>(getDrmManagerClientImpl(env, thiz)->removeAllRights(uniqueId));
}

static jint android_drm_DrmManagerClient_openConvertSession(JNIEnv* env, jobject thiz,
                                                            jint uniqueId, jstring mimeType) {
    ALOGV("openConvertSession Enter");
    int convertId = getDrmManagerClientImpl(env, thiz)->openConvertSession(
            uniqueId, Utility::getStringValue(env, mimeType));
...
static jobject GetConvertedStatus(JNIEnv* env, DrmConvertedStatus* pDrmConvertedStatus) {
    ...
    if (NULL != localRef && NULL != pDrmConvertedStatus) {
        ...
        if (NULL != pDrmConvertedStatus->convertedData) {
            ...
            delete pDrmConvertedStatus->convertedData;
            pDrmConvertedStatus->convertedData = NULL;
        }
        jmethodID constructorId = env->GetMethodID(localRef, "<init>", "(I[BI)V");
        drmConvertedStatus = env->NewObject(localRef, constructorId, statusCode, dataArray,
                                            pDrmConvertedStatus->offset);
    }

    delete pDrmConvertedStatus;
    pDrmConvertedStatus = NULL;

    ALOGV("GetConvertedStatus - Exit");
    return drmConvertedStatus;
}

static jobject android_drm_DrmManagerClient_convertData(JNIEnv* env, jobject thiz, jint uniqueId,
                                                        jint convertId, jbyteArray inputData) {
...
static jobject android_drm_DrmManagerClient_closeConvertSession(JNIEnv* env, jobject thiz,
                                                                jint uniqueId, jint convertId) {
...
static const JNINativeMethod nativeMethods[] = {
        ...
        {"_initialize", "()I", (void*)android_drm_DrmManagerClient_initialize},

        {"_setListeners", "(ILjava/lang/Object;)V",
         (void*)android_drm_DrmManagerClient_setListeners},

        {"_release", "(I)V", (void*)android_drm_DrmManagerClient_release},
        ...
        {"_removeAllRights", "(I)I", (void*)android_drm_DrmManagerClient_removeAllRights},
